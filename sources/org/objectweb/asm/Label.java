...
/* loaded from: 地图_V1.10.0_20240112105442_Release.apk:org/objectweb/asm/Label.SCL.lombok */
public class Label {
        ...
        for (int i = this.forwardReferences[0]; i > 0; i -= 2) {
            ...
            if ((reference & FORWARD_REFERENCE_TYPE_MASK) == 268435456) {
                if (relativeOffset < -32768 || relativeOffset > 32767) {
                    int opcode = code[sourceInsnBytecodeOffset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
                    if (opcode < 198) {
