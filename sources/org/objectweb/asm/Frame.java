...
/* loaded from: 地图_V1.10.0_20240112105442_Release.apk:org/objectweb/asm/Frame.SCL.lombok */
public class Frame {
            ...
            case 58:
                ...
                if (arg > 0) {
                    ...
                    if (previousLocalType == LONG || previousLocalType == DOUBLE) {
                        ...
                        return;
                    } else if ((previousLocalType & KIND_MASK) == 16777216 || (previousLocalType & KIND_MASK) == STACK_KIND) {
            ...
            case 57:
                ...
                if (arg > 0) {
                    ...
                    if (previousLocalType2 == LONG || previousLocalType2 == DOUBLE) {
                        setLocal(arg - 1, 4194304);
                        return;
                    } else if ((previousLocalType2 & KIND_MASK) == 16777216 || (previousLocalType2 & KIND_MASK) == STACK_KIND) {
