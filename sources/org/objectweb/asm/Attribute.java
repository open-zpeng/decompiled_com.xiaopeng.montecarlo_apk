...
/* loaded from: 地图_V1.10.0_20240112105442_Release.apk:org/objectweb/asm/Attribute.SCL.lombok */
public class Attribute {
    ...
    public static int computeAttributesSize(SymbolTable symbolTable, int accessFlags, int signatureIndex) {
        ...
        if (signatureIndex != 0) {
            symbolTable.addConstantUtf8(RequestParameters.SIGNATURE);
            size += 8;
        }
    ...
    public static void putAttributes(SymbolTable symbolTable, int accessFlags, int signatureIndex, ByteVector output) {
        ...
        if (signatureIndex != 0) {
            output.putShort(symbolTable.addConstantUtf8(RequestParameters.SIGNATURE)).putInt(2).putShort(signatureIndex);
        }
        if ((accessFlags & 131072) != 0) {
    ...
    /* loaded from: 地图_V1.10.0_20240112105442_Release.apk:org/objectweb/asm/Attribute$Set.SCL.lombok */
