...
/* loaded from: xp_Montecarlo-benchDavid55.apk:org/objectweb/asm/ClassReader.SCL.lombok */
public class ClassReader {
    ...
    public void accept(ClassVisitor classVisitor, Attribute[] attributePrototypes, int parsingOptions) {
        ...
        for (int i2 = readUnsignedShort(currentAttributeOffset - 2); i2 > 0; i2--) {
            ...
            } else if (RequestParameters.SIGNATURE.equals(attributeName)) {
    ...
    private int readRecordComponent(ClassVisitor classVisitor, Context context, int recordComponentOffset) {
        ...
        while (true) {
            ...
            if (RequestParameters.SIGNATURE.equals(attributeName)) {
    ...
    private void readCode(MethodVisitor methodVisitor, Context context, int codeOffset) {
        ...
        while (currentOffset < bytecodeEndOffset) {
            ...
            switch (classBuffer[currentOffset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) {
                case 0:
                case 1:
                case 2:
                case 3:
                ...
                case Opcodes.INVOKEDYNAMIC /* 186 */:
                    ...
                    break;
                case 196:
                    switch (classBuffer[currentOffset + 1] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) {
                        case 21:
                        case 22:
                        case 23:
                        case 24:
                ...
                case 200:
                case 201:
                case LocTrafficSignType.LOC_TRAFFIC_SIGN_NO_OVERTAKING /* 220 */:
                ...
                case 216:
                case 217:
                case LocTrafficSignType.LOC_TRAFFIC_SIGN_NO_STRAIGHT_THRU_RIGHT_TURN /* 218 */:
                case LocTrafficSignType.LOC_TRAFFIC_SIGN_NO_U_TURN /* 219 */:
                    ...
                    if (i4 > 0) {
                        ...
                        if (stackMapFrameOffset != 0) {
                            ...
                            for (int offset = stackMapFrameOffset; offset < stackMapTableEndOffset - 2; offset++) {
                                if (classBuffer[offset] == 8 && (potentialBytecodeOffset = readUnsignedShort(offset + 1)) >= 0 && potentialBytecodeOffset < codeLength && (classBuffer[currentOffset + potentialBytecodeOffset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) == 187) {
                        ...
                        while (currentOffset6 < bytecodeEndOffset) {
                            ...
                            switch (opcode) {
                                ...
                                case 17:
                                    ...
                                    break;
                                case 18:
                                    methodVisitor.visitLdcInsn(readConst(classBuffer[currentOffset6 + 1] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR, charBuffer));
                                    currentOffset6 += 2;
                                    break;
                                case 19:
                                case 20:
    ...
    private int[] readTypeAnnotations(MethodVisitor methodVisitor, Context context, int runtimeTypeAnnotationsOffset, boolean visible) {
        ...
        for (int i = 0; i < typeAnnotationsOffsets.length; i++) {
            ...
            if ((targetType >>> 24) == 66) {
                ...
                readElementValues = readElementValues(methodVisitor.visitTryCatchAnnotation(targetType & InputDeviceCompat.SOURCE_ANY, path, annotationDescriptor, visible), currentOffset3 + 2, true, charBuffer);
            } else {
    ...
    private void readParameterAnnotations(MethodVisitor methodVisitor, Context context, int runtimeParameterAnnotationsOffset, boolean visible) {
        ...
        int numParameters = this.classFileBuffer[runtimeParameterAnnotationsOffset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
    ...
    private int readElementValue(AnnotationVisitor annotationVisitor, int elementValueOffset, String elementName, char[] charBuffer) {
        ...
        if (annotationVisitor != null) {
            ...
            switch (this.classFileBuffer[elementValueOffset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) {
                case 64:
                ...
                case 91:
                    ...
                    switch (this.classFileBuffer[currentOffset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) {
                        case 66:
    ...
    private int readStackMapFrame(int stackMapFrameOffset, boolean compressed, boolean expand, Context context) {
        ...
        if (compressed) {
            currentOffset++;
            frameType = this.classFileBuffer[currentOffset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
        } else {
            frameType = 255;
            context.currentFrameOffset = -1;
        }
    ...
    private int readVerificationTypeInfo(int verificationTypeInfoOffset, Object[] frame, int index, char[] charBuffer, Label[] labels) {
        ...
        int tag = this.classFileBuffer[verificationTypeInfoOffset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
        switch (tag) {
            case 0:
    ...
    public int readByte(int offset) {
        return this.classFileBuffer[offset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
    }

    public int readUnsignedShort(int offset) {
        byte[] classBuffer = this.classFileBuffer;
        return ((classBuffer[offset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) | (classBuffer[offset + 1] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
    }

    public short readShort(int offset) {
        byte[] classBuffer = this.classFileBuffer;
        return (short) (((classBuffer[offset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) | (classBuffer[offset + 1] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR));
    }

    public int readInt(int offset) {
        byte[] classBuffer = this.classFileBuffer;
        return ((classBuffer[offset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 24) | ((classBuffer[offset + 1] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 16) | ((classBuffer[offset + 2] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) | (classBuffer[offset + 3] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
    }

    public long readLong(int offset) {
        long l1 = readInt(offset);
        long l0 = readInt(offset + 4) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
        return (l1 << 32) | l0;
    }
