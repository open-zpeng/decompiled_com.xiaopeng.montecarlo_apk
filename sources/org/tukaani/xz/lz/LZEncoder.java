...
public abstract class LZEncoder {
    ...
    public int getByte(int i) {
        return this.buf[this.readPos - i] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
    }

    public int getByte(int i, int i2) {
        return this.buf[(this.readPos + i) - i2] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
    }
