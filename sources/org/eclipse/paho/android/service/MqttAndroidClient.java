...
public class MqttAndroidClient extends BroadcastReceiver implements IMqttAsyncClient {
    ...
    public final class MyServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            Log.i(MqttAndroidClient.TAG, "onServiceConnected");
        ...
        public void onServiceDisconnected(ComponentName name) {
            Log.i(MqttAndroidClient.TAG, "onServiceDisconnected");
    ...
    public IMqttToken disconnect(long quiesceTimeout) throws MqttException {
        ...
        String storeToken = storeToken(mqttTokenAndroid);
        if (isMqttServiceAvailable()) {
            this.mqttService.disconnect(this.clientHandle, quiesceTimeout, null, storeToken);
            return mqttTokenAndroid;
        }
        return null;
    }
    ...
    public IMqttToken disconnectConnection(IMqttActionListener callback) throws MqttException {
        ...
        String storeToken = storeToken(mqttTokenAndroid);
        if (isMqttServiceAvailable()) {
            this.mqttService.disconnectConnection(this.clientHandle, null, storeToken);
            return mqttTokenAndroid;
        }
        return null;
    }
    ...
    public IMqttDeliveryToken publish(String topic, byte[] payload, int qos, boolean retained, Object userContext, IMqttActionListener callback) throws MqttException, MqttPersistenceException {
        ...
        if (isMqttServiceAvailable()) {
            mqttDeliveryTokenAndroid.setDelegate(this.mqttService.publish(this.clientHandle, topic, payload, qos, retained, null, storeToken));
    ...
    public IMqttDeliveryToken publish(String topic, MqttMessage message, Object userContext, IMqttActionListener callback) throws MqttException, MqttPersistenceException {
        ...
        String storeToken = storeToken(mqttDeliveryTokenAndroid);
        if (isMqttServiceAvailable()) {
            mqttDeliveryTokenAndroid.setDelegate(this.mqttService.publish(this.clientHandle, topic, message, null, storeToken));
            return mqttDeliveryTokenAndroid;
        }
        return null;
    }
    ...
    public IMqttToken subscribe(String topic, int qos, Object userContext, IMqttActionListener callback) throws MqttException {
        ...
        String storeToken = storeToken(mqttTokenAndroid);
        if (isMqttServiceAvailable()) {
            this.mqttService.subscribe(this.clientHandle, topic, qos, (String) null, storeToken);
            return mqttTokenAndroid;
        }
        return null;
    }
    ...
    public IMqttToken subscribe(String[] topicFilters, int[] qos, Object userContext, IMqttActionListener callback, IMqttMessageListener[] messageListeners) throws MqttException {
        String storeToken = storeToken(new MqttTokenAndroid(this, userContext, callback, topicFilters));
        if (isMqttServiceAvailable()) {
            this.mqttService.subscribe(this.clientHandle, topicFilters, qos, null, storeToken, messageListeners);
            return null;
        }
        return null;
    }
    ...
    public IMqttToken unsubscribe(String topic, Object userContext, IMqttActionListener callback) throws MqttException {
        ...
        String storeToken = storeToken(mqttTokenAndroid);
        if (isMqttServiceAvailable()) {
            this.mqttService.unsubscribe(this.clientHandle, topic, (String) null, storeToken);
            return mqttTokenAndroid;
        }
        return null;
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (MqttServiceConstants.CONNECT_ACTION.equals(string2)) {
            ...
            traceAction(extras);
        } else if (isMqttServiceAvailable()) {
    ...
    public boolean acknowledgeMessage(String messageId) {
        return this.messageAck == Ack.MANUAL_ACK && isMqttServiceAvailable() && this.mqttService.acknowledgeMessageArrival(this.clientHandle, messageId) == Status.OK;
    }
    ...
    private boolean isMqttServiceAvailable() {
    ...
    public void checkPing(IMqttActionListener callback) throws MqttException, MqttPersistenceException {
        String storeToken = storeToken(new MqttDeliveryTokenAndroid(this, null, callback, null));
        if (isMqttServiceAvailable()) {
            this.mqttService.checkPing(this.clientHandle, storeToken);
        }
    }
}
