...
public class CommsTokenStore {
    ...
    public void saveToken(MqttToken mqttToken, MqttWireMessage mqttWireMessage) throws MqttException {
        synchronized (this.tokens) {
            if (this.closedResponse == null) {
                ...
                log.fine(CLASS_NAME, "saveToken", XPNaviSearchParam.PARAM_TYPE_VALUE_AOI, new Object[]{key, mqttWireMessage});
    ...
    public String toString() {
        String stringBuffer;
        String property = System.getProperty("line.separator", FDManager.LINE_SEPERATOR);
