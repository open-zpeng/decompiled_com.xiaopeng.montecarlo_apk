...
public class BlockSort {
    ...
    private static final int[] INCS = {1, 4, 13, 40, 121, 364, 1093, LayerPriorityType.LayerPriorityRouteOddLine, 9841, 29524, 88573, 265720, 797161, 2391484};
    ...
    final void fallbackSort(int[] iArr, byte[] bArr, int i) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = bArr[i4] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
            iArr2[i5] = iArr2[i5] + 1;
        }
        ...
        for (int i7 = 0; i7 < i; i7++) {
            int i8 = bArr[i7] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
            int i9 = iArr2[i8] - 1;
            iArr2[i8] = i9;
            iArr[i9] = i7;
        }
    ...
    */
    ...
    private void mainQSort3(BZip2CompressorOutputStream.Data data, int i, int i2, int i3, int i4) {
        ...
        while (true) {
            ...
            if (i11 - i10 < 20 || i12 > 10) {
                ...
                int i13 = i12 + 1;
                int med3 = med3(bArr[iArr4[i10] + i13], bArr[iArr4[i11] + i13], bArr[iArr4[(i10 + i11) >>> i7] + i13]) & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
                int i14 = i10;
                int i15 = i14;
                int i16 = i11;
                int i17 = i16;
                while (true) {
                    if (i14 <= i16) {
                        int i18 = (bArr[iArr4[i14] + i13] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) - med3;
                        if (i18 == 0) {
                            int i19 = iArr4[i14];
                            iArr4[i14] = iArr4[i15];
                            iArr4[i15] = i19;
                    ...
                    i6 = i17;
                    while (i14 <= i16) {
                        int i20 = (bArr[iArr4[i16] + i13] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) - med3;
                        if (i20 != 0) {
                            if (i20 <= 0) {
                                break;
                            }
    ...
    final void mainSort(BZip2CompressorOutputStream.Data data, int i) {
        ...
        bArr[0] = bArr[i12];
        int i13 = 255;
        int i14 = bArr[0] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
        int i15 = 0;
        while (i15 <= i) {
            i15++;
            int i16 = bArr[i15] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
            int i17 = (i14 << 8) + i16;
        ...
        int i19 = bArr[1] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
        int i20 = 0;
        while (i20 < i) {
            int i21 = bArr[i20 + 2] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
            int i22 = (i19 << 8) + i21;
            int i23 = iArr4[i22] - 1;
            iArr4[i22] = i23;
            iArr5[i23] = i20;
        ...
        int i24 = ((bArr[i12] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) + (bArr[c] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
        int i25 = iArr4[i24] - 1;
        iArr4[i24] = i25;
        iArr5[i25] = i;
        int i26 = 256;
        ...
        while (i35 <= i13) {
            ...
            while (i47 < i49) {
                int i50 = iArr5[i47];
                int i51 = i49;
                int i52 = bArr[i50] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
                if (!zArr[i52]) {
