    ...
    */
            ...
            while (i11 < bZip2CompressorOutputStream.nMTF) {
                ...
                if (i == 6) {
                    ...
                    while (i13 <= min) {
                        char c = cArr[i13];
                        byte[] bArr10 = bArr4;
                        short s7 = (short) (s2 + (bArr5[c] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR));
                        short s8 = (short) (s3 + (bArr6[c] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR));
                        short s9 = (short) (s4 + (bArr7[c] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR));
                        short s10 = (short) (s5 + (bArr8[c] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR));
                        i13++;
                        s6 = (short) (s6 + (bArr9[c] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR));
                        s5 = s10;
                        bArr4 = bArr10;
                        s4 = s9;
                        s3 = s8;
                        s2 = s7;
                        s = (short) (s + (bArr4[c] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR));
                        i6 = i6;
                    }
                    bArr = bArr4;
                    i3 = i6;
                    ...
                    for (int i15 = i12; i15 <= min; i15++) {
                        ...
                        while (true) {
                            i16--;
                            if (i16 >= 0) {
                                sArr[i16] = (short) (sArr[i16] + (bArr3[i16][c2] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR));
                            }
                        }
                    }
                }
    ...
    private void sendMTFValues3(int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            while (true) {
                i6--;
                if (i6 >= 0) {
                    int i7 = bArr2[i6] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
                    if (i7 > i4) {
                        i4 = i7;
                    }
                    if (i7 < i5) {
    ...
    private void sendMTFValues5(int i, int i2) throws IOException {
        ...
        for (int i6 = 0; i6 < i2; i6++) {
            int i7 = bArr[i6] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
            int i8 = i5;
            int i9 = i4;
    ...
    private void sendMTFValues6(int i, int i2) throws IOException {
        ...
        while (i5 < i) {
            byte[] bArr2 = bArr[i5];
            int i6 = bArr2[0] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
            while (i3 >= 8) {
                outputStream.write(i4 >> 24);
                i4 <<= 8;
                i3 -= 8;
            ...
            for (int i9 = 0; i9 < i2; i9++) {
                int i10 = bArr2[i9] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
                while (i8 < i10) {
                    while (i3 >= 8) {
    ...
    private void sendMTFValues7() throws IOException {
        ...
        while (i4 < i) {
            ...
            int i6 = bArr2[i5] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
            int[] iArr2 = iArr[i6];
            byte[] bArr3 = bArr[i6];
            while (i4 <= min) {
                char c = cArr[i4];
                ...
                int i7 = bArr3[c] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
                i3 |= iArr2[c] << ((32 - i2) - i7);
                i2 += i7;
                i4++;
            }
    ...
    private void generateMTFValues() {
        ...
        for (int i8 = 0; i8 <= i; i8++) {
            byte b = bArr2[bArr[iArr[i8]] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR];
            byte b2 = bArr3[0];
            int i9 = 0;
            while (b != b2) {
                i9++;
