...
public class BZip2CompressorInputStream extends CompressorInputStream implements BZip2Constants {
    ...
    private void recvDecodingTables() throws IOException {
        ...
        for (int i11 = 0; i11 < bsR2; i11++) {
            int i12 = bArr3[i11] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
            byte b = bArr[i12];
            while (i12 > 0) {
                bArr[i12] = bArr[i12 - 1];
                i12--;
    ...
    private void getAndMoveToFrontDecode() throws IOException {
        ...
        int i10 = bArr2[0] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
        int[] iArr6 = iArr4[i10];
        int[] iArr7 = iArr3[i10];
        int i11 = i9;
        int i12 = i8;
        ...
        while (i16 != i7) {
            ...
            if (i16 == 0 || i16 == 1) {
                ...
                while (true) {
                    if (i16 == 0) {
                        ...
                        if (i16 == 1) {
                            ...
                            int[][] iArr14 = iArr5;
                            byte b = bArr3[cArr[0]];
                            int i23 = b & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
                    ...
                    if (i13 == 0) {
                        i21++;
                        int i25 = bArr2[i21] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
                        iArr13 = iArr4[i25];
                        iArr12 = iArr3[i25];
                        iArr11 = iArr5[i25];
                        i3 = iArr2[i25];
                ...
                int i34 = i16 - 1;
                char c2 = cArr[i34];
                int i35 = bArr3[c2] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
                iArr[i35] = iArr[i35] + 1;
                bArr[i14] = bArr3[c2];
                if (i16 <= 16) {
                    while (i34 > 0) {
                ...
                if (i13 == 0) {
                    i17++;
                    int i37 = bArr2[i17] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
    ...
    private int getAndMoveToFrontDecode0(int i) throws IOException {
        InputStream inputStream = this.in;
        Data data = this.data;
        int i2 = data.selector[i] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
    ...
    private int setupRandPartA() throws IOException {
        if (this.su_i2 <= this.last) {
            ...
            int i = this.data.ll8[this.su_tPos] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
    ...
    private int setupRandPartB() throws IOException {
        ...
        this.su_count = i;
        if (i >= 4) {
            this.su_z = (char) (this.data.ll8[this.su_tPos] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
            this.su_tPos = this.data.tt[this.su_tPos];
            int i2 = this.su_rNToGo;
            if (i2 == 0) {
                this.su_rNToGo = Rand.rNums(this.su_rTPos) - 1;
