...
public class X000A_NTFS implements ZipExtraField {
    ...
    private static ZipEightByteInteger dateToZip(Date date) {
        ...
        return new ZipEightByteInteger((date.getTime() * NavRestoreManager.WAKELOCK_TIMEOUT_10SEC) - EPOCH_OFFSET);
    }
    ...
    private static Date zipToDate(ZipEightByteInteger zipEightByteInteger) {
        ...
        return new Date((zipEightByteInteger.getLongValue() + EPOCH_OFFSET) / NavRestoreManager.WAKELOCK_TIMEOUT_10SEC);
    }
}
