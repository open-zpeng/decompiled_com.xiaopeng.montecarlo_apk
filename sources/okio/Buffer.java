...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
        ...
        return new InputStream() { // from class: okio.Buffer.2
            ...
            public int read() {
                if (Buffer.this.size > 0) {
                    return Buffer.this.readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
                }
                return -1;
            }
    ...
    public short readShort() {
        ...
        int i2 = segment.limit;
        if (i2 - i < 2) {
            return (short) (((readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) | (readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR));
        }
        byte[] bArr = segment.data;
        int i3 = i + 1;
        int i4 = i3 + 1;
        int i5 = ((bArr[i] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) | (bArr[i3] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
        this.size -= 2;
        if (i4 == i2) {
            this.head = segment.pop();
            SegmentPool.recycle(segment);
    ...
    public int readInt() {
        ...
        int i2 = segment.limit;
        if (i2 - i < 4) {
            return ((readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 24) | ((readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 16) | ((readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) | (readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
        }
        byte[] bArr = segment.data;
        int i3 = i + 1;
        int i4 = i3 + 1;
        int i5 = ((bArr[i] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 24) | ((bArr[i3] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 16);
        int i6 = i4 + 1;
        int i7 = i5 | ((bArr[i4] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8);
        int i8 = i6 + 1;
        int i9 = i7 | (bArr[i6] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
        this.size -= 4;
        if (i8 == i2) {
            this.head = segment.pop();
            SegmentPool.recycle(segment);
