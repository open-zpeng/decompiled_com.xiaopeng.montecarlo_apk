...
public final class Span implements Serializable {
    ...
    public int hashCode() {
        int hashCode = (this.traceId.hashCode() ^ LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        String str = this.parentId;
        int hashCode2 = (((hashCode ^ (str == null ? 0 : str.hashCode())) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ this.id.hashCode()) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        Kind kind = this.kind;
        int hashCode3 = (hashCode2 ^ (kind == null ? 0 : kind.hashCode())) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        String str2 = this.name;
        int hashCode4 = (hashCode3 ^ (str2 == null ? 0 : str2.hashCode())) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        long j = this.timestamp;
        int i = (hashCode4 ^ ((int) (hashCode4 ^ (j ^ (j >>> 32))))) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        long j2 = this.duration;
        int i2 = (i ^ ((int) (i ^ (j2 ^ (j2 >>> 32))))) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        Endpoint endpoint = this.localEndpoint;
        int hashCode5 = (i2 ^ (endpoint == null ? 0 : endpoint.hashCode())) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        Endpoint endpoint2 = this.remoteEndpoint;
        return ((((((hashCode5 ^ (endpoint2 != null ? endpoint2.hashCode() : 0)) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ this.annotations.hashCode()) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ this.tags.hashCode()) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ this.flags;
    }
