    ...
    public Buffer writeUtf8(String str) {
        ...
        while (true) {
            ...
            if (charAt2 < 128) {
                ...
                int i7 = this.pos;
                this.pos = i7 + 1;
                bArr4[i7] = (byte) ((charAt2 >> '\f') | LocTrafficSignType.LOC_TRAFFIC_SIGN_NO_HONKING);
                int i8 = this.pos;
                this.pos = i8 + 1;
                ...
                if (!Character.isLowSurrogate(charAt3)) {
                    ...
                    int i14 = this.pos;
                    this.pos = i14 + 1;
                    bArr8[i14] = (byte) ((codePoint >> 18) | RouteChargeDecorator.TYPE_SELECTED_KEEPER);
                    int i15 = this.pos;
                    this.pos = i15 + 1;
