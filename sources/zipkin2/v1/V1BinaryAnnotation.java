...
public final class V1BinaryAnnotation implements Comparable<V1BinaryAnnotation> {
    ...
    public int hashCode() {
        int hashCode = (this.key.hashCode() ^ LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        String str = this.stringValue;
        int hashCode2 = (hashCode ^ (str == null ? 0 : str.hashCode())) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        Endpoint endpoint = this.endpoint;
