...
public final class V1Span {
    ...
    public int hashCode() {
        ...
        long j2 = this.traceIdHigh;
        int i = (((int) (j ^ (j2 ^ (j2 >>> 32)))) ^ LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        long j3 = this.traceId;
        int i2 = (i ^ ((int) (i ^ (j3 ^ (j3 >>> 32))))) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        String str = this.name;
        int hashCode = (i2 ^ (str == null ? 0 : str.hashCode())) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        long j4 = this.id;
        int i3 = (hashCode ^ ((int) (hashCode ^ (j4 ^ (j4 >>> 32))))) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        long j5 = this.parentId;
        int i4 = (i3 ^ ((int) (i3 ^ (j5 ^ (j5 >>> 32))))) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        long j6 = this.timestamp;
        int i5 = (i4 ^ ((int) (i4 ^ (j6 ^ (j6 >>> 32))))) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        long j7 = this.duration;
        int hashCode2 = (((((i5 ^ ((int) (((j7 >>> 32) ^ j7) ^ i5))) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ this.annotations.hashCode()) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ this.binaryAnnotations.hashCode()) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        Boolean bool = this.debug;
