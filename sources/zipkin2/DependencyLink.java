...
public final class DependencyLink implements Serializable {
    ...
    public int hashCode() {
        int hashCode = (((this.parent.hashCode() ^ LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ this.child.hashCode()) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        long j = this.callCount;
        int i = (hashCode ^ ((int) (j ^ (j >>> 32)))) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
