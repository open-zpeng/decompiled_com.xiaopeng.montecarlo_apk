...
public final class Endpoint implements Serializable {
    ...
    public static final class Builder {
        ...
        public final boolean parseIp(byte[] bArr) {
            ...
            if (bArr.length == 4) {
                this.ipv4Bytes = bArr;
                this.ipv4 = String.valueOf(bArr[0] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) + '.' + (bArr[1] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) + '.' + (bArr[2] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) + '.' + (bArr[3] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
        ...
        boolean parseEmbeddedIPv4(byte[] bArr) {
            ...
            int i2 = ((bArr[10] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) | (bArr[11] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
            if (i2 == 0 || i2 == -1) {
                byte b = bArr[12];
                byte b2 = bArr[13];
                byte b3 = bArr[14];
                ...
                this.ipv4 = String.valueOf(b & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) + '.' + (b2 & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) + '.' + (b3 & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) + '.' + (b4 & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
    ...
    public static byte[] textToNumericFormatV6(String str) {
        int length;
        int i;
        String[] split = str.split(LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR, 10);
    ...
    public int hashCode() {
        String str = this.serviceName;
        int hashCode = ((str == null ? 0 : str.hashCode()) ^ LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        String str2 = this.ipv4;
        int hashCode2 = (hashCode ^ (str2 == null ? 0 : str2.hashCode())) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
        String str3 = this.ipv6;
        return ((hashCode2 ^ (str3 != null ? str3.hashCode() : 0)) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ this.port;
    }
