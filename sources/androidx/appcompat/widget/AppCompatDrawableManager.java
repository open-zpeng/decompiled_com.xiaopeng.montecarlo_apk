            ...
            if (INSTANCE == null) {
                ...
                INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() { // from class: androidx.appcompat.widget.AppCompatDrawableManager.1
                    ...
                    private LayerDrawable getRatingBarLayerDrawable(@NonNull ResourceManagerInternal resourceManagerInternal, @NonNull Context context, @DimenRes int i) {
                        ...
                        layerDrawable.setId(0, System.ErrorCodeOutOfDisk);
                    ...
                    public boolean tintDrawable(@NonNull Context context, int i, @NonNull Drawable drawable) {
                        if (i == R.drawable.abc_seekbar_track_material) {
                            ...
                            setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(System.ErrorCodeOutOfDisk), ThemeUtils.getThemeAttrColor(context, R.attr.colorControlNormal), AppCompatDrawableManager.DEFAULT_MODE);
                            ...
                            setPorterDuffColorFilter(layerDrawable2.findDrawableByLayerId(System.ErrorCodeOutOfDisk), ThemeUtils.getDisabledThemeAttrColor(context, R.attr.colorControlNormal), AppCompatDrawableManager.DEFAULT_MODE);
