...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - XpCacheConsts.ONE_DAY, location.getLatitude(), location.getLongitude());
        ...
        twilightCalculator.calculateTwilight(XpCacheConsts.ONE_DAY + currentTimeMillis, location.getLatitude(), location.getLongitude());
        long j5 = twilightCalculator.sunrise;
        if (j3 == -1 || j4 == -1) {
            j = NavRestoreManager.SILENCE_TIME_SPAN_12H + currentTimeMillis;
        } else {
