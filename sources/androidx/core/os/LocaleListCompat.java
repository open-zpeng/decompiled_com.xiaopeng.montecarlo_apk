...
public final class LocaleListCompat {
    ...
    public static Locale forLanguageTagCompat(String str) {
        ...
        } else if (str.contains(DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT)) {
            String[] split2 = str.split(DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT, -1);
            if (split2.length > 2) {
