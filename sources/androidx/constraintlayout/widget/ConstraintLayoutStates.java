...
public class ConstraintLayoutStates {
    ...
    private void parseConstraintSet(Context context, XmlPullParser parser) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (attributeName != null && attributeValue != null && VuiConstants.ELEMENT_ID.equals(attributeName)) {
                int identifier = attributeValue.contains(MqttTopic.TOPIC_LEVEL_SEPARATOR) ? context.getResources().getIdentifier(attributeValue.substring(attributeValue.indexOf(47) + 1), VuiConstants.ELEMENT_ID, context.getPackageName()) : -1;
                if (identifier == -1) {
