...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            canvas.drawRGB(LocTrafficSignType.LOC_TRAFFIC_SIGN_NO_PARKING, LocTrafficSignType.LOC_TRAFFIC_SIGN_NO_PARKING, LocTrafficSignType.LOC_TRAFFIC_SIGN_NO_PARKING);
