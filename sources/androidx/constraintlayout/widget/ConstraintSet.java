...
public class ConstraintSet {
    ...
    public static class Layout {
        ...
        public void dump(MotionScene scene, StringBuilder stringBuilder) {
            ...
            stringBuilder.append(FDManager.LINE_SEPERATOR);
    ...
    */
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        while (i2 < split.length) {
            ...
            if (i == 0) {
                i = context.getResources().getIdentifier(trim, VuiConstants.ELEMENT_ID, context.getPackageName());
            }
    ...
    static String getDebugName(int v) {
        ...
        for (Field field : ConstraintSet.class.getDeclaredFields()) {
            if (field.getName().contains(DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT) && field.getType() == Integer.TYPE && Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                try {
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{"left", "right", "top", "bottom", "start", DMWait.STATUS_END}, -1);
        ...
        void writeVariable(String name, int[] value) throws IOException {
            ...
            Writer writer = this.writer;
            writer.write(SPACE + name);
            this.writer.write(LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR);
            int i = 0;
        ...
        void writeVariable(String name, String value) throws IOException {
            ...
            Writer writer = this.writer;
            writer.write(", " + value);
            this.writer.write(FDManager.LINE_SEPERATOR);
        }
    }
