    ...
    */
    ...
    private int getId(Context context, String idString) {
        ...
        if (idString.contains(MqttTopic.TOPIC_LEVEL_SEPARATOR)) {
            i = context.getResources().getIdentifier(idString.substring(idString.indexOf(47) + 1), VuiConstants.ELEMENT_ID, context.getPackageName());
            if (this.DEBUG_DESKTOP) {
    ...
    private int parseConstraintSet(Context context, XmlPullParser parser) {
        ...
        for (int i3 = 0; i3 < attributeCount; i3++) {
            ...
            if (hashCode == -1995929160) {
                ...
                if (hashCode == 3355 && attributeName.equals(VuiConstants.ELEMENT_ID)) {
                    z = false;
                }
                z = true;
            } else {
