...
public class Debug {
    public static void logStack(String tag, String msg, int n) {
        ...
        for (int i = 1; i <= min; i++) {
            ...
            str = str + " ";
            Log.v(tag, msg + str + (".(" + stackTrace[i].getFileName() + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + stackTrace[i].getLineNumber() + ") " + stackTrace[i].getMethodName()) + str);
        }
    }
    ...
    public static void printStack(String msg, int n) {
        ...
        for (int i = 1; i <= min; i++) {
            ...
            printStream.println(msg + str + (".(" + stackTrace[i].getFileName() + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + stackTrace[i].getLineNumber() + ") ") + str);
        }
    }
    ...
    public static void dumpPoc(Object obj) {
        ...
        String str = ".(" + stackTraceElement.getFileName() + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + stackTraceElement.getLineNumber() + ")";
    ...
    public static String getState(MotionLayout layout, int stateId, int len) {
        ...
        if (len != -1) {
            ...
            return resourceEntryName.replaceAll(CharBuffer.allocate(length2).toString().replace((char) 0, '.') + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT, DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT);
        }
        return resourceEntryName;
    }
    ...
    public static String getLocation() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        return ".(" + stackTraceElement.getFileName() + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + stackTraceElement.getLineNumber() + ")";
    }

    public static String getLoc() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        return ".(" + stackTraceElement.getFileName() + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName() + "()";
    }
    ...
    public static void dumpLayoutParams(ViewGroup layout, String str) {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str2 = ".(" + stackTraceElement.getFileName() + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + stackTraceElement.getLineNumber() + ") " + str + "  ";
