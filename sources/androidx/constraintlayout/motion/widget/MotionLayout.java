...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public class Model {
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            String str5 = ICarService.CAR_STAGE_B;
            String str6 = "__";
            if (constraintAnchor != null) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append("T");
                sb2.append(child.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? "T" : ICarService.CAR_STAGE_B);
                str2 = sb2.toString();
            } else {
                str2 = "__";
            }
            ...
            if (child.mBottom.mTarget != null) {
                StringBuilder sb5 = new StringBuilder();
                sb5.append(ICarService.CAR_STAGE_B);
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str3 = DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT;
                sb.append(constraintAnchor != null ? "T" : DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT);
                String sb2 = sb.toString();
                StringBuilder sb3 = new StringBuilder();
                sb3.append(sb2);
                sb3.append(constraintWidget.mBottom.mTarget != null ? ICarService.CAR_STAGE_B : DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT);
                String sb4 = sb3.toString();
                StringBuilder sb5 = new StringBuilder();
                sb5.append(sb4);
                sb5.append(constraintWidget.mLeft.mTarget != null ? "L" : DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT);
                String sb6 = sb5.toString();
                StringBuilder sb7 = new StringBuilder();
                sb7.append(sb6);
        ...
        public void measure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (MotionLayout.this.mCurrentState == MotionLayout.this.getStartState()) {
                ...
                motionLayout2.resolveSystem(constraintWidgetContainer, optimizationLevel, i, (constraintSet2 == null || constraintSet2.mRotate == 0) ? heightMeasureSpec : widthMeasureSpec);
                ...
                motionLayout3.resolveSystem(constraintWidgetContainer2, optimizationLevel, i2, (constraintSet6 == null || constraintSet6.mRotate == 0) ? heightMeasureSpec : widthMeasureSpec);
            }
            if (((MotionLayout.this.getParent() instanceof MotionLayout) && mode == 1073741824 && mode2 == 1073741824) ? false : true) {
                MotionLayout motionLayout4 = MotionLayout.this;
                motionLayout4.mWidthMeasureMode = mode;
                motionLayout4.mHeightMeasureMode = mode2;
                if (motionLayout4.mCurrentState == MotionLayout.this.getStartState()) {
    ...
    private class DevModeDraw {
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> frameArrayList, int duration, int debugPath) {
            ...
            if (!MotionLayout.this.isInEditMode() && (debugPath & 1) == 2) {
                String str = MotionLayout.this.getContext().getResources().getResourceName(MotionLayout.this.mEndState) + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + MotionLayout.this.getProgress();
