...
public class Utils {
    ...
    public static void logStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            ...
            str2 = str2 + " ";
            PrintStream printStream = System.out;
            printStream.println(str + str2 + (".(" + stackTrace[i2].getFileName() + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName()) + str2);
        }
    }
    ...
    public static void log(String str) {
        ...
        PrintStream printStream = System.out;
        printStream.println((".(" + stackTraceElement.getFileName() + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + " " + str);
    }
}
