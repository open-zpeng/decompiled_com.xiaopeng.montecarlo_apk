...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        ...
        sb.append(str + " ===== " + this.mType + FDManager.LINE_SEPERATOR);
        sb.append(str);
        ...
        String str2 = sb.toString() + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + FDManager.LINE_SEPERATOR;
        if (this.mNumberOfStages > 1) {
            str2 = str2 + str + " dur " + this.mStage2Duration + " vel " + this.mStage2Velocity + " pos " + this.mStage2EndPosition + FDManager.LINE_SEPERATOR;
        }
        if (this.mNumberOfStages > 2) {
            str2 = str2 + str + " dur " + this.mStage3Duration + " vel " + this.mStage3Velocity + " pos " + this.mStage3EndPosition + FDManager.LINE_SEPERATOR;
        }
