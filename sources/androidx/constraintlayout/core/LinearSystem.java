...
public class LinearSystem {
    ...
    private void displayRows() {
        ...
        String str = "";
        for (int i = 0; i < this.mNumRows; i++) {
            str = (str + this.mRows[i]) + FDManager.LINE_SEPERATOR;
        }
        System.out.println(str + this.mGoal + FDManager.LINE_SEPERATOR);
    }

    public void displayReadableRows() {
        displaySolverVariables();
        String str = " num vars " + this.mVariablesID + FDManager.LINE_SEPERATOR;
        for (int i = 0; i < this.mVariablesID + 1; i++) {
            SolverVariable solverVariable = this.mCache.mIndexedVariables[i];
            if (solverVariable != null && solverVariable.isFinalValue) {
                str = str + " $[" + i + "] => " + solverVariable + " = " + solverVariable.computedValue + FDManager.LINE_SEPERATOR;
            }
        }
        String str2 = str + FDManager.LINE_SEPERATOR;
        for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
            ...
            if (solverVariable2 != null && solverVariable2.isSynonym) {
                str2 = str2 + " ~[" + i2 + "] => " + solverVariable2 + " = " + this.mCache.mIndexedVariables[solverVariable2.synonym] + " + " + solverVariable2.synonymDelta + FDManager.LINE_SEPERATOR;
            }
        }
        String str3 = str2 + "\n\n #  ";
        ...
        if (this.mGoal != null) {
            str3 = str3 + "Goal: " + this.mGoal + FDManager.LINE_SEPERATOR;
        }
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            if (this.mRows[i].variable.mType == SolverVariable.Type.UNRESTRICTED) {
                str = (str + this.mRows[i].toReadableString()) + FDManager.LINE_SEPERATOR;
            }
        }
        System.out.println(str + this.mGoal + FDManager.LINE_SEPERATOR);
    }
