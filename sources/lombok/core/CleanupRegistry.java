...
/* loaded from: xp_Montecarlo-benchEdward.apk:lombok/core/CleanupRegistry.SCL.lombok */
public class CleanupRegistry {
    private final ConcurrentMap<CleanupKey, CleanupTask> tasks = new ConcurrentHashMap();

    /* loaded from: xp_Montecarlo-benchEdward.apk:lombok/core/CleanupRegistry$CleanupKey.SCL.lombok */
