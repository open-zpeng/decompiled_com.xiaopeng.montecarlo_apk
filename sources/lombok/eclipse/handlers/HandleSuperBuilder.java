...
/* loaded from: xp_Montecarlo-benchEdward.apk:lombok/eclipse/handlers/HandleSuperBuilder.SCL.lombok */
public class HandleSuperBuilder extends EclipseAnnotationHandler<SuperBuilder> {
    ...
    /* loaded from: xp_Montecarlo-benchEdward.apk:lombok/eclipse/handlers/HandleSuperBuilder$SuperBuilderJob.SCL.lombok */
    ...
    */
    ...
    private void generateSetterMethodsForBuilder(HandleBuilder.BuilderJob job, HandleBuilder.BuilderFieldData bfd, final String builderGenericName, String setterPrefix) {
        ...
        if (bfd.singularData == null || bfd.singularData.getSingularizer() == null) {
            generateSimpleSetterMethodForBuilder(job, deprecate, bfd.createdFields.get(0), bfd.name, bfd.nameOfSetFlag, returnTypeMaker.make(), returnStatementMaker.mo170make(), bfd.annotations, bfd.originalFieldNode, setterPrefix);
        } else {
