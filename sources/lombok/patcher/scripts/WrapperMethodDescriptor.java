...
/* loaded from: 地图_V1.10.0_20240112105442_Release.apk:lombok/patcher/scripts/WrapperMethodDescriptor.SCL.lombok */
public class WrapperMethodDescriptor {
    ...
    public int hashCode() {
        ...
        return (31 * ((31 * ((31 * ((31 * ((31 * ((31 * result) + (this.itf ? RangeType.RANGETYPE_CAMERA_SPEED_PROMPT : 1237))) + (this.name == null ? 0 : this.name.hashCode()))) + this.opcode)) + (this.owner == null ? 0 : this.owner.hashCode()))) + (this.targetDescriptor == null ? 0 : this.targetDescriptor.hashCode()))) + (this.wrapperDescriptor == null ? 0 : this.wrapperDescriptor.hashCode());
    }
