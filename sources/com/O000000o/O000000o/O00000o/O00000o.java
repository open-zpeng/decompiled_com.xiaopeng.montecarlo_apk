...
public class O00000o implements Closeable, Flushable {
    ...
    public O00000o(Writer writer) {
        O000000o(6);
        this.O0000O0o = LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR;
        this.O0000OoO = true;
        if (writer == null) {
    ...
    */
    ...
    private void O0000OoO() throws IOException {
        ...
        this.O00000o0.write(FDManager.LINE_SEPERATOR);
        int i = this.O00000oO;
    ...
    public O00000o O000000o(boolean z) throws IOException {
        O0000Oo();
        O00000oO(false);
        this.O00000o0.write(z ? "true" : "false");
        return this;
    }
    ...
    public final void O00000o0(String str) {
        ...
        if (str.length() == 0) {
            this.O00000oo = null;
            str2 = LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR;
        } else {
            this.O00000oo = str;
            str2 = ": ";
        }
