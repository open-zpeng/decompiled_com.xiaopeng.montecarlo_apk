...
public class c {
        ...
        public boolean process(byte[] bArr, int i, int i2, boolean z) {
            ...
            while (i9 < i4) {
                if (i8 == 0) {
                    while (true) {
                        int i10 = i9 + 4;
                        if (i10 > i4 || (i7 = (iArr[bArr[i9] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR] << 18) | (iArr[bArr[i9 + 1] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR] << 12) | (iArr[bArr[i9 + 2] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR] << 6) | iArr[bArr[i9 + 3] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR]) < 0) {
                            break;
                        }
                        bArr2[i6 + 2] = (byte) i7;
                ...
                int i11 = i9 + 1;
                int i12 = iArr[bArr[i9] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR];
                if (i8 != 0) {
                    if (i8 == 1) {
                        if (i12 < 0) {
                            if (i12 != -1) {
    ...
    public static class C0009c extends a {
        static final /* synthetic */ boolean J = !c.class.desiredAssertionStatus();
        private static final byte[] a = {GnssLocation.LOC_VALID, 66, 67, 68, 69, 70, 71, 72, 73, 74, TarConstants.LF_GNUTYPE_LONGLINK, TarConstants.LF_GNUTYPE_LONGNAME, 77, 78, 79, 80, 81, 82, TarConstants.LF_GNUTYPE_SPARSE, 84, 85, GnssLocation.LOC_INVALID, 87, TarConstants.LF_PAX_EXTENDED_HEADER_UC, 89, 90, 97, 98, 99, 100, 101, 102, TarConstants.LF_PAX_GLOBAL_EXTENDED_HEADER, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, TarConstants.LF_PAX_EXTENDED_HEADER_LC, 121, 122, TarConstants.LF_NORMAL, TarConstants.LF_LINK, TarConstants.LF_SYMLINK, TarConstants.LF_CHR, TarConstants.LF_BLK, TarConstants.LF_DIR, TarConstants.LF_FIFO, TarConstants.LF_CONTIG, 56, 57, 43, 47};
        private static final byte[] b = {GnssLocation.LOC_VALID, 66, 67, 68, 69, 70, 71, 72, 73, 74, TarConstants.LF_GNUTYPE_LONGLINK, TarConstants.LF_GNUTYPE_LONGNAME, 77, 78, 79, 80, 81, 82, TarConstants.LF_GNUTYPE_SPARSE, 84, 85, GnssLocation.LOC_INVALID, 87, TarConstants.LF_PAX_EXTENDED_HEADER_UC, 89, 90, 97, 98, 99, 100, 101, 102, TarConstants.LF_PAX_GLOBAL_EXTENDED_HEADER, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, TarConstants.LF_PAX_EXTENDED_HEADER_LC, 121, 122, TarConstants.LF_NORMAL, TarConstants.LF_LINK, TarConstants.LF_SYMLINK, TarConstants.LF_CHR, TarConstants.LF_BLK, TarConstants.LF_DIR, TarConstants.LF_FIFO, TarConstants.LF_CONTIG, 56, 57, 45, 95};
        int E;
