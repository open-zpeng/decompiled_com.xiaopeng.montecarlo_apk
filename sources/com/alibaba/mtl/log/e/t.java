...
public class t {
    ...
    public static String b(String str, Map<String, Object> map, Map<String, Object> map2) throws Exception {
        ...
        return str + "?ak=" + appkey + "&av=" + str2 + "&c=" + URLEncoder.encode(o) + "&d=" + str4 + "&" + HttpConst.XP_CLIENT_PARAMETER_SV + "=" + SdkMeta.SDK_VERSION + "&t=" + valueOf + "&is=" + str5 + "&_b01n15=" + map.get("_b01n15") + "&_b01na=" + map.get("_b01na") + "&s=" + sign;
    }
