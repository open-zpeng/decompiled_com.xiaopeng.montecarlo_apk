                        ...
                        while (true) {
                            try {
                                ...
                                if (aVar2 != null) {
                                    ...
                                    contentValues.put("priority", aVar2.U);
                                    contentValues.put("content", aVar2.l());
                                    contentValues.put(DebugConfiguration.DebugActionExtra.CRUISE_CONGESTION_TIME, aVar2.W);
        ...
        try {
            ...
            if (writableDatabase != null) {
                ...
                while (rawQuery != null && rawQuery.moveToNext()) {
                    ...
                    aVar.W = rawQuery.getString(rawQuery.getColumnIndex(DebugConfiguration.DebugActionExtra.CRUISE_CONGESTION_TIME));
                    try {
