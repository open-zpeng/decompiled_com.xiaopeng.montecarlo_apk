                        ...
                        while (true) {
                            try {
                                ...
                                if (aVar2 != null) {
                                    ...
                                    contentValues.put("priority", aVar2.Y);
                                    contentValues.put("content", aVar2.j());
                                    contentValues.put(DebugConfiguration.DebugActionExtra.CRUISE_CONGESTION_TIME, aVar2.aa);
    ...
    public synchronized ArrayList<com.alibaba.mtl.log.model.a> a(String str, int i) {
        ...
        try {
            ...
            if (writableDatabase != null) {
                ...
                sb.append(" ORDER BY ");
                sb.append(DebugConfiguration.DebugActionExtra.CRUISE_CONGESTION_TIME);
                sb.append(" ASC ");
                sb.append(" LIMIT ");
                sb.append(i + "");
                ...
                while (rawQuery != null && rawQuery.moveToNext()) {
                    ...
                    aVar.Y = rawQuery.getString(rawQuery.getColumnIndex("priority"));
                    aVar.l(rawQuery.getString(rawQuery.getColumnIndex("content")));
                    aVar.aa = rawQuery.getString(rawQuery.getColumnIndex(DebugConfiguration.DebugActionExtra.CRUISE_CONGESTION_TIME));
                    try {
