...
public class c {
    ...
    public synchronized void F() {
        ...
        try {
            ...
            if (arrayList != null && arrayList.size() > 0) {
                this.f58a.mo24a((List<com.alibaba.mtl.log.model.a>) arrayList);
            }
    ...
    public void G() {
        ...
        calendar.add(5, -3);
        this.f58a.c(DebugConfiguration.DebugActionExtra.CRUISE_CONGESTION_TIME, String.valueOf(calendar.getTimeInMillis()));
    }
