...
public class c {
    ...
    public synchronized void E() {
        ...
        try {
            ...
            if (arrayList != null && arrayList.size() > 0) {
                this.f59a.mo23a((List<com.alibaba.mtl.log.model.a>) arrayList);
            }
    ...
    public void F() {
        ...
        calendar.add(5, -3);
        this.f59a.c(DebugConfiguration.DebugActionExtra.CRUISE_CONGESTION_TIME, String.valueOf(calendar.getTimeInMillis()));
    }
