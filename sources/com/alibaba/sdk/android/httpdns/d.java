...
public class d {
    ...
    private static IPProbeService f86a = com.alibaba.sdk.android.httpdns.probe.d.a(new com.alibaba.sdk.android.httpdns.probe.b() { // from class: com.alibaba.sdk.android.httpdns.d.1
        ...
        public void a(String str, String[] strArr) {
            ...
            for (int i = 0; i < eVar2.m49a().length; i++) {
                sb.append(eVar2.m49a()[i] + ",");
            }
    ...
    private boolean a(String str, e eVar) {
        IPProbeItem a2;
        if (eVar == null || eVar.m49a() == null || eVar.m49a().length <= 1 || f86a == null || (a2 = a(str)) == null) {
            return false;
        }
        ...
        i.f("START PROBE");
        f86a.launchIPProbeTask(str, a2.getPort(), eVar.m49a());
        return true;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public e m41a(String str) {
        return f87a.get(str);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public ArrayList<String> m42a() {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public void m43a() {
        if (com.alibaba.sdk.android.httpdns.b.b.m32a()) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public void m45a(String str, e eVar) {
        f87a.put(str, eVar);
        if (com.alibaba.sdk.android.httpdns.b.b.m32a()) {
            com.alibaba.sdk.android.httpdns.b.e m48a = eVar.m48a();
            if (m48a.a == null || m48a.a.size() <= 0) {
                com.alibaba.sdk.android.httpdns.b.b.b(m48a);
            } else {
                com.alibaba.sdk.android.httpdns.b.b.a(m48a);
            }
        }
        a(str, eVar);
    }
