...
public class ObjectMetadata {
    ...
    public String toString() {
        ...
        return "Last-Modified:" + getLastModified() + FDManager.LINE_SEPERATOR + "Expires" + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + str + "\nrawExpires:" + getRawExpiresValue() + FDManager.LINE_SEPERATOR + HttpHeaders.CONTENT_MD5 + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + getContentMD5() + FDManager.LINE_SEPERATOR + OSSHeaders.OSS_OBJECT_TYPE + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + getObjectType() + FDManager.LINE_SEPERATOR + OSSHeaders.OSS_SERVER_SIDE_ENCRYPTION + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + getServerSideEncryption() + FDManager.LINE_SEPERATOR + "Content-Disposition" + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + getContentDisposition() + FDManager.LINE_SEPERATOR + "Content-Encoding" + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + getContentEncoding() + FDManager.LINE_SEPERATOR + "Cache-Control" + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + getCacheControl() + FDManager.LINE_SEPERATOR + "ETag" + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + getETag() + FDManager.LINE_SEPERATOR;
    }
}
