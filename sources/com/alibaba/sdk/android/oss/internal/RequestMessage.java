...
public class RequestMessage extends HttpMessage {
    ...
    public String buildCanonicalURL() throws Exception {
        ...
        if (!TextUtils.isEmpty(valueOf)) {
            str2 = str2 + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + valueOf;
        }
        ...
        if (z) {
            str2 = str2 + MqttTopic.TOPIC_LEVEL_SEPARATOR + this.bucketName;
        }
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("request---------------------\n");
        sb.append("request url=" + str2 + FDManager.LINE_SEPERATOR);
