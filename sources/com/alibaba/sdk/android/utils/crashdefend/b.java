...
public class b {
    ...
    private void a() {
        if (e.m80a(this.context, this.f167a, this.f169a)) {
            this.f167a.a++;
            return;
        }
        this.f167a.a = 1L;
    ...
    public boolean m79a(c cVar, SDKMessageCallback sDKMessageCallback) {
        c a2;
