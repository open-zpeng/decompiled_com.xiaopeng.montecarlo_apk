...
public class AlicloudSender {
    ...
    private static void a(Application application, SdkInfo sdkInfo) {
        if (f161a.compareAndSet(false, true)) {
            ...
            c = m74a(application.getApplicationContext());
            a = new SendService();
            a.openHttp = true;
    ...
    public static synchronized void b(Context context, SdkInfo sdkInfo) {
        synchronized (AlicloudSender.class) {
            ...
            hashMap.put(VuiConstants.SCENE_PACKAGE_NAME, context.getPackageName());
    ...
    private static Map<String, a> m74a(Context context) {
        HashMap hashMap = new HashMap();
            ...
            try {
                ...
                if (jSONArray.length() > 0) {
                    for (int i = 0; i < jSONArray.length(); i++) {
                        ...
                        String string2 = jSONObject.getString(VuiConstants.ELEMENT_ID);
                        a aVar = new a();
                        aVar.b = jSONObject.getString(DebugConfiguration.DebugActionExtra.CRUISE_CONGESTION_TIME);
    ...
    private static void a(Context context, Map<String, a> map) {
        ...
        for (String str : map.keySet()) {
            ...
            try {
                jSONObject.put(VuiConstants.ELEMENT_ID, str);
                jSONObject.put(DebugConfiguration.DebugActionExtra.CRUISE_CONGESTION_TIME, aVar.b);
