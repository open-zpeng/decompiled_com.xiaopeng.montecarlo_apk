...
public class a {
    ...
    public static String a(String str, boolean z) {
        ...
        arrayList.add(RootUtil.NAVI_LOG_DIR_XPLOG_NAME);
        if (i.b((CharSequence) str)) {
            arrayList.add("-b");
            arrayList.add(str);
        }
        int i = 0;
        List asList = Arrays.asList("-t", Integer.toString(q), "-v", DebugConfiguration.DebugActionExtra.CRUISE_CONGESTION_TIME);
            ...
            if (!i.b((CharSequence) str)) {
                while (true) {
                    ...
                    if ((str2 == null || readLine.contains(str2)) && ((readLine.contains("W/") || readLine.contains("E/")) && !readLine.contains("com.alibaba.motu.crashreporter"))) {
                        aVar.add(readLine + FDManager.LINE_SEPERATOR);
                    }
                    i++;
                }
            } else {
                while (true) {
                    ...
                    if (str2 == null || readLine2.contains(str2)) {
                        aVar.add(readLine2 + FDManager.LINE_SEPERATOR);
                    }
                    i++;
                }
            }
