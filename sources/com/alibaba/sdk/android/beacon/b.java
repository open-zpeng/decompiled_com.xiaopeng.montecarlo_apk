...
public final class b {
    ...
    private C0010b a(Context context, String str, String str2, Map<String, String> map) {
        return new C0010b.a().a(str).b(str2).c(c.a(context)).d("Android").e(String.valueOf(Build.VERSION.SDK_INT)).f(UTDevice.getUtdid(context)).g(BuildConfig.VERSION_NAME).a(map).a();
    }
    ...
    public void m31a(Context context, String str, String str2, Map<String, String> map) {
