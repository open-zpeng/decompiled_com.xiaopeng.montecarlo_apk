...
public class GifHeaderParser {
    ...
    private void readNetscapeExt() {
        do {
            ...
            if (bArr[0] == 1) {
                this.header.loopCount = ((bArr[2] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) | (bArr[1] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
            }
            if (this.blockSize <= 0) {
                return;
            }
    ...
    private int[] readColorTable(int i) {
        ...
        try {
            ...
            while (i2 < i) {
                ...
                int i6 = i5 + 1;
                int i7 = i2 + 1;
                iArr[i2] = ((bArr[i3] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 16) | (-16777216) | ((bArr[i4] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) | (bArr[i5] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
                i3 = i6;
                i2 = i7;
            }
