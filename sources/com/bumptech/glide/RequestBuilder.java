...
public class RequestBuilder<TranscodeType> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    public RequestOptions getMutableOptions() {
        ...
        return requestOptions == requestOptions2 ? requestOptions2.mo84clone() : requestOptions2;
    }
    ...
    @CheckResult
    /* renamed from: clone */
    public RequestBuilder<TranscodeType> mo82clone() {
        try {
            RequestBuilder<TranscodeType> requestBuilder = (RequestBuilder) super.clone();
            requestBuilder.requestOptions = requestBuilder.requestOptions.mo84clone();
            requestBuilder.transitionOptions = (TransitionOptions<?, ? super TranscodeType>) requestBuilder.transitionOptions.m83clone();
    ...
    public ViewTarget<ImageView, TranscodeType> into(@NonNull ImageView imageView) {
        ...
        if (!requestOptions.isTransformationSet() && requestOptions.isTransformationAllowed() && imageView.getScaleType() != null) {
            switch (AnonymousClass2.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
                case 1:
                    requestOptions = requestOptions.mo84clone().optionalCenterCrop();
                    break;
                case 2:
                    requestOptions = requestOptions.mo84clone().optionalCenterInside();
                    break;
                case 3:
                case 4:
                case 5:
                    requestOptions = requestOptions.mo84clone().optionalFitCenter();
                    break;
                case 6:
                    requestOptions = requestOptions.mo84clone().optionalCenterInside();
                    break;
