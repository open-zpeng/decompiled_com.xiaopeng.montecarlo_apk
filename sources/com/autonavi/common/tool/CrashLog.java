...
public class CrashLog {
    ...
    private static long anrCost = 0;
    private static int anrCount = 0;
    private static String appVersion = null;
    private static Application application = null;
    private static ICrashLogController controler = null;
    private static int crashCountForCrashMode = 0;
    private static int crashTimeForCrashMode = 0;
    private static String dibv = null;
    private static String dic = null;
    private static String diu = null;
    private static String diu2 = null;
    private static String diu3 = null;
    private static String div = null;
    private static boolean hasInit = false;
    private static boolean isNeedCrashModeCheck = false;
    private static volatile boolean jniReportOtherThread = false;
    private static String logSpyId = null;
    private static ActivityStatusMonitor mActivityStatusMonitor = null;
    private static boolean mIsDebugMode = false;
    private static boolean mNeedBuildHeapError = false;
    ...
    public static void triggerAnrTraces(String str, String str2, String str3) {
        LogUtil.logE("CrashLog", "triggerAnrTraces whiteList = " + str + ",anrInfo = " + str2 + ",anrInfoPath = " + str3);
    ...
    public static String getLocalCrashDir() {
        ...
        LogUtil.logE("getLocalCrashDir filePath = " + localCrashDir);
