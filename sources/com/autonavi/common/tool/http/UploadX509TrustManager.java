...
public class UploadX509TrustManager implements X509TrustManager {
    ...
    public UploadX509TrustManager(boolean z, String str) {
        ...
        if (this.mNeedCheck) {
            ...
            try {
                ...
                LogUtil.log("Failed to obtain X.509 CertificateFactory");
            }
        }
    }
            ...
            for (X509Certificate x509Certificate : x509CertificateArr) {
                for (X509Certificate x509Certificate2 : this.mCertificates) {
                    try {
                        ...
                        LogUtil.log("Failed to verify with message" + e.getMessage());
                    }
                }
            }
            LogUtil.log("Failed to verify with custom certs");
    ...
    private X509Certificate readCertificate(String str) {
        ...
        try {
            ...
            LogUtil.log("Failed to read certificate from " + str + "exception :" + e.getMessage());
    ...
    private X509TrustManager getSystemDefaultTrustManager() {
        try {
            ...
            LogUtil.log("Unexpected default trust managers:" + Arrays.toString(trustManagers));
            return null;
        } catch (GeneralSecurityException e) {
            LogUtil.log("Unexpected exception" + e.getMessage());
            return null;
        }
    }
}
