...
public class CrashFileManager {
    ...
    public class NativeErrorInfo {
        ...
        public boolean hasLogcat = false;
    ...
    public void init() {
        ...
        LogUtil.log("init maxTamperCount = " + this.maxTamperCount + ",maxForegroundCount = " + this.maxForegroundCount + ",maxBackgroundCount = " + this.maxBackgroundCount);
        checkWhenInit();
    ...
    private String getCrashLibName(String str, boolean z) {
        ...
        if (substring.contains("#00")) {
            LogUtil.log("getCrashLibName crashStr:" + substring);
            String libNameWithPath = SystemUtils.getLibNameWithPath(substring);
            LogUtil.log("getCrashLibName :" + libNameWithPath);
    ...
    public boolean buildNativeHeapErrorException() {
        LogUtil.log("begin buildNativeHeapErrorException");
    ...
    public NativeErrorInfo buildNativeErrorInfoInner(File file) {
        if (file != null && file.exists()) {
            ...
            IOUtil.readFile(file, new IOUtil.ReadFileCallback() { // from class: com.autonavi.common.tool.util.CrashFileManager.2
                ...
                public boolean onLine(String str) {
                    ...
                    if (str.contains("AppVersion:")) {
                        ...
                        nativeErrorInfo.hasLogcat = true;
            ...
            file.delete();
            if (checkNativeErrorInfoValid(nativeErrorInfo)) {
    ...
    private static boolean checkNativeErrorInfoValid(NativeErrorInfo nativeErrorInfo) {
        return !TextUtils.isEmpty(nativeErrorInfo.errorInfo);
    }
    ...
    public String appendCrashInfo(String str, boolean z, Thread thread, boolean z2, NativeErrorInfo nativeErrorInfo) {
        try {
            ...
            if (z) {
                ...
                String paramsString = Utils.getParamsString(CrashLog.getControler().getCrashExtraInfo());
                LogUtil.log(512, paramsString);
