...
public class GroupService implements IService {
    ...
    public int addObserver(IGroupServiceObserver iGroupServiceObserver) {
        ...
        try {
            ...
            IGroupServiceObserverImpl iGroupServiceObserverImpl = null;
            if (iGroupServiceObserver != null && (typeHelper = this.mTypeHelper) != null) {
                iGroupServiceObserverImpl = (IGroupServiceObserverImpl) typeHelper.transfer(method, 0, iGroupServiceObserver);
            }
            IGroupServiceImpl iGroupServiceImpl = this.mControl;
            if (iGroupServiceImpl != null) {
                return iGroupServiceImpl.addObserver(iGroupServiceObserverImpl);
            }
            return Integer.MIN_VALUE;
        } catch (Exception e) {
    ...
    public void removeObserver(IGroupServiceObserver iGroupServiceObserver) {
        ...
        try {
            ...
            IGroupServiceImpl iGroupServiceImpl = this.mControl;
            if (iGroupServiceImpl != null) {
                iGroupServiceImpl.removeObserver(iGroupServiceObserverImpl);
