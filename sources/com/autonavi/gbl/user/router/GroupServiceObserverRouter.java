...
public class GroupServiceObserverRouter extends IGroupServiceObserverImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.user.router.GroupServiceObserverRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.user.router.GroupServiceObserverRouter.2
        }));
        super.delete();
        unbind();
    }
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseStatus groupResponseStatus) {
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseCreate groupResponseCreate) {
        IGroupServiceObserver iGroupServiceObserver = this.mObserver;
        if (iGroupServiceObserver != null) {
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseDissolve groupResponseDissolve) {
        IGroupServiceObserver iGroupServiceObserver = this.mObserver;
        if (iGroupServiceObserver != null) {
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseJoin groupResponseJoin) {
        IGroupServiceObserver iGroupServiceObserver = this.mObserver;
        if (iGroupServiceObserver != null) {
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseQuit groupResponseQuit) {
        IGroupServiceObserver iGroupServiceObserver = this.mObserver;
        if (iGroupServiceObserver != null) {
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseInvite groupResponseInvite) {
        IGroupServiceObserver iGroupServiceObserver = this.mObserver;
        if (iGroupServiceObserver != null) {
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseKick groupResponseKick) {
        IGroupServiceObserver iGroupServiceObserver = this.mObserver;
        if (iGroupServiceObserver != null) {
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseInfo groupResponseInfo) {
        IGroupServiceObserver iGroupServiceObserver = this.mObserver;
        if (iGroupServiceObserver != null) {
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseUpdate groupResponseUpdate) {
        IGroupServiceObserver iGroupServiceObserver = this.mObserver;
        if (iGroupServiceObserver != null) {
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseSetNickName groupResponseSetNickName) {
        IGroupServiceObserver iGroupServiceObserver = this.mObserver;
        if (iGroupServiceObserver != null) {
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseFriendList groupResponseFriendList) {
        IGroupServiceObserver iGroupServiceObserver = this.mObserver;
        if (iGroupServiceObserver != null) {
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseInviteQRUrl groupResponseInviteQRUrl) {
        IGroupServiceObserver iGroupServiceObserver = this.mObserver;
        if (iGroupServiceObserver != null) {
    ...
    @Override // com.autonavi.gbl.user.group.observer.impl.IGroupServiceObserverImpl
    public void onNotify(@ErrorCode.ErrorCode1 int i, long j, GroupResponseUrlTranslate groupResponseUrlTranslate) {
        IGroupServiceObserver iGroupServiceObserver = this.mObserver;
        if (iGroupServiceObserver != null) {
