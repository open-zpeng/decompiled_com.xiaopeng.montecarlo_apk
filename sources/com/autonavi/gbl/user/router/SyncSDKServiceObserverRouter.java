...
public class SyncSDKServiceObserverRouter extends ISyncSDKServiceObserverImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.user.router.SyncSDKServiceObserverRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.user.router.SyncSDKServiceObserverRouter.2
        }));
        super.delete();
        unbind();
    }
