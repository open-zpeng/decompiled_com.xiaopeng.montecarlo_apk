...
public class AccountServiceObserverRouter extends IAccountServiceObserverImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.user.router.AccountServiceObserverRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.user.router.AccountServiceObserverRouter.2
        }));
        super.delete();
        unbind();
    }
