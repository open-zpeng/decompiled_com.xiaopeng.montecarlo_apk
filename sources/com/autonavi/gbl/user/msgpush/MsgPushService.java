...
public class MsgPushService implements IService {
    ...
    public int addObserver(IMsgPushServiceObserver iMsgPushServiceObserver) {
        try {
            ...
            if (iMsgPushServiceObserver != null) {
                TypeHelper typeHelper = this.mTypeHelper;
                r2 = typeHelper != null ? (IMsgPushServiceObserverImpl) typeHelper.transfer(method, 0, iMsgPushServiceObserver) : null;
                if (r2 == null) {
                    DebugTool.e("%s: $observer == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.user.msgpush.MsgPushService.1
                    }));
                    return Integer.MIN_VALUE;
                }
            }
            IMsgPushServiceImpl iMsgPushServiceImpl = this.mControl;
            if (iMsgPushServiceImpl != null) {
                return iMsgPushServiceImpl.addObserver(r2);
            }
            return Integer.MIN_VALUE;
        } catch (Exception e) {
    ...
    public void removeObserver(IMsgPushServiceObserver iMsgPushServiceObserver) {
        try {
            ...
            if (iMsgPushServiceObserver != null) {
                TypeHelper typeHelper = this.mTypeHelper;
                r1 = typeHelper != null ? (IMsgPushServiceObserverImpl) typeHelper.transfer(method, 0, iMsgPushServiceObserver) : null;
                if (r1 == null) {
                    DebugTool.e("%s: $observer == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.user.msgpush.MsgPushService.2
                    }));
                }
            }
            IMsgPushServiceImpl iMsgPushServiceImpl = this.mControl;
            if (iMsgPushServiceImpl != null) {
                iMsgPushServiceImpl.removeObserver(r1);
    ...
    public static boolean parseAimRoutePushInfo(String str, AimRoutePushInfo aimRoutePushInfo) {
        return IMsgPushServiceImpl.parseAimRoutePushInfo(str, aimRoutePushInfo);
    }
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.user.msgpush.MsgPushService.3
        });
    ...
    protected void clean() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.user.msgpush.MsgPushService.4
        }));
        TypeHelper typeHelper = this.mTypeHelper;
        if (typeHelper != null) {
    ...
    protected synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.user.msgpush.MsgPushService.5
        }));
        if (!this.mHasDestroy) {
            onDestroy();
        }
