...
public class IAccountServiceObserverImpl {
    ...
    private static native void notify18Native(long j, IAccountServiceObserverImpl iAccountServiceObserverImpl, int i, int i2, long j2, CarltdAuthInfoResult carltdAuthInfoResult);
    ...
    public void notify(int i, int i2, CarltdAuthInfoResult carltdAuthInfoResult) {
        ...
        notify18Native(j, this, i, i2, 0L, carltdAuthInfoResult);
    }
