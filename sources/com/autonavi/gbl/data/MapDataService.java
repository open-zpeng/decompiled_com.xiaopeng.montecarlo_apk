...
public class MapDataService implements IService {
    ...
    public int init(InitConfig initConfig, IDataInitObserver iDataInitObserver) {
        ...
        try {
            ...
            IMapDataServiceImpl iMapDataServiceImpl = this.mControl;
            if (iMapDataServiceImpl != null) {
                int init = iMapDataServiceImpl.init(initConfig, iDataInitObserverImpl);
    ...
    public String getPoiIdByBuildingId(int i, long j) {
        IMapDataServiceImpl iMapDataServiceImpl = this.mControl;
        if (iMapDataServiceImpl != null) {
            return iMapDataServiceImpl.getPoiIdByBuildingId(i, j);
        }
        return null;
    }
    ...
    public int setRequestDataList(@DownLoadMode.DownLoadMode1 int i, ArrayList<Integer> arrayList) {
        IMapDataServiceImpl iMapDataServiceImpl = this.mControl;
        if (iMapDataServiceImpl != null) {
            return iMapDataServiceImpl.setRequestDataList(i, arrayList);
        }
        return Integer.MIN_VALUE;
    }
    ...
    public int requestDataListCheck(@DownLoadMode.DownLoadMode1 int i, String str, IDataListObserver iDataListObserver) {
        ...
        try {
            ...
            IMapDataServiceImpl iMapDataServiceImpl = this.mControl;
            if (iMapDataServiceImpl != null) {
                int requestDataListCheck = iMapDataServiceImpl.requestDataListCheck(i, str, iDataListObserverImpl);
    ...
    public int setIMergedStatusInfoObserver(IMergedStatusInfoObserver iMergedStatusInfoObserver) {
        ...
        try {
            ...
            TypeHelper typeHelper3 = this.mTypeHelper;
            if (typeHelper3 != null) {
                hashSet = (HashSet) typeHelper3.getBindSet(method, 0);
            } else {
                hashSet = new HashSet();
            }
    ...
    public int removeDownloadObserver(@DownLoadMode.DownLoadMode1 int i, IDownloadObserver iDownloadObserver) {
        ...
        try {
            ...
            IMapDataServiceImpl iMapDataServiceImpl = this.mControl;
            if (iMapDataServiceImpl != null) {
                int removeDownloadObserver = iMapDataServiceImpl.removeDownloadObserver(i, iDownloadObserverImpl);
    ...
    public void addDataDeletionObserver(@DownLoadMode.DownLoadMode1 int i, IDataDeletionObserver iDataDeletionObserver) {
        ...
        try {
            ...
            IMapDataServiceImpl iMapDataServiceImpl = this.mControl;
            if (iMapDataServiceImpl != null) {
                iMapDataServiceImpl.addDataDeletionObserver(i, iDataDeletionObserverImpl);
            }
        } catch (Exception e) {
            Log.w("INTFAUTO", Log.getStackTraceString(e));
        }
