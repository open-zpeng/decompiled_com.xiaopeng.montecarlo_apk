...
public class CityDownLoadItem implements Serializable {
    ...
    public CityDownLoadItem(int i, boolean z, @TaskStatusCode.TaskStatusCode1 int i2, @OperationErrCode.OperationErrCode1 int i3, float f, boolean z2, boolean z3, boolean z4, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
        this.adcode = i;
        this.bValidItem = z;
        this.taskState = i2;
        this.errCode = i3;
