...
public class IMapDataServiceImpl implements IService {
    ...
    private static native void getDownLoadAdcodeListNative(long j, IMapDataServiceImpl iMapDataServiceImpl, ArrayList<Integer> arrayList);

    private static native String getEngineVersionNative(long j, IMapDataServiceImpl iMapDataServiceImpl);

    private static native int getPoiIdByBuildingIdNative(long j, IMapDataServiceImpl iMapDataServiceImpl, int i, long j2, String[] strArr);
    ...
    private static native int setRequestDataListNative(long j, IMapDataServiceImpl iMapDataServiceImpl, int i, ArrayList<Integer> arrayList);
    ...
    public String getPoiIdByBuildingId(int i, long j) {
        String[] strArr = new String[1];
        Integer.valueOf(getPoiIdByBuildingId(i, j, strArr));
        return strArr[0];
    }

    private int getPoiIdByBuildingId(int i, long j, String[] strArr) {
        long j2 = this.swigCPtr;
        if (j2 == 0) {
            throw new NullPointerException();
        }
        return getPoiIdByBuildingIdNative(j2, this, i, j, strArr);
    }
    ...
    public int setRequestDataList(@DownLoadMode.DownLoadMode1 int i, ArrayList<Integer> arrayList) {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        return setRequestDataListNative(j, this, i, arrayList);
    }
    ...
    public Area getArea(@DownLoadMode.DownLoadMode1 int i, int i2) {
        Area area = new Area();
        if (Boolean.valueOf(getArea(i, i2, area)).booleanValue()) {
            return area;
        }
        return null;
    }
    ...
    public CityDownLoadItem getCityDownLoadItem(@DownLoadMode.DownLoadMode1 int i, int i2) {
        ...
        if (Boolean.valueOf(getCityDownLoadItem(i, i2, cityDownLoadItem)).booleanValue()) {
    ...
    private void getDownLoadAdcodeList(ArrayList<Integer> arrayList) {
        ...
        getDownLoadAdcodeListNative(j, this, arrayList);
    }
