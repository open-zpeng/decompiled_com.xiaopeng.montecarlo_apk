...
public class ILNDSServiceImpl implements IService {
    ...
    public int getCityDataStatus(int i, @LndsSourceDataType.LndsSourceDataType1 int i2) {
        int[] iArr = new int[1];
        Integer.valueOf(getCityDataStatus(i, iArr, i2));
        return iArr[0];
    }
    ...
    public ArrayList<LNDSCityData> getCompleteCityList(@LndsSourceDataType.LndsSourceDataType1 int i) {
        ...
        if (Integer.valueOf(getCompleteCityList(arrayList, i)).intValue() == 0) {
            return arrayList;
        }
        return null;
    }

    private int getCompleteCityList(ArrayList<LNDSCityData> arrayList, @LndsSourceDataType.LndsSourceDataType1 int i) {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
