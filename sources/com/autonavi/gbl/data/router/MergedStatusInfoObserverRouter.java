...
public class MergedStatusInfoObserverRouter extends IMergedStatusInfoObserverImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.data.router.MergedStatusInfoObserverRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.data.router.MergedStatusInfoObserverRouter.2
        }));
        super.delete();
        unbind();
    }
