...
public class EHPDataObserverRouter extends IEHPDataObserverImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.data.router.EHPDataObserverRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.data.router.EHPDataObserverRouter.2
        }));
        super.delete();
        unbind();
    }
