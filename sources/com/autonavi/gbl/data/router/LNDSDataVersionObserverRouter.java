...
public class LNDSDataVersionObserverRouter extends ILNDSDataVersionObserverImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.data.router.LNDSDataVersionObserverRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.data.router.LNDSDataVersionObserverRouter.2
        }));
        super.delete();
        unbind();
    }
