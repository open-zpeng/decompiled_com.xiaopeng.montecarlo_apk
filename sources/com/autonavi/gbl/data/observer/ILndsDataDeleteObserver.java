...
public interface ILndsDataDeleteObserver {
    default void afterDataDelete(int i, @LndsSourceDataType.LndsSourceDataType1 int i2) {
    }

    default void beforeDataDelete(int i, @LndsSourceDataType.LndsSourceDataType1 int i2) {
    }
}
