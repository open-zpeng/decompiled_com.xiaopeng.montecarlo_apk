...
public class DataObserverJNI {
    ...
    public static void SwigDirector_IDataInitObserverImpl_onInit(IDataInitObserverImpl iDataInitObserverImpl, @DownLoadMode.DownLoadMode1 int i, @DataType.DataType1 int i2, @OperationErrCode.OperationErrCode1 int i3) {
        iDataInitObserverImpl.onInit(i, i2, i3);
    }

    public static void SwigDirector_IDataListObserverImpl_onRequestDataListCheck(IDataListObserverImpl iDataListObserverImpl, @DownLoadMode.DownLoadMode1 int i, @DataType.DataType1 int i2, @OperationErrCode.OperationErrCode1 int i3) {
    ...
    public static void SwigDirector_IDownloadObserverImpl_onDownLoadStatus(IDownloadObserverImpl iDownloadObserverImpl, @DownLoadMode.DownLoadMode1 int i, @DataType.DataType1 int i2, int i3, @TaskStatusCode.TaskStatusCode1 int i4, @OperationErrCode.OperationErrCode1 int i5) {
    ...
    public static void SwigDirector_IErrorDataObserverImpl_onDeleteErrorData(IErrorDataObserverImpl iErrorDataObserverImpl, @DownLoadMode.DownLoadMode1 int i, @DataType.DataType1 int i2, int i3, @OperationErrCode.OperationErrCode1 int i4) {
        iErrorDataObserverImpl.onDeleteErrorData(i, i2, i3, i4);
    }

    public static void SwigDirector_IImageObserverImpl_onDownloadImage(IImageObserverImpl iImageObserverImpl, int i, @OperationErrCode.OperationErrCode1 int i2, String str, @DataType.DataType1 int i3) {
    ...
    public static void SwigDirector_IHotUpdateCheckObserverImpl_onInitNotify(IHotUpdateCheckObserverImpl iHotUpdateCheckObserverImpl, @OperationErrCode.OperationErrCode1 int i, AutoInitResponseData autoInitResponseData) {
        iHotUpdateCheckObserverImpl.onInitNotify(i, autoInitResponseData);
    }

    public static void SwigDirector_IHotUpdateFileObserverImpl_onHotUpdateFile(IHotUpdateFileObserverImpl iHotUpdateFileObserverImpl, @HotUpdateFileType.HotUpdateFileType1 int i, @OperationErrCode.OperationErrCode1 int i2, String str) {
        iHotUpdateFileObserverImpl.onHotUpdateFile(i, i2, str);
    }

    public static void SwigDirector_IMapNumObserverImpl_onRequestMapNum(IMapNumObserverImpl iMapNumObserverImpl, @OperationErrCode.OperationErrCode1 int i, MapNum mapNum) {
    ...
    public static boolean SwigDirector_ILNDSNearCityListObserverImpl_onNearCityRequestError(ILNDSNearCityListObserverImpl iLNDSNearCityListObserverImpl, BigInteger bigInteger, @LNDS_NETWORK_ERROR.LNDS_NETWORK_ERROR1 int i) {
        return iLNDSNearCityListObserverImpl.onNearCityRequestError(bigInteger, i);
    }

    public static void SwigDirector_ILNDSDataVersionObserverImpl_onLNDSDataVersion(ILNDSDataVersionObserverImpl iLNDSDataVersionObserverImpl, BigInteger bigInteger, @LNDS_NETWORK_ERROR.LNDS_NETWORK_ERROR1 int i, String str) {
        iLNDSDataVersionObserverImpl.onLNDSDataVersion(bigInteger, i, str);
    }

    public static void SwigDirector_ILNDSGlobalFileUpdateObserverImpl_onGlobalFileUpdate(ILNDSGlobalFileUpdateObserverImpl iLNDSGlobalFileUpdateObserverImpl, BigInteger bigInteger, @OperationErrCode.OperationErrCode1 int i) {
    ...
    public static void SwigDirector_ILNDSGlobalFileUpdateObserverImpl_onTileGlobalFileUpdate(ILNDSGlobalFileUpdateObserverImpl iLNDSGlobalFileUpdateObserverImpl, BigInteger bigInteger, @OperationErrCode.OperationErrCode1 int i) {
    ...
    public static void SwigDirector_ILNDSCityDownloadObserverImpl_onDownloadError(ILNDSCityDownloadObserverImpl iLNDSCityDownloadObserverImpl, int i, @OperationErrCode.OperationErrCode1 int i2) {
