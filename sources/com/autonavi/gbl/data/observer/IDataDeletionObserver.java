...
public interface IDataDeletionObserver {
    default void onAfterDataDeletion(@DownLoadMode.DownLoadMode1 int i, @DataType.DataType1 int i2, int i3) {
    }

    default void onBeforeDataDeletion(@DownLoadMode.DownLoadMode1 int i, @DataType.DataType1 int i2, int i3) {
    }
}
