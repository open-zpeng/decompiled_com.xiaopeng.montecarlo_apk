...
public class BizGuideRouteControl extends BizControl {
    ...
    public boolean setSelectedPathIndex(int i) {
        IBizGuideRouteControl iBizGuideRouteControl = this.mControl;
        if (iBizGuideRouteControl != null) {
            return iBizGuideRouteControl.setSelectedPathIndex(i);
        }
        return false;
    }
    ...
    public boolean switchSelectedPath(int i) {
        IBizGuideRouteControl iBizGuideRouteControl = this.mControl;
        if (iBizGuideRouteControl != null) {
            return iBizGuideRouteControl.switchSelectedPath(i);
        }
        return false;
    }
    ...
    public void setFamiliarRoute(PathInfo pathInfo) {
        try {
            Method method = BizGuideRouteControl.class.getMethod("setFamiliarRoute", PathInfo.class);
            if (pathInfo != null) {
                TypeHelper typeHelper = this.mTypeHelper;
                r1 = typeHelper != null ? (PathInfoImpl) typeHelper.transfer(method, 0, pathInfo) : null;
                if (r1 == null) {
                    DebugTool.e("%s: $pathInfo == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizGuideRouteControl.3
                    }));
                }
            }
            IBizGuideRouteControl iBizGuideRouteControl = this.mControl;
            if (iBizGuideRouteControl != null) {
                iBizGuideRouteControl.setFamiliarRoute(r1);
            }
        } catch (Exception e) {
            Log.w("INTFAUTO", Log.getStackTraceString(e));
        }
    ...
    public void updateGuideFamiliarRoutePreviewRect(RectInt rectInt) {
        IBizGuideRouteControl iBizGuideRouteControl = this.mControl;
        if (iBizGuideRouteControl != null) {
            iBizGuideRouteControl.updateGuideFamiliarRoutePreviewRect(rectInt);
        }
    }
    ...
    public void enableFamiliarRoute(boolean z) {
        IBizGuideRouteControl iBizGuideRouteControl = this.mControl;
        if (iBizGuideRouteControl != null) {
            iBizGuideRouteControl.enableFamiliarRoute(z);
        }
    }
    ...
    public BaseLayer getRouteLayer(@BizRouteType.BizRouteType1 int i) {
        ...
        try {
            ...
            if (iBizGuideRouteControl != null && (routeLayer = iBizGuideRouteControl.getRouteLayer(i)) != null) {
                ...
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizGuideRouteControl.4
                    }));
                }
            }
            return r0;
    ...
    public void updateRoutePathNumberPreviewRect(RectInt rectInt) {
        IBizGuideRouteControl iBizGuideRouteControl = this.mControl;
        if (iBizGuideRouteControl != null) {
            iBizGuideRouteControl.updateRoutePathNumberPreviewRect(rectInt);
        }
    }
    ...
    public void enableRoutePathNumber(boolean z) {
        IBizGuideRouteControl iBizGuideRouteControl = this.mControl;
        if (iBizGuideRouteControl != null) {
            iBizGuideRouteControl.enableRoutePathNumber(z);
        }
    }
    ...
    public float getDynamicLevel(@DynamicLevelType.DynamicLevelType1 int i, boolean z) {
        IBizGuideRouteControl iBizGuideRouteControl = this.mControl;
        if (iBizGuideRouteControl != null) {
            return iBizGuideRouteControl.getDynamicLevel(i, z);
        }
        return 0.0f;
    }
    ...
    public void setDynamicLevelCustomCalculator(DynamicLevelCustomCalculator dynamicLevelCustomCalculator) {
        ...
        try {
            ...
            if (dynamicLevelCustomCalculator != null) {
                ...
                if (r3 == null) {
                    DebugTool.e("%s: $calculator == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizGuideRouteControl.6
                    }));
                }
            }
            IBizGuideRouteControl iBizGuideRouteControl = this.mControl;
    ...
    public void updateGuideCongestionBoard(NaviCongestionInfo naviCongestionInfo) {
        IBizGuideRouteControl iBizGuideRouteControl = this.mControl;
        if (iBizGuideRouteControl != null) {
            iBizGuideRouteControl.updateGuideCongestionBoard(naviCongestionInfo);
        }
    }
