...
public class CruiseEventLayerItem extends PointLayerItem implements ICruiseEventLayerItem {
    ...
    public void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.CruiseEventLayerItem.1
        });
    ...
    @Override // com.autonavi.gbl.map.layer.PointLayerItem, com.autonavi.gbl.map.layer.LayerItem
    public void clean() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.CruiseEventLayerItem.2
        }));
        super.clean();
    }
    ...
    public synchronized void delete() {
        Object[] objArr = new Object[2];
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.CruiseEventLayerItem.3
        });
