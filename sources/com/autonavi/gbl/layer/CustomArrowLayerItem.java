...
public class CustomArrowLayerItem extends ArrowLayerItem implements ICustomArrowLayerItem {
    ...
    public void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.CustomArrowLayerItem.1
        });
    ...
    @Override // com.autonavi.gbl.map.layer.ArrowLayerItem, com.autonavi.gbl.map.layer.LayerItem
    public void clean() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.CustomArrowLayerItem.2
        }));
        super.clean();
    }
    ...
    public synchronized void delete() {
        Object[] objArr = new Object[2];
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.CustomArrowLayerItem.3
        });
