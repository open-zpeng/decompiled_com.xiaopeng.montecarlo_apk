...
public class OddLayerItem extends PointLayerItem implements IOddLayerItem {
    ...
    public OddLayerItem(@ODDPointType.ODDPointType1 int i, BizOddInfo bizOddInfo, RectDouble rectDouble) {
        this(new OddLayerItemRouter("OddLayerItem", null, i, bizOddInfo, rectDouble));
        ReflexTool.invokeDeclMethodSafe(this.mService, "bindObserver", new Class[]{IOddLayerItem.class}, new Object[]{this});
    }
    ...
    public void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.OddLayerItem.1
        });
    ...
    @Override // com.autonavi.gbl.map.layer.PointLayerItem, com.autonavi.gbl.map.layer.LayerItem
    public void clean() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.OddLayerItem.2
        }));
        super.clean();
    }
    ...
    public synchronized void delete() {
        Object[] objArr = new Object[2];
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.OddLayerItem.3
        });
