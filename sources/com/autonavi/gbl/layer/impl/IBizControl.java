...
public class IBizControl {
    ...
    private static native boolean getClickableNative(long j, IBizControl iBizControl, long j2);

    private static native boolean getFocusNative(long j, IBizControl iBizControl, long j2, String str);

    private static native boolean getVisible1Native(long j, IBizControl iBizControl);

    private static native boolean getVisibleNative(long j, IBizControl iBizControl, long j2);
    ...
    private static native void restoreVisibleNative(long j, IBizControl iBizControl);

    private static native void saveVisibleNative(long j, IBizControl iBizControl);
    ...
    private static native void setStyle1Native(long j, IBizControl iBizControl, long j2, long j3, IPrepareLayerStyleImpl iPrepareLayerStyleImpl);
