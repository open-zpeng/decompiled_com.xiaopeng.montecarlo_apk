...
public class OddLayerItemImpl extends PointLayerItemImpl {
    ...
    private static native long createNativeObj(int i, long j, BizOddInfo bizOddInfo, long j2, RectDouble rectDouble, long j3);
    ...
    private static native long oddIndexGetNative(long j, OddLayerItemImpl oddLayerItemImpl);

    private static native void oddIndexSetNative(long j, OddLayerItemImpl oddLayerItemImpl, long j2);
    ...
    public OddLayerItemImpl(@ODDPointType.ODDPointType1 int i, BizOddInfo bizOddInfo, RectDouble rectDouble, long j) {
        this(createNativeObj(i, 0L, bizOddInfo, 0L, rectDouble, j), true);
    ...
    public void setOddIndex(long j) {
        $explicit_setOddIndex(j);
    }

    public void $explicit_setOddIndex(long j) {
        long j2 = this.swigCPtr;
        if (j2 == 0) {
            throw new NullPointerException();
        }
        oddIndexSetNative(j2, this, j);
    }

    public long getOddIndex() {
        return $explicit_getOddIndex();
    }

    public long $explicit_getOddIndex() {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        return oddIndexGetNative(j, this);
    }
}
