...
public class IBizGuideRouteControl extends IBizControl {
    ...
    private static native void enableFamiliarRouteNative(long j, IBizGuideRouteControl iBizGuideRouteControl, boolean z);
    ...
    private static native void enableRoutePathNumberNative(long j, IBizGuideRouteControl iBizGuideRouteControl, boolean z);
    ...
    private static native float getDynamicLevelNative(long j, IBizGuideRouteControl iBizGuideRouteControl, int i, boolean z);
    ...
    private static native void setFamiliarRouteNative(long j, IBizGuideRouteControl iBizGuideRouteControl, long j2, PathInfoImpl pathInfoImpl);
    ...
    private static native boolean setSelectedPathIndexNative(long j, IBizGuideRouteControl iBizGuideRouteControl, int i);
    ...
    private static native boolean switchSelectedPathNative(long j, IBizGuideRouteControl iBizGuideRouteControl, int i);
    ...
    private static native void updateGuideCongestionBoardNative(long j, IBizGuideRouteControl iBizGuideRouteControl, long j2, NaviCongestionInfo naviCongestionInfo);
    ...
    private static native void updateGuideFamiliarRoutePreviewRectNative(long j, IBizGuideRouteControl iBizGuideRouteControl, long j2, RectInt rectInt);
    ...
    private static native void updateRoutePathNumberPreviewRectNative(long j, IBizGuideRouteControl iBizGuideRouteControl, long j2, RectInt rectInt);
    ...
    public void setFamiliarRoute(PathInfoImpl pathInfoImpl) {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        setFamiliarRouteNative(j, this, PathInfoImpl.getCPtr(pathInfoImpl), pathInfoImpl);
    }
