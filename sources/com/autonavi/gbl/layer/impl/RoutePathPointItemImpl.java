...
public class RoutePathPointItemImpl extends PointLayerItemImpl {
    ...
    private static native boolean passedGetNative(long j, RoutePathPointItemImpl routePathPointItemImpl);

    private static native void passedSetNative(long j, RoutePathPointItemImpl routePathPointItemImpl, boolean z);

    private static native long pathIdGetNative(long j, RoutePathPointItemImpl routePathPointItemImpl);

    private static native void pathIdSetNative(long j, RoutePathPointItemImpl routePathPointItemImpl, long j2);

    private static native int pointIndexGetNative(long j, RoutePathPointItemImpl routePathPointItemImpl);

    private static native void pointIndexSetNative(long j, RoutePathPointItemImpl routePathPointItemImpl, int i);
    ...
    public void setPassed(boolean z) {
        $explicit_setPassed(z);
    }

    public void $explicit_setPassed(boolean z) {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        passedSetNative(j, this, z);
    }
    ...
    public boolean $explicit_getPassed() {
        ...
        return passedGetNative(j, this);
    }

    public void setPointIndex(int i) {
        $explicit_setPointIndex(i);
    }

    public void $explicit_setPointIndex(int i) {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        pointIndexSetNative(j, this, i);
    }
    ...
    public int $explicit_getPointIndex() {
        ...
        return pointIndexGetNative(j, this);
    }
