...
public class GuideLabelLayerItemImpl extends QuadrantLayerItem {
    ...
    private static native void onVisibleNative(long j, GuideLabelLayerItemImpl guideLabelLayerItemImpl, boolean z);

    private static native void onVisibleSwigExplicitGuideLabelLayerItemImplNative(long j, GuideLabelLayerItemImpl guideLabelLayerItemImpl, boolean z);
    ...
    @Override // com.autonavi.gbl.map.layer.impl.QuadrantLayerItem, com.autonavi.gbl.map.layer.impl.LayerItemImpl
    public void $explicit_onVisible(boolean z) {
        if (this.swigCPtr == 0) {
            throw new NullPointerException();
        }
        if (getClass() == GuideLabelLayerItemImpl.class) {
            onVisibleNative(this.swigCPtr, this, z);
        } else {
            onVisibleSwigExplicitGuideLabelLayerItemImplNative(this.swigCPtr, this, z);
        }
    }
