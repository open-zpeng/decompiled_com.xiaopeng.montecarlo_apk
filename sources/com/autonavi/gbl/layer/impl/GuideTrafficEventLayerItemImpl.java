...
public class GuideTrafficEventLayerItemImpl extends QuadrantLayerItemImpl {
    ...
    private static native String mLabelDescGetNative(long j, GuideTrafficEventLayerItemImpl guideTrafficEventLayerItemImpl);

    private static native void mLabelDescSetNative(long j, GuideTrafficEventLayerItemImpl guideTrafficEventLayerItemImpl, String str);
    ...
    public GuideTrafficEventLayerItemImpl(@QuadrantType.QuadrantType1 int i, long j) {
    ...
    public void setMLabelDesc(String str) {
        $explicit_setMLabelDesc(str);
    }

    public void $explicit_setMLabelDesc(String str) {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        mLabelDescSetNative(j, this, str);
    }

    public String getMLabelDesc() {
        return $explicit_getMLabelDesc();
    }

    public String $explicit_getMLabelDesc() {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        return mLabelDescGetNative(j, this);
    }
}
