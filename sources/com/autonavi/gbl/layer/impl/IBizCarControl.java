...
public class IBizCarControl {
    ...
    private static native boolean getVisibleNative(long j, IBizCarControl iBizCarControl);

    private static native boolean matchBizControlNative(long j, IBizCarControl iBizCarControl, long j2);
    ...
    private static native void restoreVisibleNative(long j, IBizCarControl iBizCarControl);

    private static native void saveVisibleNative(long j, IBizCarControl iBizCarControl);
    ...
    private static native void setSkeletonBaseScaleNative(long j, IBizCarControl iBizCarControl, float f);
    ...
    private static native void updatePointLightParamNative(long j, IBizCarControl iBizCarControl, ArrayList<PointLightParam> arrayList);
