...
public class GuideLabelLayerItem extends QuadrantLayerItemImpl implements IGuideLabelLayerItem {
    ...
    @Override // com.autonavi.gbl.map.layer.QuadrantLayerItemImpl, com.autonavi.gbl.map.layer.LayerItem, com.autonavi.gbl.map.layer.observer.ILayerItem, com.autonavi.gbl.map.observer.ICollisionItem, com.autonavi.gbl.map.layer.observer.IQuadrantLayerItem, com.autonavi.gbl.layer.observer.IGuideLabelLayerItem
    public void onVisible(boolean z) {
        GuideLabelLayerItemImpl guideLabelLayerItemImpl = this.mService;
        if (guideLabelLayerItemImpl != null) {
            guideLabelLayerItemImpl.$explicit_onVisible(z);
        }
    }
