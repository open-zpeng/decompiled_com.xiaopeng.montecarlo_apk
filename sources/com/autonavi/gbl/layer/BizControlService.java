...
public class BizControlService implements IService {
    ...
    public void setVisible(MapView mapView, boolean z, ArrayList<Integer> arrayList) {
        try {
            ...
            IBizControlService iBizControlService = this.mControl;
            if (iBizControlService != null) {
                iBizControlService.setVisible(r1, z, arrayList);
            }
        } catch (Exception e) {
            Log.w("INTFAUTO", Log.getStackTraceString(e));
        }
    ...
    public boolean getVisible(MapView mapView, int i) {
        try {
            ...
            if (mapView != null) {
                ...
                if (r2 == null) {
                    DebugTool.e("%s: $mapView == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.6
                    }));
                    return false;
                }
            }
            IBizControlService iBizControlService = this.mControl;
            if (iBizControlService != null) {
                return iBizControlService.getVisible(r2, i);
            }
            return false;
        } catch (Exception e) {
            Log.w("INTFAUTO", Log.getStackTraceString(e));
    ...
    public void saveVisible(MapView mapView) {
        try {
            ...
            if (mapView != null) {
                ...
                r1 = typeHelper != null ? (MapViewImpl) typeHelper.transfer(method, 0, mapView) : null;
                if (r1 == null) {
                    DebugTool.e("%s: $mapView == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.7
                    }));
                }
            }
            IBizControlService iBizControlService = this.mControl;
            if (iBizControlService != null) {
                iBizControlService.saveVisible(r1);
            }
        } catch (Exception e) {
            Log.w("INTFAUTO", Log.getStackTraceString(e));
        }
    ...
    public void restoreVisible(MapView mapView) {
        try {
            ...
            if (mapView != null) {
                ...
                r1 = typeHelper != null ? (MapViewImpl) typeHelper.transfer(method, 0, mapView) : null;
                if (r1 == null) {
                    DebugTool.e("%s: $mapView == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.8
                    }));
                }
            }
            IBizControlService iBizControlService = this.mControl;
            if (iBizControlService != null) {
                iBizControlService.restoreVisible(r1);
            }
        } catch (Exception e) {
            Log.w("INTFAUTO", Log.getStackTraceString(e));
        }
    ...
    public boolean initCollisionConfig(MapView mapView, String str) {
        try {
            ...
            if (mapView != null) {
                ...
                r2 = typeHelper != null ? (MapViewImpl) typeHelper.transfer(method, 0, mapView) : null;
                if (r2 == null) {
                    DebugTool.e("%s: $mapView == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.9
                    }));
                    return false;
                }
            }
    ...
    public void setUICollisionRects(MapView mapView, ArrayList<RectDouble> arrayList) {
        try {
            ...
            if (mapView != null) {
                ...
                r1 = typeHelper != null ? (MapViewImpl) typeHelper.transfer(method, 0, mapView) : null;
                if (r1 == null) {
                    DebugTool.e("%s: $pMapView == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.10
                    }));
                }
            }
            IBizControlService iBizControlService = this.mControl;
    ...
    public BizAreaControl getBizAreaControl(MapView mapView) {
        ...
        try {
            ...
            if (mapView != null) {
                ...
                mapViewImpl = typeHelper != null ? (MapViewImpl) typeHelper.transfer(method, 0, mapView) : null;
                if (mapViewImpl == null) {
                    DebugTool.e("%s: $pMapView == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.27
                    }));
                    return null;
                }
            } else {
            ...
            if (iBizControlService != null && (bizAreaControl = iBizControlService.getBizAreaControl(mapViewImpl)) != null) {
                ...
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.28
                    }));
                }
            }
            return r0;
    ...
    public BizSearchControl getBizSearchControl(MapView mapView) {
        ...
        try {
            ...
            if (mapView != null) {
                ...
                mapViewImpl = typeHelper != null ? (MapViewImpl) typeHelper.transfer(method, 0, mapView) : null;
                if (mapViewImpl == null) {
                    DebugTool.e("%s: $pMapView == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.29
                    }));
                    return null;
                }
            } else {
            ...
            if (iBizControlService != null && (bizSearchControl = iBizControlService.getBizSearchControl(mapViewImpl)) != null) {
                ...
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.30
                    }));
                }
            }
            return r0;
    ...
    public BizGuideEagleEyeControl getBizGuideEagleEyeControl(@EGLDeviceID.EGLDeviceID1 int i) {
        ...
        try {
            ...
            if (iBizControlService != null && (bizGuideEagleEyeControl = iBizControlService.getBizGuideEagleEyeControl(i)) != null) {
                ...
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.31
                    }));
                }
            }
            return r0;
    ...
    public BizLaneControl getBizLaneControl(MapView mapView) {
        ...
        try {
            ...
            if (mapView != null) {
                ...
                mapViewImpl = typeHelper != null ? (MapViewImpl) typeHelper.transfer(method, 0, mapView) : null;
                if (mapViewImpl == null) {
                    DebugTool.e("%s: $pMapView == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.32
                    }));
                    return null;
                }
            } else {
            ...
            IBizControlService iBizControlService = this.mControl;
            if (iBizControlService != null && (bizLaneControl = iBizControlService.getBizLaneControl(mapViewImpl)) != null) {
                TypeHelper typeHelper2 = this.mTypeHelper;
                r0 = typeHelper2 != null ? (BizLaneControl) typeHelper2.transfer(method, -1, (Object) bizLaneControl, true) : null;
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.33
                    }));
                }
            }
            return r0;
    ...
    public BizCustomControl getBizCustomControl(MapView mapView) {
        ...
        try {
            ...
            if (mapView != null) {
                ...
                mapViewImpl = typeHelper != null ? (MapViewImpl) typeHelper.transfer(method, 0, mapView) : null;
                if (mapViewImpl == null) {
                    DebugTool.e("%s: $pMapView == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.34
                    }));
                    return null;
                }
            } else {
            ...
            if (iBizControlService != null && (bizCustomControl = iBizControlService.getBizCustomControl(mapViewImpl)) != null) {
                ...
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.35
                    }));
                }
            }
            return r0;
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.36
        });
    ...
    protected void clean() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.37
        }));
    }

    protected synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControlService.38
        }));
        if (!this.mHasDestroy) {
            onDestroy();
        }
