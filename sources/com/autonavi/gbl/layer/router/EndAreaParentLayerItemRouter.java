...
public class EndAreaParentLayerItemRouter extends EndAreaParentLayerItemImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.EndAreaParentLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.layer.impl.EndAreaParentLayerItemImpl, com.autonavi.gbl.map.layer.impl.QuadrantLayerItem, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.EndAreaParentLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
    ...
    public String getTypeCode() {
        IEndAreaParentLayerItem iEndAreaParentLayerItem = this.mObserver;
        if (iEndAreaParentLayerItem != null) {
            return iEndAreaParentLayerItem.getTypeCode();
        }
        return null;
    }
