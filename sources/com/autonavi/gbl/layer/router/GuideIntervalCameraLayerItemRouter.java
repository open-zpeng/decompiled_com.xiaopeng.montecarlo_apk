...
public class GuideIntervalCameraLayerItemRouter extends GuideIntervalCameraLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.GuideIntervalCameraLayerItemImpl, com.autonavi.gbl.map.layer.impl.QuadrantLayerItem, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    ...
    public String getTypeCode() {
        IGuideIntervalCameraLayerItem iGuideIntervalCameraLayerItem = this.mObserver;
        if (iGuideIntervalCameraLayerItem != null) {
            return iGuideIntervalCameraLayerItem.getTypeCode();
        }
        return null;
    }
