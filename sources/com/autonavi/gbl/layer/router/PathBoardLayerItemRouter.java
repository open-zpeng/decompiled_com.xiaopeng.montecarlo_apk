...
public class PathBoardLayerItemRouter extends PathBoardLayerItemImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.PathBoardLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.layer.impl.PathBoardLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.PathBoardLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
    ...
    public String getTypeCode() {
        IPathBoardLayerItem iPathBoardLayerItem = this.mObserver;
        if (iPathBoardLayerItem != null) {
            return iPathBoardLayerItem.getTypeCode();
        }
        return null;
    }
