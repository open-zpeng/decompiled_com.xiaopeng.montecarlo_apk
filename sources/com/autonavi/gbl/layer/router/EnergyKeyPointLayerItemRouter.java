...
public class EnergyKeyPointLayerItemRouter extends EnergyKeyPointLayerItemImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.EnergyKeyPointLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.layer.impl.EnergyKeyPointLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.EnergyKeyPointLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
    ...
    public String getTypeCode() {
        IEnergyKeyPointLayerItem iEnergyKeyPointLayerItem = this.mObserver;
        if (iEnergyKeyPointLayerItem != null) {
            return iEnergyKeyPointLayerItem.getTypeCode();
        }
        return null;
    }
