...
public class CustomPlaneLayerItemRouter extends CustomPlaneLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.CustomPlaneLayerItemImpl, com.autonavi.gbl.map.layer.impl.RasterImageLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public boolean getClickable() {
        ICustomPlaneLayerItem iCustomPlaneLayerItem = this.mObserver;
        if (iCustomPlaneLayerItem != null) {
            return iCustomPlaneLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        ICustomPlaneLayerItem iCustomPlaneLayerItem = this.mObserver;
        if (iCustomPlaneLayerItem != null) {
            return iCustomPlaneLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        ICustomPlaneLayerItem iCustomPlaneLayerItem = this.mObserver;
        if (iCustomPlaneLayerItem != null) {
            return iCustomPlaneLayerItem.canAreaCollision();
        }
        return false;
    }
}
