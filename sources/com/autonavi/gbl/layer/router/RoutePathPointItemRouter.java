...
public class RoutePathPointItemRouter extends RoutePathPointItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.RoutePathPointItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public boolean getPassed() {
        IRoutePathPointItem iRoutePathPointItem = this.mObserver;
        if (iRoutePathPointItem != null) {
            return iRoutePathPointItem.getPassed();
        }
        return false;
    }
    ...
    public int getPointIndex() {
        IRoutePathPointItem iRoutePathPointItem = this.mObserver;
        if (iRoutePathPointItem != null) {
            return iRoutePathPointItem.getPointIndex();
        }
        return 0;
    }
    ...
    public long getPathId() {
        IRoutePathPointItem iRoutePathPointItem = this.mObserver;
        if (iRoutePathPointItem != null) {
            return iRoutePathPointItem.getPathId();
        }
        return 0L;
    }
    ...
    public boolean getClickable() {
        IRoutePathPointItem iRoutePathPointItem = this.mObserver;
        if (iRoutePathPointItem != null) {
            return iRoutePathPointItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        IRoutePathPointItem iRoutePathPointItem = this.mObserver;
        if (iRoutePathPointItem != null) {
            return iRoutePathPointItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IRoutePathPointItem iRoutePathPointItem = this.mObserver;
        if (iRoutePathPointItem != null) {
            return iRoutePathPointItem.canAreaCollision();
        }
        return false;
    }
}
