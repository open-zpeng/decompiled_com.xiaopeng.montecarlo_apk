...
public class SearchChildLayerItemRouter extends SearchChildLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.SearchChildLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public boolean getClickable() {
        ISearchChildLayerItem iSearchChildLayerItem = this.mObserver;
        if (iSearchChildLayerItem != null) {
            return iSearchChildLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        ISearchChildLayerItem iSearchChildLayerItem = this.mObserver;
        if (iSearchChildLayerItem != null) {
            return iSearchChildLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        ISearchChildLayerItem iSearchChildLayerItem = this.mObserver;
        if (iSearchChildLayerItem != null) {
            return iSearchChildLayerItem.canAreaCollision();
        }
        return false;
    }
}
