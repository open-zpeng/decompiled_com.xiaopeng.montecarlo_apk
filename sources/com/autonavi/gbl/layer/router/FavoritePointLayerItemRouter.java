...
public class FavoritePointLayerItemRouter extends FavoritePointLayerItemImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.FavoritePointLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.layer.impl.FavoritePointLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.FavoritePointLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
    ...
    public String getTypeCode() {
        IFavoritePointLayerItem iFavoritePointLayerItem = this.mObserver;
        if (iFavoritePointLayerItem != null) {
            return iFavoritePointLayerItem.getTypeCode();
        }
        return null;
    }
