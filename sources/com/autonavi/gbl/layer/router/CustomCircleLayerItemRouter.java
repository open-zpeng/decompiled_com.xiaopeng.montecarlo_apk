...
public class CustomCircleLayerItemRouter extends CustomCircleLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.CustomCircleLayerItemImpl, com.autonavi.gbl.map.layer.impl.SectorLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public boolean getClickable() {
        ICustomCircleLayerItem iCustomCircleLayerItem = this.mObserver;
        if (iCustomCircleLayerItem != null) {
            return iCustomCircleLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        ICustomCircleLayerItem iCustomCircleLayerItem = this.mObserver;
        if (iCustomCircleLayerItem != null) {
            return iCustomCircleLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        ICustomCircleLayerItem iCustomCircleLayerItem = this.mObserver;
        if (iCustomCircleLayerItem != null) {
            return iCustomCircleLayerItem.canAreaCollision();
        }
        return false;
    }
}
