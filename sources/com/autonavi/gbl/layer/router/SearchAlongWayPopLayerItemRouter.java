...
public class SearchAlongWayPopLayerItemRouter extends SearchAlongWayPopLayerItemImpl {
    ...
    public float getIntersectValue(@IntersectValueType.IntersectValueType1 int i) {
        ISearchAlongWayPopLayerItem iSearchAlongWayPopLayerItem = this.mObserver;
        if (iSearchAlongWayPopLayerItem != null) {
            return iSearchAlongWayPopLayerItem.getIntersectValue(i);
        }
        return 0.0f;
    }
    ...
    public boolean getClickable() {
        ISearchAlongWayPopLayerItem iSearchAlongWayPopLayerItem = this.mObserver;
        if (iSearchAlongWayPopLayerItem != null) {
            return iSearchAlongWayPopLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        ISearchAlongWayPopLayerItem iSearchAlongWayPopLayerItem = this.mObserver;
        if (iSearchAlongWayPopLayerItem != null) {
            return iSearchAlongWayPopLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        ISearchAlongWayPopLayerItem iSearchAlongWayPopLayerItem = this.mObserver;
        if (iSearchAlongWayPopLayerItem != null) {
            return iSearchAlongWayPopLayerItem.canAreaCollision();
        }
        return false;
    }
}
