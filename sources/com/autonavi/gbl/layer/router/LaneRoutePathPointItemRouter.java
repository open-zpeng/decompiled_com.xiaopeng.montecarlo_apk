...
public class LaneRoutePathPointItemRouter extends LaneRoutePathPointItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.LaneRoutePathPointItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public boolean getClickable() {
        ILaneRoutePathPointItem iLaneRoutePathPointItem = this.mObserver;
        if (iLaneRoutePathPointItem != null) {
            return iLaneRoutePathPointItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        ILaneRoutePathPointItem iLaneRoutePathPointItem = this.mObserver;
        if (iLaneRoutePathPointItem != null) {
            return iLaneRoutePathPointItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        ILaneRoutePathPointItem iLaneRoutePathPointItem = this.mObserver;
        if (iLaneRoutePathPointItem != null) {
            return iLaneRoutePathPointItem.canAreaCollision();
        }
        return false;
    }
}
