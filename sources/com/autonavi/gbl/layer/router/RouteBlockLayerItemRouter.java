...
public class RouteBlockLayerItemRouter extends RouteBlockLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.RouteBlockLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    public synchronized void delete() {
        super.delete();
        unbind();
    }

    @Override // com.autonavi.gbl.layer.impl.RouteBlockLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl
    ...
    public String getPointTypeCode() {
        IRouteBlockLayerItem iRouteBlockLayerItem = this.mObserver;
        if (iRouteBlockLayerItem != null) {
            return iRouteBlockLayerItem.getPointTypeCode();
        }
        return null;
    }
    ...
    public float getForeshorteningCoef() {
        IRouteBlockLayerItem iRouteBlockLayerItem = this.mObserver;
        if (iRouteBlockLayerItem != null) {
            return iRouteBlockLayerItem.getForeshorteningCoef();
        }
        return 0.0f;
    }
    ...
    public boolean getClickable() {
        IRouteBlockLayerItem iRouteBlockLayerItem = this.mObserver;
        if (iRouteBlockLayerItem != null) {
            return iRouteBlockLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean getOnVisible() {
        IRouteBlockLayerItem iRouteBlockLayerItem = this.mObserver;
        if (iRouteBlockLayerItem != null) {
            return iRouteBlockLayerItem.getOnVisible();
        }
        return false;
    }
    ...
    public void resetOnVisible(boolean z) {
        IRouteBlockLayerItem iRouteBlockLayerItem = this.mObserver;
        if (iRouteBlockLayerItem != null) {
            iRouteBlockLayerItem.resetOnVisible(z);
        }
    }
    ...
    public void applyOnVisible() {
        IRouteBlockLayerItem iRouteBlockLayerItem = this.mObserver;
        if (iRouteBlockLayerItem != null) {
            iRouteBlockLayerItem.applyOnVisible();
        }
    }
    ...
    public boolean canCollision() {
        IRouteBlockLayerItem iRouteBlockLayerItem = this.mObserver;
        if (iRouteBlockLayerItem != null) {
            return iRouteBlockLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IRouteBlockLayerItem iRouteBlockLayerItem = this.mObserver;
        if (iRouteBlockLayerItem != null) {
            return iRouteBlockLayerItem.canAreaCollision();
        }
        return false;
    }
}
