...
public class CustomArrowLayerItemRouter extends CustomArrowLayerItemImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.CustomArrowLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.layer.impl.CustomArrowLayerItemImpl, com.autonavi.gbl.map.layer.impl.ArrowLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.CustomArrowLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
