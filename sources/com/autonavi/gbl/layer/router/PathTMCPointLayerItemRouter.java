...
public class PathTMCPointLayerItemRouter extends PathTMCPointLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.PathTMCPointLayerItemImpl, com.autonavi.gbl.map.layer.impl.QuadrantLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public float getIntersectValue(@IntersectValueType.IntersectValueType1 int i) {
        IPathTMCPointLayerItem iPathTMCPointLayerItem = this.mObserver;
        if (iPathTMCPointLayerItem != null) {
            return iPathTMCPointLayerItem.getIntersectValue(i);
        }
        return 0.0f;
    }
    ...
    public boolean getClickable() {
        IPathTMCPointLayerItem iPathTMCPointLayerItem = this.mObserver;
        if (iPathTMCPointLayerItem != null) {
            return iPathTMCPointLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        IPathTMCPointLayerItem iPathTMCPointLayerItem = this.mObserver;
        if (iPathTMCPointLayerItem != null) {
            return iPathTMCPointLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IPathTMCPointLayerItem iPathTMCPointLayerItem = this.mObserver;
        if (iPathTMCPointLayerItem != null) {
            return iPathTMCPointLayerItem.canAreaCollision();
        }
        return false;
    }
}
