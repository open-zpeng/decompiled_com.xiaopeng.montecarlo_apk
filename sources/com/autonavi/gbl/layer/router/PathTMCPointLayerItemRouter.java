...
public class PathTMCPointLayerItemRouter extends PathTMCPointLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.PathTMCPointLayerItemImpl, com.autonavi.gbl.map.layer.impl.QuadrantLayerItem, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    ...
    public String getTypeCode() {
        IPathTMCPointLayerItem iPathTMCPointLayerItem = this.mObserver;
        if (iPathTMCPointLayerItem != null) {
            return iPathTMCPointLayerItem.getTypeCode();
        }
        return null;
    }
