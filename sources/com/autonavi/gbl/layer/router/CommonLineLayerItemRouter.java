...
public class CommonLineLayerItemRouter extends CommonLineLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.CommonLineLayerItemImpl, com.autonavi.gbl.map.layer.impl.LineLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public long getPointsCount() {
        ICommonLineLayerItem iCommonLineLayerItem = this.mObserver;
        if (iCommonLineLayerItem != null) {
            return iCommonLineLayerItem.getPointsCount();
        }
        return 0L;
    }
    ...
    public boolean getClickable() {
        ICommonLineLayerItem iCommonLineLayerItem = this.mObserver;
        if (iCommonLineLayerItem != null) {
            return iCommonLineLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        ICommonLineLayerItem iCommonLineLayerItem = this.mObserver;
        if (iCommonLineLayerItem != null) {
            return iCommonLineLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        ICommonLineLayerItem iCommonLineLayerItem = this.mObserver;
        if (iCommonLineLayerItem != null) {
            return iCommonLineLayerItem.canAreaCollision();
        }
        return false;
    }
}
