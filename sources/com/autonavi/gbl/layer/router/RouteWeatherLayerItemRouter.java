...
public class RouteWeatherLayerItemRouter extends RouteWeatherLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.RouteWeatherLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public boolean getClickable() {
        IRouteWeatherLayerItem iRouteWeatherLayerItem = this.mObserver;
        if (iRouteWeatherLayerItem != null) {
            return iRouteWeatherLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        IRouteWeatherLayerItem iRouteWeatherLayerItem = this.mObserver;
        if (iRouteWeatherLayerItem != null) {
            return iRouteWeatherLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IRouteWeatherLayerItem iRouteWeatherLayerItem = this.mObserver;
        if (iRouteWeatherLayerItem != null) {
            return iRouteWeatherLayerItem.canAreaCollision();
        }
        return false;
    }
}
