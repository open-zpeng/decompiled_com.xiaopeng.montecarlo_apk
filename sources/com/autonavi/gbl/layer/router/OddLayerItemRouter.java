...
public class OddLayerItemRouter extends OddLayerItemImpl {
    ...
    public OddLayerItemRouter(String str, IOddLayerItem iOddLayerItem, @ODDPointType.ODDPointType1 int i, BizOddInfo bizOddInfo, RectDouble rectDouble, long j) {
        super(i, bizOddInfo, rectDouble, j);
        this.mTargetId = null;
        this.mHelper = null;
        this.mObserver = null;
        $constructor(str, iOddLayerItem);
    ...
    @Override // com.autonavi.gbl.layer.impl.OddLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public long getOddIndex() {
        IOddLayerItem iOddLayerItem = this.mObserver;
        if (iOddLayerItem != null) {
            return iOddLayerItem.getOddIndex();
        }
        return 0L;
    }
    ...
    public String getPointTypeCode() {
        IOddLayerItem iOddLayerItem = this.mObserver;
        if (iOddLayerItem != null) {
            return iOddLayerItem.getPointTypeCode();
        }
        return null;
    }
    ...
    public float getForeshorteningCoef() {
        IOddLayerItem iOddLayerItem = this.mObserver;
        if (iOddLayerItem != null) {
            return iOddLayerItem.getForeshorteningCoef();
        }
        return 0.0f;
    }
    ...
    public boolean getClickable() {
        IOddLayerItem iOddLayerItem = this.mObserver;
        if (iOddLayerItem != null) {
            return iOddLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean getOnVisible() {
        IOddLayerItem iOddLayerItem = this.mObserver;
        if (iOddLayerItem != null) {
            return iOddLayerItem.getOnVisible();
        }
        return false;
    }
    ...
    public void resetOnVisible(boolean z) {
        IOddLayerItem iOddLayerItem = this.mObserver;
        if (iOddLayerItem != null) {
            iOddLayerItem.resetOnVisible(z);
        }
    }
    ...
    public boolean canCollision() {
        IOddLayerItem iOddLayerItem = this.mObserver;
        if (iOddLayerItem != null) {
            return iOddLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IOddLayerItem iOddLayerItem = this.mObserver;
        if (iOddLayerItem != null) {
            return iOddLayerItem.canAreaCollision();
        }
        return false;
    }
}
