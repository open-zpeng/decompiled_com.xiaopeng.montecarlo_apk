...
public class LocalTrafficEventLineLayerItemRouter extends LocalTrafficEventLineLayerItemImpl {
    ...
    public LocalTrafficEventLineLayerItemRouter(String str, ILocalTrafficEventLineLayerItem iLocalTrafficEventLineLayerItem, @LocalTrafficEventType.LocalTrafficEventType1 int i, String str2) {
        super(i, str2);
        this.mTargetId = null;
        this.mHelper = null;
        this.mObserver = null;
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.LocalTrafficEventLineLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.layer.impl.LocalTrafficEventLineLayerItemImpl, com.autonavi.gbl.map.layer.impl.LineLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.LocalTrafficEventLineLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
