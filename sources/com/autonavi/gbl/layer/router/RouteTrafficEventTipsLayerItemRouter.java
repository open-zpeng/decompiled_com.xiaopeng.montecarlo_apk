...
public class RouteTrafficEventTipsLayerItemRouter extends RouteTrafficEventTipsLayerItemImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.RouteTrafficEventTipsLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.layer.impl.RouteTrafficEventTipsLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.RouteTrafficEventTipsLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
    ...
    public String getTypeCode() {
        IRouteTrafficEventTipsLayerItem iRouteTrafficEventTipsLayerItem = this.mObserver;
        if (iRouteTrafficEventTipsLayerItem != null) {
            return iRouteTrafficEventTipsLayerItem.getTypeCode();
        }
        return null;
    }
