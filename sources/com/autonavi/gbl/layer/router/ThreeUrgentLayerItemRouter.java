...
public class ThreeUrgentLayerItemRouter extends ThreeUrgentLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.ThreeUrgentLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public boolean getClickable() {
        IThreeUrgentLayerItem iThreeUrgentLayerItem = this.mObserver;
        if (iThreeUrgentLayerItem != null) {
            return iThreeUrgentLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        IThreeUrgentLayerItem iThreeUrgentLayerItem = this.mObserver;
        if (iThreeUrgentLayerItem != null) {
            return iThreeUrgentLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IThreeUrgentLayerItem iThreeUrgentLayerItem = this.mObserver;
        if (iThreeUrgentLayerItem != null) {
            return iThreeUrgentLayerItem.canAreaCollision();
        }
        return false;
    }
}
