...
public class RouteViaRoadLayerItemRouter extends RouteViaRoadLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.RouteViaRoadLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public boolean getClickable() {
        IRouteViaRoadLayerItem iRouteViaRoadLayerItem = this.mObserver;
        if (iRouteViaRoadLayerItem != null) {
            return iRouteViaRoadLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        IRouteViaRoadLayerItem iRouteViaRoadLayerItem = this.mObserver;
        if (iRouteViaRoadLayerItem != null) {
            return iRouteViaRoadLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IRouteViaRoadLayerItem iRouteViaRoadLayerItem = this.mObserver;
        if (iRouteViaRoadLayerItem != null) {
            return iRouteViaRoadLayerItem.canAreaCollision();
        }
        return false;
    }
}
