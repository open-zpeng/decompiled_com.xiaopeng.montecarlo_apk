...
public class CruiseCongestionItemRouter extends CruiseCongestionItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.CruiseCongestionItemImpl, com.autonavi.gbl.map.layer.impl.LineLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public long getPointsCount() {
        ICruiseCongestionItem iCruiseCongestionItem = this.mObserver;
        if (iCruiseCongestionItem != null) {
            return iCruiseCongestionItem.getPointsCount();
        }
        return 0L;
    }
    ...
    public boolean getClickable() {
        ICruiseCongestionItem iCruiseCongestionItem = this.mObserver;
        if (iCruiseCongestionItem != null) {
            return iCruiseCongestionItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        ICruiseCongestionItem iCruiseCongestionItem = this.mObserver;
        if (iCruiseCongestionItem != null) {
            return iCruiseCongestionItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        ICruiseCongestionItem iCruiseCongestionItem = this.mObserver;
        if (iCruiseCongestionItem != null) {
            return iCruiseCongestionItem.canAreaCollision();
        }
        return false;
    }
}
