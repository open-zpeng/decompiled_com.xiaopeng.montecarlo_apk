...
public class RangeOnMapPolygonPointLayerItemRouter extends RangeOnMapPolygonPointLayerItemImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.RangeOnMapPolygonPointLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.layer.impl.RangeOnMapPolygonPointLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.RangeOnMapPolygonPointLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
    ...
    public String getTypeCode() {
        IRangeOnMapPolygonPointLayerItem iRangeOnMapPolygonPointLayerItem = this.mObserver;
        if (iRangeOnMapPolygonPointLayerItem != null) {
            return iRangeOnMapPolygonPointLayerItem.getTypeCode();
        }
        return null;
    }
