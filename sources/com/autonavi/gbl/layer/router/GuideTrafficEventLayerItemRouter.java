...
public class GuideTrafficEventLayerItemRouter extends GuideTrafficEventLayerItemImpl {
    ...
    public GuideTrafficEventLayerItemRouter(String str, IGuideTrafficEventLayerItem iGuideTrafficEventLayerItem) {
        this.mTargetId = null;
        this.mHelper = null;
        this.mObserver = null;
        $constructor(str, iGuideTrafficEventLayerItem);
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.GuideTrafficEventLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.layer.impl.GuideTrafficEventLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.GuideTrafficEventLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
    ...
    public String getTypeCode() {
        IGuideTrafficEventLayerItem iGuideTrafficEventLayerItem = this.mObserver;
        if (iGuideTrafficEventLayerItem != null) {
            return iGuideTrafficEventLayerItem.getTypeCode();
        }
        return null;
    }
