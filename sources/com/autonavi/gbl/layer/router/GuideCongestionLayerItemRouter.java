...
public class GuideCongestionLayerItemRouter extends GuideCongestionLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.GuideCongestionLayerItemImpl, com.autonavi.gbl.map.layer.impl.QuadrantLayerItem, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    ...
    public String getTypeCode() {
        IGuideCongestionLayerItem iGuideCongestionLayerItem = this.mObserver;
        if (iGuideCongestionLayerItem != null) {
            return iGuideCongestionLayerItem.getTypeCode();
        }
        return null;
    }
