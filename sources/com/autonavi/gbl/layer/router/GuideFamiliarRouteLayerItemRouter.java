...
public class GuideFamiliarRouteLayerItemRouter extends GuideFamiliarRouteLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.GuideFamiliarRouteLayerItemImpl, com.autonavi.gbl.map.layer.impl.QuadrantLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public float getIntersectValue(@IntersectValueType.IntersectValueType1 int i) {
        IGuideFamiliarRouteLayerItem iGuideFamiliarRouteLayerItem = this.mObserver;
        if (iGuideFamiliarRouteLayerItem != null) {
            return iGuideFamiliarRouteLayerItem.getIntersectValue(i);
        }
        return 0.0f;
    }
    ...
    public boolean getClickable() {
        IGuideFamiliarRouteLayerItem iGuideFamiliarRouteLayerItem = this.mObserver;
        if (iGuideFamiliarRouteLayerItem != null) {
            return iGuideFamiliarRouteLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        IGuideFamiliarRouteLayerItem iGuideFamiliarRouteLayerItem = this.mObserver;
        if (iGuideFamiliarRouteLayerItem != null) {
            return iGuideFamiliarRouteLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IGuideFamiliarRouteLayerItem iGuideFamiliarRouteLayerItem = this.mObserver;
        if (iGuideFamiliarRouteLayerItem != null) {
            return iGuideFamiliarRouteLayerItem.canAreaCollision();
        }
        return false;
    }
}
