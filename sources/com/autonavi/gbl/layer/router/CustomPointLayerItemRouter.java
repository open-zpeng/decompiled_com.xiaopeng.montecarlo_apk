...
public class CustomPointLayerItemRouter extends CustomPointLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.CustomPointLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public boolean getClickable() {
        ICustomPointLayerItem iCustomPointLayerItem = this.mObserver;
        if (iCustomPointLayerItem != null) {
            return iCustomPointLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        ICustomPointLayerItem iCustomPointLayerItem = this.mObserver;
        if (iCustomPointLayerItem != null) {
            return iCustomPointLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        ICustomPointLayerItem iCustomPointLayerItem = this.mObserver;
        if (iCustomPointLayerItem != null) {
            return iCustomPointLayerItem.canAreaCollision();
        }
        return false;
    }
}
