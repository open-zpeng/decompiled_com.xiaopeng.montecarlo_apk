...
public class GuideCameraLayerItemRouter extends GuideCameraLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.layer.impl.GuideCameraLayerItemImpl, com.autonavi.gbl.map.layer.impl.QuadrantLayerItem, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    ...
    public String getTypeCode() {
        IGuideCameraLayerItem iGuideCameraLayerItem = this.mObserver;
        if (iGuideCameraLayerItem != null) {
            return iGuideCameraLayerItem.getTypeCode();
        }
        return null;
    }
