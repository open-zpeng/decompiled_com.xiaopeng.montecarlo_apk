...
public class GuideTrafficLightLayerItemRouter extends GuideTrafficLightLayerItemImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.GuideTrafficLightLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.layer.impl.GuideTrafficLightLayerItemImpl, com.autonavi.gbl.map.layer.impl.QuadrantLayerItem, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.router.GuideTrafficLightLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
    ...
    public String getTypeCode() {
        IGuideTrafficLightLayerItem iGuideTrafficLightLayerItem = this.mObserver;
        if (iGuideTrafficLightLayerItem != null) {
            return iGuideTrafficLightLayerItem.getTypeCode();
        }
        return null;
    }
