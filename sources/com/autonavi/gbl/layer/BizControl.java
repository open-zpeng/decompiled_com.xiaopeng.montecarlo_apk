...
public class BizControl {
    ...
    public void setParam(PrepareLayerParam prepareLayerParam) {
        try {
            ...
            if (prepareLayerParam != null) {
                ...
                if (r1 == null) {
                    DebugTool.e("%s: $customParam == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControl.2
                    }));
                }
            }
            IBizControl iBizControl = this.mControl;
    ...
    public void addClickObserver(ILayerClickObserver iLayerClickObserver) {
        try {
            ...
            if (iLayerClickObserver != null) {
                ...
                if (r1 == null) {
                    DebugTool.e("%s: $pObserver == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControl.3
                    }));
                }
            }
            IBizControl iBizControl = this.mControl;
    ...
    public void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControl.7
        });
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void clean() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.BizControl.8
        }));
        TypeHelper typeHelper = this.mTypeHelper;
        if (typeHelper != null) {
