...
public class CustomPlaneLayerItem extends RasterImageLayerItem implements ICustomPlaneLayerItem {
    ...
    public void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.CustomPlaneLayerItem.1
        });
    ...
    @Override // com.autonavi.gbl.map.layer.RasterImageLayerItem, com.autonavi.gbl.map.layer.LayerItem
    public void clean() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.CustomPlaneLayerItem.2
        }));
        super.clean();
    }
    ...
    public synchronized void delete() {
        Object[] objArr = new Object[2];
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.layer.CustomPlaneLayerItem.3
        });
