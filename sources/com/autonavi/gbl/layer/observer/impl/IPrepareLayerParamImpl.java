...
public class IPrepareLayerParamImpl {
    ...
    private static native boolean isInForegroundSwigExplicitIPrepareLayerParamImplNative(long j, IPrepareLayerParamImpl iPrepareLayerParamImpl);
    ...
    public boolean $explicit_updateCardContent(BaseLayerImpl baseLayerImpl, LayerItemImpl layerItemImpl, ItemStyleInfo itemStyleInfo, CustomTextureParam customTextureParam) {
        ...
        return updateCardContentNative(j, this, BaseLayerImpl.getCPtr(baseLayerImpl), baseLayerImpl, LayerItemImpl.getCPtr(layerItemImpl), layerItemImpl, 0L, itemStyleInfo, 0L, customTextureParam);
    }
    ...
    public boolean $explicit_getPrepareLayerParam(LayerItemImpl layerItemImpl, PrepareLayerMarkerParam prepareLayerMarkerParam) {
        ...
        return getPrepareLayerParamNative(j, this, LayerItemImpl.getCPtr(layerItemImpl), layerItemImpl, 0L, prepareLayerMarkerParam);
    }
    ...
    public boolean $explicit_getNewStaticMarkerId(BaseLayerImpl baseLayerImpl, LayerItemImpl layerItemImpl, ItemStyleInfo itemStyleInfo, String[] strArr) {
        ...
        return getNewStaticMarkerIdNative(j, this, BaseLayerImpl.getCPtr(baseLayerImpl), baseLayerImpl, LayerItemImpl.getCPtr(layerItemImpl), layerItemImpl, 0L, itemStyleInfo, strArr);
    }
    ...
    public boolean $explicit_isInForeground() {
        if (this.swigCPtr != 0) {
            return getClass() == IPrepareLayerParamImpl.class ? isInForegroundNative(this.swigCPtr, this) : isInForegroundSwigExplicitIPrepareLayerParamImplNative(this.swigCPtr, this);
        }
        throw new NullPointerException();
    }
}
