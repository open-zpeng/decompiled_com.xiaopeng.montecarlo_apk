...
public class LayerObserverJNI {
    ...
    public static boolean SwigDirector_PrepareLayerStyleInnerImpl_switchStyle(PrepareLayerStyleInnerImpl prepareLayerStyleInnerImpl, int i) {
        return prepareLayerStyleInnerImpl.switchStyle(i);
    }
    ...
    public static int SwigDirector_PrepareLayerStyleInnerImpl_getInnerMarkerId(PrepareLayerStyleInnerImpl prepareLayerStyleInnerImpl, BaseLayerImpl baseLayerImpl, LayerItemImpl layerItemImpl, ItemStyleInfo itemStyleInfo) {
        return prepareLayerStyleInnerImpl.getInnerMarkerId(baseLayerImpl, layerItemImpl, itemStyleInfo);
    }

    public static float SwigDirector_IDynamicLayerObserverImpl_getPointMarkerScaleFactor(IDynamicLayerObserverImpl iDynamicLayerObserverImpl) {
        return iDynamicLayerObserverImpl.getPointMarkerScaleFactor();
    }

    public static boolean SwigDirector_IDynamicLayerObserverImpl_isNightMode(IDynamicLayerObserverImpl iDynamicLayerObserverImpl) {
        return iDynamicLayerObserverImpl.isNightMode();
    }

    public static void SwigDirector_IDynamicLayerObserverImpl_onNotifyClick(IDynamicLayerObserverImpl iDynamicLayerObserverImpl, DynamicLayerObserverParam dynamicLayerObserverParam) {
        iDynamicLayerObserverImpl.onNotifyClick(dynamicLayerObserverParam);
    }

    public static void SwigDirector_IDynamicLayerObserverImpl_onFocusChange(IDynamicLayerObserverImpl iDynamicLayerObserverImpl, DynamicLayerObserverParam dynamicLayerObserverParam, boolean z) {
        iDynamicLayerObserverImpl.onFocusChange(dynamicLayerObserverParam, z);
    }
