...
public class PrepareLayerStyleInnerImpl extends IPrepareLayerStyleImpl {
    ...
    private static native long createNativeObj(long j, MapViewImpl mapViewImpl, long j2, ICardServiceImpl iCardServiceImpl, long j3, IPrepareLayerParamImpl iPrepareLayerParamImpl, long j4, InnerStyleParam innerStyleParam);
    ...
    public PrepareLayerStyleInnerImpl(MapViewImpl mapViewImpl, ICardServiceImpl iCardServiceImpl, IPrepareLayerParamImpl iPrepareLayerParamImpl, InnerStyleParam innerStyleParam) {
        this(createNativeObj(MapViewImpl.getCPtr(mapViewImpl), mapViewImpl, ICardServiceImpl.getCPtr(iCardServiceImpl), iCardServiceImpl, IPrepareLayerParamImpl.getCPtr(iPrepareLayerParamImpl), iPrepareLayerParamImpl, 0L, innerStyleParam), true);
