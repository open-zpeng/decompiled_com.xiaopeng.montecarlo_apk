...
public class PrepareLayerParamInnerImpl extends IPrepareLayerParamImpl {
    ...
    private static native boolean updateMarkerInfoNative(long j, PrepareLayerParamInnerImpl prepareLayerParamInnerImpl, long j2, BaseLayerImpl baseLayerImpl, long j3, LayerItemImpl layerItemImpl, long j4, long j5, CustomTextureParam customTextureParam);
    ...
    public boolean updateMarkerInfo(BaseLayerImpl baseLayerImpl, LayerItemImpl layerItemImpl, long j, CustomTextureParam customTextureParam) {
        return $explicit_updateMarkerInfo(baseLayerImpl, layerItemImpl, j, customTextureParam);
    }

    public boolean $explicit_updateMarkerInfo(BaseLayerImpl baseLayerImpl, LayerItemImpl layerItemImpl, long j, CustomTextureParam customTextureParam) {
        long j2 = this.swigCPtr;
        if (j2 == 0) {
            throw new NullPointerException();
        }
        return updateMarkerInfoNative(j2, this, BaseLayerImpl.getCPtr(baseLayerImpl), baseLayerImpl, LayerItemImpl.getCPtr(layerItemImpl), layerItemImpl, j, 0L, customTextureParam);
    }
}
