...
public class RouteService implements IService {
    ...
    public RouteConsisAdditionService getRouteConsisAdditionService() {
        ...
        try {
            ...
            IRouteServiceImpl iRouteServiceImpl = this.mControl;
            if (iRouteServiceImpl != null && (routeConsisAdditionService = iRouteServiceImpl.getRouteConsisAdditionService()) != null) {
                TypeHelper typeHelper = this.mTypeHelper;
                r0 = typeHelper != null ? (RouteConsisAdditionService) typeHelper.transfer(method, -1, (Object) routeConsisAdditionService, true) : null;
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.route.RouteService.1
                    }));
                }
            }
            return r0;
    ...
    public int requestRouteRestoration(RouteRestorationOption routeRestorationOption) {
        try {
            ...
            if (routeRestorationOption != null) {
                ...
                if (r2 == null) {
                    DebugTool.e("%s: $routeOption == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.route.RouteService.3
                    }));
                    return 0;
                }
            }
    ...
    public long requestPathWeather(PathInfo pathInfo) {
        try {
            ...
            if (pathInfo != null) {
                ...
                if (r3 == null) {
                    DebugTool.e("%s: $pathInfo == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.route.RouteService.4
                    }));
                    return 0L;
                }
            }
    ...
    public void removeRouteWeatherObserver(IRouteWeatherObserver iRouteWeatherObserver) {
        try {
            ...
            if (iRouteWeatherObserver != null) {
                ...
                r1 = typeHelper != null ? (IRouteWeatherObserverImpl) typeHelper.transfer(method, 0, iRouteWeatherObserver) : null;
                if (r1 == null) {
                    DebugTool.e("%s: $ob == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.route.RouteService.8
                    }));
                }
            }
            IRouteServiceImpl iRouteServiceImpl = this.mControl;
        ...
        try {
            ...
            if (routeAosOption != null) {
                ...
                if (iRouteAosOptionImpl == null) {
                    DebugTool.e("%s: $routeAosOption == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.route.RouteService.9
                    }));
                    return null;
                }
            } else {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.route.RouteService.10
        });
    ...
    protected synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.route.RouteService.12
        }));
        if (!this.mHasDestroy) {
            onDestroy();
        }
