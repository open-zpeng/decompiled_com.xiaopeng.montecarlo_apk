...
public class IRouteConsisAdditionObserverImpl {
    ...
    private static native void onGetNaviPathNative(long j, IRouteConsisAdditionObserverImpl iRouteConsisAdditionObserverImpl, ArrayList<ConsisPathIdentity> arrayList, ArrayList<PathInfo> arrayList2);
    ...
    public void onSyncRouteResult(long j, String str, ArrayList<PathInfo> arrayList, BinaryStream binaryStream, int i) {
        ...
        if (arrayList != null) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                jArr2[i2] = PathInfo.getCPtr(arrayList.get(i2));
            }
            jArr = jArr2;
        } else {
            jArr = null;
