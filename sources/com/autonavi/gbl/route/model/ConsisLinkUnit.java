...
public class ConsisLinkUnit implements Serializable {
    public long mAdcode;
    public ArrayList<CameraExt> mCameras;
    @Formway.Formway1
    public int mFormway;
    ...
    public ConsisLinkUnit(@RoadClass.RoadClass1 int i, @Formway.Formway1 int i2, @LinkType.LinkType1 int i3, boolean z, boolean z2, short s, @Ownership.Ownership1 int i4, short s2, ArrayList<SlopeInfo> arrayList, ArrayList<CameraExt> arrayList2, ArrayList<RoadFacility> arrayList3, ArrayList<TurnInfo> arrayList4, String str, long j, long j2) {
        this.mRoadClass = i;
        this.mFormway = i2;
        this.mLinkType = i3;
        this.mIsOverHead = z;
