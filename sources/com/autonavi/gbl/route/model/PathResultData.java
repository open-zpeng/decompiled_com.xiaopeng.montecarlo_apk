...
public class PathResultData implements Serializable {
    ...
    public PathResultData(long j, @CalcRouteRespType.CalcRouteRespType1 int i, @RouteMode.RouteMode1 int i2, @RouteRespCategory.RouteRespCategory1 int i3, @RouteType.RouteType1 int i4, boolean z, @RouteErrorcode.RouteErrorcode1 int i5, boolean z2, boolean z3, CalcRouteResultData calcRouteResultData, RouteRestorationResultData routeRestorationResultData, OddRespInfo oddRespInfo, String str) {
        this.requestId = j;
