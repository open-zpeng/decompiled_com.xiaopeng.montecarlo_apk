...
public class IRouteRestorationOptionImpl {
    ...
    private static native void setFlagNative(long j, IRouteRestorationOptionImpl iRouteRestorationOptionImpl, String str);

    private static native void setNaviIdNative(long j, IRouteRestorationOptionImpl iRouteRestorationOptionImpl, String str);

    private static native void setNeedSwitchToLocalNative(long j, IRouteRestorationOptionImpl iRouteRestorationOptionImpl, boolean z);

    private static native void setOfflineRouteOptionNative(long j, IRouteRestorationOptionImpl iRouteRestorationOptionImpl, long j2, IRouteOptionImpl iRouteOptionImpl);
    ...
    private static native void setPriorityTypeNative(long j, IRouteRestorationOptionImpl iRouteRestorationOptionImpl, long j2);
    ...
    private static native void setTypeNative(long j, IRouteRestorationOptionImpl iRouteRestorationOptionImpl, String str);
    ...
    public void setOfflineRouteOption(IRouteOptionImpl iRouteOptionImpl) {
        ...
        setOfflineRouteOptionNative(j, this, IRouteOptionImpl.getCPtr(iRouteOptionImpl), iRouteOptionImpl);
    }
    ...
    public void setNeedSwitchToLocal(boolean z) {
        ...
        setNeedSwitchToLocalNative(j, this, z);
    }
