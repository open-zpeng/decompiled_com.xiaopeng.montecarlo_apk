...
public class PosLocInfoObserverRouter extends IPosLocInfoObserverImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.pos.router.PosLocInfoObserverRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.pos.router.PosLocInfoObserverRouter.2
        }));
        super.delete();
        unbind();
    }
