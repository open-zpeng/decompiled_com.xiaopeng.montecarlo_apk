...
public class PosSwitchParallelRoadObserverRouter extends IPosSwitchParallelRoadObserverImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.pos.router.PosSwitchParallelRoadObserverRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.pos.router.PosSwitchParallelRoadObserverRouter.2
        }));
        super.delete();
        unbind();
    }
