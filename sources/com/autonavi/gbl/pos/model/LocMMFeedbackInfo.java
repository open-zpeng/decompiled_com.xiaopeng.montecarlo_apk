...
public class LocMMFeedbackInfo implements Serializable {
    ...
    public LocMMFeedbackInfo(BigInteger bigInteger, int i, double d, double d2, ArrayList<LocFeedbackNode> arrayList, boolean z, boolean z2, boolean z3, boolean z4, int i2, String str) {
