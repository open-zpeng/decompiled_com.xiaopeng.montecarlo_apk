...
public class LocSignData implements Serializable {
    ...
    public LocLaneInfoExternal locLaneExternal;
    public LocLaneFusionResultExternal locLaneRes;
    ...
    public LocSignData() {
        ...
        this.locLaneRes = new LocLaneFusionResultExternal();
        this.locLaneExternal = new LocLaneInfoExternal();
    }

    public LocSignData(@LocDataType.LocDataType1 int i, LocECompass locECompass, LocGyro locGyro, LocPulse locPulse, LocAcce3d locAcce3d, LocGnss locGnss, LocAirPressure locAirPressure, LocDrPos locDrPos, LocGpgsv locGpgsv, LocDoorIn locDoorIn, LocDriveMode locDriveMode, LocDriveEvent locDriveEvent, LocDriveComfort locDriveComfort, LocW4M locW4M, LocW4MTR locW4MTR, LocMagnetic locMagnetic, LocVDRSignal locVDRSignal, LocLight locLight, LocVDRInfo locVDRInfo, LocGnssMeasurement locGnssMeasurement, LocOrientation locOrientation, LocNema locNema, LocSpeedometer locSpeedometer, LocVisionLocate locVisionLocate, LocVision locVision, LocVisualObj locVisualObj, LocAllFusionPos locAllFusionPos, LocLaneFusionResultExternal locLaneFusionResultExternal, LocLaneInfoExternal locLaneInfoExternal) {
        this.dataType = i;
        ...
        this.locLaneRes = locLaneFusionResultExternal;
        this.locLaneExternal = locLaneInfoExternal;
    }
}
