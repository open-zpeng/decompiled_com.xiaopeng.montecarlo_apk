...
import com.autonavi.gbl.pos.observer.impl.IPosAttitudeAngleObserver;
...
public class IPosServiceImpl implements IService {
    ...
    private static native void addAttitudeAngleObserverNative(long j, IPosServiceImpl iPosServiceImpl, long j2, IPosAttitudeAngleObserver iPosAttitudeAngleObserver);
    ...
    private static native void removeAttitudeAngleObserverNative(long j, IPosServiceImpl iPosServiceImpl, long j2, IPosAttitudeAngleObserver iPosAttitudeAngleObserver);
    ...
    private static native void signalRecordSwitch1Native(long j, IPosServiceImpl iPosServiceImpl, boolean z, boolean z2, int i);

    private static native void signalRecordSwitch2Native(long j, IPosServiceImpl iPosServiceImpl, boolean z, long j2, LocLogConf locLogConf);

    private static native void signalRecordSwitchNative(long j, IPosServiceImpl iPosServiceImpl, boolean z, boolean z2, int i, int i2);
    ...
    public void signalRecordSwitch(boolean z, boolean z2, int i, @LocLogType.LocLogType1 int i2) {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        signalRecordSwitchNative(j, this, z, z2, i, i2);
    }
    ...
    public void signalRecordSwitch(boolean z, boolean z2, int i) {
        ...
        signalRecordSwitch1Native(j, this, z, z2, i);
    }
    ...
    public void signalRecordSwitch(boolean z, LocLogConf locLogConf) {
        ...
        signalRecordSwitch2Native(j, this, z, 0L, locLogConf);
    }
    ...
    public void addAttitudeAngleObserver(IPosAttitudeAngleObserver iPosAttitudeAngleObserver) {
        ...
        addAttitudeAngleObserverNative(j, this, IPosAttitudeAngleObserver.getCPtr(iPosAttitudeAngleObserver), iPosAttitudeAngleObserver);
    }
    ...
    public void removeAttitudeAngleObserver(IPosAttitudeAngleObserver iPosAttitudeAngleObserver) {
        ...
        removeAttitudeAngleObserverNative(j, this, IPosAttitudeAngleObserver.getCPtr(iPosAttitudeAngleObserver), iPosAttitudeAngleObserver);
    }
