...
public class IPosServiceImpl implements IService {
    ...
    private static native void addPosDiagnosisInfoObserverNative(long j, IPosServiceImpl iPosServiceImpl, long j2, IPosDiagnosisInfoObserverImpl iPosDiagnosisInfoObserverImpl);
    ...
    private static native int init1Native(long j, IPosServiceImpl iPosServiceImpl, long j2, PosWorkPath posWorkPath, long j3, LocModeType locModeType);
    ...
    private static native void removePosDiagnosisInfoObserverNative(long j, IPosServiceImpl iPosServiceImpl, long j2, IPosDiagnosisInfoObserverImpl iPosDiagnosisInfoObserverImpl);
    ...
    private static native void setDiagnosisSwitchNative(long j, IPosServiceImpl iPosServiceImpl, boolean z);
    ...
    public int init(PosWorkPath posWorkPath, LocModeType locModeType) {
        ...
        return init1Native(j, this, 0L, posWorkPath, 0L, locModeType);
    }
    ...
    public void addPosDiagnosisInfoObserver(IPosDiagnosisInfoObserverImpl iPosDiagnosisInfoObserverImpl) {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        addPosDiagnosisInfoObserverNative(j, this, IPosDiagnosisInfoObserverImpl.getCPtr(iPosDiagnosisInfoObserverImpl), iPosDiagnosisInfoObserverImpl);
    }

    public void removePosDiagnosisInfoObserver(IPosDiagnosisInfoObserverImpl iPosDiagnosisInfoObserverImpl) {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        removePosDiagnosisInfoObserverNative(j, this, IPosDiagnosisInfoObserverImpl.getCPtr(iPosDiagnosisInfoObserverImpl), iPosDiagnosisInfoObserverImpl);
    }
    ...
    public void setDiagnosisSwitch(boolean z) {
        ...
        setDiagnosisSwitchNative(j, this, z);
    }
}
