...
public class PosService implements IService {
    ...
    public void signalRecordSwitch(boolean z, boolean z2, int i, @LocLogType.LocLogType1 int i2) {
        IPosServiceImpl iPosServiceImpl = this.mControl;
        if (iPosServiceImpl != null) {
            iPosServiceImpl.signalRecordSwitch(z, z2, i, i2);
        }
    }
    ...
    public void signalRecordSwitch(boolean z, boolean z2, int i) {
        IPosServiceImpl iPosServiceImpl = this.mControl;
        if (iPosServiceImpl != null) {
            iPosServiceImpl.signalRecordSwitch(z, z2, i);
        }
    }
    ...
    public void addAttitudeAngleObserver(IPosAttitudeAngleObserver iPosAttitudeAngleObserver) {
        IPosServiceImpl iPosServiceImpl = this.mControl;
        if (iPosServiceImpl != null) {
            iPosServiceImpl.addAttitudeAngleObserver(iPosAttitudeAngleObserver);
        }
    }
    ...
    public void removeAttitudeAngleObserver(IPosAttitudeAngleObserver iPosAttitudeAngleObserver) {
        IPosServiceImpl iPosServiceImpl = this.mControl;
        if (iPosServiceImpl != null) {
            iPosServiceImpl.removeAttitudeAngleObserver(iPosAttitudeAngleObserver);
        }
    }
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.pos.PosService.18
        });
    ...
    protected void clean() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.pos.PosService.19
        }));
        TypeHelper typeHelper = this.mTypeHelper;
        if (typeHelper != null) {
    ...
    protected synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.pos.PosService.20
        }));
        if (!this.mHasDestroy) {
            onDestroy();
        }
