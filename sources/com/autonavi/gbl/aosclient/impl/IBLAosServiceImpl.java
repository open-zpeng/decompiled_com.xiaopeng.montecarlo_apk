...
public class IBLAosServiceImpl implements IService {
    ...
    private static native long sendReqWsChargeListNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsChargeListRequestParam gWsChargeListRequestParam, long j3, ICallBackWsChargeListImpl iCallBackWsChargeListImpl);
    ...
    private static native long sendReqWsDynamicInfoCongestionGroupChatUserAddV3Native(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsDynamicInfoCongestionGroupChatUserAddV3RequestParam gWsDynamicInfoCongestionGroupChatUserAddV3RequestParam, long j3, ICallBackWsDynamicInfoCongestionGroupChatUserAddV3Impl iCallBackWsDynamicInfoCongestionGroupChatUserAddV3Impl);

    private static native long sendReqWsDynamicInfoCongestionGroupChatUserRemoveNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsDynamicInfoCongestionGroupChatUserRemoveRequestParam gWsDynamicInfoCongestionGroupChatUserRemoveRequestParam, long j3, ICallBackWsDynamicInfoCongestionGroupChatUserRemoveImpl iCallBackWsDynamicInfoCongestionGroupChatUserRemoveImpl);

    private static native long sendReqWsDynamicInfoEventPraiseStampStatusQueryNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsDynamicInfoEventPraiseStampStatusQueryRequestParam gWsDynamicInfoEventPraiseStampStatusQueryRequestParam, long j3, ICallBackWsDynamicInfoEventPraiseStampStatusQueryImpl iCallBackWsDynamicInfoEventPraiseStampStatusQueryImpl);

    private static native long sendReqWsEventSearchNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsEventSearchRequestParam gWsEventSearchRequestParam, long j3, ICallBackWsEventSearchImpl iCallBackWsEventSearchImpl);
    ...
    private static native long sendReqWsFencingFencesQueryNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsFencingFencesQueryRequestParam gWsFencingFencesQueryRequestParam, long j3, ICallBackWsFencingFencesQueryImpl iCallBackWsFencingFencesQueryImpl);

    private static native long sendReqWsFencingGroupsQueryNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsFencingGroupsQueryRequestParam gWsFencingGroupsQueryRequestParam, long j3, ICallBackWsFencingGroupsQueryImpl iCallBackWsFencingGroupsQueryImpl);
    ...
    private static native long sendReqWsMapapiLinkidsNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsMapapiLinkidsRequestParam gWsMapapiLinkidsRequestParam, long j3, ICallBackWsMapapiLinkidsImpl iCallBackWsMapapiLinkidsImpl);
    ...
    private static native long sendReqWsMapapiRoadNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsMapapiRoadRequestParam gWsMapapiRoadRequestParam, long j3, ICallBackWsMapapiRoadImpl iCallBackWsMapapiRoadImpl);

    private static native long sendReqWsMiniappCarVipGwNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsMiniappCarVipGwRequestParam gWsMiniappCarVipGwRequestParam, long j3, ICallBackWsMiniappCarVipGwImpl iCallBackWsMiniappCarVipGwImpl);
    ...
    private static native long sendReqWsPpCarltdAuthCancelNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsPpCarltdAuthCancelRequestParam gWsPpCarltdAuthCancelRequestParam, long j3, ICallBackWsPpCarltdAuthCancelImpl iCallBackWsPpCarltdAuthCancelImpl);
    ...
    private static native long sendReqWsPpQrcodeInnerGetNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsPpQrcodeInnerGetRequestParam gWsPpQrcodeInnerGetRequestParam, long j3, ICallBackWsPpQrcodeInnerGetImpl iCallBackWsPpQrcodeInnerGetImpl);
    ...
    private static native long sendReqWsSdsFilesNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsSdsFilesRequestParam gWsSdsFilesRequestParam, long j3, ICallBackWsSdsFilesImpl iCallBackWsSdsFilesImpl);

    private static native long sendReqWsSearchPoiAutoCmallFillOrderNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsSearchPoiAutoCmallFillOrderRequestParam gWsSearchPoiAutoCmallFillOrderRequestParam, long j3, ICallBackWsSearchPoiAutoCmallFillOrderImpl iCallBackWsSearchPoiAutoCmallFillOrderImpl);
    ...
    private static native long sendReqWsShieldImMsgCommentSetNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsShieldImMsgCommentSetRequestParam gWsShieldImMsgCommentSetRequestParam, long j3, ICallBackWsShieldImMsgCommentSetImpl iCallBackWsShieldImMsgCommentSetImpl);
    ...
    private static native long sendReqWsTcAlscOrderCancelNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsTcAlscOrderCancelRequestParam gWsTcAlscOrderCancelRequestParam, long j3, ICallBackWsTcAlscOrderCancelImpl iCallBackWsTcAlscOrderCancelImpl);

    private static native long sendReqWsTcCarServiceOrderCancelNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsTcCarServiceOrderCancelRequestParam gWsTcCarServiceOrderCancelRequestParam, long j3, ICallBackWsTcCarServiceOrderCancelImpl iCallBackWsTcCarServiceOrderCancelImpl);

    private static native long sendReqWsTcCarServiceSubmitNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsTcCarServiceSubmitRequestParam gWsTcCarServiceSubmitRequestParam, long j3, ICallBackWsTcCarServiceSubmitImpl iCallBackWsTcCarServiceSubmitImpl);

    private static native long sendReqWsTcCommonAgreementOrderquickpayNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsTcCommonAgreementOrderquickpayRequestParam gWsTcCommonAgreementOrderquickpayRequestParam, long j3, ICallBackWsTcCommonAgreementOrderquickpayImpl iCallBackWsTcCommonAgreementOrderquickpayImpl);

    private static native long sendReqWsTcCommonAgreementSignNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsTcCommonAgreementSignRequestParam gWsTcCommonAgreementSignRequestParam, long j3, ICallBackWsTcCommonAgreementSignImpl iCallBackWsTcCommonAgreementSignImpl);
    ...
    private static native long sendReqWsTcKoubeiOrderSubmitNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsTcKoubeiOrderSubmitRequestParam gWsTcKoubeiOrderSubmitRequestParam, long j3, ICallBackWsTcKoubeiOrderSubmitImpl iCallBackWsTcKoubeiOrderSubmitImpl);

    private static native long sendReqWsTcOrderApiMergeListNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsTcOrderApiMergeListRequestParam gWsTcOrderApiMergeListRequestParam, long j3, ICallBackWsTcOrderApiMergeListImpl iCallBackWsTcOrderApiMergeListImpl);
    ...
    private static native long sendReqWsTcPoiInfoNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsTcPoiInfoRequestParam gWsTcPoiInfoRequestParam, long j3, ICallBackWsTcPoiInfoImpl iCallBackWsTcPoiInfoImpl);

    private static native long sendReqWsTserviceDatainterflowGetNative(long j, IBLAosServiceImpl iBLAosServiceImpl, long j2, GWsTserviceDatainterflowGetRequestParam gWsTserviceDatainterflowGetRequestParam, long j3, ICallBackWsTserviceDatainterflowGetImpl iCallBackWsTserviceDatainterflowGetImpl);
    ...
    public long sendReqWsMapapiLinkids(GWsMapapiLinkidsRequestParam gWsMapapiLinkidsRequestParam, ICallBackWsMapapiLinkidsImpl iCallBackWsMapapiLinkidsImpl) {
        ...
        return sendReqWsMapapiLinkidsNative(j, this, 0L, gWsMapapiLinkidsRequestParam, ICallBackWsMapapiLinkidsImpl.getCPtr(iCallBackWsMapapiLinkidsImpl), iCallBackWsMapapiLinkidsImpl);
    }
    ...
    public long sendReqWsMapapiRoad(GWsMapapiRoadRequestParam gWsMapapiRoadRequestParam, ICallBackWsMapapiRoadImpl iCallBackWsMapapiRoadImpl) {
        ...
        return sendReqWsMapapiRoadNative(j, this, 0L, gWsMapapiRoadRequestParam, ICallBackWsMapapiRoadImpl.getCPtr(iCallBackWsMapapiRoadImpl), iCallBackWsMapapiRoadImpl);
    }
    ...
    public long sendReqWsEventSearch(GWsEventSearchRequestParam gWsEventSearchRequestParam, ICallBackWsEventSearchImpl iCallBackWsEventSearchImpl) {
        ...
        return sendReqWsEventSearchNative(j, this, 0L, gWsEventSearchRequestParam, ICallBackWsEventSearchImpl.getCPtr(iCallBackWsEventSearchImpl), iCallBackWsEventSearchImpl);
    }
    ...
    public long sendReqWsChargeList(GWsChargeListRequestParam gWsChargeListRequestParam, ICallBackWsChargeListImpl iCallBackWsChargeListImpl) {
        ...
        return sendReqWsChargeListNative(j, this, 0L, gWsChargeListRequestParam, ICallBackWsChargeListImpl.getCPtr(iCallBackWsChargeListImpl), iCallBackWsChargeListImpl);
    }
    ...
    public long sendReqWsSdsFiles(GWsSdsFilesRequestParam gWsSdsFilesRequestParam, ICallBackWsSdsFilesImpl iCallBackWsSdsFilesImpl) {
        ...
        return sendReqWsSdsFilesNative(j, this, 0L, gWsSdsFilesRequestParam, ICallBackWsSdsFilesImpl.getCPtr(iCallBackWsSdsFilesImpl), iCallBackWsSdsFilesImpl);
    }
    ...
    public long sendReqWsShieldImMsgCommentSet(GWsShieldImMsgCommentSetRequestParam gWsShieldImMsgCommentSetRequestParam, ICallBackWsShieldImMsgCommentSetImpl iCallBackWsShieldImMsgCommentSetImpl) {
        ...
        return sendReqWsShieldImMsgCommentSetNative(j, this, 0L, gWsShieldImMsgCommentSetRequestParam, ICallBackWsShieldImMsgCommentSetImpl.getCPtr(iCallBackWsShieldImMsgCommentSetImpl), iCallBackWsShieldImMsgCommentSetImpl);
    }
    ...
    public long sendReqWsDynamicInfoEventPraiseStampStatusQuery(GWsDynamicInfoEventPraiseStampStatusQueryRequestParam gWsDynamicInfoEventPraiseStampStatusQueryRequestParam, ICallBackWsDynamicInfoEventPraiseStampStatusQueryImpl iCallBackWsDynamicInfoEventPraiseStampStatusQueryImpl) {
        ...
        return sendReqWsDynamicInfoEventPraiseStampStatusQueryNative(j, this, 0L, gWsDynamicInfoEventPraiseStampStatusQueryRequestParam, ICallBackWsDynamicInfoEventPraiseStampStatusQueryImpl.getCPtr(iCallBackWsDynamicInfoEventPraiseStampStatusQueryImpl), iCallBackWsDynamicInfoEventPraiseStampStatusQueryImpl);
    }
    ...
    public long sendReqWsDynamicInfoCongestionGroupChatUserAddV3(GWsDynamicInfoCongestionGroupChatUserAddV3RequestParam gWsDynamicInfoCongestionGroupChatUserAddV3RequestParam, ICallBackWsDynamicInfoCongestionGroupChatUserAddV3Impl iCallBackWsDynamicInfoCongestionGroupChatUserAddV3Impl) {
        ...
        return sendReqWsDynamicInfoCongestionGroupChatUserAddV3Native(j, this, 0L, gWsDynamicInfoCongestionGroupChatUserAddV3RequestParam, ICallBackWsDynamicInfoCongestionGroupChatUserAddV3Impl.getCPtr(iCallBackWsDynamicInfoCongestionGroupChatUserAddV3Impl), iCallBackWsDynamicInfoCongestionGroupChatUserAddV3Impl);
    }
    ...
    public long sendReqWsFencingGroupsQuery(GWsFencingGroupsQueryRequestParam gWsFencingGroupsQueryRequestParam, ICallBackWsFencingGroupsQueryImpl iCallBackWsFencingGroupsQueryImpl) {
        ...
        return sendReqWsFencingGroupsQueryNative(j, this, 0L, gWsFencingGroupsQueryRequestParam, ICallBackWsFencingGroupsQueryImpl.getCPtr(iCallBackWsFencingGroupsQueryImpl), iCallBackWsFencingGroupsQueryImpl);
    }
    ...
    public long sendReqWsFencingFencesQuery(GWsFencingFencesQueryRequestParam gWsFencingFencesQueryRequestParam, ICallBackWsFencingFencesQueryImpl iCallBackWsFencingFencesQueryImpl) {
        ...
        return sendReqWsFencingFencesQueryNative(j, this, 0L, gWsFencingFencesQueryRequestParam, ICallBackWsFencingFencesQueryImpl.getCPtr(iCallBackWsFencingFencesQueryImpl), iCallBackWsFencingFencesQueryImpl);
    }
    ...
    public long sendReqWsTcCommonAgreementSign(GWsTcCommonAgreementSignRequestParam gWsTcCommonAgreementSignRequestParam, ICallBackWsTcCommonAgreementSignImpl iCallBackWsTcCommonAgreementSignImpl) {
        ...
        return sendReqWsTcCommonAgreementSignNative(j, this, 0L, gWsTcCommonAgreementSignRequestParam, ICallBackWsTcCommonAgreementSignImpl.getCPtr(iCallBackWsTcCommonAgreementSignImpl), iCallBackWsTcCommonAgreementSignImpl);
    }
    ...
    public long sendReqWsTcCommonAgreementOrderquickpay(GWsTcCommonAgreementOrderquickpayRequestParam gWsTcCommonAgreementOrderquickpayRequestParam, ICallBackWsTcCommonAgreementOrderquickpayImpl iCallBackWsTcCommonAgreementOrderquickpayImpl) {
        ...
        return sendReqWsTcCommonAgreementOrderquickpayNative(j, this, 0L, gWsTcCommonAgreementOrderquickpayRequestParam, ICallBackWsTcCommonAgreementOrderquickpayImpl.getCPtr(iCallBackWsTcCommonAgreementOrderquickpayImpl), iCallBackWsTcCommonAgreementOrderquickpayImpl);
    }
    ...
    public long sendReqWsPpQrcodeInnerGet(GWsPpQrcodeInnerGetRequestParam gWsPpQrcodeInnerGetRequestParam, ICallBackWsPpQrcodeInnerGetImpl iCallBackWsPpQrcodeInnerGetImpl) {
        ...
        return sendReqWsPpQrcodeInnerGetNative(j, this, 0L, gWsPpQrcodeInnerGetRequestParam, ICallBackWsPpQrcodeInnerGetImpl.getCPtr(iCallBackWsPpQrcodeInnerGetImpl), iCallBackWsPpQrcodeInnerGetImpl);
    }
    ...
    public long sendReqWsTcCarServiceOrderCancel(GWsTcCarServiceOrderCancelRequestParam gWsTcCarServiceOrderCancelRequestParam, ICallBackWsTcCarServiceOrderCancelImpl iCallBackWsTcCarServiceOrderCancelImpl) {
        ...
        return sendReqWsTcCarServiceOrderCancelNative(j, this, 0L, gWsTcCarServiceOrderCancelRequestParam, ICallBackWsTcCarServiceOrderCancelImpl.getCPtr(iCallBackWsTcCarServiceOrderCancelImpl), iCallBackWsTcCarServiceOrderCancelImpl);
    }
    ...
    public long sendReqWsMiniappCarVipGw(GWsMiniappCarVipGwRequestParam gWsMiniappCarVipGwRequestParam, ICallBackWsMiniappCarVipGwImpl iCallBackWsMiniappCarVipGwImpl) {
        ...
        return sendReqWsMiniappCarVipGwNative(j, this, 0L, gWsMiniappCarVipGwRequestParam, ICallBackWsMiniappCarVipGwImpl.getCPtr(iCallBackWsMiniappCarVipGwImpl), iCallBackWsMiniappCarVipGwImpl);
    }
    ...
    public long sendReqWsTcCarServiceSubmit(GWsTcCarServiceSubmitRequestParam gWsTcCarServiceSubmitRequestParam, ICallBackWsTcCarServiceSubmitImpl iCallBackWsTcCarServiceSubmitImpl) {
        ...
        return sendReqWsTcCarServiceSubmitNative(j, this, 0L, gWsTcCarServiceSubmitRequestParam, ICallBackWsTcCarServiceSubmitImpl.getCPtr(iCallBackWsTcCarServiceSubmitImpl), iCallBackWsTcCarServiceSubmitImpl);
    }
    ...
    public long sendReqWsSearchPoiAutoCmallFillOrder(GWsSearchPoiAutoCmallFillOrderRequestParam gWsSearchPoiAutoCmallFillOrderRequestParam, ICallBackWsSearchPoiAutoCmallFillOrderImpl iCallBackWsSearchPoiAutoCmallFillOrderImpl) {
        ...
        return sendReqWsSearchPoiAutoCmallFillOrderNative(j, this, 0L, gWsSearchPoiAutoCmallFillOrderRequestParam, ICallBackWsSearchPoiAutoCmallFillOrderImpl.getCPtr(iCallBackWsSearchPoiAutoCmallFillOrderImpl), iCallBackWsSearchPoiAutoCmallFillOrderImpl);
    }
    ...
    public long sendReqWsTcAlscOrderCancel(GWsTcAlscOrderCancelRequestParam gWsTcAlscOrderCancelRequestParam, ICallBackWsTcAlscOrderCancelImpl iCallBackWsTcAlscOrderCancelImpl) {
        ...
        return sendReqWsTcAlscOrderCancelNative(j, this, 0L, gWsTcAlscOrderCancelRequestParam, ICallBackWsTcAlscOrderCancelImpl.getCPtr(iCallBackWsTcAlscOrderCancelImpl), iCallBackWsTcAlscOrderCancelImpl);
    }
    ...
    public long sendReqWsTcOrderApiMergeList(GWsTcOrderApiMergeListRequestParam gWsTcOrderApiMergeListRequestParam, ICallBackWsTcOrderApiMergeListImpl iCallBackWsTcOrderApiMergeListImpl) {
        ...
        return sendReqWsTcOrderApiMergeListNative(j, this, 0L, gWsTcOrderApiMergeListRequestParam, ICallBackWsTcOrderApiMergeListImpl.getCPtr(iCallBackWsTcOrderApiMergeListImpl), iCallBackWsTcOrderApiMergeListImpl);
    }
    ...
    public long sendReqWsTcKoubeiOrderSubmit(GWsTcKoubeiOrderSubmitRequestParam gWsTcKoubeiOrderSubmitRequestParam, ICallBackWsTcKoubeiOrderSubmitImpl iCallBackWsTcKoubeiOrderSubmitImpl) {
        ...
        return sendReqWsTcKoubeiOrderSubmitNative(j, this, 0L, gWsTcKoubeiOrderSubmitRequestParam, ICallBackWsTcKoubeiOrderSubmitImpl.getCPtr(iCallBackWsTcKoubeiOrderSubmitImpl), iCallBackWsTcKoubeiOrderSubmitImpl);
    }
    ...
    public long sendReqWsTcPoiInfo(GWsTcPoiInfoRequestParam gWsTcPoiInfoRequestParam, ICallBackWsTcPoiInfoImpl iCallBackWsTcPoiInfoImpl) {
        ...
        return sendReqWsTcPoiInfoNative(j, this, 0L, gWsTcPoiInfoRequestParam, ICallBackWsTcPoiInfoImpl.getCPtr(iCallBackWsTcPoiInfoImpl), iCallBackWsTcPoiInfoImpl);
    }
    ...
    public long sendReqWsTserviceDatainterflowGet(GWsTserviceDatainterflowGetRequestParam gWsTserviceDatainterflowGetRequestParam, ICallBackWsTserviceDatainterflowGetImpl iCallBackWsTserviceDatainterflowGetImpl) {
        ...
        return sendReqWsTserviceDatainterflowGetNative(j, this, 0L, gWsTserviceDatainterflowGetRequestParam, ICallBackWsTserviceDatainterflowGetImpl.getCPtr(iCallBackWsTserviceDatainterflowGetImpl), iCallBackWsTserviceDatainterflowGetImpl);
    }
    ...
    public long sendReqWsPpCarltdAuthCancel(GWsPpCarltdAuthCancelRequestParam gWsPpCarltdAuthCancelRequestParam, ICallBackWsPpCarltdAuthCancelImpl iCallBackWsPpCarltdAuthCancelImpl) {
        ...
        return sendReqWsPpCarltdAuthCancelNative(j, this, 0L, gWsPpCarltdAuthCancelRequestParam, ICallBackWsPpCarltdAuthCancelImpl.getCPtr(iCallBackWsPpCarltdAuthCancelImpl), iCallBackWsPpCarltdAuthCancelImpl);
    }
}
