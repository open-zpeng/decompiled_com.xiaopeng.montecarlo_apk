...
public class BLAosDataToolImpl {
    ...
    private static native long createNativeObj1(long j, BLAosDataToolImpl bLAosDataToolImpl);
    ...
    public BLAosDataToolImpl(BLAosDataToolImpl bLAosDataToolImpl) {
        this(createNativeObj1(getCPtr(bLAosDataToolImpl), bLAosDataToolImpl), true);
    }
