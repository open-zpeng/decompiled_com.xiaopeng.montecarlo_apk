...
public class CallBackWsArchiveTrafficeventUpdateRouter extends ICallBackWsArchiveTrafficeventUpdateImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsArchiveTrafficeventUpdateRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsArchiveTrafficeventUpdateRouter.2
        }));
        super.delete();
        unbind();
    }
