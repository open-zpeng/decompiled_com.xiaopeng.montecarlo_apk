...
public class CallBackCancelSignPayRouter extends ICallBackCancelSignPayImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackCancelSignPayRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackCancelSignPayRouter.2
        }));
        super.delete();
        unbind();
    }
