...
public class CallBackParkOrderListRouter extends ICallBackParkOrderListImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackParkOrderListRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackParkOrderListRouter.2
        }));
        super.delete();
        unbind();
    }
