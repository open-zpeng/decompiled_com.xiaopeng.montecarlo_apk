...
public class CallBackWsPpAutoWeixinStatusRouter extends ICallBackWsPpAutoWeixinStatusImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsPpAutoWeixinStatusRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsPpAutoWeixinStatusRouter.2
        }));
        super.delete();
        unbind();
    }
