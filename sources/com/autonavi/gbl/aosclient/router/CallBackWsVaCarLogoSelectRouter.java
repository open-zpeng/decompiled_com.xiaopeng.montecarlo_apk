...
public class CallBackWsVaCarLogoSelectRouter extends ICallBackWsVaCarLogoSelectImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsVaCarLogoSelectRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsVaCarLogoSelectRouter.2
        }));
        super.delete();
        unbind();
    }
