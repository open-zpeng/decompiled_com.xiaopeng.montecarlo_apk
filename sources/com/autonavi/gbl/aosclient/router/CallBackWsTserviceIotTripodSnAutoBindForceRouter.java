...
public class CallBackWsTserviceIotTripodSnAutoBindForceRouter extends ICallBackWsTserviceIotTripodSnAutoBindForceImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTserviceIotTripodSnAutoBindForceRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTserviceIotTripodSnAutoBindForceRouter.2
        }));
        super.delete();
        unbind();
    }
