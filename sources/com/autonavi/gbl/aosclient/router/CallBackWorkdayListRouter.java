...
public class CallBackWorkdayListRouter extends ICallBackWorkdayListImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWorkdayListRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWorkdayListRouter.2
        }));
        super.delete();
        unbind();
    }
