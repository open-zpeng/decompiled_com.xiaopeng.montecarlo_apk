...
public class CallBackWsTserviceIotTripodSnAutoBoundRouter extends ICallBackWsTserviceIotTripodSnAutoBoundImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTserviceIotTripodSnAutoBoundRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTserviceIotTripodSnAutoBoundRouter.2
        }));
        super.delete();
        unbind();
    }
