...
public class CallBackWsTserviceIotTripodSnAutoBindRouter extends ICallBackWsTserviceIotTripodSnAutoBindImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTserviceIotTripodSnAutoBindRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTserviceIotTripodSnAutoBindRouter.2
        }));
        super.delete();
        unbind();
    }
