...
public class CallBackServerTimestampRouter extends ICallBackServerTimestampImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackServerTimestampRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackServerTimestampRouter.2
        }));
        super.delete();
        unbind();
    }
