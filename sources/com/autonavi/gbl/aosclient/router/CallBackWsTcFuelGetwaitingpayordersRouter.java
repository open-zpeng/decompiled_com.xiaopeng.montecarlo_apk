...
public class CallBackWsTcFuelGetwaitingpayordersRouter extends ICallBackWsTcFuelGetwaitingpayordersImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTcFuelGetwaitingpayordersRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTcFuelGetwaitingpayordersRouter.2
        }));
        super.delete();
        unbind();
    }
