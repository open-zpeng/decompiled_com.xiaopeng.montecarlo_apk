...
public class CallBackQuerybylinksRouter extends ICallBackQuerybylinksImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackQuerybylinksRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackQuerybylinksRouter.2
        }));
        super.delete();
        unbind();
    }
