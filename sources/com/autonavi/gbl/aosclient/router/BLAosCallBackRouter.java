...
public class BLAosCallBackRouter extends IBLAosCallBackImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.BLAosCallBackRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.BLAosCallBackRouter.2
        }));
        super.delete();
        unbind();
    }
