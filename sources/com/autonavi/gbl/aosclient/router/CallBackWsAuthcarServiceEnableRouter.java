...
public class CallBackWsAuthcarServiceEnableRouter extends ICallBackWsAuthcarServiceEnableImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsAuthcarServiceEnableRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsAuthcarServiceEnableRouter.2
        }));
        super.delete();
        unbind();
    }
