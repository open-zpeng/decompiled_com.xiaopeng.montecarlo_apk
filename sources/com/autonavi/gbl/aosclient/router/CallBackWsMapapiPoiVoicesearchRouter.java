...
public class CallBackWsMapapiPoiVoicesearchRouter extends ICallBackWsMapapiPoiVoicesearchImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsMapapiPoiVoicesearchRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsMapapiPoiVoicesearchRouter.2
        }));
        super.delete();
        unbind();
    }
