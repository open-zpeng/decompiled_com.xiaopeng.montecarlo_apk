...
public class CallBackWsTserviceTeamJoinRouter extends ICallBackWsTserviceTeamJoinImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTserviceTeamJoinRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTserviceTeamJoinRouter.2
        }));
        super.delete();
        unbind();
    }
