...
public class CallBackWsAuthcarTokenRouter extends ICallBackWsAuthcarTokenImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsAuthcarTokenRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsAuthcarTokenRouter.2
        }));
        super.delete();
        unbind();
    }
