...
public class CallBackQRCodeConfirmRouter extends ICallBackQRCodeConfirmImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackQRCodeConfirmRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackQRCodeConfirmRouter.2
        }));
        super.delete();
        unbind();
    }
