...
public class CallBackWsShieldSearchRanklistPortalRouter extends ICallBackWsShieldSearchRanklistPortalImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsShieldSearchRanklistPortalRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsShieldSearchRanklistPortalRouter.2
        }));
        super.delete();
        unbind();
    }
