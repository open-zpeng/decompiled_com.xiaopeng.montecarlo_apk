...
public class CallBackTrafficEventDetailRouter extends ICallBackTrafficEventDetailImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackTrafficEventDetailRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackTrafficEventDetailRouter.2
        }));
        super.delete();
        unbind();
    }
