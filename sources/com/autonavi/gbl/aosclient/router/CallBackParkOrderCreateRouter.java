...
public class CallBackParkOrderCreateRouter extends ICallBackParkOrderCreateImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackParkOrderCreateRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackParkOrderCreateRouter.2
        }));
        super.delete();
        unbind();
    }
