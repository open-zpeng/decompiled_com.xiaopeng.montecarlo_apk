...
public class CallBackWsAppConfAppUpdateRouter extends ICallBackWsAppConfAppUpdateImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsAppConfAppUpdateRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsAppConfAppUpdateRouter.2
        }));
        super.delete();
        unbind();
    }
