...
public class CallBackWsUserviewFootprintNaviDeleteRouter extends ICallBackWsUserviewFootprintNaviDeleteImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsUserviewFootprintNaviDeleteRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsUserviewFootprintNaviDeleteRouter.2
        }));
        super.delete();
        unbind();
    }
