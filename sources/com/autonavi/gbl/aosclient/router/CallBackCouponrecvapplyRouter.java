...
public class CallBackCouponrecvapplyRouter extends ICallBackCouponrecvapplyImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackCouponrecvapplyRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackCouponrecvapplyRouter.2
        }));
        super.delete();
        unbind();
    }
