...
public class CallBackWsTcFuelQueryagreementRouter extends ICallBackWsTcFuelQueryagreementImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTcFuelQueryagreementRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTcFuelQueryagreementRouter.2
        }));
        super.delete();
        unbind();
    }
