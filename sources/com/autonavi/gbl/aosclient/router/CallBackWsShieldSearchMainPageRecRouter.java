...
public class CallBackWsShieldSearchMainPageRecRouter extends ICallBackWsShieldSearchMainPageRecImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsShieldSearchMainPageRecRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsShieldSearchMainPageRecRouter.2
        }));
        super.delete();
        unbind();
    }
