...
public class CallBackWsTserviceTeamUserStatusRouter extends ICallBackWsTserviceTeamUserStatusImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTserviceTeamUserStatusRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsTserviceTeamUserStatusRouter.2
        }));
        super.delete();
        unbind();
    }
