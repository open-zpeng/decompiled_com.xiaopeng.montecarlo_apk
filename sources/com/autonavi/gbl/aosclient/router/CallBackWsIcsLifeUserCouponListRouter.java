...
public class CallBackWsIcsLifeUserCouponListRouter extends ICallBackWsIcsLifeUserCouponListImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsIcsLifeUserCouponListRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.aosclient.router.CallBackWsIcsLifeUserCouponListRouter.2
        }));
        super.delete();
        unbind();
    }
