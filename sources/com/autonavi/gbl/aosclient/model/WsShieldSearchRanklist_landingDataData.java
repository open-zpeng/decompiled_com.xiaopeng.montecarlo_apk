...
public class WsShieldSearchRanklist_landingDataData implements Serializable {
    public String avgPrice;
    public WsShieldSearchRanklist_landingDataBookIcon book_icon;
    ...
    public WsShieldSearchRanklist_landingDataData() {
        this.show_collect = 0;
        this.name = "";
        this.pic_info = "";
        this.poiid = "";
        ...
        this.distance = "";
        this.rec_reason = "";
        this.book_icon = new WsShieldSearchRanklist_landingDataBookIcon();
        this.rating = "";
        this.rating_color = "";
        this.brief_comment = "";
        this.price = "";
    ...
    public WsShieldSearchRanklist_landingDataData(int i, String str, String str2, String str3, String str4, String str5, int i2, String str6, String str7, String str8, String str9, double d, String str10, String str11, String str12, String str13, int i3, String str14, String str15, int i4, String str16, String str17, String str18, String str19, WsShieldSearchRanklist_landingDataBookIcon wsShieldSearchRanklist_landingDataBookIcon, String str20, String str21, String str22, String str23, String str24, String str25, String str26) {
        this.show_collect = i;
        this.name = str;
        this.pic_info = str2;
        this.poiid = str3;
        ...
        this.book_icon = wsShieldSearchRanklist_landingDataBookIcon;
        this.rating = str20;
        this.rating_color = str21;
        this.brief_comment = str22;
        this.price = str23;
        this.avgPrice = str24;
        this.recommendReason = str25;
        this.outstandingReason = str26;
    }
}
