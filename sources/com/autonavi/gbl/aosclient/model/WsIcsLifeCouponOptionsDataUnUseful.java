...
public class WsIcsLifeCouponOptionsDataUnUseful implements Serializable {
    ...
    public WsIcsLifeCouponOptionsDataUnUseful(long j, String str, int i, String str2, long j2, int i2, int i3, int i4, ArrayList<WsIcsLifeCouponOptionsUsefulDisRule> arrayList, String str3, int i5, int i6, int i7, String str4, String str5, String str6) {
        this.recordId = j;
