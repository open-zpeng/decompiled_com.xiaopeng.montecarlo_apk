...
public class WsFeedbackReviewReportNaviParams implements Serializable {
    ...
    public WsFeedbackReviewReportNaviParams() {
    ...
    public WsFeedbackReviewReportNaviParams(int i, int i2, int i3, int i4, String str, int i5, int i6, String str2, int i7, int i8, int i9, ArrayList<Integer> arrayList, String str3, ArrayList<Integer> arrayList2, int i10) {
