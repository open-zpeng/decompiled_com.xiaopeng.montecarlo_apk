...
public class GSubTraEventDetail implements Serializable {
    ...
    public GSubTraEventDetail(int i, int i2, String str, String str2, String str3, String str4, int i3, int i4, String str5, String str6, String str7, int i5, String str8, String str9, String str10, String str11, int i6, String str12, String str13, int i7, String str14, String str15, double d, double d2, String str16, String str17, GTrifficSocolPicture gTrifficSocolPicture, String str18) {
        this.criticism = i;
        this.layer = i2;
        this.id = str;
