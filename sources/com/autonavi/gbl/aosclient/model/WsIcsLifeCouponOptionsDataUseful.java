...
public class WsIcsLifeCouponOptionsDataUseful implements Serializable {
    ...
    public WsIcsLifeCouponOptionsDataUseful(int i, String str, int i2, String str2, int i3, int i4, int i5, int i6, ArrayList<WsIcsLifeCouponOptionsUsefulDisRule> arrayList, String str3, int i7, int i8, int i9, String str4, String str5) {
        this.recordId = i;
