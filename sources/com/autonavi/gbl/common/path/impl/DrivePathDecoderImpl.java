...
public class DrivePathDecoderImpl {
    ...
    private static native int decodePBDriveGuideNative(byte[] bArr, ArrayList<PathInfoImpl> arrayList);

    private static native int decodePBDrivePlanNative(byte[] bArr, ArrayList<PathInfoImpl> arrayList);
    ...
    public static ArrayList<PathInfoImpl> decodePBDrivePlan(byte[] bArr) {
        ArrayList<PathInfoImpl> arrayList = new ArrayList<>();
        if (decodeRouteData(bArr, arrayList) == 1) {
            return arrayList;
        }
    ...
    public static ArrayList<PathInfoImpl> decodePBDriveGuide(byte[] bArr) {
        ArrayList<PathInfoImpl> arrayList = new ArrayList<>();
        if (decodeRouteData(bArr, arrayList) == 1) {
            return arrayList;
        }
    ...
    public static ArrayList<PathInfoImpl> decodePBDriveOdd(byte[] bArr) {
        ArrayList<PathInfoImpl> arrayList = new ArrayList<>();
        if (decodeRouteData(bArr, arrayList) == 1) {
            return arrayList;
        }
    ...
    @RouteErrorcode.RouteErrorcode1
    private static int decodePBDrivePlan(byte[] bArr, ArrayList<PathInfoImpl> arrayList) {
        return decodePBDrivePlanNative(bArr, arrayList);
    }

    @RouteErrorcode.RouteErrorcode1
    private static int decodePBDriveGuide(byte[] bArr, ArrayList<PathInfoImpl> arrayList) {
        return decodePBDriveGuideNative(bArr, arrayList);
    }
