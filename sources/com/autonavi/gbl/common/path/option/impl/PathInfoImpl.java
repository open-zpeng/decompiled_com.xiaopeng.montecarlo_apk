...
public class PathInfoImpl {
    ...
    private static native boolean getIndoorParkingInfoNative(long j, PathInfoImpl pathInfoImpl, long j2, PathIndoorParkingInfo pathIndoorParkingInfo);
    ...
    private static native void getOfflineReqCustomIdentityIdNative(long j, PathInfoImpl pathInfoImpl, String[] strArr);
    ...
    private static native void getPlanChannelIdNative(long j, PathInfoImpl pathInfoImpl, String[] strArr);
    ...
    private static native void setLineItemNaviToConsisNative(long j, PathInfoImpl pathInfoImpl, long j2, LineItem lineItem);

    private static native void setOfflineReqCustomIdentityIdNative(long j, PathInfoImpl pathInfoImpl, String str);

    private static native void setPlanChannelIdNative(long j, PathInfoImpl pathInfoImpl, String str);

    private static native void setPriorityNative(long j, PathInfoImpl pathInfoImpl, int i);

    private static native void setTravelTimeNative(long j, PathInfoImpl pathInfoImpl, long j2);
    ...
    public PathIndoorParkingInfo getIndoorParkingInfo() {
        ...
        if (getIndoorParkingInfo(pathIndoorParkingInfo)) {
