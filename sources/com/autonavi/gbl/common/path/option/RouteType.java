...
public final class RouteType {
    ...
    public static final int RouteTypeAvoidRoadClose = 25;
    public static final int RouteTypeChangeJnyPnt = 9;
    public static final int RouteTypeChangeRouteCovertly = 28;
    public static final int RouteTypeChangeStratege = 3;
    public static final int RouteTypeCommon = 1;
    public static final int RouteTypeCustomSceneRoute = 24;
    ...
    public static final int RouteTypeGuideChangePlayType = 8000;
    ...
    public static final int RouteTypeReturnOnSameWay = 27;
