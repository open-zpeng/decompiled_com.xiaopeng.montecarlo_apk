...
public class DrivePathDecoder {
    ...
    public static ArrayList<PathInfo> decodePBDrivePlan(byte[] bArr) {
        if (bArr != null && bArr.length == 0) {
            bArr = null;
        }
        try {
            Method method = DrivePathDecoder.class.getMethod("decodePBDrivePlan", byte[].class);
            ArrayList<PathInfoImpl> decodePBDrivePlan = DrivePathDecoderImpl.decodePBDrivePlan(bArr);
            if (decodePBDrivePlan != null) {
                TypeHelper typeHelper = gTypeHelper;
                r0 = typeHelper != null ? (ArrayList) typeHelper.transfer(method, -1, (ArrayList) decodePBDrivePlan, true) : null;
                if (r0 == null) {
    ...
    public static ArrayList<PathInfo> decodePBDriveGuide(byte[] bArr) {
        if (bArr != null && bArr.length == 0) {
            bArr = null;
        }
        try {
            Method method = DrivePathDecoder.class.getMethod("decodePBDriveGuide", byte[].class);
            ArrayList<PathInfoImpl> decodePBDriveGuide = DrivePathDecoderImpl.decodePBDriveGuide(bArr);
            if (decodePBDriveGuide != null) {
                TypeHelper typeHelper = gTypeHelper;
                r0 = typeHelper != null ? (ArrayList) typeHelper.transfer(method, -1, (ArrayList) decodePBDriveGuide, true) : null;
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.common.path.DrivePathDecoder.3
                    }));
                }
            }
            return r0;
    ...
    public static ArrayList<PathInfo> decodePBDriveOdd(byte[] bArr) {
        if (bArr != null && bArr.length == 0) {
            bArr = null;
        }
        try {
            Method method = DrivePathDecoder.class.getMethod("decodePBDriveOdd", byte[].class);
            ArrayList<PathInfoImpl> decodePBDriveOdd = DrivePathDecoderImpl.decodePBDriveOdd(bArr);
            if (decodePBDriveOdd != null) {
                TypeHelper typeHelper = gTypeHelper;
                r0 = typeHelper != null ? (ArrayList) typeHelper.transfer(method, -1, (ArrayList) decodePBDriveOdd, true) : null;
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.common.path.DrivePathDecoder.4
                    }));
                }
            }
            return r0;
    ...
    public static ArrayList<PathInfo> decodeMultiRouteData(CalcRouteResultData calcRouteResultData) {
        try {
            ...
            if (decodeMultiRouteData != null) {
                ...
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.common.path.DrivePathDecoder.5
                    }));
                }
            }
            return r0;
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.common.path.DrivePathDecoder.6
        });
    ...
    protected void clean() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.common.path.DrivePathDecoder.7
        }));
    }

    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.common.path.DrivePathDecoder.8
        }));
        if (!this.mHasDestroy) {
            onDestroy();
        }
