...
public class JamBubblesPostBack implements Serializable {
    ...
    public JamBubblesPostBack(long j, String str, String str2, String str3, int i, int i2, ArrayList<String> arrayList, String str4, String str5, int i3, int i4, int i5) {
        this.arriveTime = j;
