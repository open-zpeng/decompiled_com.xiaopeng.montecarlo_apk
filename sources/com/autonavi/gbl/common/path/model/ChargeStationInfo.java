...
public class ChargeStationInfo implements Serializable {
    ...
    public ChargeStationInfo(int i, short s, Coord2DInt32 coord2DInt32, Coord2DInt32 coord2DInt322, String str, String str2, String str3, int i2, short s2, int i3, int i4, double d) {
        this.segmentIdx = i;
        this.direction = s;
