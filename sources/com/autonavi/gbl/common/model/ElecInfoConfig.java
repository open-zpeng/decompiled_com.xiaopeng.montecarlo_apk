...
public class ElecInfoConfig implements Serializable {
    ...
    public ElecInfoConfig(String str, short s, short s2, short s3, short s4, short s5, short s6, short s7, float f, float f2, int i, int i2, int i3, ArrayList<ElecCostList> arrayList) {
        this.orgaName = str;
        this.driveTrain = s;
        this.fesMode = s2;
