...
public class ITbtCommonControlImpl {
    ...
    private static native int initNative(long j, ITbtCommonControlImpl iTbtCommonControlImpl, long j2, WorkPathImpl workPathImpl, long j3, UserConfigImpl userConfigImpl);
    ...
    public int init(WorkPathImpl workPathImpl, UserConfigImpl userConfigImpl) {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        return initNative(j, this, WorkPathImpl.getCPtr(workPathImpl), workPathImpl, UserConfigImpl.getCPtr(userConfigImpl), userConfigImpl);
    }
