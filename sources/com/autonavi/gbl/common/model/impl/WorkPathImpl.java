...
public class WorkPathImpl {
    ...
    private static native String continueNaviGetNative(long j, WorkPathImpl workPathImpl);

    private static native void continueNaviSetNative(long j, WorkPathImpl workPathImpl, String str);
    ...
    public void setContinueNavi(String str) {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        continueNaviSetNative(j, this, str);
    }

    public String getContinueNavi() {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        return continueNaviGetNative(j, this);
    }
