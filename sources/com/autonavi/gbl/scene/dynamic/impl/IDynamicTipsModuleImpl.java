...
public class IDynamicTipsModuleImpl extends IBaseSceneModuleImpl {
    ...
    private static native long IDynamicTipsModuleImpl_SWIGUpcast(long j);

    private static native boolean addDisplayObserverNative(long j, IDynamicTipsModuleImpl iDynamicTipsModuleImpl, long j2, IDisplayObserverImpl iDisplayObserverImpl);

    private static native void destroyNativeObj(long j);

    private static native boolean removeDisplayObserverNative(long j, IDynamicTipsModuleImpl iDynamicTipsModuleImpl, long j2, IDisplayObserverImpl iDisplayObserverImpl);

    private static native void setScreenParamAdapterNative(long j, IDynamicTipsModuleImpl iDynamicTipsModuleImpl, long j2, IScreenParamAdapterImpl iScreenParamAdapterImpl);

    private static native boolean updateScreenParamNative(long j, IDynamicTipsModuleImpl iDynamicTipsModuleImpl, long j2, ScreenParam screenParam);

    public IDynamicTipsModuleImpl(long j, boolean z) {
        super(IDynamicTipsModuleImpl_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof IDynamicTipsModuleImpl) {
            return getUID(this) == getUID((IDynamicTipsModuleImpl) obj);
        }
