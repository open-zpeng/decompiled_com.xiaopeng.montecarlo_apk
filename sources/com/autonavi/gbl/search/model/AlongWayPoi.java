...
public class AlongWayPoi implements Serializable {
    ...
    public AlongWayPoi(String str, String str2, Coord2DDouble coord2DDouble, Coord2DDouble coord2DDouble2, Coord2DDouble coord2DDouble3, String str3, String str4, String str5, String str6, int i, String str7, String str8, String str9, int i2, String str10, int i3, int i4, ArrayList<PricePoiInfo> arrayList, int i5, int i6, int i7, int i8, int i9, String str11, SearchRoadId searchRoadId, ChargingStationInfo chargingStationInfo, ArrayList<SearchChargeProvider> arrayList2) {
        this.name = str;
        this.ename = str2;
