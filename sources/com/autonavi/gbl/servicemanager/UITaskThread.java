...
public class UITaskThread implements IUITaskThread {
    ...
    public UITaskThread(int i, Looper looper) {
        ...
        this.mHandler = new Handler(looper) { // from class: com.autonavi.gbl.servicemanager.UITaskThread.1
            ...
            public void dispatchMessage(Message message) {
                ...
                LogUtils.d("UITaskThread dispatchMessage ptr = " + Long.toHexString(UITaskThread.this.ptr) + ", taskPtr = " + Long.toHexString(l.longValue()) + ", thread =" + Thread.currentThread().getId());
                if (UITaskThread.this.ptr == 0 || l == null) {
                    return;
                }
                LogUtils.d("UITaskThread runTask taskPtr = 0x" + Long.toHexString(l.longValue()));
    ...
    public void onPost(long j, long j2) {
        LogUtils.d("UITaskThread onPost taskPtr = " + j + ", 0x " + Long.toHexString(j) + " delayMillis = " + j2 + ", thread =" + Thread.currentThread().getId());
