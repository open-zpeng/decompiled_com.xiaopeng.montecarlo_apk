...
public class GuideService implements IService {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.guide.GuideService.8
        });
    ...
    protected void clean() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.guide.GuideService.9
        }));
        TypeHelper typeHelper = this.mTypeHelper;
        if (typeHelper != null) {
    ...
    protected synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.guide.GuideService.10
        }));
        if (!this.mHasDestroy) {
            onDestroy();
        }
