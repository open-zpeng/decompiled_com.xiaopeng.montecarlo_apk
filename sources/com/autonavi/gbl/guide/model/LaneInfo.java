...
public class LaneInfo implements Serializable {
    ...
    public LaneInfo() {
        ...
        this.segmentIdx = -1;
        this.linkIdx = -1;
        this.frontLaneType = new ArrayList<>();
        this.backLaneType = new ArrayList<>();
    }

    public LaneInfo(ArrayList<Integer> arrayList, ArrayList<Integer> arrayList2, ArrayList<Integer> arrayList3, ArrayList<Integer> arrayList4, ArrayList<Integer> arrayList5, ArrayList<Integer> arrayList6, Coord2DDouble coord2DDouble, int i, int i2, ArrayList<Integer> arrayList7, ArrayList<Integer> arrayList8) {
        ...
        this.segmentIdx = i;
        this.linkIdx = i2;
        this.frontLaneType = arrayList7;
        this.backLaneType = arrayList8;
    }
}
