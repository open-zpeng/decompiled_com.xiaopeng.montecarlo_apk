...
public class NaviInfo implements Serializable {
    ...
    public NaviInfo(long j, @NaviType.NaviType1 int i, TimeAndDist timeAndDist, ArrayList<TimeAndDist> arrayList, ArrayList<TimeAndDist> arrayList2, int i2, int i3, int i4, int i5, int i6, @RoadClass.RoadClass1 int i7, String str, int i8, int i9, int i10, int i11, int i12, int i13, int i14, NotAvoidInfo notAvoidInfo, int i15, ArrayList<CrossNaviInfo> arrayList3, int i16, ArrayList<NaviInfoPanel> arrayList4, String str2, String str3, boolean z) {
        ...
        this.ringOutCnt = i8;
        this.roundaboutOutAngle = i9;
        this.driveTime = i10;
        this.driveDist = i11;
        this.cityCode = i12;
        this.curLinkSpeed = i13;
        this.segTipsDis = i14;
        this.notAvoidInfo = notAvoidInfo;
        this.crossManeuverID = i15;
        this.nextCrossInfo = arrayList3;
        this.NaviInfoFlag = i16;
