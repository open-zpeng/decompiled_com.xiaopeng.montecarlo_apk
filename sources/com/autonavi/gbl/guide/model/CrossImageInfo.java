...
public class CrossImageInfo implements Serializable {
    ...
    public CrossImageInfo(@CrossType.CrossType1 int i, @VectorCrossImageType.VectorCrossImageType1 int i2, byte[] bArr, byte[] bArr2, BigInteger bigInteger, boolean z, long j, long j2, long j3, ArrayList<Long> arrayList) {
        this.type = i;
        this.vectorType = i2;
        this.dataBuf = bArr;
