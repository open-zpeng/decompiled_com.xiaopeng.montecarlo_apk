...
public final class Type {
    ...
    public static final int GuideParamContinueParam = 30;
    public static final int GuideParamCrossing = 10;
    public static final int GuideParamCruise = 6;
    public static final int GuideParamCruiseLane = 24;
    public static final int GuideParamEasy3d = 14;
    public static final int GuideParamElecVehicleCharge = 26;
    ...
    public static final int GuideParamManeuverParam = 29;
    public static final int GuideParamNavi = 7;
    public static final int GuideParamNaviFacility = 23;
    public static final int GuideParamNaviOdd = 28;
    public static final int GuideParamNaviScenicSpot = 27;
    ...
    public static final int GuideParamTimeConversion = 31;
    public static final int GuideParamTollGateLane = 22;
    public static final int GuideParamTollGateQuickPay = 18;
    public static final int GuideParamTrafficLightInfo = 25;
