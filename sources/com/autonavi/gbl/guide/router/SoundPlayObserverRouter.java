...
public class SoundPlayObserverRouter extends ISoundPlayObserverImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.guide.router.SoundPlayObserverRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.guide.router.SoundPlayObserverRouter.2
        }));
        super.delete();
        unbind();
    }
