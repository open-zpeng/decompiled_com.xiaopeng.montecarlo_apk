...
public class ICruiseObserverImpl {
    ...
    private static native void onHideCruisePredictiveLaneInfoNative(long j, ICruiseObserverImpl iCruiseObserverImpl);

    private static native void onHideCruisePredictiveLaneInfoSwigExplicitICruiseObserverImplNative(long j, ICruiseObserverImpl iCruiseObserverImpl);
    ...
    private static native void onShowCruisePredictiveLaneInfoNative(long j, ICruiseObserverImpl iCruiseObserverImpl, long j2, CruisePredictiveLaneInfo cruisePredictiveLaneInfo);

    private static native void onShowCruisePredictiveLaneInfoSwigExplicitICruiseObserverImplNative(long j, ICruiseObserverImpl iCruiseObserverImpl, long j2, CruisePredictiveLaneInfo cruisePredictiveLaneInfo);
