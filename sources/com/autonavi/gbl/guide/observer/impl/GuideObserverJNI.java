...
public class GuideObserverJNI {
    ...
    public static void SwigDirector_INaviObserverImpl_onUpdateTMCCongestionInfo(INaviObserverImpl iNaviObserverImpl, NaviCongestionInfoImpl naviCongestionInfoImpl) {
        NaviCongestionInfoImpl naviCongestionInfoImpl2 = new NaviCongestionInfoImpl();
        naviCongestionInfoImpl2.copy(naviCongestionInfoImpl);
        iNaviObserverImpl.onUpdateTMCCongestionInfo(naviCongestionInfoImpl2);
    }
    ...
    public static boolean SwigDirector_IGuideOperateObserverImpl_startNavi(IGuideOperateObserverImpl iGuideOperateObserverImpl, @NaviType.NaviType1 int i) {
        return iGuideOperateObserverImpl.startNavi(i);
    }

    public static boolean SwigDirector_IGuideOperateObserverImpl_stopNavi(IGuideOperateObserverImpl iGuideOperateObserverImpl) {
        return iGuideOperateObserverImpl.stopNavi();
    }

    public static boolean SwigDirector_IGuideOperateObserverImpl_pauseNavi(IGuideOperateObserverImpl iGuideOperateObserverImpl) {
        return iGuideOperateObserverImpl.pauseNavi();
    }

    public static boolean SwigDirector_IGuideOperateObserverImpl_resumeNavi(IGuideOperateObserverImpl iGuideOperateObserverImpl) {
        return iGuideOperateObserverImpl.resumeNavi();
    }

    public static boolean SwigDirector_IGuideOperateObserverImpl_setNaviPath(IGuideOperateObserverImpl iGuideOperateObserverImpl, NaviPathImpl naviPathImpl, int i) {
        return iGuideOperateObserverImpl.setNaviPath(naviPathImpl, i);
    }

    public static boolean SwigDirector_IGuideOperateObserverImpl_onUpdateMainNaviPath(IGuideOperateObserverImpl iGuideOperateObserverImpl, PathInfoImpl pathInfoImpl) {
        return iGuideOperateObserverImpl.onUpdateMainNaviPath(pathInfoImpl);
    }
}
