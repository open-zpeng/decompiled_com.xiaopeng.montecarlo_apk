...
public class GuideObserverJNI {
    ...
    public static void SwigDirector_ICruiseObserverImpl_onShowCruisePredictiveLaneInfo(ICruiseObserverImpl iCruiseObserverImpl, CruisePredictiveLaneInfo cruisePredictiveLaneInfo) {
        iCruiseObserverImpl.onShowCruisePredictiveLaneInfo(cruisePredictiveLaneInfo);
    }

    public static void SwigDirector_ICruiseObserverImpl_onHideCruisePredictiveLaneInfo(ICruiseObserverImpl iCruiseObserverImpl) {
        iCruiseObserverImpl.onHideCruisePredictiveLaneInfo();
    }
    ...
    public static void SwigDirector_INaviObserverImpl_onShowNaviCameraExt(INaviObserverImpl iNaviObserverImpl, ArrayList<NaviCameraExt> arrayList) {
        iNaviObserverImpl.onShowNaviCameraExt(arrayList);
    }
    ...
    public static void SwigDirector_INaviObserverImpl_onDriveReport(INaviObserverImpl iNaviObserverImpl, DriveReport driveReport) {
        iNaviObserverImpl.onDriveReport(driveReport);
    }
    ...
    public static void SwigDirector_INaviObserverImpl_onUpdateTMCLightBar(INaviObserverImpl iNaviObserverImpl, ArrayList<LightBarInfo> arrayList, LightBarDetail lightBarDetail, long j, boolean z) {
        iNaviObserverImpl.onUpdateTMCLightBar(arrayList, lightBarDetail, j, z);
    }
    ...
    public static void SwigDirector_INaviObserverImpl_onMainNaviPath(INaviObserverImpl iNaviObserverImpl, PathInfo pathInfo) {
        iNaviObserverImpl.onMainNaviPath(pathInfo);
    }
    ...
    public static void SwigDirector_INaviObserverImpl_onUpdateTrafficLightCountdown(INaviObserverImpl iNaviObserverImpl, ArrayList<TrafficLightCountdown> arrayList) {
        iNaviObserverImpl.onUpdateTrafficLightCountdown(arrayList);
    }
    ...
    public static void SwigDirector_INaviObserverImpl_onUpdateNaviOddInfo(INaviObserverImpl iNaviObserverImpl, NaviOddInfo naviOddInfo) {
        iNaviObserverImpl.onUpdateNaviOddInfo(naviOddInfo);
    }
    ...
    public static void SwigDirector_IContinueGuideInfoObserverImpl_continueGuideStartNotify(IContinueGuideInfoObserverImpl iContinueGuideInfoObserverImpl) {
        iContinueGuideInfoObserverImpl.continueGuideStartNotify();
    }

    public static void SwigDirector_IContinueGuideInfoObserverImpl_exitContinueGuideNotify(IContinueGuideInfoObserverImpl iContinueGuideInfoObserverImpl) {
        iContinueGuideInfoObserverImpl.exitContinueGuideNotify();
    }
}
