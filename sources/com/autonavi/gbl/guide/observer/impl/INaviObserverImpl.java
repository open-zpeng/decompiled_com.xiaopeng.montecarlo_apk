...
public class INaviObserverImpl {
    ...
    private static native void onDriveReportNative(long j, INaviObserverImpl iNaviObserverImpl, long j2, DriveReport driveReport);
    ...
    private static native void onMainNaviPathNative(long j, INaviObserverImpl iNaviObserverImpl, long j2, PathInfo pathInfo);
    ...
    private static native void onShowNaviCameraExtNative(long j, INaviObserverImpl iNaviObserverImpl, ArrayList<NaviCameraExt> arrayList);
    ...
    private static native void onUpdateNaviOddInfoNative(long j, INaviObserverImpl iNaviObserverImpl, long j2, NaviOddInfo naviOddInfo);
    ...
    private static native void onUpdateTMCLightBarNative(long j, INaviObserverImpl iNaviObserverImpl, ArrayList<LightBarInfo> arrayList, long j2, LightBarDetail lightBarDetail, long j3, boolean z);
    ...
    private static native void onUpdateTrafficLightCountdownNative(long j, INaviObserverImpl iNaviObserverImpl, ArrayList<TrafficLightCountdown> arrayList);
    ...
    public void onShowNaviCameraExt(ArrayList<NaviCameraExt> arrayList) {
        ...
        onShowNaviCameraExtNative(j, this, arrayList);
    }
    ...
    public void onDriveReport(DriveReport driveReport) {
        ...
        onDriveReportNative(j, this, 0L, driveReport);
    }
    ...
    public void onUpdateTMCLightBar(ArrayList<LightBarInfo> arrayList, LightBarDetail lightBarDetail, long j, boolean z) {
        ...
        onUpdateTMCLightBarNative(j2, this, arrayList, 0L, lightBarDetail, j, z);
    }
    ...
    public void onMainNaviPath(PathInfo pathInfo) {
        ...
        onMainNaviPathNative(j, this, PathInfo.getCPtr(pathInfo), pathInfo);
    }
    ...
    public void onUpdateTrafficLightCountdown(ArrayList<TrafficLightCountdown> arrayList) {
        ...
        onUpdateTrafficLightCountdownNative(j, this, arrayList);
    }
