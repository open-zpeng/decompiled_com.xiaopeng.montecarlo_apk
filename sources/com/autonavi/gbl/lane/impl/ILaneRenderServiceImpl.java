...
public class ILaneRenderServiceImpl {
    ...
    private static native boolean setLaneLogicViewRectNative(long j, ILaneRenderServiceImpl iLaneRenderServiceImpl, long j2, LaneViewRect laneViewRect);
    ...
    private static native int setParamNative(long j, ILaneRenderServiceImpl iLaneRenderServiceImpl, int i, String str);
    ...
    private static native boolean setTMCShowStatusNative(long j, ILaneRenderServiceImpl iLaneRenderServiceImpl, int i);
    ...
    public boolean setTMCShowStatus(@LaneTMCShowStatus.LaneTMCShowStatus1 int i) {
        ...
        return setTMCShowStatusNative(j, this, i);
    }
    ...
    public boolean setLaneLogicViewRect(LaneViewRect laneViewRect) {
        ...
        return setLaneLogicViewRectNative(j, this, 0L, laneViewRect);
    }
    ...
    public LaneCameraParam getLaneCameraParam(@LaneCameraParamType.LaneCameraParamType1 int i) {
        ...
        if (Boolean.valueOf(getLaneCameraParam(i, laneCameraParam)).booleanValue()) {
