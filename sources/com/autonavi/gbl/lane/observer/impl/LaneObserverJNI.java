...
public class LaneObserverJNI {
    ...
    public static void SwigDirector_ILaneObserverImpl_onLaneLndsDataDistance__SWIG_0(ILaneObserverImpl iLaneObserverImpl, float f) {
        iLaneObserverImpl.onLaneLndsDataDistance(f);
    }

    public static void SwigDirector_ILaneObserverImpl_onLaneLndsDataDistance__SWIG_1(ILaneObserverImpl iLaneObserverImpl, LaneLndsDataDistanceInfo laneLndsDataDistanceInfo) {
        iLaneObserverImpl.onLaneLndsDataDistance(laneLndsDataDistanceInfo);
    }

    public static void SwigDirector_ILaneObserverImpl_onLaneStatus(ILaneObserverImpl iLaneObserverImpl, LaneStatusInfo laneStatusInfo) {
        iLaneObserverImpl.onLaneStatus(laneStatusInfo);
    }
    ...
    public static void SwigDirector_ILaneDigitalTrackObserverImpl_onUpdateDigitalTrack(ILaneDigitalTrackObserverImpl iLaneDigitalTrackObserverImpl, BinaryStream binaryStream) {
        iLaneDigitalTrackObserverImpl.onUpdateDigitalTrack(binaryStream);
    }

    public static void SwigDirector_ILaneDiagnosisObserverImpl_onUpdateDiagnosis(ILaneDiagnosisObserverImpl iLaneDiagnosisObserverImpl, String str) {
        iLaneDiagnosisObserverImpl.onUpdateDiagnosis(str);
    }
