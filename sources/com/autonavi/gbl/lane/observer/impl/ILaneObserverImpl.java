...
public class ILaneObserverImpl {
    ...
    private static native void onLaneLndsDataDistance1Native(long j, ILaneObserverImpl iLaneObserverImpl, long j2, LaneLndsDataDistanceInfo laneLndsDataDistanceInfo);

    private static native void onLaneLndsDataDistanceNative(long j, ILaneObserverImpl iLaneObserverImpl, float f);

    private static native void onLaneLndsDataDistanceSwigExplicitILaneObserverImpl1Native(long j, ILaneObserverImpl iLaneObserverImpl, long j2, LaneLndsDataDistanceInfo laneLndsDataDistanceInfo);
    ...
    private static native void onLaneStatusNative(long j, ILaneObserverImpl iLaneObserverImpl, long j2, LaneStatusInfo laneStatusInfo);

    private static native void onLaneStatusSwigExplicitILaneObserverImplNative(long j, ILaneObserverImpl iLaneObserverImpl, long j2, LaneStatusInfo laneStatusInfo);
    ...
    public void onLaneLndsDataDistance(LaneLndsDataDistanceInfo laneLndsDataDistanceInfo) {
        if (this.swigCPtr == 0) {
            throw new NullPointerException();
        }
        if (getClass() == ILaneObserverImpl.class) {
            onLaneLndsDataDistance1Native(this.swigCPtr, this, 0L, laneLndsDataDistanceInfo);
        } else {
            onLaneLndsDataDistanceSwigExplicitILaneObserverImpl1Native(this.swigCPtr, this, 0L, laneLndsDataDistanceInfo);
        }
    }
    ...
    public void onLaneStatus(LaneStatusInfo laneStatusInfo) {
        ...
        if (getClass() == ILaneObserverImpl.class) {
            onLaneStatusNative(this.swigCPtr, this, 0L, laneStatusInfo);
        } else {
            onLaneStatusSwigExplicitILaneObserverImplNative(this.swigCPtr, this, 0L, laneStatusInfo);
        }
    }
