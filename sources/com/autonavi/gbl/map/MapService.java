...
public class MapService implements IService {
    ...
    public int initMap(InitMapParam initMapParam) {
        return initMap(initMapParam, new DefaultMapFontObserver());
    }
    ...
    public MapDevice createDevice(@EGLDeviceID.EGLDeviceID1 int i, DeviceAttribute deviceAttribute, IDeviceObserver iDeviceObserver) {
        ...
        try {
            ...
            hashSet.remove(iDeviceObserver);
            if (iDeviceObserver != null) {
                TypeHelper typeHelper2 = this.mTypeHelper;
                iDeviceObserverImpl = typeHelper2 != null ? (IDeviceObserverImpl) typeHelper2.transfer(method, 2, iDeviceObserver) : null;
            ...
            if (mapServiceImpl != null) {
                ...
                if (createDevice != null) {
                    ...
                    mapDevice = typeHelper3 != null ? (MapDevice) typeHelper3.transfer(method, -1, (Object) createDevice, true) : null;
                    if (mapDevice == null) {
                ...
                if (typeHelper4 != null) {
                    typeHelper4.unbindSet(method, 2, hashSet);
                }
                TypeHelper typeHelper5 = mapDevice != null ? (TypeHelper) ReflexTool.getDeclFieldSafe(mapDevice, "mTypeHelper") : null;
                if (typeHelper5 != null) {
                    typeHelper5.transfer(method, 2, iDeviceObserver);
                }
    ...
    public MapDevice getDevice(@EGLDeviceID.EGLDeviceID1 int i) {
        ...
        try {
            ...
            if (mapServiceImpl != null && (device = mapServiceImpl.getDevice(i)) != null) {
                ...
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.5
                    }));
                }
            }
            return r0;
        ...
        try {
            ...
            if (mapDevice != null) {
                ...
                if (mapDeviceImpl == null) {
                    DebugTool.e("%s: $pIMapDevice == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.6
                    }));
                    return false;
                }
            } else {
    ...
    public MapView createMapView(MapViewParam mapViewParam, IBLMapViewProxy iBLMapViewProxy, IBLMapEngineObserver iBLMapEngineObserver, IBLMapBusinessDataObserver iBLMapBusinessDataObserver, IAnimationObserver iAnimationObserver) {
        ...
        ?? r4 = new IBLMapEngineObserver(iBLMapEngineObserver) { // from class: com.autonavi.gbl.map.MapService.1MapEngineObserverInnerBridge
            ...
            public void setMapView(MapView mapView2) {
                ...
                if (mapView3 != null) {
                    this.mDeviceId = mapView3.getDeviceId();
                }
            }
        ...
        try {
            ...
            if (iBLMapViewProxy != null) {
                ...
                if (iBLMapViewProxyImpl2 == null) {
                    DebugTool.e("%s: $mapViewProxy == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.7
                    }));
                    return null;
                }
            ...
            if (iBLMapEngineObserverImpl == null) {
                DebugTool.e("%s: $mapEngineObserver == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.8
                }));
                return null;
            }
            if (iBLMapBusinessDataObserver != null) {
                ...
                if (iBLMapBusinessDataObserverImpl2 == null) {
                    DebugTool.e("%s: $mapBusinessDataObserver == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.9
                    }));
                    return null;
                }
            ...
            if (iAnimationObserver != null) {
                ...
                if (iAnimationObserverImpl2 == null) {
                    DebugTool.e("%s: $animationObserver == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.10
                    }));
                    return null;
                }
    ...
    public MapView getMapView(@MapEngineID.MapEngineID1 int i) {
        ...
        try {
            ...
            if (mapServiceImpl != null && (mapView = mapServiceImpl.getMapView(i)) != null) {
                ...
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.12
                    }));
                }
            }
            return r0;
    ...
    public IBLMapViewProxy getMapViewProxy(@MapEngineID.MapEngineID1 int i) {
        ...
        try {
            ...
            if (mapServiceImpl != null && (mapViewProxy = mapServiceImpl.getMapViewProxy(i)) != null) {
                ...
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.13
                    }));
                }
            }
            return r0;
    ...
    public boolean destroyMapView(MapView mapView) {
        ...
        try {
            ...
            if (mapView != null) {
                ...
                if (mapViewImpl == null) {
                    DebugTool.e("%s: $pIMapView == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.14
                    }));
                    return false;
                }
            } else {
    ...
    public void queueEvent(@EGLDeviceID.EGLDeviceID1 int i, final IMapRunnable iMapRunnable) {
        IMapRunnable iMapRunnable2 = new IMapRunnable() { // from class: com.autonavi.gbl.map.MapService.15
        ...
        try {
            ...
            if (iMapRunnableImpl == null) {
                DebugTool.e("%s: $runnable == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.16
                }));
            }
            MapServiceImpl mapServiceImpl = this.mControl;
            if (mapServiceImpl != null) {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.17
        });
    ...
    protected void clean() {
        ...
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.18
        }));
        Set set = this.mMapViewSet;
        if (set != null) {
            synchronized (set) {
    ...
    protected synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapService.19
        }));
        if (!this.mHasDestroy) {
            onDestroy();
        }
