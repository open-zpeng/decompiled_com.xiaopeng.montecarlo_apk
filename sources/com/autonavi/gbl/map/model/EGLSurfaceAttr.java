...
public class EGLSurfaceAttr implements Serializable {
    ...
    public EGLSurfaceAttr(long j, long j2, int i, int i2, @EGLDeviceID.EGLDeviceID1 int i3, boolean z, boolean z2, boolean z3, int i4, boolean z4, boolean z5) {
        this.display = j;
