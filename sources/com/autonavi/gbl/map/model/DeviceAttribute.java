...
public class DeviceAttribute implements Serializable {
    ...
    public DeviceAttribute(boolean z, boolean z2, int i, int i2, ArrayList<EglConfigAttr> arrayList, @EGLDeviceWorkMode.EGLDeviceWorkMode1 int i3, int i4, boolean z3, long j, int i5) {
