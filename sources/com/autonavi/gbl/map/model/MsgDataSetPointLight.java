...
public class MsgDataSetPointLight implements Serializable {
    ...
    public MsgDataSetPointLight(@PointLightType.PointLightType1 int i, boolean z, Coord3DDouble coord3DDouble, Coord3DDouble coord3DDouble2, ArrayList<PointLightParam> arrayList) {
        this.type = i;
        this.positionOnly = z;
