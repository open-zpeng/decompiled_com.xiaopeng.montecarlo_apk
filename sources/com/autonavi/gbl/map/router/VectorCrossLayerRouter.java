...
public class VectorCrossLayerRouter extends VectorCrossLayerImpl {
    ...
    public VectorCrossLayerRouter(String str, IVectorCrossLayer iVectorCrossLayer, String str2, IMapViewImpl iMapViewImpl) {
    ...
    @Override // com.autonavi.gbl.map.layer.impl.VectorCrossLayerImpl, com.autonavi.gbl.map.layer.impl.BaseLayerImpl, com.autonavi.gbl.map.impl.CollisionGroupImpl, com.autonavi.gbl.map.impl.CollisionEntityImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public LayerItemImpl getItem(String str) {
        ...
        try {
            ...
            IVectorCrossLayer iVectorCrossLayer = this.mObserver;
            if (iVectorCrossLayer == null || (item = iVectorCrossLayer.getItem(str)) == null || (typeHelper = this.mHelper) == null) {
                return null;
            }
    ...
    public ArrayList<LayerItemImpl> getAllItems() {
        ...
        try {
            ...
            IVectorCrossLayer iVectorCrossLayer = this.mObserver;
            if (iVectorCrossLayer == null || (allItems = iVectorCrossLayer.getAllItems()) == null || (typeHelper = this.mHelper) == null) {
                return null;
            }
    ...
    public boolean getFocus(String str) {
        IVectorCrossLayer iVectorCrossLayer = this.mObserver;
        if (iVectorCrossLayer != null) {
            return iVectorCrossLayer.getFocus(str);
        }
        return false;
    }
    ...
    public void enableCollision(boolean z) {
        IVectorCrossLayer iVectorCrossLayer = this.mObserver;
        if (iVectorCrossLayer != null) {
            iVectorCrossLayer.enableCollision(z);
        }
    }
    ...
    public void applyItemsOnVisible() {
        IVectorCrossLayer iVectorCrossLayer = this.mObserver;
        if (iVectorCrossLayer != null) {
            iVectorCrossLayer.applyItemsOnVisible();
        }
    }
    ...
    public boolean testIntersect(CollisionItemImpl collisionItemImpl) {
        TypeHelper typeHelper;
        try {
            Method method = VectorCrossLayerRouter.class.getMethod("testIntersect", CollisionItemImpl.class);
            ...
            IVectorCrossLayer iVectorCrossLayer = this.mObserver;
            if (iVectorCrossLayer != null) {
                return iVectorCrossLayer.testIntersect(iCollisionItem);
            }
            return false;
        } catch (Exception e) {
            Log.w("INTFAUTO", Log.getStackTraceString(e));
    ...
    public boolean isCollision() {
        IVectorCrossLayer iVectorCrossLayer = this.mObserver;
        if (iVectorCrossLayer != null) {
            return iVectorCrossLayer.isCollision();
        }
        return false;
    }
    ...
    public void setIntersectThreshold(@IntersectThresholdType.IntersectThresholdType1 int i, float f) {
        IVectorCrossLayer iVectorCrossLayer = this.mObserver;
        if (iVectorCrossLayer != null) {
            iVectorCrossLayer.setIntersectThreshold(i, f);
        }
    }
    ...
    public float getIntersectThreshold(@IntersectThresholdType.IntersectThresholdType1 int i) {
        IVectorCrossLayer iVectorCrossLayer = this.mObserver;
        if (iVectorCrossLayer != null) {
            return iVectorCrossLayer.getIntersectThreshold(i);
        }
        return 0.0f;
    }
    ...
    public void setApplyItemsOnVisible(boolean z) {
        IVectorCrossLayer iVectorCrossLayer = this.mObserver;
        if (iVectorCrossLayer != null) {
            iVectorCrossLayer.setApplyItemsOnVisible(z);
        }
    }
    ...
    public boolean hasAppliedItemsOnVisible() {
        IVectorCrossLayer iVectorCrossLayer = this.mObserver;
        if (iVectorCrossLayer != null) {
            return iVectorCrossLayer.hasAppliedItemsOnVisible();
        }
        return false;
    }
}
