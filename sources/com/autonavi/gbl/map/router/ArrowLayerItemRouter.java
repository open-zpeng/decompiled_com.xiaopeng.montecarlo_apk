...
public class ArrowLayerItemRouter extends ArrowLayerItemImpl {
    ...
    public boolean getClickable() {
        IArrowLayerItem iArrowLayerItem = this.mObserver;
        if (iArrowLayerItem != null) {
            return iArrowLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean getOnVisible() {
        IArrowLayerItem iArrowLayerItem = this.mObserver;
        if (iArrowLayerItem != null) {
            return iArrowLayerItem.getOnVisible();
        }
        return false;
    }
    ...
    public void resetOnVisible(boolean z) {
        IArrowLayerItem iArrowLayerItem = this.mObserver;
        if (iArrowLayerItem != null) {
            iArrowLayerItem.resetOnVisible(z);
        }
    }
    ...
    public void applyOnVisible() {
        IArrowLayerItem iArrowLayerItem = this.mObserver;
        if (iArrowLayerItem != null) {
            iArrowLayerItem.applyOnVisible();
        }
    }
    ...
    public boolean canCollision() {
        IArrowLayerItem iArrowLayerItem = this.mObserver;
        if (iArrowLayerItem != null) {
            return iArrowLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IArrowLayerItem iArrowLayerItem = this.mObserver;
        if (iArrowLayerItem != null) {
            return iArrowLayerItem.canAreaCollision();
        }
        return false;
    }
}
