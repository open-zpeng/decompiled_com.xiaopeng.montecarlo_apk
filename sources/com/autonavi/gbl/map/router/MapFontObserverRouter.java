...
public class MapFontObserverRouter extends IMapFontObserverImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.MapFontObserverRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.MapFontObserverRouter.2
        }));
        super.delete();
        unbind();
    }
