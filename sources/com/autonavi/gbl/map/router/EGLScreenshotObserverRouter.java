...
public class EGLScreenshotObserverRouter extends IEGLScreenshotObserverImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.EGLScreenshotObserverRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.EGLScreenshotObserverRouter.2
        }));
        super.delete();
        unbind();
    }
