...
public class NaviPointLayerItemRouter extends NaviPointLayerItemImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.NaviPointLayerItemRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.NaviPointLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
