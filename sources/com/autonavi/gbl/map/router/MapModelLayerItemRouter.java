...
public class MapModelLayerItemRouter extends MapModelLayerItemImpl {
    ...
    @Override // com.autonavi.gbl.map.layer.impl.MapModelLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public boolean getClickable() {
        IMapModelLayerItem iMapModelLayerItem = this.mObserver;
        if (iMapModelLayerItem != null) {
            return iMapModelLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean getOnVisible() {
        IMapModelLayerItem iMapModelLayerItem = this.mObserver;
        if (iMapModelLayerItem != null) {
            return iMapModelLayerItem.getOnVisible();
        }
        return false;
    }
    ...
    public void resetOnVisible(boolean z) {
        IMapModelLayerItem iMapModelLayerItem = this.mObserver;
        if (iMapModelLayerItem != null) {
            iMapModelLayerItem.resetOnVisible(z);
        }
    }
    ...
    public void applyOnVisible() {
        IMapModelLayerItem iMapModelLayerItem = this.mObserver;
        if (iMapModelLayerItem != null) {
            iMapModelLayerItem.applyOnVisible();
        }
    }
    ...
    public boolean canCollision() {
        IMapModelLayerItem iMapModelLayerItem = this.mObserver;
        if (iMapModelLayerItem != null) {
            return iMapModelLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IMapModelLayerItem iMapModelLayerItem = this.mObserver;
        if (iMapModelLayerItem != null) {
            return iMapModelLayerItem.canAreaCollision();
        }
        return false;
    }
}
