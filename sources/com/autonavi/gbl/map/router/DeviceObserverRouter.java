...
public class DeviceObserverRouter extends IDeviceObserverImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.DeviceObserverRouter.1
        });
    ...
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.DeviceObserverRouter.2
        }));
        super.delete();
        unbind();
    }
