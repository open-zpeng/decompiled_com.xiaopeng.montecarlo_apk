...
public class RouteLayerItemRouter extends RouteLayerItemImpl {
    ...
    public RouteLayerItemRouter(String str, IRouteLayerItem iRouteLayerItem, IMapViewImpl iMapViewImpl) {
        super(iMapViewImpl);
        this.mTargetId = null;
        this.mHelper = null;
        this.mObserver = null;
    ...
    @Override // com.autonavi.gbl.map.layer.impl.RouteLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.CollisionItemImpl, com.autonavi.gbl.map.impl.MixtureSharedBaseImpl
    ...
    public boolean getClickable() {
        IRouteLayerItem iRouteLayerItem = this.mObserver;
        if (iRouteLayerItem != null) {
            return iRouteLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        IRouteLayerItem iRouteLayerItem = this.mObserver;
        if (iRouteLayerItem != null) {
            return iRouteLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IRouteLayerItem iRouteLayerItem = this.mObserver;
        if (iRouteLayerItem != null) {
            return iRouteLayerItem.canAreaCollision();
        }
        return false;
    }
}
