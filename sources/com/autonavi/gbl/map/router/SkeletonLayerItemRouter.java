...
public class SkeletonLayerItemRouter extends SkeletonLayerItemImpl {
    ...
    public SkeletonLayerItemRouter(String str, ISkeletonLayerItem iSkeletonLayerItem, MapViewImpl mapViewImpl) {
        super(mapViewImpl);
        this.mTargetId = null;
        this.mHelper = null;
        this.mObserver = null;
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.SkeletonLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.map.layer.impl.SkeletonLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.SkeletonLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
    ...
    public void getPosition3D(Coord3DDouble coord3DDouble) {
        ISkeletonLayerItem iSkeletonLayerItem = this.mObserver;
        if (iSkeletonLayerItem != null) {
            iSkeletonLayerItem.getPosition3D(coord3DDouble);
        }
    }

    @Override // com.autonavi.gbl.map.layer.impl.SkeletonLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl
    public void onPaint() {
        ISkeletonLayerItem iSkeletonLayerItem = this.mObserver;
        if (iSkeletonLayerItem != null) {
