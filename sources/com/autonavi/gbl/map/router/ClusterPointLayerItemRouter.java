...
public class ClusterPointLayerItemRouter extends ClusterPointLayerItemImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.ClusterPointLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.map.layer.impl.ClusterPointLayerItemImpl, com.autonavi.gbl.map.layer.impl.PointLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.ClusterPointLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
    ...
    public String getTypeCode() {
        IClusterPointLayerItem iClusterPointLayerItem = this.mObserver;
        if (iClusterPointLayerItem != null) {
            return iClusterPointLayerItem.getTypeCode();
        }
        return null;
    }
