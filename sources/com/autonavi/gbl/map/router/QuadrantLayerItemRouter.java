...
@IntfAuto(target = QuadrantLayerItemImpl.class, type = BuildType.JROUTER)
/* loaded from: classes2.dex */
public class QuadrantLayerItemRouter extends QuadrantLayerItem {
    ...
    protected void bindObserver(IQuadrantLayerItem iQuadrantLayerItem) {
        if (iQuadrantLayerItem != null) {
            ...
            if (typeHelper != null) {
                typeHelper.bind(QuadrantLayerItemImpl.class, iQuadrantLayerItem, this);
            }
        }
    }

    private void $constructor(String str, IQuadrantLayerItem iQuadrantLayerItem) {
        this.mTargetId = String.format("router_%s_%s_%d", str, String.valueOf(QuadrantLayerItem.getCPtr((QuadrantLayerItem) this)), Long.valueOf(System.currentTimeMillis()));
    ...
    public String getTypeCode() {
        IQuadrantLayerItem iQuadrantLayerItem = this.mObserver;
        if (iQuadrantLayerItem != null) {
            return iQuadrantLayerItem.getTypeCode();
        }
        return null;
    }
