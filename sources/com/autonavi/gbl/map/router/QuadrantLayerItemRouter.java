...
public class QuadrantLayerItemRouter extends QuadrantLayerItemImpl {
    ...
    public float getIntersectValue(@IntersectValueType.IntersectValueType1 int i) {
        IQuadrantLayerItem iQuadrantLayerItem = this.mObserver;
        if (iQuadrantLayerItem != null) {
            return iQuadrantLayerItem.getIntersectValue(i);
        }
        return 0.0f;
    }
    ...
    public boolean getClickable() {
        IQuadrantLayerItem iQuadrantLayerItem = this.mObserver;
        if (iQuadrantLayerItem != null) {
            return iQuadrantLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean canCollision() {
        IQuadrantLayerItem iQuadrantLayerItem = this.mObserver;
        if (iQuadrantLayerItem != null) {
            return iQuadrantLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IQuadrantLayerItem iQuadrantLayerItem = this.mObserver;
        if (iQuadrantLayerItem != null) {
            return iQuadrantLayerItem.canAreaCollision();
        }
        return false;
    }
}
