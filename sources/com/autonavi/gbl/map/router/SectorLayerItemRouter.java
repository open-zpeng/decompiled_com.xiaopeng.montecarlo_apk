...
public class SectorLayerItemRouter extends SectorLayerItemImpl {
    ...
    protected void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.SectorLayerItemRouter.1
        });
    ...
    @Override // com.autonavi.gbl.map.layer.impl.SectorLayerItemImpl, com.autonavi.gbl.map.layer.impl.LayerItemImpl, com.autonavi.gbl.map.impl.ICollisionItemImpl
    public synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.router.SectorLayerItemRouter.2
        }));
        super.delete();
        unbind();
    }
