...
public class PointLayerItemRouter extends PointLayerItemImpl {
    ...
    public PointLayerItemRouter(String str, IPointLayerItem iPointLayerItem, @PointLayerItemType.PointLayerItemType1 int i) {
        super(i);
        this.mTargetId = null;
        this.mHelper = null;
        this.mObserver = null;
    ...
    public String getPointTypeCode() {
        IPointLayerItem iPointLayerItem = this.mObserver;
        if (iPointLayerItem != null) {
            return iPointLayerItem.getPointTypeCode();
        }
        return null;
    }
    ...
    public float getForeshorteningCoef() {
        IPointLayerItem iPointLayerItem = this.mObserver;
        if (iPointLayerItem != null) {
            return iPointLayerItem.getForeshorteningCoef();
        }
        return 0.0f;
    }
    ...
    public boolean getClickable() {
        IPointLayerItem iPointLayerItem = this.mObserver;
        if (iPointLayerItem != null) {
            return iPointLayerItem.getClickable();
        }
        return false;
    }
    ...
    public boolean getOnVisible() {
        IPointLayerItem iPointLayerItem = this.mObserver;
        if (iPointLayerItem != null) {
            return iPointLayerItem.getOnVisible();
        }
        return false;
    }
    ...
    public void resetOnVisible(boolean z) {
        IPointLayerItem iPointLayerItem = this.mObserver;
        if (iPointLayerItem != null) {
            iPointLayerItem.resetOnVisible(z);
        }
    }
    ...
    public void applyOnVisible() {
        IPointLayerItem iPointLayerItem = this.mObserver;
        if (iPointLayerItem != null) {
            iPointLayerItem.applyOnVisible();
        }
    }
    ...
    public boolean canCollision() {
        IPointLayerItem iPointLayerItem = this.mObserver;
        if (iPointLayerItem != null) {
            return iPointLayerItem.canCollision();
        }
        return false;
    }
    ...
    public boolean canAreaCollision() {
        IPointLayerItem iPointLayerItem = this.mObserver;
        if (iPointLayerItem != null) {
            return iPointLayerItem.canAreaCollision();
        }
        return false;
    }
}
