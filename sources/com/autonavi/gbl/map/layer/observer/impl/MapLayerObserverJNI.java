...
public class MapLayerObserverJNI {
    ...
    public static String SwigDirector_IPrepareLayerStyleImpl_getCommonInfo(IPrepareLayerStyleImpl iPrepareLayerStyleImpl, String str) {
        return iPrepareLayerStyleImpl.getCommonInfo(str);
    }

    public static boolean SwigDirector_IPrepareLayerStyleImpl_switchStyle(IPrepareLayerStyleImpl iPrepareLayerStyleImpl, int i) {
        return iPrepareLayerStyleImpl.switchStyle(i);
    }
}
