...
public class RctRouteLayerItemImpl extends LayerItemImpl {
    ...
    private static native boolean setFlyTmcNative(long j, RctRouteLayerItemImpl rctRouteLayerItemImpl, byte[] bArr, ArrayList<RealCityTmcParam> arrayList);

    private static native boolean setFlyTmcSwigExplicitRctRouteLayerItemImplNative(long j, RctRouteLayerItemImpl rctRouteLayerItemImpl, byte[] bArr, ArrayList<RealCityTmcParam> arrayList);
    ...
    private static native boolean setRctHeadAngleSyncNative(long j, RctRouteLayerItemImpl rctRouteLayerItemImpl, boolean z);

    private static native boolean setRctHeadAngleSyncSwigExplicitRctRouteLayerItemImplNative(long j, RctRouteLayerItemImpl rctRouteLayerItemImpl, boolean z);
    ...
    public boolean setRctHeadAngleSync(boolean z) {
        return $explicit_setRctHeadAngleSync(z);
    }

    public boolean $explicit_setRctHeadAngleSync(boolean z) {
        if (this.swigCPtr != 0) {
            return getClass() == RctRouteLayerItemImpl.class ? setRctHeadAngleSyncNative(this.swigCPtr, this, z) : setRctHeadAngleSyncSwigExplicitRctRouteLayerItemImplNative(this.swigCPtr, this, z);
        }
        throw new NullPointerException();
    }
