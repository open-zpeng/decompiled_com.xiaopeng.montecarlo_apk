...
public class LayerMgrImpl {
    ...
    private static native void lockTapLayersNative(long j, LayerMgrImpl layerMgrImpl);
    ...
    private static native void unLockTapLayersNative(long j, LayerMgrImpl layerMgrImpl);
    ...
    public void lockTapLayers() {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        lockTapLayersNative(j, this);
    }

    public void unLockTapLayers() {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        unLockTapLayersNative(j, this);
    }
}
