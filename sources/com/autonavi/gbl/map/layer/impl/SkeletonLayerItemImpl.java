...
public class SkeletonLayerItemImpl extends LayerItemImpl {
    ...
    private static native void setBinaryDataNative(long j, SkeletonLayerItemImpl skeletonLayerItemImpl, byte[] bArr, int i);

    private static native void setBinaryDataSwigExplicitSkeletonLayerItemImplNative(long j, SkeletonLayerItemImpl skeletonLayerItemImpl, byte[] bArr, int i);
    ...
    public void setBinaryData(byte[] bArr, int i) {
        $explicit_setBinaryData(bArr, i);
    }

    public void $explicit_setBinaryData(byte[] bArr, int i) {
        if (this.swigCPtr == 0) {
            throw new NullPointerException();
        }
        if (getClass() == SkeletonLayerItemImpl.class) {
            setBinaryDataNative(this.swigCPtr, this, bArr, i);
        } else {
            setBinaryDataSwigExplicitSkeletonLayerItemImplNative(this.swigCPtr, this, bArr, i);
        }
    }
