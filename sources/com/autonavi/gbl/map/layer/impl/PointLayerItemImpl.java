...
public class PointLayerItemImpl extends LayerItemImpl {
    ...
    private static native String getTypeCodeNative(long j, PointLayerItemImpl pointLayerItemImpl);

    private static native String getTypeCodeSwigExplicitPointLayerItemImplNative(long j, PointLayerItemImpl pointLayerItemImpl);
    ...
    private static native void setAnimation1Native(long j, PointLayerItemImpl pointLayerItemImpl, int i);

    private static native void setAnimationNative(long j, PointLayerItemImpl pointLayerItemImpl, int i, int i2);

    private static native void setAnimationSwigExplicitPointLayerItemImpl1Native(long j, PointLayerItemImpl pointLayerItemImpl, int i);
    ...
    private static native void setTypeCodeNative(long j, PointLayerItemImpl pointLayerItemImpl, String str);

    private static native void setTypeCodeSwigExplicitPointLayerItemImplNative(long j, PointLayerItemImpl pointLayerItemImpl, String str);
    ...
    public void setTypeCode(String str) {
        $explicit_setTypeCode(str);
    }

    public void $explicit_setTypeCode(String str) {
        if (this.swigCPtr == 0) {
            throw new NullPointerException();
        }
        if (getClass() == PointLayerItemImpl.class) {
            setTypeCodeNative(this.swigCPtr, this, str);
        } else {
            setTypeCodeSwigExplicitPointLayerItemImplNative(this.swigCPtr, this, str);
        }
    }
    ...
    public String $explicit_getTypeCode() {
        if (this.swigCPtr != 0) {
            return getClass() == PointLayerItemImpl.class ? getTypeCodeNative(this.swigCPtr, this) : getTypeCodeSwigExplicitPointLayerItemImplNative(this.swigCPtr, this);
        }
        throw new NullPointerException();
    }
    ...
    public void setAnimation(@LayerItemPoiAnimation.LayerItemPoiAnimation1 int i) {
        $explicit_setAnimation(i);
    }

    public void $explicit_setAnimation(@LayerItemPoiAnimation.LayerItemPoiAnimation1 int i) {
        if (this.swigCPtr == 0) {
            throw new NullPointerException();
        }
        if (getClass() == PointLayerItemImpl.class) {
            setAnimation1Native(this.swigCPtr, this, i);
        } else {
            setAnimationSwigExplicitPointLayerItemImpl1Native(this.swigCPtr, this, i);
        }
    }
