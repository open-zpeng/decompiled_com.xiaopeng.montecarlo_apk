...
public class PointLayerItemImpl extends LayerItemImpl {
    ...
    private static native void resetOnVisibleNative(long j, PointLayerItemImpl pointLayerItemImpl, boolean z);

    private static native void resetOnVisibleSwigExplicitPointLayerItemImplNative(long j, PointLayerItemImpl pointLayerItemImpl, boolean z);
    ...
    public void $explicit_resetOnVisible(boolean z) {
        ...
        if (getClass() == PointLayerItemImpl.class) {
            ...
            resetOnVisibleSwigExplicitPointLayerItemImplNative(this.swigCPtr, this, z);
        }
    }
