...
@IntfAuto(enableCRfx = false, protoOfCRfx = BaseLayerCRfxProto.class, target = RoutePathLayer.class, type = BuildType.CPROXY)
...
public class RoutePathLayerImpl extends BaseLayerImpl {
    ...
    private static native long createNativeObj(String str, String str2, long j, MapViewImpl mapViewImpl);
    ...
    public RoutePathLayerImpl(String str, String str2, MapViewImpl mapViewImpl) {
        this(createNativeObj(str, str2, MapViewImpl.getCPtr(mapViewImpl), mapViewImpl), true);
