...
public class BaseLayerImpl extends CollisionGroupImpl {
    ...
    private static native boolean addCollisionItemNative(long j, BaseLayerImpl baseLayerImpl, long j2, CollisionItemImpl collisionItemImpl);

    private static native boolean addCollisionItemSwigExplicitBaseLayerImplNative(long j, BaseLayerImpl baseLayerImpl, long j2, CollisionItemImpl collisionItemImpl);
    ...
    private static native void applyItemsOnVisibleNative(long j, BaseLayerImpl baseLayerImpl);

    private static native void applyItemsOnVisibleSwigExplicitBaseLayerImplNative(long j, BaseLayerImpl baseLayerImpl);
    ...
    private static native long createNativeObj1(String str, long j, IMapViewImpl iMapViewImpl, int i);
    ...
    private static native boolean getFocusNative(long j, BaseLayerImpl baseLayerImpl, String str);

    private static native boolean getFocusSwigExplicitBaseLayerImplNative(long j, BaseLayerImpl baseLayerImpl, String str);
    ...
    private static native void intersectUINative(long j, BaseLayerImpl baseLayerImpl, ArrayList<UIRectRecord> arrayList);

    private static native void intersectUISwigExplicitBaseLayerImplNative(long j, BaseLayerImpl baseLayerImpl, ArrayList<UIRectRecord> arrayList);

    private static native boolean isEnablePoiFilterNative(long j, BaseLayerImpl baseLayerImpl);

    private static native boolean isEnablePoiFilterSwigExplicitBaseLayerImplNative(long j, BaseLayerImpl baseLayerImpl);

    private static native boolean isItemsCollisionNative(long j, BaseLayerImpl baseLayerImpl);

    private static native boolean isItemsCollisionSwigExplicitBaseLayerImplNative(long j, BaseLayerImpl baseLayerImpl);
    ...
    private static native void resetOverlayTypeNative(long j, BaseLayerImpl baseLayerImpl, int i);

    private static native void restoreVisibleNative(long j, BaseLayerImpl baseLayerImpl);

    private static native void restoreVisibleSwigExplicitBaseLayerImplNative(long j, BaseLayerImpl baseLayerImpl);

    private static native void saveVisibleNative(long j, BaseLayerImpl baseLayerImpl);

    private static native void saveVisibleSwigExplicitBaseLayerImplNative(long j, BaseLayerImpl baseLayerImpl);
    ...
    public BaseLayerImpl(String str, IMapViewImpl iMapViewImpl, @OverlayGeometryType.OverlayGeometryType1 int i) {
        this(createNativeObj1(str, IMapViewImpl.getCPtr(iMapViewImpl), iMapViewImpl, i), true);
        MapLayerSvrJNI.swig_jni_init();
        BaseLayerImpl_director_connect(this, this.swigCPtr, this.swigCMemOwn, true);
    }
    ...
    public void resetOverlayType(int i) {
        $explicit_resetOverlayType(i);
    }

    public void $explicit_resetOverlayType(int i) {
        long j = this.swigCPtr;
        if (j == 0) {
            throw new NullPointerException();
        }
        resetOverlayTypeNative(j, this, i);
    }
}
