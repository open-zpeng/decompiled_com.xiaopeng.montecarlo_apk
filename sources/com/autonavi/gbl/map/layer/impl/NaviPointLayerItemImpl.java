...
public class NaviPointLayerItemImpl extends LayerItemImpl {
    ...
    private static native void setAnimation1Native(long j, NaviPointLayerItemImpl naviPointLayerItemImpl, int i);

    private static native void setAnimationNative(long j, NaviPointLayerItemImpl naviPointLayerItemImpl, int i, int i2);

    private static native void setAnimationSwigExplicitNaviPointLayerItemImpl1Native(long j, NaviPointLayerItemImpl naviPointLayerItemImpl, int i);
    ...
    public void $explicit_setAnimation(@LayerItemPoiAnimation.LayerItemPoiAnimation1 int i) {
        ...
        if (getClass() == NaviPointLayerItemImpl.class) {
            ...
            setAnimationSwigExplicitNaviPointLayerItemImpl1Native(this.swigCPtr, this, i);
        }
    }
