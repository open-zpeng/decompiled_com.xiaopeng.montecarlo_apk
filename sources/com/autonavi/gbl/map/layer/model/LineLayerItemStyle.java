...
public class LineLayerItemStyle implements Serializable {
    ...
    public LineLayerItemStyle(boolean z, boolean z2, boolean z3, boolean z4, boolean z5, int i, LineLayerItemTexture lineLayerItemTexture, LineLayerItemTexture lineLayerItemTexture2, LineTextureInfo lineTextureInfo, LineCapTextureInfo lineCapTextureInfo) {
        this.useCap = z;
        this.useColor = z2;
        this.drawCover = z3;
