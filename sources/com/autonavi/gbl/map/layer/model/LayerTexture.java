...
public class LayerTexture implements Serializable {
    ...
    public LayerTexture(int i, BinaryStream binaryStream, @LayerIconAnchor.LayerIconAnchor1 int i2, long j, long j2, float f, float f2, @LayerIconType.LayerIconType1 int i3, boolean z, boolean z2, int i4, String str, boolean z3) {
        this.resID = i;
