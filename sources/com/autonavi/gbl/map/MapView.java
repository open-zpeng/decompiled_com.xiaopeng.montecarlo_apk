...
public class MapView {
    ...
    public boolean removeMapEventObserver(IMapEventObserver iMapEventObserver) {
        try {
            ...
            MapViewImpl mapViewImpl = this.mControl;
            if (mapViewImpl != null) {
                return mapViewImpl.removeMapEventObserver(r2);
            }
            return false;
        } catch (Exception e) {
            Log.w("INTFAUTO", Log.getStackTraceString(e));
    ...
    public void addReculateOverlayObserver(IReculateOverlay iReculateOverlay) {
        try {
            ...
            if (iReculateOverlay != null) {
                ...
                if (r1 == null) {
                    DebugTool.e("%s: $pIReculateOverlay == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapView.18
                    }));
                }
            }
            MapViewImpl mapViewImpl = this.mControl;
    ...
    public void setTextTextureObserver(ITextTextureObserver iTextTextureObserver) {
        ...
        try {
            ...
            if (iTextTextureObserver != null) {
                ...
                if (r3 == null) {
                    DebugTool.e("%s: $pITextTextureObserver == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapView.20
                    }));
                }
            }
            MapViewImpl mapViewImpl = this.mControl;
    ...
    public void setMapFpsObserver(IMapFpsObserver iMapFpsObserver) {
        try {
            ...
            if (iMapFpsObserver != null) {
                ...
                if (r1 == null) {
                    DebugTool.e("%s: $pIMapFpsObserver == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapView.21
                    }));
                }
            }
            MapViewImpl mapViewImpl = this.mControl;
    ...
    public IBLMapViewProxy getMapViewProxy() {
        ...
        try {
            ...
            if (mapViewImpl != null && (mapViewProxy = mapViewImpl.getMapViewProxy()) != null) {
                ...
                if (r0 == null) {
                    DebugTool.e("%s: $ret == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapView.22
                    }));
                }
            }
            return r0;
        ...
        try {
            ...
            if (iBLMapBusinessDataObserver != null) {
                ...
                if (iBLMapBusinessDataObserverImpl == null) {
                    DebugTool.e("%s: $observer == null", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapView.23
                    }));
                    return null;
                }
            } else {
    ...
    public void flushMapPostureCache(long j, boolean z, long j2) {
        MapViewImpl mapViewImpl = this.mControl;
        if (mapViewImpl != null) {
            mapViewImpl.flushMapPostureCache(j, z, j2);
        }
    }
    ...
    public void unbind() {
        ...
        objArr[0] = ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapView.24
        });
    ...
    protected void clean() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapView.25
        }));
        TypeHelper typeHelper = this.mTypeHelper;
        if (typeHelper != null) {
        ...
        TypeHelper typeHelper2 = this.mTypeHelper;
        if (typeHelper2 != null) {
            Iterator it2 = ((HashSet) typeHelper2.getBindSet("com.autonavi.gbl.map.observer.IMapviewObserver")).iterator();
            while (it2.hasNext()) {
                removeMapviewObserver((IMapviewObserver) it2.next());
            }
        }
        TypeHelper typeHelper3 = this.mTypeHelper;
        if (typeHelper3 != null) {
            Iterator it3 = ((HashSet) typeHelper3.getBindSet("com.autonavi.gbl.map.observer.IReculateOverlay")).iterator();
            while (it3.hasNext()) {
                removeReculateOverlayObserver((IReculateOverlay) it3.next());
            }
        }
    }

    protected synchronized void delete() {
        DebugTool.d("%s", ReflexTool.EMD(new Object() { // from class: com.autonavi.gbl.map.MapView.26
        }));
        if (!this.mHasDestroy) {
            onDestroy();
        }
