...
public class CollisionCombinationImpl extends CollisionEntityImpl {
    ...
    private static native void enableCollisionNative(long j, CollisionCombinationImpl collisionCombinationImpl, boolean z);

    private static native void enableCollisionSwigExplicitCollisionCombinationImplNative(long j, CollisionCombinationImpl collisionCombinationImpl, boolean z);
    ...
    private static native boolean isCollisionNative(long j, CollisionCombinationImpl collisionCombinationImpl);

    private static native boolean isCollisionSwigExplicitCollisionCombinationImplNative(long j, CollisionCombinationImpl collisionCombinationImpl);
    ...
    private static native void onRecoverCollisonItemNative(long j, CollisionCombinationImpl collisionCombinationImpl, long j2, CollisionItemImpl collisionItemImpl);

    private static native void onRecoverCollisonItemSwigExplicitCollisionCombinationImplNative(long j, CollisionCombinationImpl collisionCombinationImpl, long j2, CollisionItemImpl collisionItemImpl);

    private static native void recoverAreaCollisionRecordNative(long j, CollisionCombinationImpl collisionCombinationImpl, long j2, CollisionItemImpl collisionItemImpl, long j3, CollisionCombinationImpl collisionCombinationImpl2);
    ...
    private static native boolean testIntersectNative(long j, CollisionCombinationImpl collisionCombinationImpl, long j2, CollisionItemImpl collisionItemImpl);

    private static native boolean testIntersectSwigExplicitCollisionCombinationImplNative(long j, CollisionCombinationImpl collisionCombinationImpl, long j2, CollisionItemImpl collisionItemImpl);
    ...
    public void $explicit_enableCollision(boolean z) {
        ...
        if (getClass() == CollisionCombinationImpl.class) {
            ...
            enableCollisionSwigExplicitCollisionCombinationImplNative(this.swigCPtr, this, z);
        }
    }
    ...
    public void $explicit_removeCollisionItems(ArrayList<CollisionItemImpl> arrayList) {
        ...
        if (arrayList != null) {
            ...
            for (int i = 0; i < size; i++) {
                jArr2[i] = CollisionItemImpl.getCPtr(arrayList.get(i));
            }
            jArr = jArr2;
        }
        if (getClass() == CollisionCombinationImpl.class) {
    ...
    public void $explicit_recoverAreaCollisionRecord(CollisionItemImpl collisionItemImpl, CollisionCombinationImpl collisionCombinationImpl) {
        ...
        recoverAreaCollisionRecordNative(j, this, CollisionItemImpl.getCPtr(collisionItemImpl), collisionItemImpl, getCPtr(collisionCombinationImpl), collisionCombinationImpl);
    }
