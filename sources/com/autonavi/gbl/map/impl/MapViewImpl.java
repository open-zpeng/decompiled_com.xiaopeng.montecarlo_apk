...
public class MapViewImpl {
    ...
    private static native void flushMapPostureCacheNative(long j, MapViewImpl mapViewImpl, long j2, boolean z, long j3);
    ...
    public RectDouble get3DModelBoundRect(int i) {
        ...
        if (Boolean.valueOf(get3DModelBoundRect(i, rectDouble)) == Boolean.TRUE) {
            return rectDouble;
        }
        return null;
    }
    ...
    public LayerTexture getLayerTexture(int i) {
        ...
        if (Boolean.valueOf(getLayerTexture(i, layerTexture)) == Boolean.TRUE) {
            return layerTexture;
        }
        return null;
    }
    ...
    public int getMapViewStatesOperator(@MapViewStateType.MapViewStateType1 int i) {
        int[] iArr = new int[1];
        if (Boolean.valueOf(getMapViewStatesOperator(i, iArr)) == Boolean.TRUE) {
            return iArr[0];
        }
        return 0;
    }
    ...
    public int getControllerStatesOperator(@MapControllerStatesType.MapControllerStatesType1 int i) {
        int[] iArr = new int[1];
        if (Boolean.valueOf(getControllerStatesOperator(i, iArr)) == Boolean.TRUE) {
            return iArr[0];
        }
        return 0;
    }
    ...
    public MapViewPortParam getMapviewPort() {
        ...
        if (Boolean.valueOf(getMapviewPort(mapViewPortParam)) == Boolean.TRUE) {
    ...
    public void flushMapPostureCache(long j, boolean z, long j2) {
        ...
        flushMapPostureCacheNative(j3, this, j, z, j2);
    }
}
