...
public class CollisionGroupImpl extends CollisionEntityImpl {
    ...
    private static native boolean addCollisionItemNative(long j, CollisionGroupImpl collisionGroupImpl, long j2, CollisionItemImpl collisionItemImpl);

    private static native boolean addCollisionItemSwigExplicitCollisionGroupImplNative(long j, CollisionGroupImpl collisionGroupImpl, long j2, CollisionItemImpl collisionItemImpl);
    ...
    private static native void enableCollisionNative(long j, CollisionGroupImpl collisionGroupImpl, boolean z);

    private static native void enableCollisionSwigExplicitCollisionGroupImplNative(long j, CollisionGroupImpl collisionGroupImpl, boolean z);
    ...
    private static native float getIntersectThresholdNative(long j, CollisionGroupImpl collisionGroupImpl, int i);

    private static native float getIntersectThresholdSwigExplicitCollisionGroupImplNative(long j, CollisionGroupImpl collisionGroupImpl, int i);
    ...
    private static native void intersectUINative(long j, CollisionGroupImpl collisionGroupImpl, ArrayList<UIRectRecord> arrayList);

    private static native void intersectUISwigExplicitCollisionGroupImplNative(long j, CollisionGroupImpl collisionGroupImpl, ArrayList<UIRectRecord> arrayList);
    ...
    private static native boolean isCollisionNative(long j, CollisionGroupImpl collisionGroupImpl);

    private static native boolean isCollisionSwigExplicitCollisionGroupImplNative(long j, CollisionGroupImpl collisionGroupImpl);
    ...
    private static native boolean removeCollisionItemNative(long j, CollisionGroupImpl collisionGroupImpl, long j2, CollisionItemImpl collisionItemImpl);

    private static native boolean removeCollisionItemSwigExplicitCollisionGroupImplNative(long j, CollisionGroupImpl collisionGroupImpl, long j2, CollisionItemImpl collisionItemImpl);
    ...
    private static native void setIntersectThresholdNative(long j, CollisionGroupImpl collisionGroupImpl, int i, float f);

    private static native void setIntersectThresholdSwigExplicitCollisionGroupImplNative(long j, CollisionGroupImpl collisionGroupImpl, int i, float f);

    private static native boolean testIntersectNative(long j, CollisionGroupImpl collisionGroupImpl, long j2, CollisionItemImpl collisionItemImpl);

    private static native boolean testIntersectSwigExplicitCollisionGroupImplNative(long j, CollisionGroupImpl collisionGroupImpl, long j2, CollisionItemImpl collisionItemImpl);
    ...
    public ArrayList<CollisionItemImpl> $explicit_getCollisionItems() {
        ...
        if (collisionItemsNative != null) {
            ...
            for (long j : collisionItemsNative) {
                arrayList.add(new CollisionItemImpl(j, false));
            }
            return arrayList;
        }
        return null;
    ...
    public void $explicit_enableCollision(boolean z) {
        ...
        if (getClass() == CollisionGroupImpl.class) {
            ...
            enableCollisionSwigExplicitCollisionGroupImplNative(this.swigCPtr, this, z);
        }
    }
    ...
    public void setIntersectThreshold(@IntersectThresholdType.IntersectThresholdType1 int i, float f) {
        $explicit_setIntersectThreshold(i, f);
    }

    public void $explicit_setIntersectThreshold(@IntersectThresholdType.IntersectThresholdType1 int i, float f) {
        if (this.swigCPtr == 0) {
            throw new NullPointerException();
        }
        if (getClass() == CollisionGroupImpl.class) {
            setIntersectThresholdNative(this.swigCPtr, this, i, f);
        } else {
            setIntersectThresholdSwigExplicitCollisionGroupImplNative(this.swigCPtr, this, i, f);
        }
    }

    public float getIntersectThreshold(@IntersectThresholdType.IntersectThresholdType1 int i) {
        return $explicit_getIntersectThreshold(i);
    }

    public float $explicit_getIntersectThreshold(@IntersectThresholdType.IntersectThresholdType1 int i) {
        if (this.swigCPtr != 0) {
            return getClass() == CollisionGroupImpl.class ? getIntersectThresholdNative(this.swigCPtr, this, i) : getIntersectThresholdSwigExplicitCollisionGroupImplNative(this.swigCPtr, this, i);
        }
        throw new NullPointerException();
    }
