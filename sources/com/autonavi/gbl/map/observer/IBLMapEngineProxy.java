...
public interface IBLMapEngineProxy {
    default void onMapLogReporter(long j, @ReportType.ReportType1 int i, @ReportCode.ReportCode1 int i2, String str) {
    }

    default void onSendBehaviorLog(long j, String str, String str2, String str3) {
    }

    default void requireMapRender(long j, int i, int i2) {
    }
