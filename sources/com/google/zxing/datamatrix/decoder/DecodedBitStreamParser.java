...
final class DecodedBitStreamParser {
            ...
            if (readBits > 128) {
                if (readBits != 129) {
                    if (readBits <= 229) {
                        ...
                        switch (readBits) {
                            case LocTrafficSignType.LOC_TRAFFIC_SIGN_CARRYING_HAZARDOUS_MATERIAL_PROHIBITED /* 230 */:
                                return Mode.C40_ENCODE;
                            case LocTrafficSignType.LOC_TRAFFIC_SIGN_CUSTOMS /* 231 */:
                                return Mode.BASE256_ENCODE;
                            case LocTrafficSignType.LOC_TRAFFIC_SIGN_NO_PARKING_AREA /* 232 */:
                                sb.append((char) 29);
                                break;
                            case 233:
                            case LocTrafficSignType.LOC_TRAFFIC_SIGN_NO_STOPPING_AREA /* 234 */:
                            case 241:
                                break;
                            case LocTrafficSignType.LOC_TRAFFIC_SIGN_END_OF_NO_STOPPING_ZONE /* 235 */:
                                z = true;
                                break;
                            case LocTrafficSignType.LOC_TRAFFIC_SIGN_MAX_SPEED_LIMIT /* 236 */:
                                sb.append("[)>\u001e05\u001d");
                                sb2.insert(0, "\u001e\u0004");
                                break;
                ...
                if (i != 0) {
                    if (i != 1) {
                        if (i == 2) {
                            ...
                            if (z2) {
                                sb.append((char) (i3 + LocTrafficSignType.LOC_TRAFFIC_SIGN_NO_HONKING));
                                z2 = false;
                                i = 0;
                            } else {
    ...
    private static void parseTwoBytes(int i, int i2, int[] iArr) {
        int i3 = ((i << 8) + i2) - 1;
        int i4 = i3 / LayerPriorityType.LayerPriorityRouteJamLine;
        iArr[0] = i4;
        int i5 = i3 - (i4 * LayerPriorityType.LayerPriorityRouteJamLine);
        int i6 = i5 / 40;
        iArr[1] = i6;
        iArr[2] = i5 - (i6 * 40);
    }
