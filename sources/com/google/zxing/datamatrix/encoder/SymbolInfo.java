...
public class SymbolInfo {
    ...
    static {
        SymbolInfo[] symbolInfoArr = {new SymbolInfo(false, 3, 5, 8, 8, 1), new SymbolInfo(false, 5, 7, 10, 10, 1), new SymbolInfo(true, 5, 7, 16, 6, 1), new SymbolInfo(false, 8, 10, 12, 12, 1), new SymbolInfo(true, 10, 11, 14, 6, 2), new SymbolInfo(false, 12, 12, 14, 14, 1), new SymbolInfo(true, 16, 14, 24, 10, 1), new SymbolInfo(false, 18, 14, 16, 16, 1), new SymbolInfo(false, 22, 18, 18, 18, 1), new SymbolInfo(true, 22, 18, 16, 10, 2), new SymbolInfo(false, 30, 20, 20, 20, 1), new SymbolInfo(true, 32, 24, 16, 14, 2), new SymbolInfo(false, 36, 24, 22, 22, 1), new SymbolInfo(false, 44, 28, 24, 24, 1), new SymbolInfo(true, 49, 28, 22, 14, 2), new SymbolInfo(false, 62, 36, 14, 14, 4), new SymbolInfo(false, 86, 42, 16, 16, 4), new SymbolInfo(false, 114, 48, 18, 18, 4), new SymbolInfo(false, 144, 56, 20, 20, 4), new SymbolInfo(false, Opcodes.FRETURN, 68, 22, 22, 4), new SymbolInfo(false, 204, 84, 24, 24, 4, 102, 42), new SymbolInfo(false, 280, 112, 14, 14, 16, 140, 56), new SymbolInfo(false, MarkUtils.MARKER_ID_FAVOURITE_FOCUS, 144, 16, 16, 16, 92, 36), new SymbolInfo(false, 456, 192, 18, 18, 16, 114, 48), new SymbolInfo(false, 576, LocTrafficSignType.LOC_TRAFFIC_SIGN_NO_HONKING, 20, 20, 16, 144, 56), new SymbolInfo(false, 696, 272, 22, 22, 16, Opcodes.FRETURN, 68), new SymbolInfo(false, 816, LocTrafficSignType.LOC_TRAFFIC_SIGN_CARRIAGEWAY, 24, 24, 16, 136, 56), new SymbolInfo(false, BLParams.ACCIDENT, SpeechNaviEvent.SPEECH_MAP_MODE_HEAD_UP_2D, 18, 18, 36, Opcodes.DRETURN, 68), new SymbolInfo(false, IpcConfig.OTAConfig.SHOW_OTA_DETAIL, MarkUtils.MARKER_ID_ROUTE_CHARGE_FOCUS_LAST_REACHABLE, 20, 20, 36, 163, 62), new DataMatrixSymbolInfo144()};
