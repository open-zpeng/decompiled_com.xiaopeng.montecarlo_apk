        ...
        try {
            ...
            if ((map != null && map.containsKey(DecodeHintType.TRY_HARDER)) && binaryBitmap.isRotateSupported()) {
                ...
                if (resultMetadata != null && resultMetadata.containsKey(ResultMetadataType.ORIENTATION)) {
                    i = (((Integer) resultMetadata.get(ResultMetadataType.ORIENTATION)).intValue() + VerticalSeekBar.ROTATION_ANGLE_CW_270) % MarkUtils.MARKER_ID_BUBBLE_VIA_CHARGE;
                }
            ...
            try {
                ...
                while (i13 < 2) {
                    ...
                    try {
                        ...
                        if (i13 == i6) {
                            try {
                                decodeRow.putMetadata(ResultMetadataType.ORIENTATION, Integer.valueOf((int) Opcodes.GETFIELD));
