...
public abstract class AbstractMessage extends AbstractMessageLite implements Message {
    ...
    protected static int hashBoolean(boolean z) {
        if (z) {
            return RangeType.RANGETYPE_CAMERA_SPEED_PROMPT;
        }
        return 1237;
    }
    ...
    public int hashCode() {
        ...
        if (i == 0) {
            int hashFields = (hashFields(BLParams.RouteOverlayRangeOnMap + getDescriptorForType().hashCode(), getAllFields()) * 29) + getUnknownFields().hashCode();
    ...
    private static Map convertMapEntryListToMap(List list) {
        ...
        Descriptors.FieldDescriptor findFieldByName = descriptorForType.findFieldByName(CacheEntity.KEY);
    ...
    public static abstract class Builder<BuilderType extends Builder<BuilderType>> extends AbstractMessageLite.Builder implements Message.Builder {
        ...
        public BuilderType mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            if (getDescriptorForType().getFile().getSyntax() == Descriptors.FileDescriptor.Syntax.PROTO3) {
                shouldDiscardUnknownFields = codedInputStream.shouldDiscardUnknownFieldsProto3();
            } else {
                shouldDiscardUnknownFields = codedInputStream.shouldDiscardUnknownFields();
            }
            UnknownFieldSet.Builder newBuilder = shouldDiscardUnknownFields ? null : UnknownFieldSet.newBuilder(getUnknownFields());
            do {
