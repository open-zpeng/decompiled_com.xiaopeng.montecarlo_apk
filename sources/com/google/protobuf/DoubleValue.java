...
public final class DoubleValue extends GeneratedMessageV3 implements DoubleValueOrBuilder {
    ...
    public int hashCode() {
        ...
        int hashCode = ((((((BLParams.RouteOverlayRangeOnMap + getDescriptor().hashCode()) * 37) + 1) * 53) + Internal.hashLong(Double.doubleToLongBits(getValue()))) * 29) + this.unknownFields.hashCode();
