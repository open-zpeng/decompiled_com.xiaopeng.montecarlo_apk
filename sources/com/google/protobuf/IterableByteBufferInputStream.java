...
public class IterableByteBufferInputStream extends InputStream {
    ...
    public int read() throws IOException {
        ...
        if (this.hasArray) {
            int i = this.currentArray[this.currentByteBufferPos + this.currentArrayOffset] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
            updateCurrentByteBufferPos(1);
            return i;
        }
        int i2 = UnsafeUtil.getByte(this.currentByteBufferPos + this.currentAddress) & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR;
        updateCurrentByteBufferPos(1);
        return i2;
    }
