...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        protected void copyOnWrite() {
            if (this.isBuilt) {
                super.copyOnWrite();
                ((ExtendableMessage) this.instance).extensions = ((ExtendableMessage) this.instance).extensions.m67clone();
            }
        }
        ...
        private FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable() {
            ...
            if (fieldSet.isImmutable()) {
                FieldSet<ExtensionDescriptor> m67clone = fieldSet.m67clone();
                ((ExtendableMessage) this.instance).extensions = m67clone;
                return m67clone;
            }
            return fieldSet;
        }
    ...
    protected static class DefaultInstanceBasedParser<T extends GeneratedMessageLite<T, ?>> extends AbstractParser<T> {
        ...
        public T parsePartialFrom(byte[] bArr) throws InvalidProtocolBufferException {
            return (T) GeneratedMessageLite.parsePartialFrom(this.defaultInstance, bArr);
        }
    }
    ...
    static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t, byte[] bArr) throws InvalidProtocolBufferException {
        return (T) parsePartialFrom(t, bArr, ExtensionRegistryLite.getEmptyRegistry());
    }
