    ...
    public static final class ArrayDecoder extends CodedInputStream {
        ...
        */
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            byte[] bArr = this.buffer;
            this.pos = i + 4;
            return ((bArr[i + 3] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 24) | (bArr[i] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) | ((bArr[i + 1] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) | ((bArr[i + 2] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 16);
        }
    ...
    public static final class UnsafeDirectNioDecoder extends CodedInputStream {
        ...
        */
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.limit != j5) {
                ...
                if (b >= 0) {
                    ...
                    long j7 = j6 + 1;
                    int i2 = b ^ (UnsafeUtil.getByte(j6) << 7);
                    if (i2 >= 0) {
                        j = j7 + 1;
                        int i3 = i2 ^ (UnsafeUtil.getByte(j7) << MqttWireMessage.MESSAGE_TYPE_DISCONNECT);
                        if (i3 >= 0) {
                            j2 = i3 ^ 16256;
                        } else {
                            j7 = j + 1;
                            ...
                            if (i4 < 0) {
                                ...
                                if (j8 >= 0) {
                                    ...
                                    long j9 = j + 1;
                                    long j10 = j8 ^ (UnsafeUtil.getByte(j) << 35);
                                    if (j10 < 0) {
                                        j3 = -34093383808L;
                                    } else {
                                        j = j9 + 1;
                                        ...
                                        if (j8 >= 0) {
                                            ...
                                            j9 = j + 1;
                                            j10 = j8 ^ (UnsafeUtil.getByte(j) << 49);
                                            if (j10 < 0) {
                                                j3 = -558586000294016L;
                                            } else {
                                                j = j9 + 1;
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            this.pos = 4 + j;
            return ((UnsafeUtil.getByte(j + 3) & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 24) | (UnsafeUtil.getByte(j) & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) | ((UnsafeUtil.getByte(1 + j) & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) | ((UnsafeUtil.getByte(2 + j) & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 16);
        }
        ...
        */
        ...
        private ByteString readBytesSlowPath(int i) throws IOException {
            ...
            for (byte[] bArr : readRawBytesSlowPathRemainingChunks) {
                arrayList.add(ByteString.wrap(bArr));
            }
    ...
    public static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        */
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            return (readRawByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) | ((readRawByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8) | ((readRawByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 16) | ((readRawByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 24);
        }
