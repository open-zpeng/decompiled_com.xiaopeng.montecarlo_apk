...
public final class Utf8 {
        ...
        final void encodeUtf8Default(CharSequence charSequence, ByteBuffer byteBuffer) {
            ...
            while (i < length) {
                ...
                if (charAt2 < 128) {
                    ...
                    int i3 = position + 1;
                    byteBuffer.put(position, (byte) ((charAt2 >>> '\f') | LocTrafficSignType.LOC_TRAFFIC_SIGN_NO_HONKING));
                    position = i3 + 1;
                    ...
                    if (i4 != length) {
                        try {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                int i5 = position + 1;
                                try {
                                    byteBuffer.put(position, (byte) ((codePoint >>> 18) | RouteChargeDecorator.TYPE_SELECTED_KEEPER));
                                    int i6 = i5 + 1;
        ...
        int encodeUtf8(CharSequence charSequence, byte[] bArr, int i, int i2) {
            ...
            while (i4 < length) {
                ...
                if (charAt2 < c && j4 < j5) {
                    ...
                    if (j4 <= j5 - 4) {
                        ...
                        if (i5 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                int codePoint = Character.toCodePoint(charAt2, charAt3);
                                long j10 = j4 + 1;
                                UnsafeUtil.putByte(bArr, j4, (byte) ((codePoint >>> 18) | RouteChargeDecorator.TYPE_SELECTED_KEEPER));
                                long j11 = j10 + 1;
                                c2 = 128;
                    ...
                    long j13 = j4 + j;
                    UnsafeUtil.putByte(bArr, j4, (byte) ((charAt2 >>> '\f') | MarkUtils.MARKER_ID_BLOCK_EVENT));
                    long j14 = j13 + j;
            ...
            while (i3 < length) {
                ...
                if (charAt2 >= c || position >= limit) {
                    if (charAt2 >= 2048 || position > limit - 2) {
                            ...
                            if (position <= limit - 4) {
                                ...
                                if (i2 != length) {
                                    ...
                                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                                        ...
                                        j2 = limit;
                                        long j3 = position + 1;
                                        UnsafeUtil.putByte(position, (byte) ((codePoint >>> 18) | RouteChargeDecorator.TYPE_SELECTED_KEEPER));
                                        long j4 = j3 + 1;
                                        c2 = 128;
                        ...
                        long j6 = position + 1;
                        UnsafeUtil.putByte(position, (byte) ((charAt2 >>> '\f') | MarkUtils.MARKER_ID_BLOCK_EVENT));
                        long j7 = j6 + 1;
    ...
    public static class DecodeUtil {
        ...
        private static char lowSurrogate(int i) {
            return (char) ((i & MapModelDtoConstants.MAP_PARAMETERNAME_PROCESS_ROADARROW) + 56320);
        }
