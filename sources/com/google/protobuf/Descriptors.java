...
public final class Descriptors {
    ...
    public static final class Descriptor extends GenericDescriptor {
        ...
        Descriptor(String str) throws DescriptorValidationException {
            ...
            this.index = 0;
            this.proto = DescriptorProtos.DescriptorProto.newBuilder().setName(str3).addExtensionRange(DescriptorProtos.DescriptorProto.ExtensionRange.newBuilder().setStart(1).setEnd(LocFuncSwitch.LocFuncPatchFrameForFeiGeG8G9).build()).build();
            this.fullName = str;
    ...
    public static final class EnumValueDescriptor extends GenericDescriptor implements Internal.EnumLite {
        ...
        private EnumValueDescriptor(FileDescriptor fileDescriptor, EnumDescriptor enumDescriptor, Integer num) {
            DescriptorProtos.EnumValueDescriptorProto build = DescriptorProtos.EnumValueDescriptorProto.newBuilder().setName("UNKNOWN_ENUM_VALUE_" + enumDescriptor.getName() + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT + num).setNumber(num.intValue()).build();
            this.index = -1;
            this.proto = build;
            this.file = fileDescriptor;
            this.type = enumDescriptor;
