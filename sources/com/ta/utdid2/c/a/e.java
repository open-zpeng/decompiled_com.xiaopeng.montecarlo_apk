...
class e {
    ...
    public static final HashMap m102a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m103a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
        ...
        if (!name.equals("null")) {
            if (name.equals(TypedValues.Custom.S_STRING)) {
                ...
                if (name.equals(TypedValues.Custom.S_FLOAT)) {
                    ...
                    xmlPullParser.next();
                    int[] m103a = m103a(xmlPullParser, "int-array", strArr);
                    strArr[0] = attributeValue;
                    return m103a;
                } else if (name.equals("map")) {
                    xmlPullParser.next();
                    HashMap m102a = m102a(xmlPullParser, "map", strArr);
                    strArr[0] = attributeValue;
                    return m102a;
