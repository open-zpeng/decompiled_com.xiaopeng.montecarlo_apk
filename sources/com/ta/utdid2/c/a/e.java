...
class e {
    ...
    public static final HashMap m82a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m83a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
        ...
        if (!name.equals("null")) {
            if (name.equals(TypedValues.Custom.S_STRING)) {
                ...
                if (name.equals(TypedValues.Custom.S_FLOAT)) {
                    ...
                    xmlPullParser.next();
                    int[] m83a = m83a(xmlPullParser, "int-array", strArr);
                    strArr[0] = attributeValue;
                    return m83a;
                } else if (name.equals("map")) {
                    xmlPullParser.next();
                    HashMap m82a = m82a(xmlPullParser, "map", strArr);
                    strArr[0] = attributeValue;
                    return m82a;
