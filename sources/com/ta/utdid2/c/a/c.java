...
public class c {
    ...
    */
    ...
    private d a(String str) {
        File m98a = m98a(str);
        if (m98a != null) {
            this.f192a = new d(m98a.getAbsolutePath());
            return this.f192a;
        }
        return null;
    }
    ...
    public void putString(String str, String str2) {
        if (i.m96a(str) || str.equals(HttpConst.XP_CLIENT_PARAMETER_T)) {
            return;
        }
        c();
    ...
    */
    public boolean commit() {
        ...
        L37:
            ...
            r2.printStackTrace()
        L3b:
            boolean r2 = com.ta.utdid2.b.a.i.m96a(r1)
            if (r2 != 0) goto La4
