...
public class c {
    ...
    */
    ...
    private d a(String str) {
        File m78a = m78a(str);
        if (m78a != null) {
            this.f149a = new d(m78a.getAbsolutePath());
            return this.f149a;
        }
        return null;
    }
    ...
    public void putString(String str, String str2) {
        if (i.m76a(str) || str.equals(HttpConst.XP_CLIENT_PARAMETER_T)) {
            return;
        }
        c();
    ...
    */
    public boolean commit() {
        ...
        L38:
            ...
            r2.printStackTrace()
        L3c:
            boolean r2 = com.ta.utdid2.b.a.i.m76a(r1)
            if (r2 != 0) goto La5
