...
public class c {
    ...
    */
    ...
    private d a(String str) {
        File m99a = m99a(str);
        if (m99a != null) {
            this.f192a = new d(m99a.getAbsolutePath());
            return this.f192a;
        }
        return null;
    }
    ...
    public void putString(String str, String str2) {
        if (i.m97a(str) || str.equals(HttpConst.XP_CLIENT_PARAMETER_T)) {
            return;
        }
        c();
    ...
    */
    public boolean commit() {
        ...
        L37:
            ...
            r2.printStackTrace()
        L3b:
            boolean r2 = com.ta.utdid2.b.a.i.m97a(r1)
            if (r2 != 0) goto La4
