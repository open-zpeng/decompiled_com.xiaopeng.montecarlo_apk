...
public class a {
    ...
    public static String e(String str, String str2) {
        try {
            return new String(b(m95a(str.getBytes()), a(str2)));
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    private static byte[] m95a(byte[] bArr) throws Exception {
