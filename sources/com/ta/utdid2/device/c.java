...
public class c {
    ...
    private void d() {
        ...
        if (cVar != null) {
            if (i.m76a(cVar.getString("UTDID2"))) {
            ...
            boolean z = false;
            if (!i.m76a(this.b.getString("DID"))) {
                this.b.remove("DID");
                z = true;
            }
            if (!i.m76a(this.b.getString("EI"))) {
                this.b.remove("EI");
                z = true;
            }
            if (!i.m76a(this.b.getString("SI"))) {
                this.b.remove("SI");
                z = true;
            }
            if (z) {
    ...
    private void f(String str) {
        ...
        if (b(str)) {
            if (str.endsWith(FDManager.LINE_SEPERATOR)) {
    ...
    private String g() {
        ...
        if (cVar != null) {
            ...
            if (i.m76a(string) || this.f154a.a(string) == null) {
                return null;
            }
            return string;
        }
