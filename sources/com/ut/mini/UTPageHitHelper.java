...
public class UTPageHitHelper {
    ...
    private String m84a(Object obj) {
        String simpleName;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized boolean m87a(Object obj) {
        if (obj != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized void m86a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
            if (a2.getPageStatus() != null) {
                a2.setH5Called();
    ...
    private synchronized UTPageEventObject a(Object obj) {
        String m84a = m84a(obj);
        if (this.A.containsKey(m84a)) {
            return this.A.get(m84a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m84a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m84a);
    ...
    private synchronized void m85b(Object obj) {
        String m84a = m84a(obj);
        if (this.A.containsKey(m84a)) {
            this.A.remove(m84a);
        }
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m84a = m84a(obj);
            if (m84a != null && m84a.equals(this.ah)) {
                return;
            }
            if (this.ah != null) {
