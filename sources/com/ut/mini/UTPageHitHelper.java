...
public class UTPageHitHelper {
    ...
    private String m105a(Object obj) {
        String simpleName;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized boolean m108a(Object obj) {
        if (obj != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized void m107a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
            if (a2.getPageStatus() != null) {
                a2.setH5Called();
    ...
    private synchronized UTPageEventObject a(Object obj) {
        String m105a = m105a(obj);
        if (this.A.containsKey(m105a)) {
            return this.A.get(m105a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m105a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m105a);
    ...
    private synchronized void m106b(Object obj) {
        String m105a = m105a(obj);
        if (this.A.containsKey(m105a)) {
            this.A.remove(m105a);
        }
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m105a = m105a(obj);
            if (m105a != null && m105a.equals(this.al)) {
                return;
            }
            if (this.al != null) {
