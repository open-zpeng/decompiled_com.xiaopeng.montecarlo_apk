...
public class UTPageHitHelper {
    ...
    private String m104a(Object obj) {
        String simpleName;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized boolean m107a(Object obj) {
        if (obj != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized void m106a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
            if (a2.getPageStatus() != null) {
                a2.setH5Called();
    ...
    private synchronized UTPageEventObject a(Object obj) {
        String m104a = m104a(obj);
        if (this.A.containsKey(m104a)) {
            return this.A.get(m104a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m104a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m104a);
    ...
    private synchronized void m105b(Object obj) {
        String m104a = m104a(obj);
        if (this.A.containsKey(m104a)) {
            this.A.remove(m104a);
        }
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m104a = m104a(obj);
            if (m104a != null && m104a.equals(this.al)) {
                return;
            }
            if (this.al != null) {
