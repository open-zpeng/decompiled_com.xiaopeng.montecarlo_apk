...
public class VuiFloatingLayerManager {
    ...
    public static void show(@NonNull View view, boolean z) {
    ...
    public static void show(@NonNull View view, int i, int i2) {
        show(view, 0, i, i2);
    }

    public static void show(@NonNull View view, int i, int i2, int i3) {
        show(view, i, i2, i3, true);
    }

    public static void show(@NonNull final View view, final int i, final int i2, final int i3, boolean z) {
