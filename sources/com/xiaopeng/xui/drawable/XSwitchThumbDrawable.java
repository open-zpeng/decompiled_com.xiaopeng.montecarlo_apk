...
public class XSwitchThumbDrawable extends Drawable {
    ...
    public void inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        this.mIndicatorColors = obtainAttributes.getColorStateList(R.styleable.XSwitchThumbDrawable_switch_thumb_indicator_color);
        ...
        this.mThumbColors = obtainAttributes.getColorStateList(R.styleable.XSwitchThumbDrawable_switch_thumb_color);
