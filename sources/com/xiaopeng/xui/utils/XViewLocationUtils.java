...
public class XViewLocationUtils {
    ...
    public static void scrollByLocation(@NonNull View view, @NonNull OnCorrectionLocationListener onCorrectionLocationListener) {
    ...
    public static void scrollByLocation(@NonNull final ViewGroup viewGroup, @NonNull final View view, @NonNull final OnCorrectionLocationListener onCorrectionLocationListener) {
