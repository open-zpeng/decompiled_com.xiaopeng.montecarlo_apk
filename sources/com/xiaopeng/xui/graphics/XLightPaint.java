...
public class XLightPaint {
    ...
    public void setBrightness(@IntRange(from = 0, to = 255) int i) {
        this.mBrightness = i;
    }
    ...
    public void setLightStrength(@FloatRange(from = 0.0d, to = 1.0d) float f) {
    ...
    public void apply() {
        ...
        if (i > 0) {
            int i2 = (int) (f2 * i);
            this.mLightingColorFilter = new LightingColorFilter(-1, Color.argb(this.mLightAlpha, i2, i2, i2));
            this.mPaint.setColorFilter(this.mLightingColorFilter);
        }
        int i3 = this.mLightType;
        if (i3 == 0) {
            if (f3 > 0.0f) {
                this.mBlurMaskFilter = new BlurMaskFilter(f3, BlurMaskFilter.Blur.SOLID);
