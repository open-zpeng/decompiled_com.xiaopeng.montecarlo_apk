...
public class XRelativeLayout extends RelativeLayout implements VuiView {
    ...
    public XRelativeLayout(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public XRelativeLayout(Context context, @Nullable AttributeSet attributeSet, int i) {
