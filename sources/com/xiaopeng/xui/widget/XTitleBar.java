...
public class XTitleBar extends XLinearLayout implements View.OnClickListener, IVuiElementListener {
    ...
    private void addActionWithIcon(@DrawableRes int... iArr) {
        if (iArr != null) {
    ...
    private void addActionWithButton(@NonNull CharSequence... charSequenceArr) {
    ...
    public void setActionWithIcon(@DrawableRes int i, @DrawableRes int i2) {
        this.mRightContainer.removeAllViews();
        ...
        try {
            if (this.mBtnBack != null) {
                if (this.mBtnBack.getVisibility() != 0) {
                    ...
                    jSONObject.put("generalAct", VuiConstants.GENERALACT_RETURN);
            ...
            if (this.mBtnClose != null) {
                ...
                jSONObject2.put("generalAct", VuiConstants.GENERALACT_CLOSE);
