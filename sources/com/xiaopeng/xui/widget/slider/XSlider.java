...
public class XSlider extends AbsSlider {
    ...
    private float calculateIndicatorFromTouch(@NonNull MotionEvent motionEvent) {
    ...
    public /* synthetic */ void lambda$setCurrentIndex$0$XSlider(int i, boolean z) {
        ...
        this.mProgressViewLength = ((((float) (i - this.startIndex)) / ((float) (this.endIndex - this.startIndex))) * ((float) this.workableTotalLength)) + 16.0f;
        this.indicatorValue = (float) (i - this.startIndex);
        invalidate();
        notifyChildren(false, false);
        this.currentUpdateIndex = (float) i;
