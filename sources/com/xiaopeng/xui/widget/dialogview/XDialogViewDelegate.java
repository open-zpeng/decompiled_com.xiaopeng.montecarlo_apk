...
public abstract class XDialogViewDelegate {
    ...
    public static XDialogViewDelegate create(XDialogView xDialogView, @NonNull Context context, int i) {
        return new XDialogViewDelegateImpl(xDialogView, context, i);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public XDialogViewDelegate(XDialogView xDialogView, @NonNull Context context, int i) {
