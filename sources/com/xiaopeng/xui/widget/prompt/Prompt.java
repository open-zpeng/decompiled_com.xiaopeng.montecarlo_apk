...
public abstract class Prompt {
    ...
    @UiThread
    public void show(@NonNull CharSequence charSequence, @DrawableRes int i, String str) {
        show(charSequence, i, str, 1);
    }

    @UiThread
    public void show(@NonNull CharSequence charSequence, @DrawableRes int i, String str, int i2) {
        show(new XPromptMessage(i2, charSequence, i, str));
    }

    @UiThread
    public void show(@NonNull CharSequence charSequence, CharSequence charSequence2, String str) {
        show(charSequence, charSequence2, str, 1);
    }

    @UiThread
    public void show(@NonNull CharSequence charSequence, CharSequence charSequence2, String str, int i) {
        show(new XPromptMessage(i, charSequence, charSequence2, str));
    }

    @UiThread
    public void show(@NonNull XPromptMessage xPromptMessage) {
