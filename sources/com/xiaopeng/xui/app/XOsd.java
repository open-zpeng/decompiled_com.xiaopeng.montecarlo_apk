...
public class XOsd {
    ...
    public static void showOsd(@NonNull CharSequence charSequence, Icon icon, int i, int i2, int i3) {
        showOsd(charSequence, null, null, icon, null, i, i2, i3);
    }

    public static void showOsd(@NonNull CharSequence charSequence, Icon icon, CharSequence charSequence2) {
        showOsd(charSequence, null, null, icon, charSequence2, 0, 0, 0);
    }

    public static void showOsd(@NonNull CharSequence charSequence, Icon icon, Icon icon2, Icon icon3, CharSequence charSequence2) {
        showOsd(charSequence, icon, icon2, icon3, charSequence2, 0, 0, 0);
    }

    public static void showOsd(@NonNull CharSequence charSequence, Icon icon, Icon icon2, Icon icon3, CharSequence charSequence2, int i, int i2, int i3) {
        showOsd(charSequence, icon, icon2, icon3, charSequence2, i, i2, i3, -1);
    }

    public static void showOsd(@NonNull CharSequence charSequence, Icon icon, Icon icon2, Icon icon3, CharSequence charSequence2, int i, int i2, int i3, int i4) {
