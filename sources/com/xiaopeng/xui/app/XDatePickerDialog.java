...
public class XDatePickerDialog extends XDialog implements XDatePicker.OnDateChangedListener, XDialogInterface.OnClickListener {
    ...
    public XDatePickerDialog(@NonNull Context context, @StyleRes int i) {
        this(context, i, null, Calendar.getInstance(), -1, -1, -1);
    }

    public XDatePickerDialog(@NonNull Context context, @Nullable OnXDateSetListener onXDateSetListener, int i, int i2, int i3) {
        this(context, R.style.XDialogView_Large, onXDateSetListener, null, i, i2, i3);
    }

    public XDatePickerDialog(@NonNull Context context, @StyleRes int i, @Nullable OnXDateSetListener onXDateSetListener, int i2, int i3, int i4) {
        this(context, i, onXDateSetListener, null, i2, i3, i4);
    }

    private XDatePickerDialog(@NonNull Context context, @StyleRes int i, @Nullable OnXDateSetListener onXDateSetListener, @Nullable Calendar calendar, int i2, int i3, int i4) {
