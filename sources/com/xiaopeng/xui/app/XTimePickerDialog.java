...
public class XTimePickerDialog extends XDialog implements XTimePicker.OnTimeChangedListener, XDialogInterface.OnClickListener {
    ...
    public XTimePickerDialog(@NonNull Context context, @Nullable OnXTimeSetListener onXTimeSetListener, int i, int i2) {
        this(context, 0, onXTimeSetListener, i, i2);
    }

    public XTimePickerDialog(@NonNull Context context, @StyleRes int i, @Nullable OnXTimeSetListener onXTimeSetListener, int i2, int i3) {
