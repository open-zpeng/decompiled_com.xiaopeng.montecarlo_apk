...
public class XToast {
    ...
    public static void showAt(@StringRes int i, int i2) {
    ...
    public static void showLong(@StringRes int i, int i2) {
    ...
    public static void showLonger(@StringRes int i) {
        showLonger(Xui.getContext().getText(i));
    }

    public static void showLonger(@StringRes int i, int i2) {
    ...
    public static void show(CharSequence charSequence, int i, int i2, @DrawableRes int i3) {
