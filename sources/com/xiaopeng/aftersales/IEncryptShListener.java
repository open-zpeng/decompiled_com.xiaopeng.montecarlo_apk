...
public interface IEncryptShListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IEncryptShListener {
        ...
        public static IEncryptShListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IEncryptShListener)) {
                return (IEncryptShListener) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onEncryptShResponse(parcel.readInt(), parcel.readString(), parcel.readString(), parcel.readInt() != 0);
                return true;
