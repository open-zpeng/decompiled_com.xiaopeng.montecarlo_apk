...
public interface IAuthModeListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAuthModeListener {
        ...
        public static IAuthModeListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IAuthModeListener)) {
                return (IAuthModeListener) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onAuthModeChanged(parcel.readInt() != 0, parcel.readInt());
                return true;
