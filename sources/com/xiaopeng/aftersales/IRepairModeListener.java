...
public interface IRepairModeListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRepairModeListener {
        ...
        public static IRepairModeListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IRepairModeListener)) {
                return (IRepairModeListener) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onRepairModeChanged(parcel.readInt() != 0, parcel.readInt());
                return true;
