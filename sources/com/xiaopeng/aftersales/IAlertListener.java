...
public interface IAlertListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAlertListener {
        ...
        public static IAlertListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IAlertListener)) {
                return (IAlertListener) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                alertDiagnosisError(parcel.readInt(), parcel.readInt(), parcel.readLong(), parcel.readString());
                return true;
