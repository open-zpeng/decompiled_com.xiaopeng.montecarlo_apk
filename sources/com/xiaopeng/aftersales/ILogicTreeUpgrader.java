...
public interface ILogicTreeUpgrader extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILogicTreeUpgrader {
        ...
        public static ILogicTreeUpgrader asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof ILogicTreeUpgrader)) {
                return (ILogicTreeUpgrader) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onUpgradeStatus(parcel.readInt() != 0);
                return true;
