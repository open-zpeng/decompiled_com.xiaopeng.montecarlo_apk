...
public class CounterImpl implements ICounter, Handler.Callback {
    ...
    public CounterImpl(Context context, String str, long j) {
        ...
        this.mTime = new AtomicLong(this.mPreferences.getLong(generatePrefKey("time"), System.currentTimeMillis()));
    ...
    private void initValuesFromPref() {
        ...
        for (String str : all.keySet()) {
            ...
            if (!TextUtils.isEmpty(generateKeyFromPrefKey) && !generateKeyFromPrefKey.equals("time")) {
    ...
    public synchronized int count(String str, int i) {
        ...
        if (this.mDebug) {
            LogUtils.v(TAG, "count " + this.mName + " " + str + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + i3 + ", cache is:" + this.mCountMap);
        }
        boolean z = true;
    ...
    private String generatePrefKey(String str) {
        return this.mName + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT + str;
    }
    ...
    private String generateKeyFromPrefKey(String str) {
        ...
        String str2 = this.mName + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT;
    ...
    private void report(boolean z) {
        ...
        this.mEditor.putLong(generatePrefKey("time"), currentTimeMillis);
    }
}
