...
public class DataBackupHelper {
    ...
    private File createNewFile(String str, Context context) {
        String formatDate10 = DateUtils.formatDate10(System.currentTimeMillis());
        return new File(DATA_FILE_DIR + str + MqttTopic.TOPIC_LEVEL_SEPARATOR + context.getPackageName() + MqttTopic.TOPIC_LEVEL_SEPARATOR + str + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT + formatDate10 + ".log");
    }
