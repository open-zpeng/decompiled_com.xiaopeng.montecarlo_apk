...
public class NaviEvent {
    ...
    public static final String CONTROL_BRIDGE_3D_MAP = "command://navi.bridge.area.3d.map";
    public static final String CONTROL_BRIDGE_3D_MAP_OFF = "command://navi.bridge.area.3d.map.off";
    ...
    public static final String CONTROL_COMMUTER_ROUTE_SHOW = "navi.commuter.route.show";
    public static final String CONTROL_COMMUTER_ROUTE_SHOW_OFF = "command://navi.commuter.route.show.off";
    public static final String CONTROL_DISPLAY_2D_HEAD_UP = "command://navi.control.display.2d.headup";
    public static final String CONTROL_DISPLAY_3D = "command://navi.control.display.3d";
    public static final String CONTROL_DISPLAY_3D_HEAD_UP = "command://navi.control.display.3d.headup";
    public static final String CONTROL_DISPLAY_CAR = "command://navi.control.display.car";
    public static final String CONTROL_DISPLAY_DASHBOARD_2D_HEAD_UP = "command://navi.control.dashboard.display.2d.headup";
    public static final String CONTROL_DISPLAY_DASHBOARD_3D_HEAD_UP = "command://navi.control.dashboard.display.3d.headup";
    public static final String CONTROL_DISPLAY_NORTH = "command://navi.control.display.north";
    public static final String CONTROL_DRIVE_CHARGE_LESS = "command://navi.drive.charge.less";
    public static final String CONTROL_DRIVE_CHARGE_LESS_OFF = "command://navi.drive.charge.less.off";
    public static final String CONTROL_DRIVE_HIGHROAD_FIRST = "command://navi.drive.highroad.first";
    public static final String CONTROL_DRIVE_HIGHROAD_FIRST_OFF = "command://navi.drive.highroad.first.off";
    public static final String CONTROL_DRIVE_TIME_FIRST = "command://navi.drive.time.priority";
    public static final String CONTROL_DRIVE_TIME_FIRST_OFF = "command://navi.drive.time.priority.off";
    ...
    public static final String CONTROL_NAVI_SEARCH = "command://navi.search";
    public static final String CONTROL_NAVI_SEARCH_FILTER = "command://navi.search.filter";
    public static final String CONTROL_NAVI_SEARCH_ON_WAY = "command://navi.search.onway";
    ...
    public static final String CONTROL_REALTIME_TRAFFIC = "navi.realtime.traffic";
    public static final String CONTROL_REALTIME_TRAFFIC_OFF = "command://navi.realtime.traffic.off";
    ...
    public static final String CONTROL_SMART_CHARGING_ROUTE = "command://navi.smart.charging.route";
    public static final String CONTROL_SMART_CHARGING_ROUTE_OFF = "command://navi.smart.charging.route.off";
    public static final String CONTROL_SMART_RECOMMEND = "command://navi.smart.recommend";
    public static final String CONTROL_SMART_RECOMMEND_OFF = "command://navi.smart.recommend.off";
    ...
    public static final String CONTROL_SPEECH_CRUISE = "command://navi.control.speech.cruise";
    public static final String CONTROL_SPEECH_CRUISE_OFF = "command://navi.control.speech.cruise.off";
    ...
    public static final String CONTROL_SPEECH_MUTE = "command://navi.control.speech.mute";
    public static final String CONTROL_SPEECH_SIMPLE = "command://navi.control.speech.simple";
    public static final String CONTROL_SPEECH_STANDARD = "command://navi.control.speech.standard";
    ...
    public static final String CONTROL_TRAFFIC_INCIDENT = "navi.traffic.incident";
    public static final String CONTROL_TRAFFIC_INCIDENT_OFF = "command://navi.traffic.incident.off";
