...
public class CarTypeUtils {
    ...
    public static boolean isE28AEU() {
        ...
        return "E28EU".equalsIgnoreCase(str) && "Q8".equalsIgnoreCase(carPlatform);
    }
    ...
    public static boolean isD21ZH() {
        ...
        return CAR_TYPE_D21ZH.equalsIgnoreCase(str) || ("Q5".equalsIgnoreCase(carPlatform) && CAR_COUNTRY_ZH.equalsIgnoreCase(getVersionInCountryCode()));
    }
