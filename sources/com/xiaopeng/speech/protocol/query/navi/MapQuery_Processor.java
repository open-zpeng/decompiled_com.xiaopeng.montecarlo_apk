...
public class MapQuery_Processor implements IQueryProcessor {
    ...
    public String[] getQueryEvents() {
        return new String[]{"navi.is.cruise", "navi.is.explore.path", "navi.is.navigation", "navi.common.addr.get", "navi.get.navigation.info", "navi.is.zoomin.max", "navi.is.zoomout.min", "navi.is.calculate.path", "navi.favorite.open.status", "navi.open.controls.status", "navi.main.road.status", "navi.side.road.status", "navi.scale.current.level", QueryNaviEvent.GET_POI_DETAILS_FAVORITE_STATUS, "navi.is.sr"};
    }
}
