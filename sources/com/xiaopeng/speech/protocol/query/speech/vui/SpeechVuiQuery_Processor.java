    ...
    public Object querySensor(String str, String str2) {
        ...
        switch (str.hashCode()) {
            ...
            case -1526015973:
                ...
                break;
            case -1278290987:
                if (str.equals(SpeechVuiEvent.VUI_EVENT_CAN_EXECUTE)) {
                    c = '\f';
                    break;
                }
                c = 65535;
        ...
        switch (c) {
            ...
            case '\f':
                return Integer.valueOf(this.mTarget.canExecuteVuiEvent(str, str2));
            default:
                return null;
        }
    }
