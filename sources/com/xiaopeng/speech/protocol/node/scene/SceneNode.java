...
public class SceneNode extends SpeechNode<SceneListener> {
    List<String> supportAppNameList = Arrays.asList("com.android.systemui", "com.xiaopeng.chargecontrol", VuiConstants.SCENEDEMO, "com.xiaopeng.carspeechservice", IpcConfig.App.CAR_ACCOUNT);
