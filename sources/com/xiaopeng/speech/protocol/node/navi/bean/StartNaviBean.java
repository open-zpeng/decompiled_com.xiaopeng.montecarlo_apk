...
public class StartNaviBean {
    ...
    private JSONObject speechInfo = null;
    ...
    public JSONObject getSpeechInfo() {
        return this.speechInfo;
    }

    public void setSpeechInfo(JSONObject jSONObject) {
        this.speechInfo = jSONObject;
    }
    ...
    public void setFullSceneSwitch(boolean z) {
        this.fullSceneSwitch = z;
    }
    ...
    public String toString() {
        return "StartNaviBean{poiBean=" + this.poiBean + ", naviType=" + this.naviType + ", routeSelectRef=" + this.routeSelectRef + ", pathRef='" + this.pathRef + "', dialogInfo='" + this.speechInfo + "'}";
    }
