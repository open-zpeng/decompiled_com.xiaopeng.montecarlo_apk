    ...
    public static PathBean fromJson(String str) {
        ...
        try {
            ...
            if (optJSONObject != null) {
                ...
                pathBean.time = optJSONObject.optInt(DebugConfiguration.DebugActionExtra.CRUISE_CONGESTION_TIME);
                pathBean.toll = optJSONObject.optInt("toll");
                pathBean.rawAmapJson = optJSONObject.optString("rawAmapJson");
                pathBean.naviType = optJSONObject.optInt(SystemConst.NAVI_TYPE_KEY);
