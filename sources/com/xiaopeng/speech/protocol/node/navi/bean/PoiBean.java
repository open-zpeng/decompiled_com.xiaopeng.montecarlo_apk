...
public class PoiBean implements Parcelable {
    ...
    public static PoiBean fromJson(String str) {
        ...
        try {
            ...
            if (jSONObject.has("blCustomName")) {
                poiBean.blCustomName = jSONObject.optString("blCustomName");
            }
            return poiBean;
    ...
    public PoiBean(Parcel parcel) {
        ...
        this.blCustomName = parcel.readString();
    }
    ...
    public JSONObject toJson() throws JSONException {
        ...
        jSONObject.put("blCustomName", this.blCustomName);
        return jSONObject;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(this.blCustomName);
    }
}
