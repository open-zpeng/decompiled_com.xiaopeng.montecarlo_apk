...
public class NaviNode extends SpeechNode<NaviListener> {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        i = jSONObject2.optInt(SystemConst.NAVI_TYPE_KEY);
                        try {
    ...
    */
    ...
    public void onListItemSelected(String str, String str2) {
        try {
            JSONObject jSONObject = new JSONObject(str2);
            if (jSONObject.has(CPSearchParam.PARAM_KEY_INDEX)) {
                int optInt = jSONObject.optInt(CPSearchParam.PARAM_KEY_INDEX);
                Object[] collectCallbacks = this.mListenerList.collectCallbacks();
                if (collectCallbacks != null) {
                    for (Object obj : collectCallbacks) {
    ...
    public void onControlChargeServiceOpen(String str, String str2) {
        try {
            JSONObject jSONObject = new JSONObject(str2);
            if (jSONObject.has(CPSearchParam.PARAM_KEY_STATIONID)) {
                String optString = jSONObject.optString(CPSearchParam.PARAM_KEY_STATIONID);
                Object[] collectCallbacks = this.mListenerList.collectCallbacks();
                if (collectCallbacks != null) {
                    for (Object obj : collectCallbacks) {
