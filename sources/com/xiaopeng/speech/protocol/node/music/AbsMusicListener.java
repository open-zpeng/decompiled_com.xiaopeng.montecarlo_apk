...
public abstract class AbsMusicListener implements MusicListener {
    ...
    public void onAudioBookPlay(String str) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.music.MusicListener
    public void onMusicBackward(int i) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.music.MusicListener
    public void onMusicForward(int i) {
    }

    @Override // com.xiaopeng.speech.protocol.node.music.MusicListener
    public void onMusicListPlay(String str) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.music.MusicListener
    public void onMusicSettime(int i) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.music.MusicListener
    public void onMusicSpeedSet(float f) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.music.MusicListener
    public void onPlayMode(String str) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.music.MusicListener
    public void onSearch(String str, SearchMusic searchMusic) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.music.MusicListener
    public void onSupportPlayModeChange(String str) {
    }

    @Override // com.xiaopeng.speech.protocol.node.music.MusicListener
    public void onTwelveNovelPlay(String str) {
    }
}
