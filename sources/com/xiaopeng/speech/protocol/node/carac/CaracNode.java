...
public class CaracNode extends SpeechNode<CaracListener> {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* JADX WARN: Removed duplicated region for block: B:10:0x003b A[LOOP:0: B:10:0x003b->B:12:0x003e, LOOP_START, PHI: r4 
      PHI: (r4v2 int) = (r4v1 int), (r4v3 int) binds: [B:9:0x0039, B:12:0x003e] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:13:0x0048 A[ORIG_RETURN, RETURN] */
    @com.xiaopeng.speech.annotation.SpeechAnnotation(event = com.xiaopeng.speech.protocol.event.CaracEvent.WIND_UNIDIRECTION_SET)
    /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:10:0x003b A[LOOP:0: B:10:0x003b->B:12:0x003e, LOOP_START, PHI: r4 
      PHI: (r4v2 int) = (r4v1 int), (r4v3 int) binds: [B:9:0x0039, B:12:0x003e] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:13:0x0048 A[ORIG_RETURN, RETURN] */
    @com.xiaopeng.speech.annotation.SpeechAnnotation(event = com.xiaopeng.speech.protocol.event.CaracEvent.WIND_UNIDIRECTION)
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:10:0x003b A[LOOP:0: B:10:0x003b->B:12:0x003e, LOOP_START, PHI: r4 
      PHI: (r4v2 int) = (r4v1 int), (r4v3 int) binds: [B:9:0x0039, B:12:0x003e] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:13:0x0048 A[ORIG_RETURN, RETURN] */
    @com.xiaopeng.speech.annotation.SpeechAnnotation(event = com.xiaopeng.speech.protocol.event.CaracEvent.WIND_EVAD)
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:10:0x003b A[LOOP:0: B:10:0x003b->B:12:0x003e, LOOP_START, PHI: r4 
      PHI: (r4v2 int) = (r4v1 int), (r4v3 int) binds: [B:9:0x0039, B:12:0x003e] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:13:0x0048 A[ORIG_RETURN, RETURN] */
    @com.xiaopeng.speech.annotation.SpeechAnnotation(event = com.xiaopeng.speech.protocol.event.CaracEvent.WIND_FRONT)
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:10:0x003b A[LOOP:0: B:10:0x003b->B:12:0x003e, LOOP_START, PHI: r4 
      PHI: (r4v2 int) = (r4v1 int), (r4v3 int) binds: [B:9:0x0039, B:12:0x003e] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:13:0x0048 A[ORIG_RETURN, RETURN] */
    @com.xiaopeng.speech.annotation.SpeechAnnotation(event = com.xiaopeng.speech.protocol.event.CaracEvent.WIND_FREE)
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
