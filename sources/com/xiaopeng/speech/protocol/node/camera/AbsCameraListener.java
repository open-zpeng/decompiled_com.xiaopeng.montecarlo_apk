...
public abstract class AbsCameraListener implements CameraListener {
    ...
    @Override // com.xiaopeng.speech.protocol.node.camera.CameraListener
    public void onOverallOn(boolean z) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.camera.CameraListener
    public void onRearRecord(boolean z) {
    }

    @Override // com.xiaopeng.speech.protocol.node.camera.CameraListener
    public void onRearTake(boolean z) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.camera.CameraListener
    public void onTopOff(boolean z) {
    }

    @Override // com.xiaopeng.speech.protocol.node.camera.CameraListener
    public void onTopOn(boolean z) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.camera.CameraListener
    public void onTopRotateFront(boolean z) {
    }

    @Override // com.xiaopeng.speech.protocol.node.camera.CameraListener
    public void onTopRotateLeft(ChangeValue changeValue, boolean z) {
    }

    @Override // com.xiaopeng.speech.protocol.node.camera.CameraListener
    public void onTopRotateRear(boolean z) {
    }

    @Override // com.xiaopeng.speech.protocol.node.camera.CameraListener
    public void onTopRotateRight(ChangeValue changeValue, boolean z) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.camera.CameraListener
    public void onTransparentChassisCMD(String str) {
    }
}
