...
public class StockBean extends BaseBean {
    ...
    public void parseJson(JSONObject jSONObject) {
        if (jSONObject != null) {
            ...
            this.mBaseData.adate = dateStrConvert(optJSONObject.optString("date") == null ? "" : optJSONObject.optString("date"));
            ...
            if (optJSONArray2 != null) {
                ...
                for (int i2 = 0; i2 < length2; i2++) {
                    try {
                        ...
                        if (jSONObject2 != null) {
                            insertChartData(new ChartData(Float.valueOf(jSONObject2.optString("price")).floatValue(), Float.valueOf(jSONObject2.optString("volume")).floatValue(), jSONObject2.optString("date")));
                        }
