...
public class VuiSceneTestCache {
    ...
    public int getFusionType(String str) {
        ...
        if (str == null) {
            return VuiSceneTestCacheFactory.CacheType.DEFAULT.getType();
        }
        ...
        if (sceneCache != null && !sceneCache.getUploadedState(str)) {
            return VuiSceneTestCacheFactory.CacheType.BUILD.getType();
        }
        ...
        if (sceneCache2 != null && (cache = sceneCache2.getCache(str)) != null && !cache.isEmpty()) {
            return VuiSceneTestCacheFactory.CacheType.UPDATE.getType();
        }
        VuiSceneTestCache sceneCache3 = VuiSceneTestCacheFactory.instance().getSceneCache(VuiSceneTestCacheFactory.CacheType.REMOVE.getType());
        if (sceneCache3 != null && (removeCache = ((VuiSceneRemoveTestCache) sceneCache3).getRemoveCache(str)) != null && !removeCache.isEmpty()) {
            return VuiSceneTestCacheFactory.CacheType.REMOVE.getType();
        }
        VuiSceneTestCache sceneCache4 = VuiSceneTestCacheFactory.instance().getSceneCache(VuiSceneTestCacheFactory.CacheType.DISPLAY_LOCATION.getType());
        if (sceneCache4 != null && !TextUtils.isEmpty(sceneCache4.getDisplayCache(str))) {
            return VuiSceneTestCacheFactory.CacheType.DISPLAY_LOCATION.getType();
        }
        return VuiSceneTestCacheFactory.CacheType.DEFAULT.getType();
    }
