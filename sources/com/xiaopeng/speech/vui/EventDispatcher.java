...
public class EventDispatcher implements Runnable {
    ...
    public void dispatch(String str, String str2) {
        ...
        if (vuiScene == null) {
            ...
            IVuiSceneListener vuiSceneListener3 = VuiSceneManager.instance().getVuiSceneListener(this.mEventData.getSceneId());
            int i = 0;
            if (VuiUtils.is3DApp(VuiSceneManager.instance().getmPackageName()) && vuiSceneListener3 != null && (vuiSceneListener3 instanceof IUnityVuiSceneListener)) {
                try {
                    ...
                    if (sceneInfo != null) {
                        ...
                        if (subSceneList != null) {
                            while (i < subSceneList.size()) {
                                ...
                                VuiElement vuiElementById = ((VuiSceneBuildCache) VuiSceneCacheFactory.instance().getSceneCache(VuiSceneCacheFactory.CacheType.BUILD.getType())).getVuiElementById(str6, this.vuiElement.getId());
                                String str7 = this.TAG;
                                LogUtils.logInfo(str7, "targetElement:" + vuiElementById);
                                if (vuiElementById != null && (vuiSceneListener2 = VuiSceneManager.instance().getVuiSceneListener(str6)) != null) {
                                    this.handler.post(new Runnable() { // from class: com.xiaopeng.speech.vui.EventDispatcher.1
                                        @Override // java.lang.Runnable
                                        public void run() {
                                            ((IUnityVuiSceneListener) vuiSceneListener2).onVuiEvent(EventDispatcher.this.gson.toJson(EventDispatcher.this.vuiElement));
                                        }
                                    });
                                    return;
                                }
                ...
                VuiSceneInfo sceneInfo2 = VuiSceneManager.instance().getSceneInfo(this.mEventData.getSceneId());
                if (sceneInfo2 != null) {
                    List<String> subSceneList2 = sceneInfo2.getSubSceneList();
                    String str8 = this.TAG;
                    LogUtils.logInfo(str8, "subSceneIds:" + subSceneList2);
                    if (subSceneList2 != null) {
                        while (i < subSceneList2.size()) {
                            String str9 = subSceneList2.get(i);
                            VuiElement vuiElementById2 = ((VuiSceneBuildCache) VuiSceneCacheFactory.instance().getSceneCache(VuiSceneCacheFactory.CacheType.BUILD.getType())).getVuiElementById(str9, this.vuiElement.getId());
                            String str10 = this.TAG;
                            LogUtils.logInfo(str10, "targetElement:" + vuiElementById2);
                            if (vuiElementById2 != null && (vuiSceneListener = VuiSceneManager.instance().getVuiSceneListener(str9)) != null) {
                                this.handler.post(new Runnable() { // from class: com.xiaopeng.speech.vui.EventDispatcher.3
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        vuiSceneListener.onVuiEvent(new VuiEventImpl(EventDispatcher.this.vuiElement));
                                    }
                                });
                                return;
                            }
                ...
                if (vuiSceneListener4 != null) {
                    this.handler.post(new Runnable() { // from class: com.xiaopeng.speech.vui.EventDispatcher.4
                        @Override // java.lang.Runnable
                        public void run() {
                            IVuiSceneListener iVuiSceneListener = vuiSceneListener4;
                ...
                final IVuiSceneListener vuiSceneListener5 = VuiSceneManager.instance().getVuiSceneListener(this.mEventData.getSceneId());
                String str11 = this.TAG;
                LogUtils.logInfo(str11, "Event:" + vuiSceneListener5);
                if (vuiSceneListener5 != null && (vuiSceneListener5 instanceof IXpVuiSceneListener)) {
                    this.handler.post(new Runnable() { // from class: com.xiaopeng.speech.vui.EventDispatcher.5
                        @Override // java.lang.Runnable
                        public void run() {
                            vuiSceneListener5.onVuiEvent(new VuiEventImpl(EventDispatcher.this.vuiElement));
                        }
                    });
                    return;
                }
                ...
                LogUtils.logInfo(str12, "dispatch Scene:" + this.mDispatchSceneId);
                ...
                if (findView2 == null || findView2.hitView == null) {
                    if (this.mDispatchSceneId.endsWith("Dialog") || this.mDispatchSceneId.endsWith("dialog")) {
                        final IVuiSceneListener vuiSceneListener6 = VuiSceneManager.instance().getVuiSceneListener(this.mEventData.getSceneId());
                        if (vuiSceneListener6 != null) {
                            this.handler.post(new Runnable() { // from class: com.xiaopeng.speech.vui.EventDispatcher.7
                                @Override // java.lang.Runnable
                                public void run() {
                                    vuiSceneListener6.onVuiEvent(null, new VuiEventImpl(EventDispatcher.this.vuiElement));
                                }
                            });
                            return;
                        }
                    ...
                    if (findView2 != null && findView2.hitView != null) {
                        ...
                        this.handler.post(new Runnable() { // from class: com.xiaopeng.speech.vui.EventDispatcher.8
                            ...
                            public void run() {
                                ...
                                IVuiSceneListener vuiSceneListener7 = VuiSceneManager.instance().getVuiSceneListener(findView2.sceneId);
                                if (vuiSceneListener7 != null) {
                                    vuiSceneListener7.onVuiEventExecutioned();
                                }
                                if (vuiSceneListener7 != null && vuiSceneListener7.onInterceptVuiEvent(findView2.hitView, vuiEventImpl)) {
                                    ...
                                    String str13 = EventDispatcher.this.TAG;
                                    LogUtils.logInfo(str13, "程序运行时间： " + (currentTimeMillis2 - currentTimeMillis) + "ms");
                                }
                            }
                        });
                        return;
    ...
    private void handleFeedback(String str, String str2, VuiElement vuiElement) {
        try {
            if (vuiElement.getProps() == null || !vuiElement.getProps().has(VuiConstants.PROPS_FEEDBACK)) {
                return;
            }
            JSONObject jSONObject = new JSONObject(str);
            int i = jSONObject.has("soundArea") ? jSONObject.getInt("soundArea") : -1;
            VuiSceneManager.instance().storeFeedbackInfo(i, str2, vuiElement.getResourceName());
            VuiSceneToolManager.instance().storeFeedbackInfo(i, str2, vuiElement.getResourceName());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private boolean callOnVuiEvent(VuiElement vuiElement, final VuiEventInfo vuiEventInfo) {
        ...
        if (!(vuiEventInfo.hitView instanceof IVuiElementListener)) {
            if (vuiSceneListener != null) {
                this.handler.post(new Runnable() { // from class: com.xiaopeng.speech.vui.EventDispatcher.9
                    @Override // java.lang.Runnable
                    public void run() {
