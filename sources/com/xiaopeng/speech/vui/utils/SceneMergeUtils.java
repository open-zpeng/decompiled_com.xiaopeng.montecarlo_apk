...
public class SceneMergeUtils {
    ...
    private static void removeElement(JSONArray jSONArray, String str) throws Exception {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (jSONObject != null && jSONObject.has(VuiConstants.ELEMENT_ID)) {
                if (!TextUtils.isEmpty(jSONObject.optString(VuiConstants.ELEMENT_ID)) && jSONObject.optString(VuiConstants.ELEMENT_ID).equals(str)) {
                    jSONArray.remove(i);
                    return;
