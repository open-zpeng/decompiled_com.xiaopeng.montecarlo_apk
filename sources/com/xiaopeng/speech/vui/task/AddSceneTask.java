                        ...
                        if (arrayList14.size() < vuiSceneInfo2.getNotChildrenViewList().size()) {
                            for (int i4 = 0; i4 < vuiSceneInfo2.getNotChildrenViewIdList().size(); i4++) {
                                ...
                                if (!arrayList12.contains(str10)) {
                                    ...
                                    int i5 = VuiSceneManager.TYPE_REMOVE;
                                    instance.sendSceneData(i5, true, str8 + "," + str10);
                                }
                            }
                        }
                        if (arrayList15.size() == vuiSceneInfo2.getNotChildrenViewIdList().size()) {
                            VuiSceneManager.instance().sendSceneData(VuiSceneManager.TYPE_ADD, true, vuiScene2);
                        } else {
        ...
        try {
            ...
            try {
                ...
                if (arrayList.size() > 0) {
                    ...
                    VuiSceneManager.instance().sendSceneData(VuiSceneManager.TYPE_ADD, true, newVuiScene);
                }
            } catch (Exception e2) {
                e = e2;
                addSceneTask = this;
