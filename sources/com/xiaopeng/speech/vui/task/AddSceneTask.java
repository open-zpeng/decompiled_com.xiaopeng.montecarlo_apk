...
import com.xiaopeng.speech.vui.VuiSceneToolManager;
...
public class AddSceneTask extends BaseTask {
        ...
        try {
            if (VuiSceneManager.instance().canUpdateScene(str4)) {
                        ...
                        try {
                            ...
                            if (buildView == null || buildView.getId() == null) {
                                ...
                                try {
                                    ...
                                    e = e;
                                    String str6 = addSceneTask.TAG;
                                    LogUtils.e(str6, "addNotChildViewToScene e:" + e.getMessage());
                                    return;
                                }
                            }
                            z = z2;
                ...
                while (i3 < arrayList13.size()) {
                    ...
                    VuiElement vuiElementById2 = vuiSceneCache2.getVuiElementById(str8, vuiElement.getId());
                ...
                if (arrayList13.size() > 0) {
                    ...
                    if (!str7.equals(Build.TYPE) && LogUtils.getLogLevel() <= LogUtils.LOG_DEBUG_LEVEL) {
                        String str9 = addSceneTask3.TAG;
                        LogUtils.logDebug(str9, "addNotChildViewToScene completed time:" + (System.currentTimeMillis() - j3) + "," + VuiUtils.vuiUpdateSceneConvertToString(vuiScene2));
                    }
                    if (vuiSceneInfo2.getNotChildrenViewList() != null && vuiSceneInfo2.getNotChildrenViewIdList() != null) {
                        ...
                        if (arrayList14.size() < vuiSceneInfo2.getNotChildrenViewList().size()) {
                            for (int i4 = 0; i4 < vuiSceneInfo2.getNotChildrenViewIdList().size(); i4++) {
                                String str10 = vuiSceneInfo2.getNotChildrenViewIdList().get(i4);
                                if (!arrayList12.contains(str10)) {
                                    arrayList15.add(str10);
                                    VuiSceneManager instance = VuiSceneManager.instance();
                                    instance.sendSceneData(3, true, str8 + "," + str10);
                                    VuiSceneToolManager instance2 = VuiSceneToolManager.instance();
                                    instance2.sendSceneData(3, true, str8 + "," + str10);
                                }
                            }
                        }
                        if (arrayList15.size() == vuiSceneInfo2.getNotChildrenViewIdList().size()) {
                            VuiSceneManager.instance().sendSceneData(2, true, vuiScene2);
                            VuiSceneToolManager.instance().sendSceneData(2, true, vuiScene2);
                        } else {
                            VuiSceneCache sceneCache2 = VuiSceneCacheFactory.instance().getSceneCache(VuiSceneCacheFactory.CacheType.BUILD.getType());
                            if (sceneCache2 != null) {
                                List<VuiElement> fusionCache = sceneCache2.getFusionCache(str8, arrayList13, false);
                                sceneCache2.setCache(str8, fusionCache);
                                if (!str7.equals(Build.TYPE) && LogUtils.getLogLevel() <= LogUtils.LOG_DEBUG_LEVEL) {
                                    VuiScene newVuiScene2 = addSceneTask3.getNewVuiScene(str8, System.currentTimeMillis());
                                    newVuiScene2.setElements(fusionCache);
                                    String str11 = addSceneTask3.TAG;
                                    LogUtils.logDebug(str11, "addNotChildViewToScene full_scene_info" + VuiUtils.vuiSceneConvertToString(newVuiScene2));
                                }
                            }
                            VuiSceneManager.instance().sendSceneData(1, true, vuiScene2);
                            VuiSceneToolManager.instance().sendSceneData(1, true, vuiScene2);
                        }
        ...
        try {
            ...
            try {
                ...
                if (arrayList.size() > 0) {
                    ...
                    String str3 = str2 + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT + ((softReference == null || softReference.get() == null) ? -1 : softReference.get().getId());
                    ...
                    if (softReference != null && softReference.get() != null && iVuiSceneListener != null) {
                        ...
                        VuiSceneToolManager.instance().addVuiSceneListener(str3, softReference.get(), iVuiSceneListener, null, true);
                    }
                    VuiSceneManager.instance().sendSceneData(2, true, newVuiScene);
                    VuiSceneToolManager.instance().sendSceneData(2, true, newVuiScene);
                }
            } catch (Exception e2) {
                e = e2;
                addSceneTask = this;
    ...
    public void addSceneElement(SoftReference<View> softReference, String str, String str2) {
        ...
        if ((softReference instanceof IVuiElement) && VuiSceneManager.instance().canUpdateScene(str2) && (sceneInfo = VuiSceneManager.instance().getSceneInfo(str2)) != null) {
            ...
            VuiElement buildView = buildView(softReference, arrayList3, null, null, arrayList2, currentTimeMillis, sceneIdList, new ArrayList(), null, 0, (softReference == null || !(softReference.get() instanceof IVuiElement)) ? false : ((IVuiElement) softReference.get()).isVuiLayoutLoadable(), softReference != null && (softReference.get() instanceof RecyclerView), (softReference == null || !(softReference.get() instanceof RecyclerView)) ? sceneInfo.getElementChangedListener() : null);
            if (buildView == null || buildView.getId() == null) {
                arrayList = arrayList3;
                j = currentTimeMillis;
            } else {
            ...
            if (!"user".equals(Build.TYPE) && LogUtils.getLogLevel() <= LogUtils.LOG_DEBUG_LEVEL) {
                ...
                LogUtils.logDebug(str3, "addSceneElement:" + VuiUtils.vuiSceneConvertToString(newVuiScene) + "time:" + (System.currentTimeMillis() - j));
            }
