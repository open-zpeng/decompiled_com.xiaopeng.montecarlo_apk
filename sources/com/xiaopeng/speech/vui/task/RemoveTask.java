    ...
    public void execute() {
        ...
        try {
            ...
            try {
                        ...
                        if (sceneInfo != null && sceneInfo.isContainNotChildrenView()) {
                            ...
                            if (notChildrenViewIdList != null) {
                                for (int i2 = 0; i2 < notChildrenViewIdList.size(); i2++) {
                                    String str3 = notChildrenViewIdList.get(i2);
                                    VuiSceneManager.instance().sendSceneData(3, true, removeTask3.sceneId + "," + str3);
                                    VuiSceneToolManager.instance().sendSceneData(3, true, removeTask3.sceneId + "," + str3);
                                }
                            }
                                    ...
                                    try {
                                        ...
                                        if (buildView == null || buildView.getId() == null) {
                                            ...
                                            if (list2.contains(buildView.getId())) {
                                                ...
                                                VuiSceneToolManager.instance().sendSceneData(3, true, removeTask2.sceneId + str + buildView.getId());
                ...
                String str5 = removeTask3.sceneId + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT + removeTask3.viewWrapper.getElementGroupId();
                LogUtils.logInfo(removeTask3.TAG, "RemoveTask: subSceneid" + str5);
                List<String> sceneIdList2 = VuiSceneManager.instance().getSceneIdList(removeTask3.sceneId);
                List<String> sceneIdList3 = VuiSceneManager.instance().getSceneIdList(str5);
                if (sceneIdList3 != null) {
                    ...
                    VuiSceneManager.instance().removeSubSceneIds(removeTask3.sceneId, str5);
                    VuiSceneManager.instance().removeVuiSceneListener(str5, false, false, null);
                    VuiSceneToolManager.instance().removeVuiSceneListener(str5, false, false, null);
                }
                VuiSceneManager.instance().sendSceneData(3, true, removeTask3.sceneId + "," + removeTask3.viewWrapper.getElementGroupId());
                VuiSceneToolManager.instance().sendSceneData(3, true, removeTask3.sceneId + "," + removeTask3.viewWrapper.getElementGroupId());
            } catch (Exception e2) {
                e = e2;
            }
        } catch (Exception e3) {
