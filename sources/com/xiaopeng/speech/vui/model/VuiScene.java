...
public class VuiScene {
    private boolean accessibilityScene;
    ...
    public void setAccessibilityScene(boolean z) {
    }
    ...
    public boolean accessibilityScene() {
        return this.accessibilityScene;
    }

    public String toString() {
        return "VuiScene{sceneId='" + this.sceneId + "', elements=" + this.elements + ", packageName='" + this.packageName + "', appVersion='" + this.appVersion + "', accessiblityScene='" + this.accessibilityScene + "', timestamp=" + this.timestamp + '}';
    }
    ...
    private VuiScene(Builder builder) {
        ...
        this.accessibilityScene = false;
        this.sceneId = builder.sceneId;
        this.packageName = builder.packageName;
        this.appVersion = builder.appVersion;
        this.timestamp = builder.timestamp;
        this.accessibilityScene = builder.accessibilityScene;
        this.displayLocation = VuiConstants.SCREEN_DISPLAY_LF;
    ...
    public static class Builder {
        ...
        private boolean accessibilityScene = false;
    ...
    public void publish() {
        ...
        VuiSceneToolManager.instance().buildScene(this, true, true);
    }
}
