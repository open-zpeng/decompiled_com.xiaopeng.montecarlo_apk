...
public class VuiLifecycleObserver implements LifecycleObserver {
    ...
    public void onResume() {
        ...
        if (this.mContext == null || TextUtils.isEmpty(this.mSceneId) || this.mSceneId.contains("Local") || this.mSceneId.contains(AccountContentProvider.DB_NAME)) {
            return;
        }
    ...
    public void onDestroy() {
        ...
        this.mRootView = null;
        this.mListener = null;
        this.mElementChangedListener = null;
