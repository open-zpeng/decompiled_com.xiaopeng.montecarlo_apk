...
public interface IWakeupEngine extends IInterface {
    ...
    AvatarStatus getAvatarStatus() throws RemoteException;

    SwitchStatus getDialogSwitchStatus() throws RemoteException;
    ...
    void subscribeMultiTask(String str, IBinder iBinder) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IWakeupEngine {
        ...
        static final int TRANSACTION_getAvatarStatus = 60;
        static final int TRANSACTION_getDialogSwitchStatus = 59;
        ...
        static final int TRANSACTION_subscribeMultiTask = 58;
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 51:
                    parcel.enforceInterface(DESCRIPTOR);
                    startDialogWithSoundArea(parcel.readString(), parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 52:
                    parcel.enforceInterface(DESCRIPTOR);
                    suspendSpeechWithInfo(parcel.readStrongBinder(), parcel.readString(), parcel.readString(), parcel.readInt(), parcel.readInt() != 0);
                    parcel2.writeNoException();
                    return true;
                case 53:
                    parcel.enforceInterface(DESCRIPTOR);
                    resumeSpeechWithInfo(parcel.readStrongBinder(), parcel.readString());
                    parcel2.writeNoException();
                    return true;
                case 54:
                    parcel.enforceInterface(DESCRIPTOR);
                    String soundAreaStatus = getSoundAreaStatus(parcel.readInt());
                    parcel2.writeNoException();
                    parcel2.writeString(soundAreaStatus);
                    return true;
                case 55:
                    parcel.enforceInterface(DESCRIPTOR);
                    disableSpeechWithInfo(parcel.readStrongBinder(), parcel.readString(), parcel.readString(), parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 56:
                    parcel.enforceInterface(DESCRIPTOR);
                    enableSpeechWithInfo(parcel.readStrongBinder(), parcel.readString(), parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 57:
                    parcel.enforceInterface(DESCRIPTOR);
                    resumeSpeechWithTypeInfo(parcel.readStrongBinder(), parcel.readString(), parcel.readInt(), parcel.readInt() != 0);
                    parcel2.writeNoException();
                    return true;
                case 58:
                    parcel.enforceInterface(DESCRIPTOR);
                    subscribeMultiTask(parcel.readString(), parcel.readStrongBinder());
                    parcel2.writeNoException();
                    return true;
                case 59:
                    parcel.enforceInterface(DESCRIPTOR);
                    SwitchStatus dialogSwitchStatus = getDialogSwitchStatus();
                    parcel2.writeNoException();
                    if (dialogSwitchStatus != null) {
                        parcel2.writeInt(1);
                        dialogSwitchStatus.writeToParcel(parcel2, 1);
                    } else {
                        parcel2.writeInt(0);
                    }
                    return true;
                case 60:
                    ...
                    if (avatarStatus != null) {
                        parcel2.writeInt(1);
                        avatarStatus.writeToParcel(parcel2, 1);
                    } else {
                        parcel2.writeInt(0);
                    }
                    return true;
        ...
        private static class Proxy implements IWakeupEngine {
            ...
            @Override // com.xiaopeng.speech.coreapi.IWakeupEngine
            public void startDialogWithSoundArea(String str, int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.IWakeupEngine
            public void suspendSpeechWithInfo(IBinder iBinder, String str, String str2, int i, boolean z) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.IWakeupEngine
            public void resumeSpeechWithInfo(IBinder iBinder, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.IWakeupEngine
            public String getSoundAreaStatus(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.IWakeupEngine
            public void disableSpeechWithInfo(IBinder iBinder, String str, String str2, int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.IWakeupEngine
            public void enableSpeechWithInfo(IBinder iBinder, String str, int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.IWakeupEngine
            public void resumeSpeechWithTypeInfo(IBinder iBinder, String str, int i, boolean z) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.IWakeupEngine
            public void subscribeMultiTask(String str, IBinder iBinder) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.IWakeupEngine
            public SwitchStatus getDialogSwitchStatus() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    obtain2.readException();
                    return obtain2.readInt() != 0 ? SwitchStatus.CREATOR.createFromParcel(obtain2) : null;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            @Override // com.xiaopeng.speech.coreapi.IWakeupEngine
            public AvatarStatus getAvatarStatus() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    obtain2.readException();
                    return obtain2.readInt() != 0 ? AvatarStatus.CREATOR.createFromParcel(obtain2) : null;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
