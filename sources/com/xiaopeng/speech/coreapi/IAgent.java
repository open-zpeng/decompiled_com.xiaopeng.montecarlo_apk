    ...
    public static abstract class Stub extends Binder implements IAgent {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 32:
                    parcel.enforceInterface(DESCRIPTOR);
                    triggerDialog(parcel.readInt(), parcel.createIntArray(), parcel.readString());
                    parcel2.writeNoException();
                    return true;
                case 33:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 34:
                    parcel.enforceInterface(DESCRIPTOR);
                    leaveTriggerWithID(parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 35:
                    parcel.enforceInterface(DESCRIPTOR);
                    sendTextWithSoundArea(parcel.readString(), parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 36:
                    parcel.enforceInterface(DESCRIPTOR);
                    int newTriggerDialog = newTriggerDialog(parcel.readInt(), parcel.createIntArray(), parcel.readString());
                    parcel2.writeNoException();
                    parcel2.writeInt(newTriggerDialog);
                    return true;
                case 37:
                    parcel.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements IAgent {
            ...
            @Override // com.xiaopeng.speech.coreapi.IAgent
            public void triggerDialog(int i, int[] iArr, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.IAgent
            public void leaveTriggerWithID(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.IAgent
            public void sendTextWithSoundArea(String str, int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.IAgent
            public int newTriggerDialog(int i, int[] iArr, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
