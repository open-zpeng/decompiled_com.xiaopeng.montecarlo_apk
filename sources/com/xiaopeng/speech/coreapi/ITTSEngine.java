    ...
    public static abstract class Stub extends Binder implements ITTSEngine {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 18:
                    parcel.enforceInterface(DESCRIPTOR);
                    boolean speakEnhanceByVoicePosition = speakEnhanceByVoicePosition(parcel.readString(), parcel.readInt(), parcel.readString(), parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readLong(), parcel.readInt());
                    parcel2.writeNoException();
                    parcel2.writeInt(speakEnhanceByVoicePosition ? 1 : 0);
                    return true;
                case 19:
                    parcel.enforceInterface(DESCRIPTOR);
                    setSoloModeByChannel(parcel.readInt(), parcel.readInt() != 0);
                    parcel2.writeNoException();
                    return true;
                case 20:
                    parcel.enforceInterface(DESCRIPTOR);
                    boolean speakParam = speakParam(parcel.readString(), parcel.readString());
                    parcel2.writeNoException();
                    parcel2.writeInt(speakParam ? 1 : 0);
                    return true;
                case 21:
                    parcel.enforceInterface(DESCRIPTOR);
                    shutupByChannel(parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                default:
        ...
        private static class Proxy implements ITTSEngine {
            ...
            @Override // com.xiaopeng.speech.coreapi.ITTSEngine
            public boolean speakEnhanceByVoicePosition(String str, int i, String str2, int i2, int i3, int i4, long j, int i5) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.ITTSEngine
            public void setSoloModeByChannel(int i, boolean z) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.ITTSEngine
            public boolean speakParam(String str, String str2) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.xiaopeng.speech.coreapi.ITTSEngine
            public void shutupByChannel(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
