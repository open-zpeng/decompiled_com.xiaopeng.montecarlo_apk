...
public class WakeupEngineProxy extends IWakeupEngine.Stub implements ConnectManager.OnConnectCallback {
    ...
    private String generateKey(IBinder iBinder, int i, String str) {
        if (iBinder != null) {
            ...
            if (i == -1) {
                return obj + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT + str;
            }
            return obj + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT + i + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT + str;
        }
        return null;
    }
