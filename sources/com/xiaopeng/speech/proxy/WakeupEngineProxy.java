...
public class WakeupEngineProxy extends IWakeupEngine.Stub implements ConnectManager.OnConnectCallback {
    ...
    private String generateKey(IBinder iBinder, int i, String str, int i2) {
        ...
        if (iBinder != null) {
            ...
            if (i == -1) {
                str2 = obj + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT + str;
            } else {
                str2 = obj + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT + i + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT + str;
            }
            if (i2 != -1) {
                return str2 + DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT + i2;
            }
            return str2;
        }
        return null;
