...
public class XpSpeechEngine {
    ...
    public static void init(Context context, boolean z) {
        ...
        initApiRouter();
        if (impl == null) {
            impl = new VuiEngineImpl(context, false, z);
        }
        impl.init("ApiRouterSceneService");
        OverallManager.instance().init(context);
    }
    ...
    public static void setBuildElement(String str, List<VuiElement> list, List<String> list2) {
        VuiEngineImpl vuiEngineImpl = impl;
        if (vuiEngineImpl != null) {
            vuiEngineImpl.setBuildElements(str, list, true, list2);
        }
    }
    ...
    public static void updateDisplayLocation(String str) {
        String str2 = TAG;
        LogUtils.logDebug(str2, "updateDisplayLocation:" + str);
        VuiEngineImpl vuiEngineImpl = impl;
        if (vuiEngineImpl != null) {
            vuiEngineImpl.updateDisplayLocation(str, VuiUtils.getSourceDisplayLocation());
        }
    }
    ...
    public static void exitScene(String str, boolean z) {
        String str2 = TAG;
        LogUtils.logDebug(str2, "exitScene:" + str);
        VuiEngineImpl vuiEngineImpl = impl;
        if (vuiEngineImpl != null) {
