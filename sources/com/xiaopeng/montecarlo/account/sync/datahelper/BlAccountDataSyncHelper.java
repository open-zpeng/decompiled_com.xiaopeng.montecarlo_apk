...
public class BlAccountDataSyncHelper {
    ...
    private boolean setLoginInfo(String str) {
        ...
        int config = AccountBehaviorServiceWrapper.getInstance().getAccountBehaviorService().setConfig(104, configValue, 1);
        int config2 = AccountBehaviorServiceWrapper.getInstance().getAccountBehaviorService().setConfig(ConfigKey.ConfigKeyOftenArrived, configValue, 1);
        int syncFrequentData = AccountBehaviorServiceWrapper.getInstance().getAccountBehaviorService().syncFrequentData();
        L.Tag tag = TAG;
        L.i(tag, "setLoginInfo setLoginResult = " + loginInfo + "  setMsgPushLoginResult = " + loginInfo2 + ", userId = " + str + "=syncResult=" + syncFrequentData + "=configResult=" + config + "=configResultArr=" + config2 + "=isSucess=" + z + "=value=" + AccountBehaviorServiceWrapper.getInstance().getAccountBehaviorService().getConfig(ConfigKey.ConfigKeyOftenArrived).intValue + "=valuefav=" + AccountBehaviorServiceWrapper.getInstance().getAccountBehaviorService().getConfig(104).intValue);
        return z;
    }
