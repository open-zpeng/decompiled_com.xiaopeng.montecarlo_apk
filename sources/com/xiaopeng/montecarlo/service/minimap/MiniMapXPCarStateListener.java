...
public class MiniMapXPCarStateListener implements CarServiceManager.IXPCarStateListener {
    ...
    public void onIcmMapSizeChange(final int i, final int i2) {
        UiHandlerUtil.getInstance().post(new Runnable() { // from class: com.xiaopeng.montecarlo.service.minimap.MiniMapXPCarStateListener.3
            @Override // java.lang.Runnable
            public void run() {
                if (MiniMapXPCarStateListener.this.mMiniMapServiceHelper.isMiniMapLaneMode()) {
                    return;
                }
    ...
    @Override // com.xiaopeng.montecarlo.root.carservice.CarServiceManager.IXPCarStateListener
    public void onIcmSrMapSizeChange(final int i, final int i2) {
    ...
    @Override // com.xiaopeng.montecarlo.root.carservice.CarServiceManager.IXPCarStateListener
    public void onIcmSrMapFpsChange(final int i) {
        UiHandlerUtil.getInstance().post(new Runnable() { // from class: com.xiaopeng.montecarlo.service.minimap.MiniMapXPCarStateListener.6
            @Override // java.lang.Runnable
            public void run() {
                if (MiniMapXPCarStateListener.this.mMiniMapServiceHelper.isMiniMapLaneMode()) {
                    MiniMapXPCarStateListener.this.mMiniMapServiceHelper.updateFps(i);
    ...
    public void onIcmMapImageTypeChange(final int i) {
        UiHandlerUtil.getInstance().post(new Runnable() { // from class: com.xiaopeng.montecarlo.service.minimap.MiniMapXPCarStateListener.7
            @Override // java.lang.Runnable
            public void run() {
