...
public class MiniMapServiceHelper implements MapViewWrapper.IXPMapSurfaceListener {
    private static final int LOG_CONTROL_LIMIT = 50;
    public static final int MESSAGE_SEND_MAP_DATA = 1;
    ...
    private int mSendMapImageType = 2;
    private LocalMiniMapSurface.Callback mCallback = new LocalMiniMapSurface.Callback() { // from class: com.xiaopeng.montecarlo.service.minimap.MiniMapServiceHelper.1
        ...
        public void onReaderCreated(final Surface surface, final int i, final int i2) {
            UiHandlerUtil.getInstance().post(new Runnable() { // from class: com.xiaopeng.montecarlo.service.minimap.MiniMapServiceHelper.1.1
        ...
        public void onReaderDestroy(Surface surface, int i, int i2) {
            UiHandlerUtil.getInstance().post(new Runnable() { // from class: com.xiaopeng.montecarlo.service.minimap.MiniMapServiceHelper.1.2
                @Override // java.lang.Runnable
                public void run() {
                    RootUtil.stopExceptionWatcher();
                    MiniMapServiceHelper.this.mMapViewWrapper.unInitMapView();
                    MiniMapServiceHelper.this.mMapViewWrapper.stopCheckCarIconStatus();
                    MiniMapServiceHelper.this.mMapViewWrapper.setXPMapSurfaceListener(null);
                    MiniMapServiceHelper.this.mMiniMapListener = null;
                }
            });
        }

        @Override // com.xiaopeng.montecarlo.service.minimap.LocalMiniMapSurface.Callback
        public void onReaderSizeChanged(final Surface surface, final int i, final int i2) {
            L.Tag tag = MiniMapServiceHelper.TAG;
            L.i(tag, ">>> onReaderSizeChanged width=" + i + " height=" + i2);
            UiHandlerUtil.getInstance().post(new Runnable() { // from class: com.xiaopeng.montecarlo.service.minimap.MiniMapServiceHelper.1.3
                @Override // java.lang.Runnable
                public void run() {
                    RootUtil.stopExceptionWatcher();
                    if (MiniMapServiceHelper.this.mMapViewWrapper.getGLMapView() == null) {
        ...
        public void onFrameUpdate(Image.Plane plane, int i, int i2) {
            ...
            MiniMapServiceHelper.access$508(MiniMapServiceHelper.this);
    ...
    static /* synthetic */ int access$508(MiniMapServiceHelper miniMapServiceHelper) {
    ...
    public void setMapLevel(int i) {
        MiniMapViewWrapper miniMapViewWrapper = this.mMapViewWrapper;
        if (miniMapViewWrapper != null) {
            miniMapViewWrapper.setMapLevel(i);
        }
    }
    ...
    public void updateDayNightMode(int i) {
        MiniMapViewWrapper miniMapViewWrapper = this.mMapViewWrapper;
        if (miniMapViewWrapper != null) {
            miniMapViewWrapper.updateDayNightMode(i);
    ...
    public void startNavi() {
        ...
        drawRoute();
        showNaviManeuver(TBTManager.getInstance().getNaviManeuverInfo());
    ...
    public void deletePath(List<Long> list, long j, boolean z) {
        L.Tag tag = TAG;
        L.i(tag, "deletePath isStopDelete=" + z);
        if (z) {
    ...
    public void onNaviStop(int i) {
        ...
        if (2 != i) {
            ...
            this.mMapViewWrapper.getBizControlManager().clearAllItems(BizControlWrapper.BIZ_CONTROL_TYPE_ROADFACILITY, 5014L);
                ...
                if (i != 1) {
                    if (i == 2) {
                        if (MiniMapServiceHelper.this.mSendData == null) {
                            MiniMapServiceHelper miniMapServiceHelper = MiniMapServiceHelper.this;
                            miniMapServiceHelper.mSendData = new byte[miniMapServiceHelper.mMiniMapWidth * MiniMapServiceHelper.this.mMiniMapHeight * 4];
                        }
                        this.mPoolBytes.raw2RGB8888(MiniMapServiceHelper.this.mSendData, MiniMapServiceHelper.this.mMiniMapWidth, MiniMapServiceHelper.this.mMiniMapHeight);
