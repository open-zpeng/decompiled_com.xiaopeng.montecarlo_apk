...
public class VoiceFusionUtil {
    ...
    private volatile boolean mIsAlreadyNoticeStopSpeech = false;
    ...
    public void enterVoiceSearchFusionMode() {
        ...
        this.mIsAlreadyNoticeStopSpeech = false;
    }
            ...
            if (CollectionUtils.isNotEmpty(content)) {
                ...
                for (SpeechDataContentItem speechDataContentItem : content) {
                    ...
                    if (exta != null) {
                        ...
                        if (fromJson.getPoiExtra() != null && ((fromJson.getPoiExtra().getAcNums() >= 0 && fromJson.getPoiExtra().getAcFreeNums() >= 0) || (fromJson.getPoiExtra().getDcNums() >= 0 && fromJson.getPoiExtra().getDcFreeNums() >= 0))) {
                            XPDeepCharging xPDeepCharging = new XPDeepCharging();
                            xPDeepCharging.setNumFast(fromJson.getPoiExtra().getDcNums());
                            xPDeepCharging.setNumFastFree(fromJson.getPoiExtra().getDcFreeNums());
                            xPDeepCharging.setNumSlow(fromJson.getPoiExtra().getAcNums());
                            xPDeepCharging.setNumSlowFree(fromJson.getPoiExtra().getAcFreeNums());
                            XPDeepCharging[] xPDeepChargingArr = {xPDeepCharging};
                            ...
                            L.Tag tag = TAG;
                            L.d(tag, "navi.getPoiExtra()=" + fromJson.getPoiExtra());
                            if (fromJson.getPoiExtra() != null) {
                                L.Tag tag2 = TAG;
                                L.d(tag2, "navi.getAcNums()=" + fromJson.getPoiExtra().getAcNums());
                                L.Tag tag3 = TAG;
                                L.d(tag3, "navi.getDcNums()=" + fromJson.getPoiExtra().getDcNums());
                                L.Tag tag4 = TAG;
                                L.d(tag4, "navi.getAcFreeNums()=" + fromJson.getPoiExtra().getAcFreeNums());
                                L.Tag tag5 = TAG;
                                L.d(tag5, "navi.getAcFreeNums()=" + fromJson.getPoiExtra().getDcFreeNums());
                            }
                        }
                ...
                if (L.ENABLE) {
                    L.Tag tag6 = TAG;
                    L.d(tag6, "analysisVoiceFusionData result:" + hashMap);
                }
    ...
    public void noticeStopSpeechDialog() {
        if (this.mIsAlreadyNoticeStopSpeech) {
            L.i(TAG, "noticeStopSpeechDialog failure,already noticed");
            return;
        }
        this.mIsAlreadyNoticeStopSpeech = true;
