...
import com.autonavi.gbl.map.model.EglConfigAttr;
...
public class MiniMapViewWrapper extends MapViewWrapper {
    ...
    public static final int MINI_MAP_RENDER_MODE_ANIM_FPS = 10;
    public static final int MINI_MAP_RENDER_MODE_GESTURE_FPS = 10;
    public static final int MINI_MAP_RENDER_MODE_NAV_FPS = 4;
    public static final int MINI_MAP_RENDER_MODE_NORMAL_FPS = 5;
    ...
    protected void creatMapSurfaceView(@Nullable Application application, int i, int i2, int i3, MapViewWrapper.IXPMapSurfaceListener iXPMapSurfaceListener) {
        if (this.mMapView == null) {
            ...
            deviceAttribute.configAttribs.add(new EglConfigAttr(8, 8, 8, 0, 24, 8, 1, 4));
            deviceAttribute.configAttribs.add(new EglConfigAttr(8, 8, 8, 0, 24, 8, 1, 2));
            deviceAttribute.configAttribs.add(new EglConfigAttr(8, 8, 8, 8, 24, 8, 1, 4));
            deviceAttribute.configAttribs.add(new EglConfigAttr(8, 8, 8, 8, 24, 8, 1, 2));
            deviceAttribute.configAttrNum = 4;
            ...
            this.mMapDevice.setRenderFpsByMode(1, 4);
