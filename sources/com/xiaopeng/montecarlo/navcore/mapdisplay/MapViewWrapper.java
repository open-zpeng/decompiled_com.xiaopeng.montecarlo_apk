...
public class MapViewWrapper implements PosServiceWrapper.IPosUpdateOneShotCallback {
    ...
    public static final float LANE_MODE_MAP_TOP_RATIO = 0.75f;
    ...
    public static final int RENDER_MODE_GESTURE_FPS = 40;
    public static final int RENDER_MODE_NAV_FPS = 10;
    public static final int RENDER_MODE_NAV_LANE_FPS = 10;
    public static final int RENDER_MODE_NORMAL_FPS = 10;
    ...
    protected void creatMapSurfaceView(@Nullable Application application, int i, int i2, int i3, IXPMapSurfaceListener iXPMapSurfaceListener) {
        if (this.mMapService == null) {
            ...
            this.mBizControlManager = new BizControlManager(this);
    ...
    public void switchToSD(int i) {
        if (checkMapViewValid() && isLaneMode()) {
            L.Tag tag = TAG;
            L.i(tag, "switchToSD:" + TBTManager.getInstance().getCurrentStatus());
    ...
    private void exitLane() {
        ...
        LaneServiceManager.getInstance().updateDynamicViewAngle(this.mMainEngineID, false);
        finishAllAnimation();
    ...
    public void switchToLane(int i) {
        ...
        getBizControlManager().setCarLineAndNaviEndVisible(false);
        getBizControlManager().setVisible(BizControlWrapper.BIZ_CONTROL_TYPE_GUIDEROUTE, BizRouteType.BizRouteTypeGuideLabel, false);
        restoreCarPosition();
    }
    ...
    @MainThread
    public void initBizStyleReader(IPrepareLayerStyle iPrepareLayerStyle, int i) {
        if (this.mMapView == null) {
            return;
        }
        initMapLayerStyle(iPrepareLayerStyle, i);
    ...
    public void initMapLayerStyle(IPrepareLayerStyle iPrepareLayerStyle, int i) {
        initLayerControl(iPrepareLayerStyle, i);
    }

    public void initLayerControl(IPrepareLayerStyle iPrepareLayerStyle, int i) {
    ...
    public Coord2DDouble pixelToLonLat(long j, long j2) {
        ...
        if (checkMapViewValid() && (screenToMap = screenToMap(j, j2)) != null) {
            return OperatorPosture.mapToLonLat(screenToMap.x, screenToMap.y);
        }
        return null;
    }

    @Nullable
    public PointD lonLatToMap(double d, double d2) {
        if (checkMapViewValid()) {
    ...
    public Point lonLatToPixel(XPCoordinate2DDouble xPCoordinate2DDouble) {
        ...
        PointD lonLatToGeoPoint = lonLatToGeoPoint(xPCoordinate2DDouble);
        if (lonLatToGeoPoint != null && (mapToScreen = mapToScreen(lonLatToGeoPoint.x, lonLatToGeoPoint.y, 0.0d)) != null) {
    ...
    @Nullable
    public PointD lonLatToGeoPoint(XPCoordinate2DDouble xPCoordinate2DDouble) {
        if (checkMapViewValid()) {
    ...
    public Coord2DInt32 lonLatToP20(double d, double d2) {
        PointD lonLatToMap = OperatorPosture.lonLatToMap(d, d2);
        return new Coord2DInt32(Double.valueOf(lonLatToMap.x).intValue(), Double.valueOf(lonLatToMap.y).intValue());
    }
    ...
    public void updateDayNightMode(int i) {
        if (!checkMapViewValid()) {
            L.Tag tag = TAG;
    ...
    @NonNull
    private MapStyleParam formatMapStyleParam(int i, int i2) {
        boolean z = i == 0;
        ...
        if (i2 == 1) {
            mapStyleParam.style = z ? MapModelDtoConstants.MAP_STYLE_PLAN_DAY : MapModelDtoConstants.MAP_STYLE_PLAN_NIGHT;
        } else if (i2 == 4) {
            mapStyleParam.style = z ? MapModelDtoConstants.MAP_STYLE_NAVI_DAY : MapModelDtoConstants.MAP_STYLE_NAVI_NIGHT;
        } else if (i2 == 22) {
            mapStyleParam.style = z ? MapModelDtoConstants.MAP_STYLE_LANE_DAY : MapModelDtoConstants.MAP_STYLE_LANE_NIGHT;
        } else {
            mapStyleParam.style = z ? MapModelDtoConstants.MAP_STYLE_NORMAL_DAY : MapModelDtoConstants.MAP_STYLE_NORMAL_NIGHT;
        }
        L.Tag tag = TAG;
    ...
    public void setMapMode(final int i, final boolean z, final boolean z2) {
        if (checkMapViewValid()) {
            this.mIsMapModeChangedWithAnimation = z;
            L.i(TAG, "setMapMode start---");
            BizControlManager bizControlManager = this.mBizControlManager;
            if (bizControlManager != null && bizControlManager.isOpenDynamicLevel()) {
                this.mBizControlManager.setDynamicLevelLock(true, new IBizDynamicLevelListener() { // from class: com.xiaopeng.montecarlo.navcore.mapdisplay.-$$Lambda$MapViewWrapper$PoXDl6ZEEn6geS4JXAG6I78Z4Ng
                    @Override // com.xiaopeng.montecarlo.navcore.control.base.IBizDynamicLevelListener
                    public final void onOpenDynamicLevelFinish() {
                        MapViewWrapper.this.lambda$setMapMode$0$MapViewWrapper(i, z, z2);
                    }
                });
            } else {
                L.Tag tag = TAG;
            ...
            L.i(TAG, "setEnter3D end---");
        }
    }

    public /* synthetic */ void lambda$setMapMode$0$MapViewWrapper(int i, boolean z, boolean z2) {
        L.Tag tag = TAG;
        L.i(tag, L.formatWithEngine("setDynamicLevelLock after setMapMode : " + i + " , animation : " + z, getMainEngineID()));
        MapviewModeParam mapviewModeParam = new MapviewModeParam();
        mapviewModeParam.mode = i;
        mapviewModeParam.bChangeCenter = z2;
        this.mMapView.setMapMode(mapviewModeParam, z);
        this.mBizControlManager.setDynamicLevelLock(false);
    }
    ...
    public float getFloatMapLevel() {
        if (checkMapViewValid()) {
            return this.mOperatorPosture.getZoomLevel();
        }
        return -1000.0f;
    }
    ...
    public int getMapViewLeft() {
        if (checkMapViewValid()) {
            return this.mMapView.getMapLeftTop().x;
        }
        return 0;
    }
    ...
    public int getMapViewTop() {
        if (checkMapViewValid()) {
            return this.mMapView.getMapLeftTop().y;
        }
        return 0;
    }
    ...
    private void setSkyBoxModeByMode(boolean z, boolean z2) {
        L.Tag tag = TAG;
        StringBuilder sb = new StringBuilder();
        ...
        sb.append(z2);
        L.i(tag, sb.toString());
        final String str = "blRes/MapAsset/" + (z2 ? "skybox_day.data" : "skybox_night.data");
                ...
                try {
                    try {
                        try {
                            ...
                            inputStream = MapViewWrapper.this.mApplication.getAssets().open(str);
                            try {
                                ...
                                try {
                                    ...
                                    if (MapViewWrapper.this.mOperatorBusiness != null) {
                                        ...
                                        L.i(MapViewWrapper.TAG, L.formatWithEngine(" setSkyBoxModeByMode to bl", MapViewWrapper.this.getMainEngineID()) + ", byte[]=" + Arrays.hashCode(byteArray) + ", source=" + str);
                                    }
                                    if (inputStream != null) {
                                        inputStream.close();
                                    }
