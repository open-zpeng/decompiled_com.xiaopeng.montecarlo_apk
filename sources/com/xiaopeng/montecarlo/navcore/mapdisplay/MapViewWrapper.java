...
public class MapViewWrapper implements PosServiceWrapper.IPosUpdateOneShotCallback {
    ...
    private void exitLane() {
        ...
        SRNaviManager.getInstance().enterLane(false);
    ...
    public void switchToLane(int i) {
        ...
        SRNaviManager.getInstance().enterLane(true);
        restoreCarPosition();
    }
    ...
    private void updateMapViewState(boolean z) {
        ...
        if (z) {
            ...
            this.mOperatorBusiness.setMapBusinessDataPara(81, new MapParameter(0, LayerPriorityType.LayerPriorityRouteEndAreaPoygon, 1000, 0, 0L));
            return;
        }
    ...
    public void goBackCenter(boolean z, boolean z2, boolean z3) {
        ...
        if (checkMapViewValid()) {
            ...
            if (isLaneMode()) {
                SRNaviManager.getInstance().openFollowMode(z);
            }
            resetTickCount(1);
        }
    }
