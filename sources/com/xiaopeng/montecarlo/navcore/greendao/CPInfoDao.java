...
public class CPInfoDao extends AbstractDao<CPInfo, Long> {
    ...
    public static class Properties {
        ...
        public static final Property UltraNums = new Property(10, Integer.TYPE, "ultraNums", false, "S4_NUMS");
        public static final Property FastNums = new Property(11, Integer.TYPE, "fastNums", false, "DC_NUMS");
        public static final Property SlowNums = new Property(12, Integer.TYPE, "slowNums", false, "AC_NUMS");
        public static final Property Key = new Property(13, String.class, CacheEntity.KEY, false, "KEY");
    }
    ...
    public static void createTable(Database database, boolean z) {
        ...
        database.execSQL("CREATE TABLE " + str + "\"CPINFO\" (\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"CITY_CODE\" TEXT,\"STATION_ID\" TEXT NOT NULL UNIQUE ,\"STATION_NAME\" TEXT,\"STATION_ADDR\" TEXT,\"OPER_ID\" TEXT,\"OPER_NAME\" TEXT,\"SELF_SUPPORT_FLAG\" INTEGER NOT NULL ,\"LON\" REAL NOT NULL ,\"LAT\" REAL NOT NULL ,\"S4_NUMS\" INTEGER NOT NULL ,\"DC_NUMS\" INTEGER NOT NULL ,\"AC_NUMS\" INTEGER NOT NULL ,\"KEY\" TEXT);");
    }
    ...
    public final void bindValues(DatabaseStatement databaseStatement, CPInfo cPInfo) {
        ...
        databaseStatement.bindLong(11, cPInfo.getUltraNums());
        databaseStatement.bindLong(12, cPInfo.getFastNums());
        databaseStatement.bindLong(13, cPInfo.getSlowNums());
    ...
    public final void bindValues(SQLiteStatement sQLiteStatement, CPInfo cPInfo) {
        ...
        sQLiteStatement.bindLong(11, cPInfo.getUltraNums());
        sQLiteStatement.bindLong(12, cPInfo.getFastNums());
        sQLiteStatement.bindLong(13, cPInfo.getSlowNums());
        String key = cPInfo.getKey();
        if (key != null) {
    ...
    public void readEntity(Cursor cursor, CPInfo cPInfo, int i) {
        ...
        cPInfo.setUltraNums(cursor.getInt(i + 10));
        cPInfo.setFastNums(cursor.getInt(i + 11));
        cPInfo.setSlowNums(cursor.getInt(i + 12));
        int i8 = i + 13;
