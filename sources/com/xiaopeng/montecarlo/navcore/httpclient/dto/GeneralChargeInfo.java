...
public class GeneralChargeInfo implements Comparable<GeneralChargeInfo> {
    ...
    public int hashCode() {
        int selfSupportFlag = ((((((((((((((((((getSelfSupportFlag() + 59) * 59) + getDcNums()) * 59) + getDcFreeNums()) * 59) + getAcNums()) * 59) + getAcFreeNums()) * 59) + getFreeNums()) * 59) + (isAllXpPile() ? 79 : 97)) * 59) + (isFreeStation() ? 79 : 97)) * 59) + getEvaScore()) * 59) + getEvaNum();
