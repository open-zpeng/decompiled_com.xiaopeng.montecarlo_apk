...
public class NaviPoiChargeStationInfo {
    ...
    @SerializedName("s4_free_num")
    private int mUltraFreeNum;
    @SerializedName("s4_num")
    private int mUltraNum;
    ...
    public int hashCode() {
        int ultraNum = (((((((((((((((((((getUltraNum() + 59) * 59) + getUltraFreeNum()) * 59) + getFastNum()) * 59) + getFastFreeNum()) * 59) + getSlowNum()) * 59) + getSlowFreeNum()) * 59) + getFreeNum()) * 59) + (isFreeCharging() ? 79 : 97)) * 59) + getOperationMode()) * 59) + (isFreeParking() ? 79 : 97)) * 59;
        int i = isAllXpPile() ? 79 : 97;
        Integer freeParkingType = getFreeParkingType();
        int hashCode = ((ultraNum + i) * 59) + (freeParkingType == null ? 43 : freeParkingType.hashCode());
        Integer pileNum = getPileNum();
    ...
    public int getUltraNum() {
        return this.mUltraNum;
    }

    public int getUltraFreeNum() {
        return this.mUltraFreeNum;
    }
