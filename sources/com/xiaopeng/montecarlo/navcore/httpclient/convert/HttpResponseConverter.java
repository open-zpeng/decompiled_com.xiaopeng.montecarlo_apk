...
public class HttpResponseConverter {
    ...
    public static XPPoiInfo generalChargeInfo2XPPoiInfo(GeneralChargeInfo generalChargeInfo) {
        ...
        xPDeepChargingArr[0].setNumUltra(generalChargeInfo.getS4Nums());
        if (generalChargeInfo.getS4Nums() > 0) {
            xPDeepChargingArr[0].setNumUltraFree(generalChargeInfo.getS4FreeNums());
        } else {
            xPDeepChargingArr[0].setNumUltraFree(-1);
        }
        xPDeepChargingArr[0].setNumFast(generalChargeInfo.getDcNums() - generalChargeInfo.getS4Nums());
        if (generalChargeInfo.getDcNums() > 0) {
            xPDeepChargingArr[0].setNumFastFree(generalChargeInfo.getDcFreeNums() - generalChargeInfo.getS4FreeNums());
        } else {
