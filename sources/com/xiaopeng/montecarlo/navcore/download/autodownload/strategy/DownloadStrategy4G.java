...
public class DownloadStrategy4G implements IDownloadStartStrategy {
    ...
    private AutoDownloadManager mAutoDownloadManager = MapDataManager.getInstance().getAutoDownloadManager();
    private DownloadUserProfile mUserProfile = this.mAutoDownloadManager.getUserProfile();
