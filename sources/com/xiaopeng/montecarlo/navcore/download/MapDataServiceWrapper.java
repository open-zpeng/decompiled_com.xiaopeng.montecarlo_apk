...
public class MapDataServiceWrapper {
    ...
    public class ErrorDataObserver implements IErrorDataObserver {
        ...
        public void onErrorNotifyH(int i, int i2, int i3, int i4, String str) {
        }
    ...
    public class DownloadObserver implements IDownloadObserver {
        ...
        @Override // com.autonavi.gbl.data.observer.IDownloadObserver
        @MainThread
        public void onDownLoadStatus(@DownLoadMode.DownLoadMode1 int i, @DataType.DataType1 int i2, final int i3, @TaskStatusCode.TaskStatusCode1 int i4, @OperationErrCode.OperationErrCode1 int i5) {
            L.Tag tag = MapDataServiceWrapper.TAG;
