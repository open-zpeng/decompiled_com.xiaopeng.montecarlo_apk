...
import com.xiaopeng.montecarlo.navcore.bean.sr.SRDataUtil;
...
public class LaneServiceManager {
    ...
    public void init() {
        if (CarServiceManager.getInstance().hasXpuForNgp()) {
            L.i(TAG, "LaneServiceManager init");
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void fillPartsStyle(int i, SRObject sRObject) {
        LaneResourceManager laneResourceManager = this.mLaneResourceManager;
        if (laneResourceManager == null) {
            return;
        }
        laneResourceManager.fillPartsStyle(i, sRObject, this.mIsDay);
    }

    public void setDriveMode(int i) {
        boolean isAutoDriveMode = SRDataUtil.isAutoDriveMode(i);
        L.Tag tag = TAG;
        L.i(tag, "setDriveMode mode:" + i + ", isAutoDriveMode:" + isAutoDriveMode);
        LaneServiceWrapper laneServiceWrapper = this.mLaneServiceWrapper;
        if (laneServiceWrapper != null) {
            laneServiceWrapper.setDriveMode(isAutoDriveMode ? 1 : 2);
        }
    }
    ...
    public void enterLane(int i, boolean z) {
        ...
        if (laneRenderServiceWrapper != null) {
            ...
            laneRenderServiceWrapper.setTMCShowStatus(2);
        }
        LaneNaviServiceWrapper laneNaviServiceWrapper = this.mLaneNaviServiceWrapper;
        if (laneNaviServiceWrapper != null) {
            laneNaviServiceWrapper.enterLane(z);
        }
    }
    ...
    public void attachToMapView(long j) {
        ...
        if (this.mLaneResourceManager == null) {
            L.i(TAG, "LaneResourceManager是null，查看初始化逻辑");
            return;
        }
        int i = (int) j;
        LaneRenderServiceWrapper laneRenderServiceWrapper = this.mLaneRenderServiceWrapperHashMap.get(Integer.valueOf(i));
    ...
    boolean openLeftTurnLamp(boolean z) {
        for (LaneRenderServiceWrapper laneRenderServiceWrapper : this.mLaneRenderServiceWrapperHashMap.values()) {
            if (laneRenderServiceWrapper != null) {
    ...
    boolean openRightTurnLamp(boolean z) {
        for (LaneRenderServiceWrapper laneRenderServiceWrapper : this.mLaneRenderServiceWrapperHashMap.values()) {
            if (laneRenderServiceWrapper != null) {
    ...
    boolean openEmergencyLamp(boolean z) {
        for (LaneRenderServiceWrapper laneRenderServiceWrapper : this.mLaneRenderServiceWrapperHashMap.values()) {
            if (laneRenderServiceWrapper != null) {
    ...
    boolean setLDWWarning(int i, int i2, boolean z) {
        LaneRenderServiceWrapper laneRenderServiceWrapper = this.mLaneRenderServiceWrapperHashMap.get(Integer.valueOf(i));
        if (laneRenderServiceWrapper != null) {
    ...
    void setWarnInfo(int i, int i2) {
        ...
        switch (i2) {
            case 1:
                warningPartsStyle.name = LaneModelDtoConstants.PARTS_WARNING_FRONT;
                warningPartsStyle.textureId = -1;
                warningPartsAnimation.name = LaneModelDtoConstants.PARTS_WARNING_FRONT;
                warningPartsAnimation.animationName = LaneModelDtoConstants.PARTS_WARNING_FRONT_OUT_ANIMATION;
                warningPartsAnimation.animationType = 0;
                warningPartsAnimation.repeatTimes = 1;
                warningPartsAnimationFade.name = LaneModelDtoConstants.PARTS_WARNING_FRONT;
            ...
            case 4:
                ...
                break;
            case 5:
                warningPartsStyle.name = LaneModelDtoConstants.PARTS_WARNING_BEHIND;
                warningPartsStyle.textureId = -1;
                warningPartsAnimation.name = LaneModelDtoConstants.PARTS_WARNING_BEHIND;
                warningPartsAnimation.animationName = LaneModelDtoConstants.PARTS_WARNING_BEHIND_OUT_ANIMATION;
                warningPartsAnimation.animationType = 0;
                warningPartsAnimation.repeatTimes = 1;
                warningPartsAnimationFade.name = LaneModelDtoConstants.PARTS_WARNING_BEHIND;
                warningPartsAnimationFade.fadeType = 0;
                break;
            case 6:
                warningPartsStyle.name = LaneModelDtoConstants.PARTS_WARNING_BEHIND;
                ...
                break;
            case 7:
                warningPartsStyle.name = LaneModelDtoConstants.PARTS_WARNING_LEFT_BEHIND;
                warningPartsStyle.textureId = -1;
                warningPartsAnimation.name = LaneModelDtoConstants.PARTS_WARNING_LEFT_BEHIND;
                warningPartsAnimation.animationName = LaneModelDtoConstants.PARTS_WARNING_LEFT_BEHIND_OUT_ANIMATION;
                warningPartsAnimation.animationType = 0;
                warningPartsAnimation.repeatTimes = 1;
                warningPartsAnimationFade.name = LaneModelDtoConstants.PARTS_WARNING_LEFT_BEHIND;
                warningPartsAnimationFade.fadeType = 0;
                break;
            case 8:
                warningPartsStyle.name = LaneModelDtoConstants.PARTS_WARNING_LEFT_BEHIND;
            ...
            case 9:
                ...
                break;
            case 10:
                warningPartsStyle.name = LaneModelDtoConstants.PARTS_WARNING_RIGHT_BEHIND;
                warningPartsStyle.textureId = -1;
                warningPartsAnimation.name = LaneModelDtoConstants.PARTS_WARNING_RIGHT_BEHIND;
                warningPartsAnimation.animationName = LaneModelDtoConstants.PARTS_WARNING_RIGHT_BEHIND_OUT_ANIMATION;
                warningPartsAnimation.animationType = 0;
                warningPartsAnimation.repeatTimes = 1;
                warningPartsAnimationFade.name = LaneModelDtoConstants.PARTS_WARNING_RIGHT_BEHIND;
                warningPartsAnimationFade.fadeType = 0;
                break;
            case 11:
                warningPartsStyle.name = LaneModelDtoConstants.PARTS_WARNING_RIGHT_BEHIND;
    ...
    private void attachToMapView(int i) {
        ...
        if (1 == i) {
            laneMapViewParam.dayStyleName = MapModelDtoConstants.MAP_STYLE_LANE_DAY;
            laneMapViewParam.nightStyleName = MapModelDtoConstants.MAP_STYLE_LANE_NIGHT;
        } else if (3 == i) {
            laneMapViewParam.dayStyleName = MapModelDtoConstants.MAP_STYLE_LANE_EXTEND_DAY;
            laneMapViewParam.nightStyleName = MapModelDtoConstants.MAP_STYLE_LANE_EXTEND_NIGHT;
        }
        LaneRenderServiceWrapper laneRenderServiceWrapper = this.mLaneRenderServiceWrapperHashMap.get(Integer.valueOf(i));
        if (laneRenderServiceWrapper != null) {
    ...
    private void initSRLevel(int i) {
        if (1 == i) {
            if (CarServiceManager.getInstance().getCarType() == 7) {
                this.mCurrentHighSpeedLevel = DEFAULT_ANCHOR_IN_LEVEL;
                this.mCurrentLowSpeedLevel = DEFAULT_ANCHOR_OUT_LEVEL;
            } else {
