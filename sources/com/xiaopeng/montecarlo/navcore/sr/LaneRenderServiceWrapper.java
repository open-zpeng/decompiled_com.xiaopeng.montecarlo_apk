...
public class LaneRenderServiceWrapper {
    ...
    private Object mCarStyleInfoLock = new Object();
    ...
    public boolean setCarStyleInfo(int i, boolean z) {
        boolean carStyleInfo;
        if (this.mLaneRenderService == null) {
            L.w(TAG, L.formatWithEngine("setCarStyleInfo mLaneRenderService is null", this.mEngineId));
            return false;
        }
        synchronized (this.mCarStyleInfoLock) {
            this.mOffSet = i;
            this.mCarStyleInfo.modelResID = this.mOffSet + 158;
            this.mCarStyleInfo.partsStyle.clear();
            CarPartsStyle carPartsStyle = new CarPartsStyle();
            carPartsStyle.name = LaneModelDtoConstants.PARTS_CAR_SELF_WHEEL_FRONT;
            int i2 = 159;
            ...
            carPartsStyle2.name = LaneModelDtoConstants.PARTS_CAR_SELF_WHEEL_BEHIND;
            ...
            carPartsStyle3.name = LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_LEFT_FRONT;
            ...
            carPartsStyle4.name = LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_RIGHT_FRONT;
            ...
            carPartsStyle5.name = LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_LEFT_BEHIND;
            ...
            carPartsStyle6.name = LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_RIGHT_BEHIND;
            ...
            carPartsStyle7.name = LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_BONNET;
            ...
            carPartsStyle8.name = LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_TRUNK;
            ...
            carPartsStyle9.name = LaneModelDtoConstants.PARTS_CAR_SELF_MAIN;
            if (!z) {
                i2 = 160;
            }
            carPartsStyle9.textureId = i2 + this.mOffSet;
            this.mCarStyleInfo.partsStyle.add(carPartsStyle9);
            CarPartsStyle carPartsStyle10 = new CarPartsStyle();
            carPartsStyle10.name = LaneModelDtoConstants.PARTS_CAR_SELF_SHADOW;
            ...
            carPartsStyle11.name = LaneModelDtoConstants.PARTS_CAR_SELF_LAMP_LEFT;
            carPartsStyle11.textureId = -1;
            this.mCarStyleInfo.partsStyle.add(carPartsStyle11);
            CarPartsStyle carPartsStyle12 = new CarPartsStyle();
            carPartsStyle12.name = LaneModelDtoConstants.PARTS_CAR_SELF_LAMP_RIGHT;
            carPartsStyle12.textureId = -1;
            this.mCarStyleInfo.partsStyle.add(carPartsStyle12);
            CarPartsStyle carPartsStyle13 = new CarPartsStyle();
            carPartsStyle13.name = LaneModelDtoConstants.PARTS_CAR_SELF_LAMP_STOP;
            carPartsStyle13.textureId = -1;
            this.mCarStyleInfo.partsStyle.add(carPartsStyle13);
            CarPartsStyle carPartsStyle14 = new CarPartsStyle();
            carPartsStyle14.name = LaneModelDtoConstants.PARTS_CAR_SELF_LAMP_LOWER;
            ...
            carPartsStyle15.name = LaneModelDtoConstants.PARTS_CAR_SELF_LAMP_HIGH;
            ...
            carPartsStyle16.name = LaneModelDtoConstants.PARTS_CAR_SELF_LAMP_EMERGENCY;
            carPartsStyle16.textureId = -1;
            ...
            carPartsStyle17.textureId = -1;
            this.mCarStyleInfo.partsStyle.add(carPartsStyle17);
            L.i(TAG, L.formatWithEngine("setCarStyleInfo, near:" + CarServiceManager.getInstance().getNearLampState() + ", far:" + CarServiceManager.getInstance().getFarLampState(), this.mEngineId));
            carStyleInfo = this.mLaneRenderService.setCarStyleInfo(this.mCarStyleInfo);
        }
        return carStyleInfo;
    }
    ...
    public void openLFDoor(boolean z) {
        ...
        synchronized (this.mCarStyleInfoLock) {
            ...
            carPartsAnimation.name = LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_LEFT_FRONT;
            carPartsAnimation.animationName = z ? LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_LEFT_FRONT_OPEN_ANIMATION : LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_LEFT_FRONT_CLOSE_ANIMATION;
    ...
    public void openRFDoor(boolean z) {
        ...
        synchronized (this.mCarStyleInfoLock) {
            this.mCarStyleInfo.partsAnimation.clear();
            CarPartsAnimation carPartsAnimation = new CarPartsAnimation();
            carPartsAnimation.name = LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_RIGHT_FRONT;
            carPartsAnimation.animationName = z ? LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_RIGHT_FRONT_OPEN_ANIMATION : LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_RIGHT_FRONT_CLOSE_ANIMATION;
            carPartsAnimation.animationType = 1;
            carPartsAnimation.repeatTimes = 1;
            this.mCarStyleInfo.partsAnimation.add(carPartsAnimation);
            this.mLaneRenderService.setCarStyleInfo(this.mCarStyleInfo);
    ...
    public void openLBDoor(boolean z) {
        ...
        synchronized (this.mCarStyleInfoLock) {
            this.mCarStyleInfo.partsAnimation.clear();
            CarPartsAnimation carPartsAnimation = new CarPartsAnimation();
            carPartsAnimation.name = LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_LEFT_BEHIND;
            carPartsAnimation.animationName = z ? LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_LEFT_BEHIND_OPEN_ANIMATION : LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_LEFT_BEHIND_CLOSE_ANIMATION;
            carPartsAnimation.animationType = 1;
            carPartsAnimation.repeatTimes = 1;
            this.mCarStyleInfo.partsAnimation.add(carPartsAnimation);
            this.mLaneRenderService.setCarStyleInfo(this.mCarStyleInfo);
    ...
    public void openRBDoor(boolean z) {
        ...
        synchronized (this.mCarStyleInfoLock) {
            this.mCarStyleInfo.partsAnimation.clear();
            CarPartsAnimation carPartsAnimation = new CarPartsAnimation();
            carPartsAnimation.name = LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_RIGHT_BEHIND;
            carPartsAnimation.animationName = z ? LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_RIGHT_BEHIND_OPEN_ANIMATION : LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_RIGHT_BEHIND_CLOSE_ANIMATION;
            carPartsAnimation.animationType = 1;
            carPartsAnimation.repeatTimes = 1;
            this.mCarStyleInfo.partsAnimation.add(carPartsAnimation);
            this.mLaneRenderService.setCarStyleInfo(this.mCarStyleInfo);
    ...
    public void openBonnet(boolean z) {
        ...
        synchronized (this.mCarStyleInfoLock) {
            this.mCarStyleInfo.partsAnimation.clear();
            CarPartsAnimation carPartsAnimation = new CarPartsAnimation();
            carPartsAnimation.name = LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_BONNET;
            carPartsAnimation.animationName = z ? LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_BONNET_OPEN_ANIMATION : LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_BONNET_CLOSE_ANIMATION;
            carPartsAnimation.animationType = 1;
            carPartsAnimation.repeatTimes = 1;
            this.mCarStyleInfo.partsAnimation.add(carPartsAnimation);
            this.mLaneRenderService.setCarStyleInfo(this.mCarStyleInfo);
    ...
    public void openTrunk(boolean z) {
        ...
        synchronized (this.mCarStyleInfoLock) {
            this.mCarStyleInfo.partsAnimation.clear();
            CarPartsAnimation carPartsAnimation = new CarPartsAnimation();
            carPartsAnimation.name = LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_TRUNK;
            carPartsAnimation.animationName = z ? LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_TRUNK_OPEN_ANIMATION : LaneModelDtoConstants.PARTS_CAR_SELF_DOOR_TRUNK_CLOSE_ANIMATION;
            carPartsAnimation.animationType = 1;
            carPartsAnimation.repeatTimes = 1;
            this.mCarStyleInfo.partsAnimation.add(carPartsAnimation);
            this.mLaneRenderService.setCarStyleInfo(this.mCarStyleInfo);
    ...
    public void openLeftTurnLamp(boolean z) {
        ...
        synchronized (this.mCarStyleInfoLock) {
            this.mCarStyleInfo.partsAnimation.clear();
            CarPartsAnimation carPartsAnimation = new CarPartsAnimation();
            carPartsAnimation.name = LaneModelDtoConstants.PARTS_CAR_SELF_LAMP_LEFT;
            carPartsAnimation.animationName = LaneModelDtoConstants.PARTS_CAR_SELF_LAMP_LEFT_ANIMATION;
            if (z) {
                carPartsAnimation.animationType = 1;
                carPartsAnimation.repeatTimes = -1;
            } else {
    ...
    public void openRightTurnLamp(boolean z) {
        ...
        synchronized (this.mCarStyleInfoLock) {
            this.mCarStyleInfo.partsAnimation.clear();
            CarPartsAnimation carPartsAnimation = new CarPartsAnimation();
            carPartsAnimation.name = LaneModelDtoConstants.PARTS_CAR_SELF_LAMP_RIGHT;
            carPartsAnimation.animationName = LaneModelDtoConstants.PARTS_CAR_SELF_LAMP_RIGHT_ANIMATION;
            if (z) {
                carPartsAnimation.animationType = 1;
                carPartsAnimation.repeatTimes = -1;
            } else {
    ...
    public void openEmergencyLamp(boolean z) {
        ...
        synchronized (this.mCarStyleInfoLock) {
            this.mCarStyleInfo.partsAnimation.clear();
            CarPartsAnimation carPartsAnimation = new CarPartsAnimation();
            carPartsAnimation.name = LaneModelDtoConstants.PARTS_CAR_SELF_LAMP_EMERGENCY;
            carPartsAnimation.animationName = LaneModelDtoConstants.PARTS_CAR_SELF_LAMP_EMERGENCY_ANIMATION;
            if (z) {
                carPartsAnimation.animationType = 1;
                carPartsAnimation.repeatTimes = -1;
            } else {
    ...
    public boolean setTMCShowStatus(@LaneTMCShowStatus.LaneTMCShowStatus1 int i) {
        L.Tag tag = TAG;
        L.i(tag, L.formatWithEngine("setTMCShowStatus " + i, this.mEngineId));
        LaneRenderService laneRenderService = this.mLaneRenderService;
        if (laneRenderService == null) {
            L.w(TAG, L.formatWithEngine("setTMCShowStatus mLaneRenderService is null", this.mEngineId));
            return false;
        }
        return laneRenderService.setTMCShowStatus(i);
    }

    boolean openShowRoadPolygon(boolean z) {
        L.Tag tag = TAG;
