...
import com.autonavi.gbl.lane.model.SRPartsAnimation;
...
public class LaneResourceManager {
        ...
        public LaneResourceResponse onRequestResource(LaneResourceRequest laneResourceRequest) {
            ...
            if (i > 157) {
                ...
                if (!TextUtils.isEmpty((String) LaneResourceManager.this.mResourceList.get(i))) {
                    String str2 = RootUtil.getDataPath() + RootUtil.SD_CARD_DIR_SR_CAR_MODEL_DATA_PATH + File.separator + SettingWrapper.getSRCarModelVersion() + File.separator + str.replace(LaneResourceManager.PATH, "");
            ...
            if (TextUtils.isEmpty(str3)) {
                ...
                if (CarServiceManager.getInstance().isD55a()) {
                    str4 = RootUtil.D55A_LAN_NAVI_ASSERT_RES_PATH + File.separator + str3;
                }
                L.d(LaneResourceManager.TAG, "lane path=" + str4);
                byte[] loadDataFromAssets = FileUtil.loadDataFromAssets(str4);
                if (loadDataFromAssets == null && str4.contains(LaneResourceManager.PATH)) {
                    str4 = str4.replace(LaneResourceManager.PATH, "");
                    if (L.ENABLE) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void fillPartsStyle(int i, int i2, int i3, SRObject sRObject, boolean z) {
        if (sRObject == null) {
            return;
        }
        int i4 = sRObject.srType;
        if (i4 != 21) {
            switch (i4) {
                case 1:
                ...
                case 2:
                    return;
                case 3:
                    fillSedanPartsStyle(i, i2, i3, z, sRObject);
                    return;
                case 4:
                    fillSUVPartsStyle(i, i2, i3, z, sRObject);
                    return;
                case 5:
                case 9:
                    fillVanPartsStyle(i, i2, i3, z, sRObject);
                    return;
                case 6:
                ...
                case 8:
                    ...
                    return;
                case 10:
                    fillBusPartsStyle(i, i2, i3, z, sRObject);
                    return;
                case 11:
                    fillPickupPartsStyle(i, i2, i3, z, sRObject);
                    return;
                default:
                    switch (i4) {
                        case 80:
    ...
    private void initRes() {
        ...
        sparseArray.put(159, "Texture" + PATH + "/CarSelf_Main.png");
        SparseArray<String> sparseArray2 = this.mResourceList;
        sparseArray2.put(160, "Texture" + PATH + "/CarSelf_Main_night.png");
    ...
    private void fillSedanPartsStyle(int i, int i2, int i3, boolean z, SRObject sRObject) {
        int i4;
        int i5;
        int i6 = i != 3 ? (i == 4 || i == 5) ? z ? 111 : 112 : i != 6 ? z ? 109 : 110 : z ? 113 : 114 : z ? 115 : 116;
        if (1 == i2) {
            i4 = 118;
            i5 = -1;
        } else if (2 == i2) {
        ...
        fillCommonPartsStyle(i6, 117, i4, i5, sRObject);
        fillCommonPartsAnimation(i3, sRObject);
    }

    private void fillSUVPartsStyle(int i, int i2, int i3, boolean z, SRObject sRObject) {
        int i4;
        int i5;
        int i6 = i != 3 ? (i == 4 || i == 5) ? z ? 85 : 86 : i != 6 ? z ? 83 : 84 : z ? 87 : 88 : z ? 89 : 90;
        if (1 == i2) {
            i4 = 92;
            i5 = -1;
        } else if (2 == i2) {
        ...
        fillCommonPartsStyle(i6, 91, i4, i5, sRObject);
        fillCommonPartsAnimation(i3, sRObject);
    }

    private void fillVanPartsStyle(int i, int i2, int i3, boolean z, SRObject sRObject) {
        int i4;
        int i5;
        int i6 = i != 3 ? (i == 4 || i == 5) ? z ? 98 : 99 : i != 6 ? z ? 96 : 97 : z ? 100 : 101 : z ? 102 : 103;
        if (1 == i2) {
            i4 = 105;
            i5 = -1;
        } else if (2 == i2) {
        ...
        fillCommonPartsStyle(i6, 104, i4, i5, sRObject);
        fillCommonPartsAnimation(i3, sRObject);
    }

    private void fillBusPartsStyle(int i, int i2, int i3, boolean z, SRObject sRObject) {
        int i4;
        int i5;
        int i6 = i != 3 ? (i == 4 || i == 5) ? z ? 59 : 60 : i != 6 ? z ? 57 : 58 : z ? 61 : 62 : z ? 63 : 64;
        if (1 == i2) {
            i4 = 66;
            i5 = -1;
        } else if (2 == i2) {
        ...
        fillCommonPartsStyle(i6, 65, i4, i5, sRObject);
        fillCommonPartsAnimation(i3, sRObject);
    }

    private void fillPickupPartsStyle(int i, int i2, int i3, boolean z, SRObject sRObject) {
        int i4;
        int i5;
        int i6 = i != 3 ? (i == 4 || i == 5) ? z ? 72 : 73 : i != 6 ? z ? 70 : 71 : z ? 74 : 75 : z ? 76 : 77;
        if (1 == i2) {
            i4 = 79;
            i5 = -1;
        } else if (2 == i2) {
        ...
        fillCommonPartsStyle(i6, 78, i4, i5, sRObject);
        fillCommonPartsAnimation(i3, sRObject);
    }

    private void fillCommonPartsStyle(int i, int i2, int i3, int i4, SRObject sRObject) {
        SRPartsStyle sRPartsStyle = new SRPartsStyle();
        sRPartsStyle.name = LaneDtoModelConstants.PARTS_CAR_AROUND_MAIN;
        sRPartsStyle.textureId = i;
        sRObject.partsStyle.add(sRPartsStyle);
        SRPartsStyle sRPartsStyle2 = new SRPartsStyle();
        sRPartsStyle2.name = LaneDtoModelConstants.PARTS_CAR_AROUND_LAMP_LEFT;
        sRPartsStyle2.textureId = i3;
        sRObject.partsStyle.add(sRPartsStyle2);
        SRPartsStyle sRPartsStyle3 = new SRPartsStyle();
        sRPartsStyle3.name = LaneDtoModelConstants.PARTS_CAR_AROUND_LAMP_RIGHT;
        sRPartsStyle3.textureId = i4;
        sRObject.partsStyle.add(sRPartsStyle3);
        SRPartsStyle sRPartsStyle4 = new SRPartsStyle();
        sRPartsStyle4.name = LaneDtoModelConstants.PARTS_CAR_AROUND_SHADOW;
        sRPartsStyle4.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle4);
    }

    private void fillCommonPartsAnimation(int i, SRObject sRObject) {
        if (i != 0) {
            SRPartsAnimation sRPartsAnimation = new SRPartsAnimation();
            sRPartsAnimation.name = LaneDtoModelConstants.PARTS_CAR_AROUND_LAMP_LEFT;
            sRPartsAnimation.animationName = LaneDtoModelConstants.PARTS_CAR_AROUND_LAMP_LEFT_ANIMATION;
            if (1 == i) {
                sRPartsAnimation.animationType = 1;
                sRPartsAnimation.repeatTimes = -1;
            } else {
                sRPartsAnimation.animationType = 0;
                sRPartsAnimation.repeatTimes = 1;
            }
            SRPartsAnimation sRPartsAnimation2 = new SRPartsAnimation();
            sRPartsAnimation2.name = LaneDtoModelConstants.PARTS_CAR_AROUND_LAMP_RIGHT;
            sRPartsAnimation2.animationName = LaneDtoModelConstants.PARTS_CAR_AROUND_LAMP_RIGHT_ANIMATION;
            if (2 == i) {
                sRPartsAnimation2.animationType = 1;
                sRPartsAnimation2.repeatTimes = -1;
            } else {
                sRPartsAnimation2.animationType = 0;
                sRPartsAnimation2.repeatTimes = 1;
            }
            sRObject.partsAnimation.clear();
            sRObject.partsAnimation.add(sRPartsAnimation);
            sRObject.partsAnimation.add(sRPartsAnimation2);
        }
    }
    ...
    private void fillPersonPartsStyle(int i, boolean z, SRObject sRObject) {
        ...
        SRPartsStyle sRPartsStyle = new SRPartsStyle();
        sRPartsStyle.name = LaneDtoModelConstants.PARTS_PEDESTRIAN_MAIN;
        sRPartsStyle.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle);
        SRPartsStyle sRPartsStyle2 = new SRPartsStyle();
        sRPartsStyle2.name = LaneDtoModelConstants.PARTS_PEDESTRIAN_SHADOW;
    ...
    private void fillBicyclePartsStyle(int i, boolean z, SRObject sRObject) {
        ...
        SRPartsStyle sRPartsStyle = new SRPartsStyle();
        sRPartsStyle.name = LaneDtoModelConstants.PARTS_BICYCLE_BODY;
        sRPartsStyle.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle);
        SRPartsStyle sRPartsStyle2 = new SRPartsStyle();
        sRPartsStyle2.name = LaneDtoModelConstants.PARTS_BICYCLE_HUMAN;
        sRPartsStyle2.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle2);
        SRPartsStyle sRPartsStyle3 = new SRPartsStyle();
        sRPartsStyle3.name = LaneDtoModelConstants.PARTS_BICYCLE_WHEEL_FRONT;
        sRPartsStyle3.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle3);
        SRPartsStyle sRPartsStyle4 = new SRPartsStyle();
        sRPartsStyle4.name = LaneDtoModelConstants.PARTS_BICYCLE_WHEEL_BEHIND;
        sRPartsStyle4.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle4);
        SRPartsStyle sRPartsStyle5 = new SRPartsStyle();
        sRPartsStyle5.name = LaneDtoModelConstants.PARTS_BICYCLE_SHADOW;
    ...
    private void fillTricyclePartsStyle(int i, boolean z, SRObject sRObject) {
        ...
        SRPartsStyle sRPartsStyle = new SRPartsStyle();
        sRPartsStyle.name = LaneDtoModelConstants.PARTS_TRICYCLE_BODY;
        sRPartsStyle.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle);
        SRPartsStyle sRPartsStyle2 = new SRPartsStyle();
        sRPartsStyle2.name = LaneDtoModelConstants.PARTS_TRICYCLE_HUMAN;
        sRPartsStyle2.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle2);
        SRPartsStyle sRPartsStyle3 = new SRPartsStyle();
        sRPartsStyle3.name = LaneDtoModelConstants.PARTS_TRICYCLE_WHEEL_FRONT;
        sRPartsStyle3.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle3);
        SRPartsStyle sRPartsStyle4 = new SRPartsStyle();
        sRPartsStyle4.name = LaneDtoModelConstants.PARTS_TRICYCLE_WHEEL_BEHIND;
        sRPartsStyle4.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle4);
        SRPartsStyle sRPartsStyle5 = new SRPartsStyle();
        sRPartsStyle5.name = LaneDtoModelConstants.PARTS_TRICYCLE_SHADOW;
    ...
    private void fillMotorcyclePartsStyle(int i, boolean z, SRObject sRObject) {
        ...
        SRPartsStyle sRPartsStyle = new SRPartsStyle();
        sRPartsStyle.name = LaneDtoModelConstants.PARTS_MOTOCYCLE_BODY;
        sRPartsStyle.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle);
        SRPartsStyle sRPartsStyle2 = new SRPartsStyle();
        sRPartsStyle2.name = LaneDtoModelConstants.PARTS_MOTOCYCLE_HUMAN;
        sRPartsStyle2.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle2);
        SRPartsStyle sRPartsStyle3 = new SRPartsStyle();
        sRPartsStyle3.name = LaneDtoModelConstants.PARTS_MOTOCYCLE_WHEEL_FRONT;
        sRPartsStyle3.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle3);
        SRPartsStyle sRPartsStyle4 = new SRPartsStyle();
        sRPartsStyle4.name = LaneDtoModelConstants.PARTS_MOTOCYCLE_WHEEL_BACK;
        sRPartsStyle4.textureId = i2;
        sRObject.partsStyle.add(sRPartsStyle4);
        SRPartsStyle sRPartsStyle5 = new SRPartsStyle();
        sRPartsStyle5.name = LaneDtoModelConstants.PARTS_MOTOCYCLE_SHADOW;
    ...
    private void fillPolicePartsStyle(int i, boolean z, SRObject sRObject) {
        SRPartsStyle sRPartsStyle = new SRPartsStyle();
        sRPartsStyle.name = LaneDtoModelConstants.PARTS_POLICE_MAIN;
        sRPartsStyle.textureId = 44;
        sRObject.partsStyle.add(sRPartsStyle);
        SRPartsStyle sRPartsStyle2 = new SRPartsStyle();
        sRPartsStyle2.name = LaneDtoModelConstants.PARTS_POLICE_SHADOW;
    ...
    private void fillDrumPartsStyle(boolean z, SRObject sRObject) {
        int i = z ? 128 : 129;
        SRPartsStyle sRPartsStyle = new SRPartsStyle();
        sRPartsStyle.name = LaneDtoModelConstants.PARTS_DRUM_MAIN;
        sRPartsStyle.textureId = i;
        sRObject.partsStyle.add(sRPartsStyle);
        SRPartsStyle sRPartsStyle2 = new SRPartsStyle();
        sRPartsStyle2.name = LaneDtoModelConstants.PARTS_DRUM_SHADOW;
    ...
    private void fillWaterBarrierPartsStyle(boolean z, SRObject sRObject) {
        int i = z ? 132 : 133;
        SRPartsStyle sRPartsStyle = new SRPartsStyle();
        sRPartsStyle.name = LaneDtoModelConstants.PARTS_BARRICADE_MAIN;
        sRPartsStyle.textureId = i;
        sRObject.partsStyle.add(sRPartsStyle);
        SRPartsStyle sRPartsStyle2 = new SRPartsStyle();
        sRPartsStyle2.name = LaneDtoModelConstants.PARTS_BARRICADE_SHADOW;
    ...
    private void fillTrafficConePartsStyle(boolean z, SRObject sRObject) {
        int i = z ? 122 : 123;
        SRPartsStyle sRPartsStyle = new SRPartsStyle();
        sRPartsStyle.name = LaneDtoModelConstants.PARTS_TRAFFIC_CONE_MAIN;
        sRPartsStyle.textureId = i;
        sRObject.partsStyle.add(sRPartsStyle);
    }
}
