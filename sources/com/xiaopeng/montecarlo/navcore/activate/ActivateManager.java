...
public class ActivateManager {
    ...
    private INetActivateObserver mNetActivateObserver = new INetActivateObserver() { // from class: com.xiaopeng.montecarlo.navcore.activate.ActivateManager.1
        ...
        public void onNetActivateResponse(int i) {
            ...
            } else if ((20 != i && 1140850694 != i) || ActivateManager.this.mActivateCount >= 3) {
                ActivateManager.this.mActivateCount = 0;
    ...
    private IXPNetworkListener mNetworkListener = new IXPNetworkListener() { // from class: com.xiaopeng.montecarlo.navcore.activate.ActivateManager.2
        ...
        public void onNetworkChanged(XPNetworkManager.XPNetworkType xPNetworkType, boolean z) {
            if (z) {
                if ((ActivateManager.this.mActivateType == 0 || 1 == ActivateManager.this.mActivateType) && ActivateManager.this.mActivateCode != 0) {
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 1003:
                    ...
                    if (ActivateManager.this.mActivateCode == 0) {
                        ActivateManager.this.sendActivateSuccess();
                        return;
                    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0076, code lost:
        if (com.xiaopeng.montecarlo.root.util.ioutil.FileUtil.existFile(com.xiaopeng.montecarlo.root.util.RootUtil.ACTIVATE_BACKUP_DIR + org.eclipse.paho.client.mqttv3.MqttTopic.TOPIC_LEVEL_SEPARATOR + com.xiaopeng.montecarlo.navcore.activate.ActivateManager.ACTIVATE_FILE_NAME) != false) goto L22;
     */
    ...
    */
    private boolean initActivateData() {
        /*
            ...
            java.lang.StringBuilder r0 = new java.lang.StringBuilder
            r0.<init>()
            java.lang.String r3 = com.xiaopeng.montecarlo.root.util.RootUtil.ACTIVATE_SDCARD_DIR
            r0.append(r3)
            r0.append(r1)
            java.lang.String r3 = "value.dat"
            r0.append(r3)
            java.lang.String r0 = r0.toString()
            boolean r0 = com.xiaopeng.montecarlo.root.util.ioutil.FileUtil.existFile(r0)
            if (r0 == 0) goto L44
        ...
        L78:
            java.lang.String r0 = com.xiaopeng.montecarlo.root.util.RootUtil.ACTIVATE_SDCARD_DIR
            java.lang.String r3 = com.xiaopeng.montecarlo.root.util.RootUtil.ACTIVATE_BACKUP_DIR
        ...
        L95:
            ...
            byte[] r6 = com.xiaopeng.montecarlo.root.util.ioutil.FileUtil.loadDataFromAssets(r6)
            java.lang.String r7 = com.xiaopeng.montecarlo.root.util.RootUtil.ACTIVATE_SDCARD_DIR
            com.xiaopeng.montecarlo.root.util.ioutil.FileUtil.createFileWithByte(r7, r2, r6)
            int r6 = r8.batchActivate()
            r8.mActivateCode = r6
            int r6 = r8.mActivateCode
            if (r6 != 0) goto Lbe
            return r4
        Lbe:
            java.lang.StringBuilder r6 = new java.lang.StringBuilder
            ...
            r6.append(r2)
            java.lang.String r6 = r6.toString()
            com.xiaopeng.montecarlo.root.util.ioutil.FileUtil.deleteFile(r6)
            int r5 = r5 + 1
            goto L95
        Ld8:
            r0 = 1
    ...
    public void sendActivateSuccess() {
        ...
        if (iActivateResultListener != null) {
            iActivateResultListener.onActivateResult(this.mActivateType, 0);
        }
