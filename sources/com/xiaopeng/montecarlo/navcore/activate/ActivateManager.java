...
public class ActivateManager {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0077, code lost:
        if (com.xiaopeng.montecarlo.root.util.ioutil.FileUtil.existFile(com.xiaopeng.montecarlo.root.util.RootUtil.ACTIVATE_BACKUP_DIR + "/" + com.xiaopeng.montecarlo.navcore.activate.ActivateManager.ACTIVATE_FILE_NAME) != false) goto L20;
     */
    ...
    */
    ...
    public /* synthetic */ void lambda$checkManualActiveInfo$1$ActivateManager() {
        ResponseWrapper<NaviGetSdkActivationCodeResponse> sdkActivationCode = this.mNaviVehicleService.getSdkActivationCode();
        if (sdkActivationCode != null && 200 == sdkActivationCode.getResponseCode() && sdkActivationCode.getData() != null) {
            L.i(TAG, ">>> checkManualActiveInfo onSuccess");
            NaviGetSdkActivationCodeResponse data = sdkActivationCode.getData();
            this.mUuid = data.getUuid();
            this.mUserCode = data.getSeqNo();
            this.mLoginCode = data.getActiveCode();
            saveActivateInfo();
            checkActivate();
            return;
        }
    ...
    private void saveActivateInfo() {
        ...
        fileIOUtil.writeList2SDCard(RootUtil.ACTIVATE_SDCARD_DIR + "/", ACTIVATE_INFO_FILE_NAME, arrayList);
    }

    private void getActivateInfoFormSDCard() {
        String str = RootUtil.ACTIVATE_SDCARD_DIR + "/" + ACTIVATE_INFO_FILE_NAME;
        String str2 = RootUtil.ACTIVATE_BACKUP_DIR + "/" + ACTIVATE_INFO_FILE_NAME;
    ...
    private ActivationInitParam createBatchActivateParams() {
        ...
        activationInitParam.szUserDataFileDir = RootUtil.ACTIVATE_SDCARD_DIR + "/";
