...
public class PosServiceWrapper implements IPosLocInfoObserver, IPosParallelRoadObserver, IPosSwitchParallelRoadObserver, IPosSensorParaObserver, IPosSignInfoObserver, IThreadObserver {
    ...
    public void setSignalRecordSwitch(boolean z) {
        if (checkPosServiceValid()) {
            ...
            locLogConf.logType = NaviLogUtil.getBLLocLogType();
            this.mPosService.signalRecordSwitch(z, locLogConf);
        }
    }
    ...
    public void setContextPos() {
        if (this.mPosService != null) {
            XPCarLocation currentCarLocation = getCurrentCarLocation();
            Coord3DDouble coord3DDouble = new Coord3DDouble(currentCarLocation.mLongitude, currentCarLocation.mLatitude, 0.0d);
            L.Tag tag = TAG;
            L.i(tag, "setContextPos contextPos = " + coord3DDouble);
            this.mPosService.setContextPos(coord3DDouble, currentCarLocation.mCarDir);
        }
    }
    ...
    public void setLocation(GnssLocation gnssLocation, boolean z, long j) {
        ...
        if (checkPosServiceValid() && z == isFakeLocation()) {
            ...
            locSignData.gnss.tickTime = BigInteger.valueOf(j);
        ...
        if (checkPosServiceValid()) {
            ...
            synchronized (this.mCarLocationDirMutex) {
                if (this.mCurrentLocation != null) {
                    DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.VALUE_LAST_LOCAL_SAVE_LON, (long) (this.mCurrentLocation.mLongitude * 1000000.0d));
                    DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.VALUE_LAST_LOCAL_SAVE_LAT, (long) (this.mCurrentLocation.mLatitude * 1000000.0d));
                    DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.VALUE_LAST_LOCAL_SAVE_DIR, this.mCurrentLocation.mCarDir);
                }
            }
        }
    }
    ...
    public XPCarLocation getXPCarLocation() {
        synchronized (this.mCarLocationDirMutex) {
            if (this.mCurrentLocation != null) {
                return new XPCarLocation(this.mCurrentLocation.mLongitude, this.mCurrentLocation.mLatitude, this.mCurrentLocation.mCarDir);
            }
            return null;
        }
    }
    ...
    public void setViaductRecognizeSwitch(boolean z) {
        if (checkPosServiceValid()) {
            this.mPosService.setViaductRecognizeSwitch(z);
        }
    }
