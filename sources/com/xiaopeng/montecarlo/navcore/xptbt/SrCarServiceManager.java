...
import com.xiaopeng.montecarlo.navcore.sr.XpuSRBinderClient;
...
public class SrCarServiceManager implements ISRCarService.ISRCarStateListener {
    ...
    XpuSRBinderClient mXpuSRBinderClient = new XpuSRBinderClient();
    ...
    public void init(ISRCarService iSRCarService) {
        ...
        L.i(TAG, "init");
        this.mXpuSRBinderClient.bindXpuService(ContextUtils.getContext());
    ...
    public void release() {
        L.i(TAG, "release");
        if (this.mIsInitialized) {
            this.mXpuSRBinderClient.unBindXpuService(ContextUtils.getContext());
            SrCarServiceWrapper srCarServiceWrapper = this.mCarServiceWrapper;
            if (srCarServiceWrapper != null) {
