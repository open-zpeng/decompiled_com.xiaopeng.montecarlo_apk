...
public class RouteServiceWrapper implements IRouteResultObserver {
    ...
    private final XCountDownTimer.ITimerCallback mTimerCallback = new XCountDownTimer.ITimerCallback() { // from class: com.xiaopeng.montecarlo.navcore.xptbt.RouteServiceWrapper.1
        ...
        public void onTimeOut() {
            ...
            RouteServiceWrapper.this.mRouteManager.onNewRouteError(0, i, 822083596, null, z, false);
        }
    };
    ...
    public boolean initRouteService() {
        if (this.mRouteService == null) {
            this.mRouteService = (RouteService) ServiceMgr.getServiceMgrInstance().getBLService(17);
            if (this.mRouteService == null) {
        ...
        if (this.mRouteService.isInit() == 1) {
            ...
            if (this.mRouteService.init(routeInitParam) != 0) {
    ...
    public void onNewRoute(PathResultData pathResultData, ArrayList<PathInfo> arrayList, RouteLimitInfo routeLimitInfo) {
        ...
        try {
            ...
            if (pathResultData.type == 14 && arrayList != null && arrayList.size() > 0) {
                arrayList.remove(0);
            }
    ...
    private RouteOption convertParamsToRouteOption(RouteParams routeParams) {
        ...
        routeControlRouteControlKeySetInvoker(routeParams.mRouteControlKeySetInvoker);
    ...
    public void routeControlRouteControlKeySetInvoker(String str) {
        if (this.mRouteService != null) {
            L.Tag tag = TAG;
            L.i(tag, "RouteControlKeySetInvoker : " + str);
            this.mRouteService.control(313, str);
        }
    }
}
