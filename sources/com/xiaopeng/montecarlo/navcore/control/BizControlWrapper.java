...
public class BizControlWrapper {
    ...
    private void drawRoute(int i, IPathResult iPathResult, RouteParams routeParams, int i2, boolean z) {
        ...
        if (769 == i) {
            ...
            this.mGuideRouteControlProxy.setDisplayScale(6012, new LayerScale(d, d2));
    ...
    public void clearLaneGuideRouteOverlay() {
        L.i(TAG, "clearLaneGuideRouteOverlay");
        clearAllItems(BIZ_CONTROL_TYPE_LANE, 10001L);
        clearAllItems(BIZ_CONTROL_TYPE_LANE, 10002L);
        clearAllItems(BIZ_CONTROL_TYPE_LANE, 10003L);
        clearAllItems(BIZ_CONTROL_TYPE_LANE, 10004L);
    }
