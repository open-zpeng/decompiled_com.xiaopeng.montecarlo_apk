...
public class BizControlWrapper {
    ...
    public static final String BIZ_CONTROL_TYPE_LANE = "LaneControlProxy";
    ...
    private LaneControlProxy mLaneControlProxy = new LaneControlProxy();
    ...
    public BizControlWrapper(BizControlManager bizControlManager, MapViewWrapper mapViewWrapper) {
    ...
    public void initBizControl(BizControlDataModel bizControlDataModel) {
        ...
        this.mLaneControlProxy.init(this.mBizService, this.mMapView, this.mCustomMapListener);
        ...
        this.mRoadFacilityControlProxy.enableTrafficSignalLight(true);
        ...
        this.mBizControlMap.put(BIZ_CONTROL_TYPE_LANE, this.mLaneControlProxy);
    ...
    public void initBizService(int i) {
        this.mBizService = (BizControlService) ServiceMgr.getServiceMgrInstance().getBLService(20);
    ...
    private void drawRoute(int i, IPathResult iPathResult, RouteParams routeParams, int i2, boolean z) {
        ...
        if (!this.mapViewWrapper.isLaneMode()) {
            setRadarState();
        }
    ...
    public void setCarLineAndNaviEndVisible(boolean z) {
        if (!checkMapViewValid() || this.mapViewWrapper.isLaneMode()) {
            return;
        }
        L.Tag tag = TAG;
    ...
    public void updateResMarker(boolean z) {
        if (checkMapViewValid()) {
            ...
            this.mBizControlMap.get(BIZ_CONTROL_TYPE_LANE).updateStyle();
    ...
    public void initCruiseCar() {
        if (checkMapViewValid()) {
            ...
            this.mCarControlProxy.updateCarStyle(2002);
            setVisible(BIZ_CONTROL_TYPE_ROADFACILITY, BizRoadFacilityType.BizRoadFacilityTypeGuideTrafficEvent, false);
        }
    }
    ...
    public void setDynamicLevelLock(boolean z) {
        if (L.ENABLE) {
            L.Tag tag = TAG;
            L.d(tag, "setDynamicLevelLock isOpen = " + z);
        }
        this.mGuideRouteControlProxy.setDynamicLevelLock(z);
    }
    ...
    public void renderAoiAreaInfo(BizPolygonBusinessInfo bizPolygonBusinessInfo) {
        ...
        setVisible(BIZ_CONTROL_TYPE_SEARCH, 7002, true);
        setVisible(BIZ_CONTROL_TYPE_SEARCH, 7003, true);
    }
    ...
    public void addMapOverLayItems(XPPointBaseData[] xPPointBaseDataArr) {
        ...
        this.mUserControlProxy.clearFocus(8001L);
        this.mUserControlProxy.clearFocus(8003L);
        addItems(BIZ_CONTROL_TYPE_USER, 8001, NavCoreUtil.translationLayerItems(8001, xPPointBaseDataArr));
        addItems(BIZ_CONTROL_TYPE_USER, 8003, NavCoreUtil.translationLayerItems(8003, xPPointBaseDataArr));
    }
    ...
    public void drawGPSandDRDataAddIOverlay(BizControlDataModel bizControlDataModel) {
        ...
        clearAllItems(BIZ_CONTROL_TYPE_USER, 8001L);
        addItems(BIZ_CONTROL_TYPE_USER, 8001, NavCoreUtil.translationLayerItems(8001, bizControlDataModel.mOverlaysCp));
        addItems(BIZ_CONTROL_TYPE_USER, 8003, NavCoreUtil.translationLayerItems(8003, bizControlDataModel.mOverlaysTrace));
    }
    ...
    public boolean isOpenDynamicLevel() {
        return this.mGuideRouteControlProxy.isOpenDynamicLevel();
    }
}
