        ...
        */
        public static java.util.List<com.xiaopeng.montecarlo.navcore.database.MigrationHelper.TableInfo> getTableInfo(org.greenrobot.greendao.database.Database r4, java.lang.String r5) {
            /*
                ...
                r0.<init>()
                r1 = 0
                android.database.Cursor r1 = r4.rawQuery(r5, r1)     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
            L38:
                boolean r4 = r1.moveToNext()     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                if (r4 == 0) goto L79
                com.xiaopeng.montecarlo.navcore.database.MigrationHelper$TableInfo r4 = new com.xiaopeng.montecarlo.navcore.database.MigrationHelper$TableInfo     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                r4.<init>()     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                r5 = 0
                int r2 = r1.getInt(r5)     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                r4.mCid = r2     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                r2 = 1
                java.lang.String r3 = r1.getString(r2)     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                r4.mName = r3     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                r3 = 2
                java.lang.String r3 = r1.getString(r3)     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                r4.mType = r3     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                r3 = 3
            ...
            L61:
                r3 = r5
            L62:
                r4.mNotnull = r3     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                r3 = 4
                java.lang.String r3 = r1.getString(r3)     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                r4.mDfltValue = r3     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                r3 = 5
                int r3 = r1.getInt(r3)     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
                if (r3 != r2) goto L73
                r5 = r2
            L73:
                r4.mPk = r5     // Catch: java.lang.Throwable -> L7c java.lang.Exception -> L7e
