...
public class CPInfo {
    ...
    private int ultraNums;
    private static final L.Tag TAG = new L.Tag("CPInfo");
    public static int COLUMNS = 10;

    public CPInfo(Long l, String str, String str2, String str3, String str4, String str5, String str6, byte b, double d, double d2, int i, int i2, int i3, String str7) {
        this.id = l;
        this.cityCode = str;
        this.stationId = str2;
    ...
    public static XPPoiInfo toXPPoiInfo(CPInfo cPInfo) {
        ...
        xPDeepChargingArr[0].setNumUltra(cPInfo.getUltraNums());
    ...
    public int getUltraNums() {
        return this.ultraNums;
    }

    public void setUltraNums(int i) {
        this.ultraNums = i;
    }
