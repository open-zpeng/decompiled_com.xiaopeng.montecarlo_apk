...
public class EHPServiceWrapper implements IEHPHdDataVersionObserver {
    ...
    public boolean init(boolean z) {
        ...
        this.mEHPService.addHdDataVersionObserver(this);
    ...
    public boolean uninit() {
        if (isEhpInited()) {
            this.mEHPService.removeHdDataVersionObserver(this);
    ...
    @Override // com.autonavi.gbl.ehp.observer.IEHPHdDataVersionObserver
    public void onHdDataVersion(String str) {
        L.Tag tag = TAG;
        L.i(tag, "onHdDataVersion : " + str);
        this.mEHPVersion = str;
    }

    public String getEHPVersion() {
        return this.mEHPVersion;
    }
}
