...
public class CalibrationVersionChecker {
    ...
    public static final String[] DEFAULT_CONFIG_FILE_LIST = {"EhpConfig.dat", "GRestConfig.ini", "GblConfig.json", "IdcConfig.dat"};
    public static final String[] SD_CARD_FILE_LIST = {"font_cn.ttf", "style.json", "GNaviConfig.xml", "GLndsConfig.xml", "res/global.db", "GuideConfig.json", "MultipleScreen.json", "GblConfig.json.bak", "description.json"};
