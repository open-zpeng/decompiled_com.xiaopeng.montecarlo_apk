...
public class DRLogSimulateThread implements Runnable {
    ...
    private void sendFakeGnss(String[] strArr, long j) {
        ...
        try {
            ...
            locSignData.gnss.point = new Coord2DDouble();
            ...
            locSignData.gnss.point.lon = parseDouble(strArr[8], CPSearchParam.PARAM_KEY_LON);
            locSignData.gnss.point.lat = parseDouble(strArr[9], CPSearchParam.PARAM_KEY_LAT);
