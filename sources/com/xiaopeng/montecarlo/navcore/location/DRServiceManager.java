...
public class DRServiceManager implements IXPLocationListener, CarServiceManager.IXPCarStateListener, PosServiceWrapper.IPosUpdateOneShotCallback {
    ...
    private Runnable mSetSaveLocStorageRunnable = new Runnable() { // from class: com.xiaopeng.montecarlo.navcore.location.DRServiceManager.1
        ...
        public void run() {
            ...
            if (DRServiceManager.this.mEnableBLDR && CarServiceManager.getInstance().isBcmPowerOn()) {
                ...
                XPCarLocation currentCarLocation = DRServiceManager.this.mPosServiceWrapper.getCurrentCarLocation();
                DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.VALUE_LAST_LOCAL_SAVE_LON, (long) (currentCarLocation.mLongitude * 1000000.0d));
                DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.VALUE_LAST_LOCAL_SAVE_LAT, (long) (currentCarLocation.mLatitude * 1000000.0d));
                DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.VALUE_LAST_LOCAL_SAVE_DIR, currentCarLocation.mCarDir);
            ...
            if (CarServiceManager.getInstance().isBcmPowerOn() && DRServiceManager.this.mEnableBLDR && fArr != null && fArr.length >= 3) {
                ...
                if (i != 1) {
                    ...
                    if (DRServiceManager.this.mGyrLossRate < -0.001f) {
                        ...
                        dRServiceManager14.mGyrTimeChipInt = (int) dRServiceManager14.mGyrTimeChipFloat;
                        if (DRServiceManager.this.mGyrCycleNum == DRServiceManager.this.mGyrTickCnt) {
                            DRServiceManager.this.mGyrTickCnt = i4;
                            DRServiceManager.this.mGyrTimeChipFloat = f4;
                            DRServiceManager.this.mGyrTimeChipInt = i4;
                            DRServiceManager.this.mSetGyrInterpolationFlag = z;
                            return;
                        }
                        return;
                        ...
                        dRServiceManager15.onGyroUpdate(fArr, f, millis, currentTimeMillis, -dRServiceManager15.mGyrTimeChipInt, xPSensorType);
                        DRServiceManager.access$9908(DRServiceManager.this);
                        DRServiceManager.this.mGyrTimeChipFloat += DRServiceManager.this.mGyrTimeChip;
                        DRServiceManager dRServiceManager16 = DRServiceManager.this;
                        dRServiceManager16.mGyrTimeChipInt = (int) dRServiceManager16.mGyrTimeChipFloat;
                        if (DRServiceManager.this.mGyrCycleNum == DRServiceManager.this.mGyrTickCnt) {
                ...
                if (DRServiceManager.this.mA3dDataCnt >= 600 && DRServiceManager.this.mA3dDataCntStartFlag) {
                    ...
                    dRServiceManager17.mA3dDataCntStart = dRServiceManager17.mA3dDataCnt;
                }
                if (DRServiceManager.this.mA3dDataCnt >= 1600 && DRServiceManager.this.mA3dDataCntEndFlag) {
                    ...
                    dRServiceManager18.mA3dDataCntEnd = dRServiceManager18.mA3dDataCnt;
                    ...
                    dRServiceManager19.mA3dCycleNum = (int) Math.abs(0.1f / (0.1f - (1.0f / dRServiceManager19.mA3dDataFreq)));
                ...
                if (DRServiceManager.this.mA3dLossRate < -0.001f) {
                    if (DRServiceManager.this.mSetA3dInterpolationFlag) {
                        ...
                        f3 = 0.0f;
                        str = ", CycleNum is ";
                        dRServiceManager20.onAccelUpdate(fArr, millis, currentTimeMillis, dRServiceManager20.mA3dTimeChipInt, xPSensorType);
                    }
                    ...
                    dRServiceManager21.mA3dTimeChipInt = (int) dRServiceManager21.mA3dTimeChipFloat;
                    if (DRServiceManager.this.mA3dCycleNum == DRServiceManager.this.mA3dTickCnt) {
                        DRServiceManager.this.mA3dTickCnt = 0;
                        DRServiceManager.this.mA3dTimeChipFloat = f3;
                ...
                if (DRServiceManager.this.mEnableBLDR) {
                    if (DRServiceManager.this.mCarSpeedDataCnt >= 600 && DRServiceManager.this.mCarSpeedDataCntStartFlag) {
                        ...
                        DRServiceManager.this.mCarSpeedDataCntEndFlag = true;
                        ...
                        dRServiceManager24.mCarSpeedDataCntStart = dRServiceManager24.mCarSpeedDataCnt;
                    }
                    if (DRServiceManager.this.mCarSpeedDataCnt >= 1600 && DRServiceManager.this.mCarSpeedDataCntEndFlag) {
                        ...
                        dRServiceManager25.mCarSpeedDataCntEnd = dRServiceManager25.mCarSpeedDataCnt;
                        ...
                        dRServiceManager26.mCarSpeedCycleNum = (int) Math.abs(0.1f / (0.1f - (1.0f / dRServiceManager26.mCarSpeedDataFreq)));
                    ...
                    if (((int) DRServiceManager.this.mEspRawSpeed) != 0 && !DRServiceManager.this.mCarSpeedInitStatus) {
                        DRServiceManager.this.mCarSpeedInitStatus = true;
                    }
                    if (!CarFeatureManager.INSTANCE.isEspAndScuAutoPilotSpeedFusionEnable()) {
                        if (DRServiceManager.this.mCarSpeedInitStatus) {
                            ...
                            dRServiceManager27.mCarSpeedTemp = dRServiceManager27.mCarForward * DRServiceManager.this.mEspRawSpeed;
                        } else {
                            DRServiceManager dRServiceManager28 = DRServiceManager.this;
                            dRServiceManager28.mCarSpeedTemp = (dRServiceManager28.mCarForward * DRServiceManager.this.mScuSpeed) / DRServiceManager.REAL_CAR_SPEED_SCALE_FACTOR;
                        }
                    } else {
                        DRServiceManager dRServiceManager29 = DRServiceManager.this;
                        dRServiceManager29.mCarSpeedTemp = dRServiceManager29.espAndScuAutoPilotSpeedFusion(dRServiceManager29.mCarForward * DRServiceManager.this.mEspRawSpeed, DRServiceManager.this.mScuAutoPilotSpeed);
                    }
                    if (!RootUtil.isUserVersion()) {
                        DRServiceManager dRServiceManager30 = DRServiceManager.this;
                        float onZeroSpeedCalibration = dRServiceManager30.onZeroSpeedCalibration(dRServiceManager30.mCarSpeedTemp);
                    ...
                    if (DRServiceManager.this.mCarSpeedLossRate < -0.001f) {
                        if (DRServiceManager.this.mSetCarSpeedInterpolationFlag) {
                            ...
                            dRServiceManager31.onSpeedUpdate(millis, currentTimeMillis, dRServiceManager31.mCarSpeedTemp, DRServiceManager.this.mCarSpeedTimeChipInt);
                        }
                        ...
                        dRServiceManager32.mCarSpeedTimeChipInt = (int) dRServiceManager32.mCarSpeedTimeChipFloat;
                        if (DRServiceManager.this.mCarSpeedCycleNum == DRServiceManager.this.mCarSpeedTickCnt) {
                            ...
                            DRServiceManager.this.mCarSpeedTimeChipFloat = f2;
                            DRServiceManager.this.mCarSpeedTimeChipInt = 0;
                            DRServiceManager.this.mSetCarSpeedInterpolationFlag = true;
                        }
                        ...
                        dRServiceManager34.mCarSpeedTimeChipInt = (int) dRServiceManager34.mCarSpeedTimeChipFloat;
                        if (DRServiceManager.this.mCarSpeedCycleNum == DRServiceManager.this.mCarSpeedTickCnt) {
                            DRServiceManager.this.mCarSpeedTickCnt = 0;
                            DRServiceManager.this.mCarSpeedTimeChipFloat = f2;
                            DRServiceManager.this.mCarSpeedTimeChipInt = 0;
                            ...
                            if (DRServiceManager.this.mSetCarSpeedInterpolationFlag) {
                                ...
                                dRServiceManager35.onSpeedUpdate(millis, currentTimeMillis, dRServiceManager35.mCarSpeedTemp, 0);
                            }
                        }
                    } else {
                        DRServiceManager dRServiceManager36 = DRServiceManager.this;
                        dRServiceManager36.onSpeedUpdate(millis, currentTimeMillis, dRServiceManager36.mCarSpeedTemp, 0);
                    }
                }
            }
        }
    ...
    public void onAccelUpdate(float[] fArr, long j, long j2, int i, IXpSensor.XPSensorType xPSensorType) {
        if (this.mMountAngle != null) {
            if (IXpSensor.XPSensorType.SENSOR_TYPE_IMU == xPSensorType) {
    ...
    public void onGearLevelChange(int i) {
        ...
        if (4 == this.mCarGearLevel) {
            ...
            XPCarLocation currentCarLocation = this.mPosServiceWrapper.getCurrentCarLocation();
            DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.VALUE_LAST_LOCAL_SAVE_LON, (long) (currentCarLocation.mLongitude * 1000000.0d));
            DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.VALUE_LAST_LOCAL_SAVE_LAT, (long) (currentCarLocation.mLatitude * 1000000.0d));
            DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.VALUE_LAST_LOCAL_SAVE_DIR, currentCarLocation.mCarDir);
        }
    ...
    @Override // com.xiaopeng.montecarlo.root.carservice.CarServiceManager.IXPCarStateListener
    public void onImuRawDataChange(boolean z, boolean z2, float[] fArr) {
        IXpSensor iXpSensor = this.mSensor;
        if (iXpSensor != null) {
            iXpSensor.setRawData(z, z2, fArr);
        }
    }
    ...
    private void sendNmeaLocData(GnssLocation gnssLocation) {
        this.mPosServiceWrapper.setLocation(gnssLocation, false);
    ...
    public void onNmeaReceived(long j, String str) {
        ...
        if (CarServiceManager.getInstance().isBcmPowerOn() && !TextUtils.isEmpty(str)) {
            ...
            if (gnssLocation != null && gnssLocation.getRmcUtcTime() == this.mGnssLocation.getGgaUtcTime() && this.mGnssLocation.isRmcEnable() && this.mGnssLocation.isGgaEnable() && this.mGnssLocation.isGsaEnable() && this.mGnssLocation.isGstEnable()) {
                ...
                sendNmeaLocData(this.mGnssLocation);
            }
        }
    }
    ...
    public void checkDataCityAdCode() {
        ...
        if (MapDataManager.getInstance().getAutoDownloadManager() != null) {
            MapDataManager.getInstance().getAutoDownloadManager().onAdCodeChanged(this.mCityAdCode);
        }
        DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.KEY_CURRENT_CITY_AD_CODE, this.mCityAdCode);
    }
