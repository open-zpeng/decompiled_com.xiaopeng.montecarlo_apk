...
public class DefaultAccountServiceObserver implements IAccountServiceObserver {
    ...
    @Override // com.autonavi.gbl.user.account.observer.IAccountServiceObserver
    public void notify(int i, int i2, @Nullable AccountCheckResult accountCheckResult) {
    ...
    @Override // com.autonavi.gbl.user.account.observer.IAccountServiceObserver
    public void notify(int i, int i2, @Nullable VerificationCodeResult verificationCodeResult) {
    ...
    @Override // com.autonavi.gbl.user.account.observer.IAccountServiceObserver
    public void notify(int i, int i2, @Nullable MobileLoginResult mobileLoginResult) {
    ...
    @Override // com.autonavi.gbl.user.account.observer.IAccountServiceObserver
    public void notify(int i, int i2, @Nullable final QRCodeLoginResult qRCodeLoginResult) {
    ...
    @Override // com.autonavi.gbl.user.account.observer.IAccountServiceObserver
    public void notify(int i, int i2, @Nullable QRCodeLoginConfirmResult qRCodeLoginConfirmResult) {
