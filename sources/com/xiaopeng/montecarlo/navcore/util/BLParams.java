...
public class BLParams {
    ...
    public static final int ACTIVATE_CODE_CHECKERROR = 1140850688;
    public static final int ACTIVATE_FAIL = -1;
    public static final int ACTIVATE_FILE_FLUSHFAIL = 10;
    public static final int ACTIVATE_FILE_OPENERROR = 16777216;
    public static final int ACTIVATE_FILE_SYNCFAIL = 9;
    public static final int ACTIVATE_INPUT_DEVIDERROR = 1140850689;
    public static final int ACTIVATE_INPUT_LOGINCODEERROR = 1140850691;
    public static final int ACTIVATE_INPUT_NET_ERROR = 1140850694;
    public static final int ACTIVATE_INPUT_USERCODEERROR = 1140850690;
    ...
    public static final int ROUTE_FAIL_BUFFER_FORMAT_ERROR = 822083592;
    public static final int ROUTE_FAIL_CALCULATE_FAIL = 1;
    public static final int ROUTE_FAIL_DANGER_ELUDE_FAIL = 822083617;
    public static final int ROUTE_FAIL_DECODER_NOT_INIT = 822083584;
    public static final int ROUTE_FAIL_DISTANCE_TOO_LONG = 822083602;
    public static final int ROUTE_FAIL_DISTANCE_TOO_SHORT = 38;
    public static final int ROUTE_FAIL_END_POINT_CITY_NO_OFFLINE_DATA = 822083607;
    public static final int ROUTE_FAIL_END_POINT_ERROR = 822083589;
    public static final int ROUTE_FAIL_END_POINT_NO_ROUTE = 822083594;
    public static final int ROUTE_FAIL_GET_INFO_FAIL = 822083588;
    public static final int ROUTE_FAIL_HAVE_UNUSUAL_ACTION = 822083615;
    public static final int ROUTE_FAIL_JAM_ELUDE_FAIL = 822083616;
    public static final int ROUTE_FAIL_MULTI_ROUTE_ID_NULL = 822083613;
    public static final int ROUTE_FAIL_NETWORK_ERROR = 822083585;
    public static final int ROUTE_FAIL_NETWORK_NO_CONNECT = 822083600;
    public static final int ROUTE_FAIL_NETWORK_TIMEOUT = 822083599;
    public static final int ROUTE_FAIL_NO_BEST_ROUTE = 822083614;
    public static final int ROUTE_FAIL_NO_MULTI_ROUTE = 822083612;
    public static final int ROUTE_FAIL_NO_ROUTE_RECOMMEND = 822083611;
    public static final int ROUTE_FAIL_OFFLINE_ROUTE_FAIL = 822083597;
    public static final int ROUTE_FAIL_OFFLINE_ROUTING = 822083609;
    public static final int ROUTE_FAIL_OFFLINT_ROUTE_PARAMS_ERROR = 822083610;
    public static final int ROUTE_FAIL_ONLINE_TO_OFFLINE = 822083620;
    public static final int ROUTE_FAIL_PREVIEW_DATA_LACK = 822083591;
    public static final int ROUTE_FAIL_PROTOCOL_ILLEGAL = 822083587;
    public static final int ROUTE_FAIL_REPLACE_CHARGE = 39;
    public static final int ROUTE_FAIL_REQUEST_CALL = 822083619;
    public static final int ROUTE_FAIL_ROUTE_TYPE_ERROR = 822083606;
    public static final int ROUTE_FAIL_SERVER_ERROR = 822083590;
    public static final int ROUTE_FAIL_START_POINT_ERROR = 822083586;
    public static final int ROUTE_FAIL_START_POINT_NO_OFFLINE_DATA = 822083601;
    public static final int ROUTE_FAIL_START_POINT_NO_ROUTE = 822083593;
    public static final int ROUTE_FAIL_TIME_OUT = 822083618;
    public static final int ROUTE_FAIL_UNKNOWN_ERROR = 822083596;
    public static final int ROUTE_FAIL_UPDATING = 822083605;
    public static final int ROUTE_FAIL_USER_CANCEL = 822083598;
    public static final int ROUTE_FAIL_VIA_CITY_NO_OFFLINE_DATA = 822083603;
    public static final int ROUTE_FAIL_VIA_POINT_CITY_NO_OFFLINE_DATA = 822083608;
    public static final int ROUTE_FAIL_VIA_POINT_ERROR = 822083604;
    public static final int ROUTE_FAIL_VIA_POINT_NO_ROUTE = 822083595;
