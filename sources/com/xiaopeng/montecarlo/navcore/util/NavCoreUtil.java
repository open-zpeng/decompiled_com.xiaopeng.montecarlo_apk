...
public class NavCoreUtil {
    ...
    public static final String LANE_CAR_PATH = "/scissorsGate-" + getScissorsGate() + "/color-" + getBodyColor();
    ...
    public static boolean isNaviIntervalCamera(@SubCameraExtType.SubCameraExtType1 int i) {
        switch (i) {
            case 25:
            case 26:
            case 27:
    ...
    public static boolean isNetworkError(int i) {
        return 822083585 == i || 822083599 == i || 822083600 == i;
    }
    ...
    public static int getScissorsGate() {
        return SystemProperties.getInt("persist.sys.xiaopeng.scissorsGate", 0);
    }
    ...
    */
    ...
    private static int[] byte2ColorInt(byte[] bArr, int i) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            int i7 = (i5 & 255) << 8;
            int i8 = i4 & 255;
            if (((((b & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 24) | i6 | i7 | i8) & (-1)) == TBTManager.getInstance().getManeuverBackColor()) {
                b = (byte) (b & i);
            }
            iArr[i2] = (i6 | ((b & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 24) | i7 | i8) & (-1);
        }
        return iArr;
    }
