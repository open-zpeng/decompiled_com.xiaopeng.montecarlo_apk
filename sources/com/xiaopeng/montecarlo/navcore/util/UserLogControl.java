...
public enum UserLogControl {
    ...
    public void checkAndReportLogStatus() {
        if (RootUtil.isRemoteOpenLog()) {
            ...
            AfterSalesUtil.getInstance().recordDiagnosisError(AfterSalesUtil.ERROR_CODE_REMOTE_LOG_OPEN, Double.valueOf(LogFileManager.getFsAvailaleSize(RootUtil.DIR_BL_LOG) / 1.073741824E9d).toString());
        }
    }
