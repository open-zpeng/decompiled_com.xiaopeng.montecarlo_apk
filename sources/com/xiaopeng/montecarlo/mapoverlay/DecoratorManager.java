...
public class DecoratorManager {
    ...
    public BaseMapDecorator getCurrentSearchDecorator() {
        return findDecorator(this.mMainContext.getCurrentScene(), DecoratorType.SEARCH);
    }
    ...
    public void showMapDecorator(IBaseScene iBaseScene, DecoratorType decoratorType, Bundle bundle) {
        if (L.ENABLE) {
            L.Tag tag = TAG;
            L.d(tag, "showMapDecorator scene:" + iBaseScene + ",type:" + decoratorType);
        }
    ...
    public BaseMapDecorator getCurrentActiveDecorator() {
        return this.mCurrentActiveDecorator;
    }

    public XPPoiInfo getCurrentFocusPoint() {
        BaseMapDecorator baseMapDecorator = this.mCurrentActiveDecorator;
        if (baseMapDecorator == null || !baseMapDecorator.isFocus()) {
            return null;
        }
        return this.mCurrentActiveDecorator.getCurrentExpandedPoi();
    }
