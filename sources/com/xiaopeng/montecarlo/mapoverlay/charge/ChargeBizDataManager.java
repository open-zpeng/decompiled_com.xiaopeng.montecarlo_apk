...
public class ChargeBizDataManager {
    ...
    private TextView mTotalNum = null;
    private ImageView mIvCooperate = null;
    private ImageView mIvCooperateIcon = null;
    ...
    public void createChargeTextureViewAync(final MapViewWrapper mapViewWrapper, final ChargeBizData chargeBizData) {
        WorkThreadUtil.getInstance().executeIOTask(new Runnable() { // from class: com.xiaopeng.montecarlo.mapoverlay.charge.ChargeBizDataManager.1
    ...
    */
    public void createChargeTextureViewSync(com.xiaopeng.montecarlo.navcore.mapdisplay.MapViewWrapper r18, com.xiaopeng.montecarlo.mapoverlay.charge.ChargeBizData r19) {
        /*
