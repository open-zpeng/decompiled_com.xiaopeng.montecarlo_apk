...
public class NavRestoreManager implements CarServiceManager.IXPCarStateListener, AiMsgManager.MsgListener {
    ...
    public void powerOff() {
        ...
        if (TBTManager.getInstance().isInit()) {
            ...
            if (currentStatus != 0) {
                ...
                if (restoreRouteParams != null && restoreRouteParams.mRestoreRouteData != null) {
                    restoreRouteParams.mRestoreRouteData.clear();
                }
                ...
                if (d > 1000.0d && (currentStatus == 1 || z)) {
                    ...
                    i--;
                    LaneServiceManager.getInstance().saveHappyEnding();
                }
    ...
    private void checkRestoreNavi(int i, long j) {
        ...
        if (z) {
            LaneServiceManager.getInstance().restoreHappyEnding();
        }
