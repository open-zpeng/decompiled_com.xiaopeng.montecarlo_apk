...
public class NaviFragment_ViewBinding implements Unbinder {
    ...
    public NaviFragment_ViewBinding(final NaviFragment naviFragment, View view) {
        ...
        naviFragment.mTrafficLightView = (XpTrafficLightView) Utils.findRequiredViewAsType(view, R.id.traffic_light_view, "field 'mTrafficLightView'", XpTrafficLightView.class);
    ...
    public void unbind() {
        ...
        naviFragment.mTrafficLightView = null;
        ...
        this.view7f0902bc.setOnLongClickListener(null);
