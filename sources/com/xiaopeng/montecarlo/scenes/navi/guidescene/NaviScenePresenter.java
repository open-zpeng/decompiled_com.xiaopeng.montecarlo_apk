...
public class NaviScenePresenter extends BaseNaviPresenter<INaviContract.LogicView> implements INaviContract.Presenter {
    ...
    public void onViewCreated(@NonNull NaviPresenterData naviPresenterData) {
        ...
        if (naviPresenterData.getIsNeedToSrNav() && SRNaviManager.getInstance().canShowSRScene()) {
    ...
    public void setRecommendParkZoomLevel(boolean z) {
        ...
        if (isRecommendParkDebug()) {
            getLogicView().runOnUiThreadDelayed(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviScenePresenter.3
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void showRecommendParkImage(List<XPPoiInfo> list, boolean z) {
        if (CollectionUtils.isNotEmpty(list)) {
            ...
            getLogicView().runOnUiThread(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviScenePresenter.4
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void addParkOverlay() {
        if (CollectionUtils.isNotEmpty(this.mRecommendParkData)) {
            getMapView().getBizControlManager().setVisible(BizControlWrapper.BIZ_CONTROL_TYPE_SEARCH, 7010, true);
            getMapView().getBizControlManager().addItems(BizControlWrapper.BIZ_CONTROL_TYPE_SEARCH, 7010, this.mRecommendParkData);
        }
    }
    ...
    public void onNaviEvent(final GuideWrapperNaviEvent guideWrapperNaviEvent) {
        UiHandlerUtil.getInstance().post(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviScenePresenter.6
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void switchOverView() {
        getLogicView().runOnUiThread(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviScenePresenter.7
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void resetCruiseAheadTrafficBroadcastWithSetting() {
        ...
        L.Tag tag = TAG;
        L.i(tag, "reset Cruise Ahead Traffic Broadcast With Setting:" + isCruiseAheadTraffict);
        TBTManager.getInstance().setCruiseAheadTraffic(isCruiseAheadTraffict);
    }
    ...
    protected IXpLayerClickObserver getBizOverlayObserver() {
        return new IXpLayerClickObserver() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviScenePresenter.8
    ...
    private void handleBizRouteTypeGuideLabelClick(final long j, final double d, final double d2) {
        UiHandlerUtil.getInstance().post(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviScenePresenter.9
            @Override // java.lang.Runnable
            public void run() {
    ...
    private void handleGuideOverlayTypeParkingClick(final int i) {
        UiHandlerUtil.getInstance().post(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviScenePresenter.12
            ...
            public void run() {
                ...
                MapOpStatUtil.sendStatDataWhenMapClick(NaviScenePresenter.this.getLogicView().getMainContext(), BLParams.GuideOverlayTypeParking, 2, NaviScenePresenter.this.mRecommendParkData.get(i).mPos3D.lon, NaviScenePresenter.this.mRecommendParkData.get(i).mPos3D.lat);
            }
        });
    }
