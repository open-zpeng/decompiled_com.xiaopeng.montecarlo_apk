...
public class NaviFragment extends BaseMapScene implements INaviContract.LogicView, ISceneMapFragmentListener, RestrictHelper.IRestrictView, RecommendParkView.RecommendParkViewListener, View.OnClickListener {
    ...
    public NaviScenePresenter mo116getPresenter() {
    ...
    public void onStateImmersion() {
        ...
        UiHandlerUtil.getInstance().postDelayed(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviFragment.7
            @Override // java.lang.Runnable
            public void run() {
                NaviFragment.this.mPresenter.refresh2DCross();
            }
        }, 300L);
    ...
    private void initSRViewAngle() {
        ...
        if (xRadioGroup != null) {
            xRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviFragment.8
    ...
    public void onShowRecommendParking(List<XPPoiInfo> list, final boolean z) {
        ...
        SceneAnimHelper.getShowAnim(this, new AnimBuilder() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviFragment.9
    ...
    public void onHideOfflineRoutePanel() {
        if (isSceneLegal() && this.mOfflineView != null) {
            if (L.ENABLE) {
                L.Tag tag = TAG;
                L.d(tag, "onHideOfflineRoutePanel:" + this.mOfflineView.getVisibility());
            }
            if (this.mOfflineView.getVisibility() == 0) {
    ...
    public void updateRestrictPopLayout() {
        ...
        if (isSceneLegal() && (restrictHelper = this.mRestrictHelper) != null && restrictHelper.isRestrictedPopShow()) {
            UiHandlerUtil.getInstance().post(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviFragment.10
                @Override // java.lang.Runnable
                public void run() {
        ...
        if (isEagleEyeEnable()) {
            if (!getMapView().getBizControlManager().isInitEagleye() && !getMapView().isDayNightSwitching()) {
                ...
                if (!getMapView().getBizControlManager().isInitEagleye() && !getMapView().isDayNightSwitching()) {
                    ...
                    if (i < 3) {
                        runOnUiThreadDelayed(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviFragment.11
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    private void showContinueNavi() {
        ...
        if (L.ENABLE) {
            L.Tag tag = TAG;
            L.d(tag, "showContinueNavi isPreview : " + mo116getPresenter().isPreview() + ", mHasMotionEvent : " + this.mHasMotionEvent + ", mIs3DCrossShow : " + this.mIs3DCrossShow + ", isContinueNaviShown : " + z);
        }
        if (mo116getPresenter().isPreview()) {
            return;
        }
        ...
        this.mTvContinuNavi.setOnClickListener(new View.OnClickListener() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.NaviFragment.12
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.im_navi_info_turn /* 2131296724 */:
                ...
                return;
            case R.id.tv_sr_dynamic_level_mode /* 2131297593 */:
    ...
    public boolean onInterceptVuiEvent(View view, VuiEvent vuiEvent) {
        ...
        if (onInterceptFindTargetVuiElement != null) {
            CommonNaviVuiHelper.handleRecommendParkVuiAction(view, onInterceptFindTargetVuiElement, mo116getPresenter());
            return true;
        }
