...
import com.xiaopeng.montecarlo.views.XpTrafficLightView;
...
public class NaviFragment extends BaseMapScene implements INaviContract.LogicView, ISceneMapFragmentListener, RestrictHelper.IRestrictView, RecommendParkView.RecommendParkViewListener, View.OnClickListener {
    ...
    @BindView(R.id.traffic_light_view)
    XpTrafficLightView mTrafficLightView;
    ...
    public void observeSRNaviData() {
        SRNaviManager.getInstance().getSRInfo().getTrafficLightLiveData().observe(this, new Observer() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.-$$Lambda$NaviFragment$sJ7A0Yf1yYjocwmFfa3s3lQx7pk
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                NaviFragment.this.lambda$observeSRNaviData$0$NaviFragment((TrafficLightState) obj);
            }
        });
    }

    public /* synthetic */ void lambda$observeSRNaviData$0$NaviFragment(TrafficLightState trafficLightState) {
        L.Tag tag = TAG;
        L.i(tag, "analysisOverallData onTrafficLightChange:" + trafficLightState);
        this.mTrafficLightView.setTrafficLightState(trafficLightState);
    }
    ...
    public void onSceneViewCreated(View view, Bundle bundle) {
        ...
        if (bundle2 != null) {
            ...
            z5 = bundle2.getBoolean(NaviUtil.IS_NEED_TO_SR, false);
    ...
    public void initView() {
        ...
        if (Utils.isLandscape()) {
            ...
            this.mTrafficBar.setCarMoveListener(new TrafficBar.OnCarMoveListener() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.-$$Lambda$NaviFragment$8Ef0tSZISzUwtoqrtHnATK8mQi8
                @Override // com.xiaopeng.montecarlo.views.TrafficBar.OnCarMoveListener
                public final void onCarMove(float f) {
                    NaviFragment.this.lambda$initView$1$NaviFragment(f);
                }
            });
    ...
    public /* synthetic */ void lambda$initView$1$NaviFragment(float f) {
    ...
    private void updateTimeArrive() {
        ...
        if (this.mNaviInfo == null) {
            ...
            double kValue = PowerDistanceManager.getInstance().getKValue(this.mNaviInfo.mPathID);
            int i2 = (int) (carRemainDistance - (d * kValue));
            try {
                i = NaviUtil.checkDistanceReachableStatus(carRemainDistance, i2);
            } catch (NaviUtil.DistanceStatusIllegalArgumentException unused) {
                L.w(TAG, "invalid value carRemainDis: " + carRemainDistance + ", afterArriveRemainDis: " + i2);
                i = 0;
            }
            if (this.logIndex > 5) {
                this.logIndex = 0;
            }
            if (L.ENABLE || this.logIndex == 0) {
                L.i(TAG, "remainDis:" + d + ", remainTime:" + d2 + ", carRemainDis:" + carRemainDistance + ", afterArriveRemainDis:" + i2 + ", status:" + i + ", k:" + kValue);
            }
            if (i == 0) {
                ...
                if (carRemainDistance >= 20000) {
                    String[] remainDistanceArray2 = NaviUtil.getRemainDistanceArray(i2);
    ...
    public NaviScenePresenter mo118getPresenter() {
    ...
    public void onShowCrossImage(XPCrossImageInfo xPCrossImageInfo) {
        ...
        if (i == 1) {
            ...
            showBLCrossImage(xPCrossImageInfo, new IBizCrossListener() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.-$$Lambda$NaviFragment$y8QVmPRXH5k1pmbFUbPCrsR6r5s
                @Override // com.xiaopeng.montecarlo.navcore.control.base.IBizCrossListener
                public final void onShowCross(boolean z) {
                    NaviFragment.this.lambda$onShowCrossImage$4$NaviFragment(z);
                }
            });
        } else if (i != 4) {
        } else {
    ...
    public /* synthetic */ void lambda$onShowCrossImage$4$NaviFragment(boolean z) {
        if (z) {
            ...
            UiHandlerUtil.getInstance().runOnUiThread(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.-$$Lambda$NaviFragment$1MrgX8YGfyIxGbi288b5uVtgePE
                @Override // java.lang.Runnable
                public final void run() {
                    NaviFragment.this.lambda$null$3$NaviFragment();
                }
            });
        }
    }
    ...
    public /* synthetic */ void lambda$null$3$NaviFragment() {
    ...
    private void showCross3D(XPCrossImageInfo xPCrossImageInfo) {
        ...
        showBLCrossImage(xPCrossImageInfo, new IBizCrossListener() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.-$$Lambda$NaviFragment$kGEnMAbNvZqgN8U5B7WEHTSdHzs
            @Override // com.xiaopeng.montecarlo.navcore.control.base.IBizCrossListener
            public final void onShowCross(boolean z) {
                NaviFragment.this.lambda$showCross3D$6$NaviFragment(z);
            }
        });
    }

    public /* synthetic */ void lambda$showCross3D$6$NaviFragment(final boolean z) {
        UiHandlerUtil.getInstance().runOnUiThread(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.-$$Lambda$NaviFragment$2V91TTR2MK4Zbk1yOozdG302VRM
            @Override // java.lang.Runnable
            public final void run() {
                NaviFragment.this.lambda$null$5$NaviFragment(z);
            }
        });
    }

    public /* synthetic */ void lambda$null$5$NaviFragment(boolean z) {
        if (isLegal()) {
            if (z) {
    ...
    private void hideCross3D() {
        getMapView().getBizControlManager().hideCross(4, new IBizCrossListener() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.-$$Lambda$NaviFragment$kdT4qaBw1cZbaRG1lYa0-Hfy-lk
            @Override // com.xiaopeng.montecarlo.navcore.control.base.IBizCrossListener
            public final void onShowCross(boolean z) {
                NaviFragment.this.lambda$hideCross3D$8$NaviFragment(z);
            }
        });
    }

    public /* synthetic */ void lambda$hideCross3D$8$NaviFragment(boolean z) {
        UiHandlerUtil.getInstance().runOnUiThread(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.-$$Lambda$NaviFragment$lBWi2ptj7n49xBFWM5iEk1_p5LY
            @Override // java.lang.Runnable
            public final void run() {
                NaviFragment.this.lambda$null$7$NaviFragment();
            }
        });
    }

    public /* synthetic */ void lambda$null$7$NaviFragment() {
    ...
    public void onHideCrossImage(int i) {
        if (!isSceneLegal()) {
            ...
            getMapView().getBizControlManager().hideCross(i, new IBizCrossListener() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.-$$Lambda$NaviFragment$Gu0VTEedTCSrwVEhgMa2JxqtCYE
                @Override // com.xiaopeng.montecarlo.navcore.control.base.IBizCrossListener
                public final void onShowCross(boolean z) {
                    NaviFragment.this.lambda$onHideCrossImage$10$NaviFragment(z);
                }
            });
        } else if (i != 4) {
        } else {
    ...
    public /* synthetic */ void lambda$null$9$NaviFragment() {
        updateViewsOnCross2DVisibilityChange(false);
    }

    public /* synthetic */ void lambda$onHideCrossImage$10$NaviFragment(boolean z) {
        UiHandlerUtil.getInstance().runOnUiThread(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.-$$Lambda$NaviFragment$cTMBnPHjw0w3R5rGt2H68yN_urQ
            @Override // java.lang.Runnable
            public final void run() {
                NaviFragment.this.lambda$null$9$NaviFragment();
            }
        });
    }
    ...
    public void hideCrossUI() {
        ...
        updateViewsOnCross2DVisibilityChange(false);
        getMapView().getBizControlManager().hideCrossUI(new IBizCrossListener() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.-$$Lambda$NaviFragment$fddE3MHtf9-lhhK3QCoZbtTvkbU
            @Override // com.xiaopeng.montecarlo.navcore.control.base.IBizCrossListener
            public final void onShowCross(boolean z) {
                NaviFragment.this.lambda$hideCrossUI$12$NaviFragment(z);
            }
        });
        hideCross3D();
    }

    public /* synthetic */ void lambda$hideCrossUI$12$NaviFragment(boolean z) {
        UiHandlerUtil.getInstance().runOnUiThread(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.navi.guidescene.-$$Lambda$NaviFragment$KjHorH8Swk1GNDJrM5PH0HDbKtU
            @Override // java.lang.Runnable
            public final void run() {
                NaviFragment.this.lambda$null$11$NaviFragment();
            }
        });
    }

    public /* synthetic */ void lambda$null$11$NaviFragment() {
        updateViewsOnCross2DVisibilityChange(false);
    }
    ...
    private void updateSRViewAngleVuiState(boolean z) {
        if (this.mSRViewAngleBtnGroup != null && CarFeatureManager.INSTANCE.isVoiceCmdSRViewAngleEnable()) {
            if (z) {
                if (L.ENABLE) {
    ...
    public void onMoveBegin(long j, long j2) {
        ...
        if (this.mPresenter.isLaneViewShow()) {
            LaneServiceManager.getInstance().openFollowMode(1, false);
        }
    }
    ...
    private void setDynamicLevelModeText() {
        ...
        if (sRDynamicLevelMode == 0) {
            ...
            this.mSRLevelValue.setText(Utils.floatToString(LaneServiceManager.getInstance().getCurrentLowSpeedLevel()));
        } else if (sRDynamicLevelMode != 1) {
        } else {
            this.mSRLevelMode.setText(getString(R.string.button_speed_mode));
            this.mSRDynamicLevelMode.setText("high");
            this.mSRLevelValue.setText(Utils.floatToString(LaneServiceManager.getInstance().getCurrentHighSpeedLevel()));
        }
    }
    ...
    @Override // com.xiaopeng.montecarlo.scenes.navi.IBaseNgpLogicView
    public void onUpdateNgpLcTips(int i, int i2, int i3, boolean z, boolean z2) {
        if (isSceneLegal() && this.mXpNgpPanelView != null) {
            String tipsText = getTipsText();
            this.mXpNgpPanelView.updateNgpLcTips(SRUtil.getNgpPanelStatus(SRNaviManager.getInstance().getScuNgpLcTips1Status(), SRNaviManager.getInstance().getScuNgpOpeButtonStatus(), !TextUtils.isEmpty(tipsText)), i3, z, i2 != -1 ? ThemeWatcherUtil.getDrawable(i2) : null, tipsText);
            this.mXpNgpPanelView.updateNgpOperateBtnStatus(true);
            this.mXpNgpPanelView.updateLcTipsArrow(i2, z2);
        }
    }
    ...
    private String getTipsText() {
        ...
        if (SRUtil.isLcTipsPriorToOddStatus(scuNgpLcTips1Status, scuQuitNgpOddStatus, SRNaviManager.getInstance().isLcTipsChange()) && scuNgpLcTips1Status > 0) {
        ...
        str = SRDataUtil.isLccStatus(SRNaviManager.getInstance().getDriveMode()) ? this.mNgpLccText : "";
        return TextUtils.isEmpty(str) ? str : str;
    }

    @Override // com.xiaopeng.montecarlo.scenes.navi.IBaseNgpLogicView
    public void onUpdateNgpLcTipsToLccMode(int i, boolean z, int i2) {
        if (isSceneLegal() && this.mXpNgpPanelView != null) {
            this.mXpNgpPanelView.updateNgpLcTips(SRUtil.getNgpPanelStatus(SRNaviManager.getInstance().getScuNgpLcTips1Status(), SRNaviManager.getInstance().getScuNgpOpeButtonStatus(), !TextUtils.isEmpty(getTipsText())), i2, false, i != -1 ? ThemeWatcherUtil.getDrawable(i) : null, this.mNgpLccText);
            this.mXpNgpPanelView.updateNgpOperateBtnStatus(true);
            this.mXpNgpPanelView.updateLcTipsArrow(i, z);
        }
    }
    ...
    @Override // com.xiaopeng.montecarlo.scenes.navi.IBaseNgpLogicView
    public void onUpdateNgpQuitTips(boolean z, int i, int i2, int i3, int i4) {
        if (isSceneLegal() && this.mXpNgpPanelView != null && z && i4 < this.mNgpQuitTips.length) {
            int scuNgpLcTips1Status = SRNaviManager.getInstance().getScuNgpLcTips1Status();
            int nGPLaneChangedStatus = SRNaviManager.getInstance().getNGPLaneChangedStatus();
            this.mXpNgpPanelView.updateNgpLcTips(0, scuNgpLcTips1Status, SRUtil.isNgpPanelNeedAnimator(scuNgpLcTips1Status, i2), ThemeWatcherUtil.getDrawable(i3), String.valueOf(this.mNgpQuitTips[i4]));
            this.mXpNgpPanelView.updateNgpOperateBtnStatus(false);
            this.mXpNgpPanelView.updateLcTipsArrow(i3, SRUtil.isIconAnimator(nGPLaneChangedStatus, scuNgpLcTips1Status));
        }
    }
    ...
    public void onShowRecommendRoutePop(String str, int i, String str2, String str3, SpannableString spannableString, IVariantPath iVariantPath, int i2, boolean z) {
        ...
        RecommendRoutePop recommendRoutePop = this.mRecommendRoutePop;
        if (recommendRoutePop != null) {
            recommendRoutePop.setListener(mo118getPresenter().getRecommendRouteSwitchListener());
    ...
    private void showContinueNavi() {
        ...
        if (L.ENABLE) {
            L.Tag tag = TAG;
            L.d(tag, "showContinueNavi isPreview : " + mo118getPresenter().isPreview() + ", mHasMotionEvent : " + this.mHasMotionEvent + ", mIs3DCrossShow : " + this.mIs3DCrossShow + ", isContinueNaviShown : " + z);
        }
        if (mo118getPresenter().isPreview()) {
            return;
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_sr_level_down /* 2131296450 */:
                this.mPresenter.setLevelDown();
                setDynamicLevelModeText();
                return;
            case R.id.btn_sr_level_up /* 2131296451 */:
                this.mPresenter.setLevelUp();
                setDynamicLevelModeText();
                return;
            case R.id.guide_navi_info /* 2131296691 */:
                NaviScenePresenter naviScenePresenter = this.mPresenter;
                if (naviScenePresenter != null) {
                ...
                return;
            case R.id.im_navi_info_turn /* 2131296745 */:
                NaviScenePresenter naviScenePresenter2 = this.mPresenter;
                ...
                return;
            case R.id.tv_sr_dynamic_level_mode /* 2131297629 */:
                this.mPresenter.changeDynamicLevelSubMode();
                setDynamicLevelModeText();
                return;
            default:
                return;
    ...
    public boolean onInterceptVuiEvent(View view, VuiEvent vuiEvent) {
        ...
        if (onInterceptFindTargetVuiElement != null) {
            CommonNaviVuiHelper.handleRecommendParkVuiAction(view, onInterceptFindTargetVuiElement, mo118getPresenter());
            return true;
        }
    ...
    public void onVuiEvent(View view, VuiEvent vuiEvent) {
        ...
        if (CommonNaviVuiHelper.onVuiEventHandleRouteAlterLabel(view, vuiEvent, mo118getPresenter(), this)) {
            return;
        }
