...
public class ExploreFragment extends BaseMapScene implements IExploreContract.LogicView, RouteDetailItemView.OnItemClickListener, RestrictHelper.IRestrictView, RouteDetailPanel.IActionListener {
    ...
    public ExploreScenePresenter mo118getPresenter() {
    ...
    private void showRouteContent(IPathResult iPathResult, int i) {
        ...
        while (i9 >= 0) {
            ...
            int i14 = i9 + 1;
            RouteDetailItemView routeDetailItemView2 = (RouteDetailItemView) this.mRoutDetailContainer.getChildAt(i9);
            if (routeDetailItemView2 != null) {
                routeDetailItemView2.setVisibility(8);
            }
            i12 = i13;
            i9 = i14;
        }
    ...
    */
    ...
    public boolean onInterceptVuiEvent(View view, VuiEvent vuiEvent) {
        ...
        if (onInterceptFindTargetVuiElement != null) {
            CommonNaviVuiHelper.handleSelectRouteVuiAction(view, onInterceptFindTargetVuiElement, mo118getPresenter());
            return true;
        }
