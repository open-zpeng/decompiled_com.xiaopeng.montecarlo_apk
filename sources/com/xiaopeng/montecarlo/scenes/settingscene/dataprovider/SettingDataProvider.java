...
public class SettingDataProvider extends BaseDataProvider<SettingResultData, SettingRequestParam, BaseCallBack> {
    ...
    public String getMapPublicationNumContent() {
        return MapDataManager.getInstance().getMapNumContent();
    }

    public String getMapInternetNumContent() {
        return MapDataManager.getInstance().getInternetMapNumContent();
    }

    public String getMapLaneNumContent() {
        return MapDataManager.getInstance().getLocalLane30MapNumContent();
    }
