...
public class SettingLicencePlateFragment extends BaseFullScenes implements ISettingLicencePlateContract.LogicView {
    ...
    public void onClickLicencePlate() {
        ...
        save(this.mProvinceBtn.getText().toString() + text.toString().toUpperCase(Locale.getDefault()));
    }
        ...
        this.mEditView.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: com.xiaopeng.montecarlo.scenes.settingscene.SettingLicencePlateFragment.1
            ...
            public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                if (i == 6) {
                    ...
                    SettingLicencePlateFragment.this.save(SettingLicencePlateFragment.this.mProvinceBtn.getText().toString() + text.toString().toUpperCase(Locale.getDefault()));
                    return true;
                }
                return false;
            }
    ...
    public SettingLicencePlatePresenter mo116getPresenter() {
