...
import com.xiaopeng.montecarlo.scenes.settingscene.recycleview.SettingPreferenceAdapterProvider;
...
public class SettingFragment extends BaseFullScenes implements ISettingContract.LogicView, AccountObserver {
    ...
    public SettingPreferencePresenter mo118getPresenter() {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_return /* 2131296441 */:
                ...
                return;
            case R.id.setting_left_main_tab /* 2131297294 */:
                ...
                return;
            case R.id.setting_left_more_tab /* 2131297295 */:
    ...
    public void bindView(ISettingContract.BindViewParam bindViewParam) {
        ...
        this.mAdapter.getProvider().setPublicationUnityMapContent(bindViewParam.mPublicationMapContent);
        this.mAdapter.getProvider().setInternetUnityMapContent(bindViewParam.mInternetMapContent);
        SettingPreferenceAdapterProvider provider = this.mAdapter.getProvider();
        if (TextUtils.isEmpty(bindViewParam.mLaneMapContent)) {
            str = "";
        } else {
            str = ContextUtils.getString(R.string.setting_lane_num_prefix) + bindViewParam.mLaneMapContent;
        }
        provider.setLaneMapContent(str);
    ...
    public void onThemeSwitchDelegate(ThemeType themeType) {
        ...
        renderSettingByThemeSwitch(themeType);
    }

    private void renderSettingByThemeSwitch(ThemeType themeType) {
