...
public class SettingPreferenceAdapterView extends RecyclerView.Adapter {
    ...
    private void createRecycleViewDataList() {
        ...
        final int indexOf = this.mRecycleViewDataList.indexOf(SettingPreferenceTypeEnum.SETTING_PREFERENCE_REAL_TIME_TRAFFIC);
        this.disposable = Observable.fromCallable(new Callable() { // from class: com.xiaopeng.montecarlo.scenes.settingscene.recycleview.-$$Lambda$SettingPreferenceAdapterView$7EF__KG8QL1nGTqudSbOjVwGkxQ
            @Override // java.util.concurrent.Callable
            public final Object call() {
                Boolean valueOf;
                valueOf = Boolean.valueOf(CommonUtil.isScratchSpotEnable());
                return valueOf;
            }
        }).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer() { // from class: com.xiaopeng.montecarlo.scenes.settingscene.recycleview.-$$Lambda$SettingPreferenceAdapterView$mUaaix7lV9f4nV6RrronfQ9hDFg
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                SettingPreferenceAdapterView.this.lambda$createRecycleViewDataList$1$SettingPreferenceAdapterView(indexOf, (Boolean) obj);
            }
        });
    ...
    public /* synthetic */ void lambda$createRecycleViewDataList$1$SettingPreferenceAdapterView(int i, Boolean bool) throws Exception {
        if (bool.booleanValue()) {
            int i2 = i + 1;
            if (this.mRecycleViewDataList.isEmpty() || this.mRecycleViewDataList.size() <= i2) {
                return;
            }
            this.mRecycleViewDataList.add(i2, SettingPreferenceTypeEnum.SETTING_PREFERENCE_SCRATCH_SPOT);
