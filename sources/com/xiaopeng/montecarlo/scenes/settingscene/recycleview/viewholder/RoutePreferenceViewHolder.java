...
public class RoutePreferenceViewHolder extends BaseSettingViewHolder implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view instanceof XToggleButton) {
            ...
            switch (view.getId()) {
                case R.id.setting_route_avoid_charge_btn /* 2131297307 */:
                    ...
                    break;
                case R.id.setting_route_avoid_congestion_btn /* 2131297308 */:
                    ...
                    break;
                case R.id.setting_route_highway_priority_btn /* 2131297309 */:
                    ...
                    break;
                case R.id.setting_route_no_freeways_btn /* 2131297310 */:
