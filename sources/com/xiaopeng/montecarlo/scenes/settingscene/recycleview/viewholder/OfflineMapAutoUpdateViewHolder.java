...
public class OfflineMapAutoUpdateViewHolder extends BaseSettingViewHolder {
    ...
    public static /* synthetic */ void lambda$onCheckedChanged$0(int i) {
        AutoDownloadManager autoDownloadManager = MapDataManager.getInstance().getAutoDownloadManager();
        if (Objects.nonNull(autoDownloadManager)) {
            autoDownloadManager.onAutoDownloadSwitchChanged(SettingWrapper.isAutoDataDownloadEnabled(i));
        }
    }
}
