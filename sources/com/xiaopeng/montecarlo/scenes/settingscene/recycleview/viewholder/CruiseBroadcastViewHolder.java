...
public class CruiseBroadcastViewHolder extends BaseSettingViewHolder implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view instanceof XToggleButton) {
            ...
            switch (view.getId()) {
                case R.id.setting_cruise_ahead_traffic_btn /* 2131297282 */:
                    ...
                    break;
                case R.id.setting_cruise_electronic_eye_broadcast_btn /* 2131297283 */:
                    ...
                    break;
                case R.id.setting_cruise_safety_broadcast_btn /* 2131297284 */:
