...
public class MapVersionViewHolder extends BaseSettingViewHolder {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.setting_about_auto_privacy_agreement /* 2131297225 */:
                if (preventMultiClick(view)) {
                    showAutoAgreementDialog(1);
                    return;
                }
                return;
            case R.id.setting_about_auto_terms_service /* 2131297226 */:
                if (preventMultiClick(view)) {
                    showAutoAgreementDialog(2);
                    return;
                }
                return;
            case R.id.setting_lane_map_introduction /* 2131297260 */:
                if (preventMultiClick(view)) {
                    openUserBook();
                    return;
                }
                return;
            case R.id.setting_map_version_container /* 2131297283 */:
            case R.id.setting_map_version_expand /* 2131297287 */:
            case R.id.setting_map_version_explanation /* 2131297288 */:
                expandOrCollapseVersion();
                return;
            case R.id.setting_map_version_desc /* 2131297286 */:
