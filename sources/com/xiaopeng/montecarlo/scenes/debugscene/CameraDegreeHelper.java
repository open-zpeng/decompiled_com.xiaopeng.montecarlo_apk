...
public class CameraDegreeHelper implements Handler.Callback {
    ...
    private void handleDegreeChange() {
        ...
        changeMiniMapDegree(this.mCameraDegree);
    ...
    private void handleRatioChange() {
        ...
        changeMiniMapRatio(this.mRatio);
    ...
    private void handleLevelChange() {
        ...
        changeMiniMapLevel(this.mLevel);
    ...
    private void changeMiniMapDegree(float f) {
        Intent intent = new Intent();
        intent.setClassName(ContextUtils.getContext().getPackageName(), "com.xiaopeng.montecarlo.service.minimap.MiniMapService");
        intent.setAction("com.xiaopeng.montecarlo.minimap.ACTION_CHANGE_CAMERA_DEGREE");
        intent.putExtra("map_degree", f);
        ContextUtils.getContext().startService(intent);
    }

    private void changeMiniMapRatio(float f) {
        Intent intent = new Intent();
        intent.setClassName(ContextUtils.getContext().getPackageName(), "com.xiaopeng.montecarlo.service.minimap.MiniMapService");
        intent.setAction("com.xiaopeng.montecarlo.minimap.ACTION_CHANGE_CAR_POSITION_RATIO");
        intent.putExtra("map_ratio", f);
        ContextUtils.getContext().startService(intent);
    }

    private void changeMiniMapLevel(float f) {
        Intent intent = new Intent();
        intent.setClassName(ContextUtils.getContext().getPackageName(), "com.xiaopeng.montecarlo.service.minimap.MiniMapService");
        intent.setAction("com.xiaopeng.montecarlo.minimap.ACTION_SET_MAP_LEVEL");
        intent.putExtra("float_level", f);
        ContextUtils.getContext().startService(intent);
    }
}
