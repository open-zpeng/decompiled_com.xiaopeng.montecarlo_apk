...
public class EnvAdapter extends BaseAdapter {
    ...
    public int getCheckedEnv(int i) {
        switch (i) {
            case R.id.env_dev /* 2131296624 */:
                return 0;
            case R.id.env_pre /* 2131296625 */:
                return 2;
            case R.id.env_product /* 2131296626 */:
                return 3;
            case R.id.env_setting_list /* 2131296627 */:
            default:
                return -1;
            case R.id.env_test /* 2131296628 */:
                return 1;
        }
    }
