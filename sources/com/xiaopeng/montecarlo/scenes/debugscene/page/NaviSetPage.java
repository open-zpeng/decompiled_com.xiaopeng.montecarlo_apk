...
public class NaviSetPage extends BasePage {
    ...
    @DebugItemTag(initMethod = "initLaneDataDoubleMode", value = R.string.debug_lane_data_double_mode)
    public void menu15_initLaneDataDoubleMode(View view) {
        boolean z = DataSetHelper.GlobalSet.getBoolean(DataSetHelper.GlobalSet.KEY_ENABLE_LANE_DATA_DOUBLE_MODE, false);
        ((Switch) view.findViewById(R.id.debug_list_item_switch)).setChecked(!z);
        DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.KEY_ENABLE_LANE_DATA_DOUBLE_MODE, !z);
        RootUtil.delayExitApp(RootUtil.KILL_NAVI_DEBUG_SWITCH_LANE_DATA_DOUBLE_MODE);
    }

    public void initLaneDataDoubleMode(View view, int i) {
        ((Switch) view.findViewById(R.id.debug_list_item_switch)).setChecked(DataSetHelper.GlobalSet.getBoolean(DataSetHelper.GlobalSet.KEY_ENABLE_LANE_DATA_DOUBLE_MODE, false));
    }
}
