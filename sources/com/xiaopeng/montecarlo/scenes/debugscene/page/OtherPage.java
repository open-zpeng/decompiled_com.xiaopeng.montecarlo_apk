...
public class OtherPage extends BasePage {
    ...
    @DebugItemTag(initMethod = "initOfflineMap", value = R.string.debug_offline_map)
    public void menu4_OfflineMap(View view) {
        Switch r2 = (Switch) view.findViewById(R.id.debug_list_item_switch);
        r2.setChecked(!r2.isChecked());
        DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.CACHE_IS_SHOW_OFFLINE_MAP, r2.isChecked());
    }
    ...
    public void initOfflineMap(View view, int i) {
        ((Switch) view.findViewById(R.id.debug_list_item_switch)).setChecked(DataSetHelper.GlobalSet.getBoolean(DataSetHelper.GlobalSet.CACHE_IS_SHOW_OFFLINE_MAP, DebugCacheConsts.DEFAULT_VALUE_CACHE_IS_SHOW_OFFLINE_MAP));
    }
}
