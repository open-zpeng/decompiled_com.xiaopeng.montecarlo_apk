...
public class LocationSetPage extends BasePage {
    ...
    private static boolean sTboxLogOpen = false;
    ...
    */
    ...
    public void menu7_SwitchImuSensor(View view, int i) {
        boolean z = DataSetHelper.GlobalSet.getBoolean(DataSetHelper.GlobalSet.CACHE_IS_USED_IMU_SENSOR, DebugCacheConsts.DEFAULT_VALUE_CACHE_IS_USED_IMU_SENSOR);
        ((Switch) view.findViewById(R.id.debug_list_item_switch)).setChecked(!z);
        DataSetHelper.GlobalSet.set(DataSetHelper.GlobalSet.CACHE_IS_USED_IMU_SENSOR, !z);
        RootUtil.delayExitApp(RootUtil.KILL_NAVI_DEBUG_SWITCH_IMU);
        L.Tag tag = TAG;
    ...
    @DebugItemTag(initMethod = "initNoSwitch", value = R.string.debug_list_send_error_code)
    public void menu8_SendErrorCode() {
        AfterSalesUtil.getInstance().recordDiagnosisError(9000, "test code");
    }

    public void initSwitchImuSensor(View view, int i) {
        ((Switch) view.findViewById(R.id.debug_list_item_switch)).setChecked(DataSetHelper.GlobalSet.getBoolean(DataSetHelper.GlobalSet.CACHE_IS_USED_IMU_SENSOR, DebugCacheConsts.DEFAULT_VALUE_CACHE_IS_USED_IMU_SENSOR));
    }
