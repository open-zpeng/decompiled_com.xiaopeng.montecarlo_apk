...
public class CruiseFragment extends BaseMapScene implements ICruiseContract.LogicView, MapStateObserver.OnMapStateChangeListener, IRecommendChargerView, RecommendChargerView.RecommendChargeClickListener {
    ...
    private XCountDownTimer.ITimerCallback mITimerCallback = new XCountDownTimer.ITimerCallback() { // from class: com.xiaopeng.montecarlo.scenes.cruisescene.CruiseFragment.1
        ...
        public void onTick(long j) {
            String string = ContextUtils.getString(TBTUtil.isRestoreExplore(false) ? R.string.navi_restore_explore_dialog_continue : R.string.navi_restore_dialog_continue);
    ...
    public void onSceneViewCreated(View view, @Nullable Bundle bundle) {
        ...
        if (InitializerManager.getInstance().isInApplicationRestore()) {
            if (InitializerManager.getInstance().isInRouteRestore()) {
            ...
            L.i(TAG, "inApplicationRestore");
        } else {
            this.mPresenter.checkIsNeedShowResumeTrip(z);
        }
    ...
    public CruiseScenePresenter mo118getPresenter() {
    ...
    @Override // com.xiaopeng.montecarlo.scenes.cruisescene.ICruiseContract.LogicView
    public void resumeTrip(final boolean z, final boolean z2) {
        ...
        L.Tag tag = TAG;
        L.i(tag, "RestoreFromByteData >>> resumeTrip mAlreadyResumeTrip:" + this.mAlreadyResumeTrip);
        TBTManager.getInstance().restoreNavi(ThemeWatcherUtil.getMapModeByCurrentTheme(), false, new RouteManager.IRestoreListener() { // from class: com.xiaopeng.montecarlo.scenes.cruisescene.-$$Lambda$CruiseFragment$KpLwWIDWEYMIF5TWQ6JHKCxcx3g
            @Override // com.xiaopeng.montecarlo.navcore.xptbt.RouteManager.IRestoreListener
            public final void onRestoreResult(boolean z3) {
                CruiseFragment.this.lambda$resumeTrip$3$CruiseFragment(z, z2, z3);
            }
        });
    }

    public /* synthetic */ void lambda$resumeTrip$3$CruiseFragment(boolean z, boolean z2, boolean z3) {
        if (z3) {
            L.i(TAG, "RestoreFromByteData >>> resumeTrip restoreNavi");
            restoreRoute();
            return;
        }
        L.i(TAG, "RestoreFromByteData >>> resumeTrip start routefragment");
    ...
    public void showResumeTripDialog() {
        ...
        if (restoreRouteParams != null) {
            ...
            xTextDialog.setTitle(TBTUtil.isRestoreExplore(false) ? R.string.navi_restore_explore_dialog_title : R.string.navi_restore_dialog_title);
            ...
            xTextDialog.setOkButtonText(TBTUtil.isRestoreExplore(false) ? R.string.navi_restore_explore_dialog_continue : R.string.navi_restore_dialog_continue);
    ...
    public void restoreRoute() {
        ...
        this.mPresenter.checkIsNeedShowResumeTrip(false);
    }
    ...
    public void onUpdateCruiseFacility(final List<XPFacilityInfo> list) {
        runOnUiThread(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.cruisescene.-$$Lambda$CruiseFragment$3jB71U5Ld5qXvgcvdhcVEW0FdrY
            @Override // java.lang.Runnable
            public final void run() {
                CruiseFragment.this.lambda$onUpdateCruiseFacility$5$CruiseFragment(list);
            }
        });
    }

    public /* synthetic */ void lambda$onUpdateCruiseFacility$5$CruiseFragment(List list) {
        if (CollectionUtils.isNotEmpty(list) || this.mCameraSimpleViewContainer != null) {
            if (this.mCameraSimpleViewContainer == null) {
                ...
                this.mCameraSimpleViewContainer.setOnVisibilityChangeListener(new OnViewStateChangedListener() { // from class: com.xiaopeng.montecarlo.scenes.cruisescene.-$$Lambda$CruiseFragment$XeB6s3fYKl9XBVNpCqqUJwVVrq4
                    ...
                    public final void onVisibleStateChanged(View view, VuiView vuiView, int i) {
                        CruiseFragment.this.lambda$null$4$CruiseFragment(view, vuiView, i);
                    }
                });
            }
    ...
    public /* synthetic */ void lambda$null$4$CruiseFragment(View view, VuiView vuiView, int i) {
        updateCameraLayout();
        setLandscapeRecommendChargersLayout();
    }
