...
public class SearchResultAdapter extends PageRecyclerAdapter<XPPoiInfo> {
    private static final int CHARGE_FAST_VIEW = 1;
    private static final int CHARGE_SLOW_VIEW = 2;
    private static final int CHARGE_ULTRA_VIEW = 0;
    ...
    private void bindCommonViewHolder(CommonViewHolder commonViewHolder, int i, XPPoiInfo xPPoiInfo) {
        ...
        if (xPDeepCharging != null) {
            ...
            if (xPDeepCharging.getNumUltraFree() <= 0 && xPDeepCharging.getNumUltra() <= 0) {
                commonViewHolder.mChargeUltraIcon.setVisibility(8);
                commonViewHolder.mTvChargeUltraFree.setVisibility(8);
                commonViewHolder.mTvChargeUltraFreeNum.setVisibility(8);
                commonViewHolder.mTvChargeUltraTotal.setVisibility(8);
            } else {
                commonViewHolder.mChargeUltraIcon.setVisibility(0);
                commonViewHolder.mTvChargeUltraFree.setVisibility(0);
                commonViewHolder.mTvChargeUltraFreeNum.setVisibility(0);
                commonViewHolder.mTvChargeUltraTotal.setVisibility(0);
                if (xPDeepCharging.getNumUltraFree() >= 0) {
                    commonViewHolder.mTvChargeUltraFree.setText(R.string.poi_charge_status_available_text);
                    commonViewHolder.mTvChargeUltraFreeNum.setText(String.valueOf(xPDeepCharging.getNumUltraFree()));
                    commonViewHolder.mTvChargeUltraTotal.setText("/" + String.format(ContextUtils.getString(R.string.poi_charge_status_used), Integer.valueOf(xPDeepCharging.getNumUltra())));
                } else {
                    commonViewHolder.mTvChargeUltraFree.setText("");
                    commonViewHolder.mTvChargeUltraFreeNum.setText("");
                    commonViewHolder.mTvChargeUltraTotal.setText(String.format(ContextUtils.getString(R.string.poi_charge_status_total), Integer.valueOf(xPDeepCharging.getNumUltra())));
                }
                commonViewHolder.mChargeUltraIcon.setImageResource(getChargeImageRes(xPDeepCharging.getNumUltraFree(), 0));
                int chargeFreeTextColor = getChargeFreeTextColor(xPDeepCharging.getNumUltraFree(), 0);
                commonViewHolder.mTvChargeUltraFree.setTextColor(chargeFreeTextColor);
                commonViewHolder.mTvChargeUltraFreeNum.setTextColor(chargeFreeTextColor);
            }
            if (xPDeepCharging.getNumFastFree() <= 0 && xPDeepCharging.getNumFast() <= 0) {
                ...
                if (xPDeepCharging.getNumFastFree() >= 0) {
                    ...
                    commonViewHolder.mTvChargeFastTotal.setText("/" + String.format(ContextUtils.getString(R.string.poi_charge_status_used), Integer.valueOf(xPDeepCharging.getNumFast())));
                } else {
                ...
                commonViewHolder.mChargeFastIcon.setImageResource(getChargeImageRes(xPDeepCharging.getNumFastFree(), 1));
                int chargeFreeTextColor2 = getChargeFreeTextColor(xPDeepCharging.getNumFastFree(), 1);
                commonViewHolder.mTvChargeFastFree.setTextColor(chargeFreeTextColor2);
                commonViewHolder.mTvChargeFastFreeNum.setTextColor(chargeFreeTextColor2);
            }
            if (xPDeepCharging.getNumSlowFree() <= 0 && xPDeepCharging.getNumSlow() <= 0) {
                ...
                if (xPDeepCharging.getNumSlowFree() >= 0) {
                    ...
                    commonViewHolder.mTvChargeSlowTotal.setText("/" + String.format(ContextUtils.getString(R.string.poi_charge_status_used), Integer.valueOf(xPDeepCharging.getNumSlow())));
                } else {
                ...
                commonViewHolder.mChargeSlowIcon.setImageResource(getChargeImageRes(xPDeepCharging.getNumSlowFree(), 2));
                int chargeFreeTextColor3 = getChargeFreeTextColor(xPDeepCharging.getNumSlowFree(), 2);
                commonViewHolder.mTvChargeSlowFree.setTextColor(chargeFreeTextColor3);
                commonViewHolder.mTvChargeSlowFreeNum.setTextColor(chargeFreeTextColor3);
            }
            if (commonViewHolder.mChargeUltraIcon.getVisibility() == 0 || commonViewHolder.mChargeFastIcon.getVisibility() == 0 || commonViewHolder.mChargeSlowIcon.getVisibility() == 0) {
    ...
    private int getChargeImageRes(int i, int i2) {
        if (i2 == 0) {
            return ThemeWatcherUtil.getDrawableResId(i > 0 ? R.drawable.vector_tag_texttag_ultra : R.drawable.vector_tag_texttag_unavailable_ultra);
        } else if (i2 == 1) {
            return ThemeWatcherUtil.getDrawableResId(i > 0 ? R.drawable.vector_tag_texttag_smallquick : R.drawable.vector_tag_texttag_smallunavailable_quick);
        } else {
            return ThemeWatcherUtil.getDrawableResId(i > 0 ? R.drawable.vector_tag_texttag_smallslow : R.drawable.vector_tag_texttag_smallunavailable_slow);
        }
    }

    private int getChargeFreeTextColor(int i, int i2) {
        if (i == 0) {
    ...
    */
    private void bindOpenTimeView(com.xiaopeng.montecarlo.scenes.searchscene.SearchResultAdapter.CommonViewHolder r7, com.xiaopeng.montecarlo.navcore.bean.search.XPPoiInfo r8) {
        ...
        L98:
            ...
            if (r0 == 0) goto Laf
            r8 = 2131232034(0x7f080522, float:1.8080166E38)
        ...
        Laf:
            ...
            if (r8 == 0) goto L96
            r8 = 2131232036(0x7f080524, float:1.808017E38)
            android.graphics.drawable.Drawable r8 = com.xiaopeng.montecarlo.util.ThemeWatcherUtil.getDrawable(r8)
        Le2:
            if (r8 == 0) goto Lef
    ...
    public class CommonViewHolder extends XpSearchViewHolder implements View.OnClickListener {
        ...
        XTextView mTvChargeUltraFree;
        XTextView mTvChargeUltraFreeNum;
        XTextView mTvChargeUltraTotal;
        ...
        void initChargeContainer() {
            if (this.mChargeInfoStub == null) {
                ...
                this.mChargeUltraIcon = (XImageView) this.mChargeInfoStub.findViewById(R.id.charge_icon_ultra);
                this.mTvChargeUltraFree = (XTextView) this.mChargeInfoStub.findViewById(R.id.tv_ultra_free);
                this.mTvChargeUltraFreeNum = (XTextView) this.mChargeInfoStub.findViewById(R.id.tv_ultra_free_num);
                this.mTvChargeUltraTotal = (XTextView) this.mChargeInfoStub.findViewById(R.id.tv_ultra_total);
