...
public class SearchNaviListener implements INaviListener {
    ISearchResultContract.LogicView mLogicView;
    ...
    public SearchNaviListener(SearchResultPresenter searchResultPresenter, ISearchResultContract.LogicView logicView) {
    ...
    public void onMainPathChanged() {
        this.mLogicView.runOnUiThread(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.searchscene.SearchNaviListener.1
            @Override // java.lang.Runnable
            public void run() {
                SearchNaviListener.this.mPresenter.onMainPathChanged();
            }
        });
    }
}
