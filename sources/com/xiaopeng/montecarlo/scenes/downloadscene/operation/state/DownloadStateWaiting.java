...
public class DownloadStateWaiting extends AbstractDownloadState {
    private static final L.Tag TAG = new L.Tag("DownloadStateWaiting");
    ...
    public DownloadStateWaiting(DownloadStateManager downloadStateManager) {
        super(downloadStateManager);
    }

    /* renamed from: com.xiaopeng.montecarlo.scenes.downloadscene.operation.state.DownloadStateWaiting$1  reason: invalid class name */
    /* loaded from: classes2.dex */
