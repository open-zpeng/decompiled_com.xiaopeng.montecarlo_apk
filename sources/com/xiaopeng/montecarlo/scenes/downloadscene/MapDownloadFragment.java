...
public class MapDownloadFragment extends BaseFullScenes implements IMapDownloadContract.LogicView {
    ...
    public class AnonymousClass2 implements IScrollListener {
        ...
        public void scrollToPosition(final int i) {
            ...
            MapDownloadFragment.this.runOnUiThread(new Runnable() { // from class: com.xiaopeng.montecarlo.scenes.downloadscene.-$$Lambda$MapDownloadFragment$2$CS4NCputZC0jBAgi5UdAytKQtkA
                @Override // java.lang.Runnable
                public final void run() {
                    MapDownloadFragment.AnonymousClass2.this.lambda$scrollToPosition$0$MapDownloadFragment$2(i);
                }
            });
        }

        public /* synthetic */ void lambda$scrollToPosition$0$MapDownloadFragment$2(int i) {
    ...
    public /* synthetic */ void lambda$refreshFullView$0$MapDownloadFragment() {
        ...
        this.mAllCityRecyclerView.stopScroll();
        showLoading(!this.mAdapterView.isRecycleViewDataReady());
    ...
    public MapDownloadPresenter mo118getPresenter() {
