    ...
    */
    public void handleAiMsgEvent(int r7, java.lang.String r8, android.os.Bundle r9) {
        ...
        L65:
            ...
            monitor-enter(r7)
            com.xiaopeng.montecarlo.aimessage.AiMsgManager$MsgListener r8 = r6.mCurrentCarStateRequester     // Catch: java.lang.Throwable -> Lb3
            if (r8 == 0) goto Lac
            com.xiaopeng.montecarlo.aimessage.AiMsgManager$MsgListener r8 = r6.mCurrentCarStateRequester     // Catch: java.lang.Throwable -> Lb3
            r8.onReceive(r2)     // Catch: java.lang.Throwable -> Lb3
            boolean r8 = com.xiaopeng.montecarlo.root.util.L.ENABLE     // Catch: java.lang.Throwable -> Lb3
            if (r8 == 0) goto Laa
            com.xiaopeng.montecarlo.aimessage.AiMsgManager$MsgListener r8 = r6.mCurrentCarStateRequester     // Catch: java.lang.Throwable -> Lb3
            java.lang.String r8 = r8.getName()     // Catch: java.lang.Throwable -> Lb3
            com.xiaopeng.montecarlo.root.util.L$Tag r9 = com.xiaopeng.montecarlo.aimessage.LocalAiMsgService.TAG     // Catch: java.lang.Throwable -> Lb3
            ...
            r0.append(r8)     // Catch: java.lang.Throwable -> Lb3
            java.lang.String r8 = ", "
            r0.append(r8)     // Catch: java.lang.Throwable -> Lb3
            com.xiaopeng.montecarlo.aimessage.AiMsgManager$MsgListener r8 = r6.mCurrentCarStateRequester     // Catch: java.lang.Throwable -> Lb3
            java.lang.Class r8 = r8.getClass()     // Catch: java.lang.Throwable -> Lb3
            java.lang.String r8 = r8.getSimpleName()     // Catch: java.lang.Throwable -> Lb3
            r0.append(r8)     // Catch: java.lang.Throwable -> Lb3
            java.lang.String r8 = r0.toString()     // Catch: java.lang.Throwable -> Lb3
            com.xiaopeng.montecarlo.root.util.L.d(r9, r8)     // Catch: java.lang.Throwable -> Lb3
        Laa:
            r6.mCurrentCarStateRequester = r1     // Catch: java.lang.Throwable -> Lb3
        Lac:
            java.lang.Object r8 = r6.mLock     // Catch: java.lang.Throwable -> Lb3
            r8.notify()     // Catch: java.lang.Throwable -> Lb3
