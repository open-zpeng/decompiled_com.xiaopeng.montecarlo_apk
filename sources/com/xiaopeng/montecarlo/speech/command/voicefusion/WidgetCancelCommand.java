...
public class WidgetCancelCommand extends BaseSpeechCommand {
    private static final L.Tag TAG = new L.Tag("WidgetCancelCommand");
    ...
    public void doSomething() {
        executeSpeechEvent(new SpeechNaviEvent(2008));
