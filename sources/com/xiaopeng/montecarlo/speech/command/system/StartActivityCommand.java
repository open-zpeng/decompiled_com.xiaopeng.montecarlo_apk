...
@CommandPriority(priority = 1)
@Deprecated
/* loaded from: classes3.dex */
public class StartActivityCommand extends BaseSpeechCommand {
    private static final L.Tag TAG = new L.Tag("StartActivityCommand");
    ...
    public void doSomething() {
        executeSpeechEvent(new SpeechNaviEvent(902));
    }
}
