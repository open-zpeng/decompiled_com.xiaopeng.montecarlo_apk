...
public class MainContextImpl implements IMainContext {
    ...
    public void updateRecenterBtn() {
        this.mMapFragment.mo118getPresenter().updateRecenterStatus();
    }
    ...
    public void switchMapModeForVui(DrawModeType drawModeType) {
        MapScenePresenter mo118getPresenter = this.mMapFragment.mo118getPresenter();
        if (mo118getPresenter != null) {
            if (drawModeType == null) {
                mo118getPresenter.switchMapMode();
            } else if (drawModeType == DrawModeType.NORTHUP) {
                mo118getPresenter.executeSpeechCmdMapModeNorthUp();
            } else if (drawModeType == DrawModeType.HEADUP_2D) {
                mo118getPresenter.executeSpeechCmdMapModeHeadUp2D();
            } else if (drawModeType == DrawModeType.HEADUP_3D) {
                mo118getPresenter.executeSpeechCmdMapModeHeadUp3D();
            }
        }
    }
    ...
    public void switchMapScaleForVui(int i) {
        if (i == 19) {
            this.mMapFragment.mo118getPresenter().zoomInToMax();
        } else if (i == 3) {
            this.mMapFragment.mo118getPresenter().zoomOutToMin();
        } else {
            this.mMapFragment.mo118getPresenter().zoom(i);
        }
    }
    ...
    public void showLocationInfo(final boolean z) {
        runOnUiThreadRelyMap(new Runnable() { // from class: com.xiaopeng.montecarlo.base.MainContextImpl.2
            ...
            public void run() {
                MainContextImpl.this.mMapFragment.mo118getPresenter().showLocationInfo(z);
            }
        });
    }
    ...
    public void showSRData(final boolean z) {
        runOnUiThreadRelyMap(new Runnable() { // from class: com.xiaopeng.montecarlo.base.MainContextImpl.3
            @Override // java.lang.Runnable
            public void run() {
                MainContextImpl.this.mMapFragment.mo118getPresenter().showSRData(z);
            }
        });
    }
    ...
    public boolean isLocationInfoShow() {
        return this.mMapFragment.mo118getPresenter().isLocationInfoShow();
    }
    ...
    public void onChargeSettingChanged(boolean z) {
        this.mMapFragment.mo118getPresenter().setChargeEnable(z);
    }

    @Override // com.xiaopeng.montecarlo.base.IMainContext
    public void onScratchSpotChanged(boolean z) {
        this.mMapFragment.mo118getPresenter().setScratchSpotEnable(z);
    }
