...
public class MapFragment extends DayNightFragment implements ActivityLifecycleHelper.ActivityLifecycleListener, IMapContract.LogicView, ISpeechEvent, MapViewWrapper.IXPMapSurfaceListener {
    ...
    public void onClickSrAndNormalSwitch(View view) {
        ...
        preventMultiClick(view);
        if (this.mSRNaviSwitch.getVisibility() != 0) {
    ...
    private void refreshRenderFps(boolean z) {
        if (getMapView() != null) {
            ...
            getMapView().setRenderFpsByMode(3, z ? 40 : 1);
        }
    }
    ...
    public void updateSRNaviSwitchStatus(int i, boolean z) {
        ...
        if (xImageButton != null) {
            xImageButton.setVisibility((!this.mIsParallelRoadShow || this.mIsSRNavi) ? 8 : 8);
        }
    }
    ...
    public void updateDebugSRDriveMode(int i) {
        ...
        if (textView != null) {
            textView.setText(String.format("驾驶模式信号(RD16): %d", Integer.valueOf(i)));
        }
    }
    ...
    public MapScenePresenter mo96getPresenter() {
    ...
    public void updateRecenterShowTag(boolean z) {
        mo96getPresenter().updateRecenterShowTag(z);
    }
    ...
    public final boolean onInterceptSpeechEvent(SpeechNaviEvent speechNaviEvent, ICommandCallback iCommandCallback) {
        return mo96getPresenter().onInterceptSpeechEvent(speechNaviEvent, iCommandCallback);
    }

    @Override // com.xiaopeng.montecarlo.speech.command.ISpeechEvent
    public final boolean onSpeechEvent(SpeechNaviEvent speechNaviEvent, ICommandCallback iCommandCallback) {
        return mo96getPresenter().onSpeechEvent(speechNaviEvent, iCommandCallback);
    }
    ...
    public void syncMapMode() {
        ...
        int i = AnonymousClass13.$SwitchMap$com$xiaopeng$montecarlo$bridge$StatusConst$Mode[mode.ordinal()];
        int i2 = 0;
        if (i != 1 && i != 2 && i != 3 && i != 4) {
            if (i == 5) {
    ...
    public void showRecenterBtnAlways(boolean z) {
        mo96getPresenter().showRecenterBtnAlways(z);
    }
    ...
    private void updateMapModeForVui(boolean z) {
        if (CommonVuiHelper.getInstance().isCanUpdateVui(this.mMainContext) && this.mBtnMapMode != null) {
    ...
    public void showProtoPlayBtn(boolean z) {
        ...
        if (z && this.mProtoPlay == null && this.mStubProtoPlay != null) {
            ...
            ProtoSimulator.getInstance().setProgressListener(new ProtoSimulator.ProgressListener() { // from class: com.xiaopeng.montecarlo.base.-$$Lambda$MapFragment$r6R6bh7D9E3tvEqlQU6nxh0vQiw
                @Override // com.xiaopeng.montecarlo.navcore.sr.ProtoSimulator.ProgressListener
                public final void onProgressChanged(int i) {
                    MapFragment.this.lambda$showProtoPlayBtn$12$MapFragment(i);
                }
            });
            this.mProtoPlayBtn.setOnClickListener(new View.OnClickListener() { // from class: com.xiaopeng.montecarlo.base.-$$Lambda$MapFragment$DzAhllNyRWO3ja1FG1zU4pL-UkE
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    MapFragment.this.lambda$showProtoPlayBtn$13$MapFragment(view);
                }
            });
            this.mProtoPlayProgress.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.xiaopeng.montecarlo.base.MapFragment.10
    ...
    public /* synthetic */ void lambda$showProtoPlayBtn$12$MapFragment(final int i) {
        runOnUiThread(new Runnable() { // from class: com.xiaopeng.montecarlo.base.-$$Lambda$MapFragment$XGPOV8jUvowwRSvEagPSt5Yyzc4
            @Override // java.lang.Runnable
            public final void run() {
                MapFragment.this.lambda$null$11$MapFragment(i);
            }
        });
    }

    public /* synthetic */ void lambda$null$11$MapFragment(int i) {
        XSeekBar xSeekBar = this.mProtoPlayProgress;
        if (xSeekBar != null) {
            xSeekBar.setProgress(i);
        }
    }

    public /* synthetic */ void lambda$showProtoPlayBtn$13$MapFragment(View view) {
    ...
    public void showLaneRecordPlayBtn(boolean z) {
        ...
        if (z && this.mLaneRecordPlay == null && (viewStub = this.mStubLaneRecordPlay) != null) {
            ...
            this.mLanePlayProgress.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.xiaopeng.montecarlo.base.MapFragment.11
                @Override // android.widget.SeekBar.OnSeekBarChangeListener
                public void onProgressChanged(SeekBar seekBar, int i, boolean z2) {
                }
                ...
                public void onStopTrackingTouch(SeekBar seekBar) {
                    ...
                    SRNaviManager.getInstance().setPlayIndex(((((long) progress) * MapFragment.this.mTotalMsgCount) / 100) - 1);
                }
            });
            UiHandlerUtil.getInstance().postDelayed(new AnonymousClass12(), UILooperObserver.ANR_TRIGGER_TIME);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.xiaopeng.montecarlo.base.MapFragment$12  reason: invalid class name */
    /* loaded from: classes2.dex */
    public class AnonymousClass12 implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            SRNaviManager.getInstance().setPlayerListener(new LaneServiceWrapper.IPlayerListener() { // from class: com.xiaopeng.montecarlo.base.MapFragment.12.1
                @Override // com.xiaopeng.montecarlo.navcore.sr.LaneServiceWrapper.IPlayerListener
                public void onPlayProgress(long j, long j2, String str, final long j3, final long j4) {
                    MapFragment.this.runOnUiThread(new Runnable() { // from class: com.xiaopeng.montecarlo.base.MapFragment.12.1.1
                        @Override // java.lang.Runnable
                        public void run() {
    ...
    public /* synthetic */ void lambda$showLaneRecordPlayBtn$14$MapFragment(View view) {
        ...
        SRNaviManager.getInstance().startRecord(equals);
    ...
    public /* synthetic */ void lambda$showLaneRecordPlayBtn$15$MapFragment(View view) {
        ...
        SRNaviManager.getInstance().resetPlay(equals);
    ...
    public /* synthetic */ void lambda$showLaneRecordPlayBtn$16$MapFragment(View view) {
        ...
        int i = R.string.debug_lane_play;
        boolean equals = TextUtils.equals(text, getString(R.string.debug_lane_play));
        SRNaviManager.getInstance().startPlay(equals);
