...
public class GuideInfoService implements IServicePublisher {
    ...
    public String getCurrentLocationInfo() {
        ...
        try {
            ...
            int i3 = -1;
            double d = 23.1595867537d;
            double d2 = 113.3850753307d;
            boolean z = true;
            if (currentLocInfo == null || currentLocInfo.matchInfoCnt <= 0 || !CollectionUtils.isNotEmpty(currentLocInfo.matchInfo) || (locMatchInfo = currentLocInfo.matchInfo.get(0)) == null) {
                i = -1;
                i2 = 0;
            } else {
                i3 = locMatchInfo.roadClass;
                i2 = locMatchInfo.linkType;
