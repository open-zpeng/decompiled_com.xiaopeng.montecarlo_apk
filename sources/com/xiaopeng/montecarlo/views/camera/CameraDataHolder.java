...
public class CameraDataHolder implements ICameraData {
    ...
    private Drawable createRestrictSpeedDrawable() {
        int speedCameraResource = ResUtil.getSpeedCameraResource(getRestrictSpeed());
        if (speedCameraResource == -1) {
            return null;
        }
        return ThemeWatcherUtil.getDrawable(speedCameraResource);
    }
