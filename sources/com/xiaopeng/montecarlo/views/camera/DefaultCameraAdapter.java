...
public class DefaultCameraAdapter implements ICameraAdapter {
    ...
    public void renderDayNightTheme() {
        for (ViewHolder viewHolder : this.mItemViewList) {
            ...
            Object tag = viewHolder.getItemView().getTag();
            if (tag instanceof ICameraData) {
                viewHolder.getItemView().setCompoundDrawablesWithIntrinsicBounds((Drawable) null, ((ICameraData) tag).getCameraDrawable(), (Drawable) null, (Drawable) null);
            }
        }
    }
    ...
    public class ViewHolder {
        ...
        protected void bindCameraItemView(ICameraData iCameraData) {
            this.mTextView.setTag(iCameraData);
