...
public class RouteDetailItemView extends XRelativeLayout implements View.OnClickListener, View.OnLongClickListener, OnUpdateRemainDisListener {
    ...
    protected XTextView mRouteTypeView;
    ...
    public String getRouteType() {
        XTextView xTextView = this.mRouteTypeView;
        if (xTextView != null) {
            String charSequence = xTextView.getText().toString();
    ...
    private void initView() {
        ...
        this.mRouteTypeView = (XTextView) this.mRootView.findViewById(R.id.route_type_name);
    ...
    protected void fillDistanceView(long j, int i) {
        ...
        L.Tag tag2 = TAG;
        L.d(tag2, "fillDistanceView Status：" + this.mBatteryStatus + " remainText:" + string + "   remain dis: " + j + " leftDis: " + i + "  pathID:" + this.mPathId);
