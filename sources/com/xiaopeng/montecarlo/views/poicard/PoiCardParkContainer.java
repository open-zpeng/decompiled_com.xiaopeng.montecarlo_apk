...
public class PoiCardParkContainer extends XRelativeLayout implements BasePoiCardViewContract {
    ...
    private void showParkInfoWithRemain() {
        ...
        showParkInfoTotal();
        setParkInfoTotalText(MqttTopic.TOPIC_LEVEL_SEPARATOR + String.format(ContextUtils.getString(R.string.park_info_total_card), Integer.valueOf(this.mPoiInfo.getParkTotal())));
    }
