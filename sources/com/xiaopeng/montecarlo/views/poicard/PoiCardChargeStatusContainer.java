...
public class PoiCardChargeStatusContainer extends XRelativeLayout implements BasePoiCardViewContract {
    ...
    public void renderChargeView(final XPDeepCharging xPDeepCharging, final int i, final boolean z) {
        ...
        post(new Runnable() { // from class: com.xiaopeng.montecarlo.views.poicard.PoiCardChargeStatusContainer.1
            ...
            public void run() {
                ...
                boolean z2 = xPDeepCharging.getNumFastFree() > 0 || xPDeepCharging.getNumFast() > 0 || xPDeepCharging.getNumSlowFree() > 0 || xPDeepCharging.getNumSlow() > 0;
                if (L.ENABLE) {
                    L.d(PoiCardChargeStatusContainer.TAG, "renderChargeView run charging.getNumFastFree()=" + xPDeepCharging.getNumFastFree() + ",charging.getNumFast()=" + xPDeepCharging.getNumFast() + ",charging.getNumSlowFree()=" + xPDeepCharging.getNumSlowFree() + ",charging.getNumSlow()=" + xPDeepCharging.getNumSlow());
                }
                if (z2) {
    ...
    private void renderChargeInfo() {
        ...
        if (xPPoiInfo == null) {
            L.Tag tag = TAG;
            L.e(tag, "mPoiInfo=" + this.mPoiInfo);
            return;
        }
    ...
    public void renderChargeView(XPDeepCharging xPDeepCharging) {
        if (xPDeepCharging == null || this.mPoiInfo == null) {
            L.Tag tag = TAG;
            L.e(tag, "charging=" + xPDeepCharging + "=mPoiInfo=" + this.mPoiInfo);
            return;
        }
        ...
        if (L.ENABLE) {
            L.Tag tag2 = TAG;
            L.d(tag2, "crenderChargeView harging.getNumFastFree()=" + xPDeepCharging.getNumFastFree() + ",charging.getNumFast()=" + xPDeepCharging.getNumFast() + ",charging.getNumSlowFree()=" + xPDeepCharging.getNumSlowFree() + ",charging.getNumSlow()=" + xPDeepCharging.getNumSlow());
        }
        if (z) {
