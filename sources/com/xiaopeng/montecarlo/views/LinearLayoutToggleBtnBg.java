...
public class LinearLayoutToggleBtnBg extends XLinearLayout {
    @DrawableRes
    private static final int S_DEFAULT_MULTI_BG_RES_ID = 2131231458;
    @DrawableRes
    private static final int S_DEFAULT_SINGLE_BG_RES_ID = 2131231622;
    ...
    public LinearLayoutToggleBtnBg(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        L.Tag tag = TAG;
        L.i(tag, "LinearLayoutToggleBtnBg : " + ThemeWatcherUtil.getCurrentTheme());
    }
    ...
    public void onAttachedToWindow() {
        ...
        L.Tag tag = TAG;
        L.i(tag, "onAttachedToWindow : " + ThemeWatcherUtil.getCurrentTheme());
        updateBg();
