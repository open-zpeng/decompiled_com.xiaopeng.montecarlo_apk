...
public class ThemeWatcherUtil {
    ...
    public static ThemeType getCurrentTheme() {
        return sLocalThemeManager.getCurrentTheme();
    }
    ...
    public static boolean isThemeChanged(@NonNull Configuration configuration) {
        return sLocalThemeManager.isThemeChanged(configuration);
    }
