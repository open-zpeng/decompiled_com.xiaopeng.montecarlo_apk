...
public class NaviUtil {
    ...
    public static int getNaviConestionDis(NaviCongestionInfo naviCongestionInfo, int i) {
        int size;
        if (naviCongestionInfo == null || naviCongestionInfo.getCongestionInfos() == null || (size = naviCongestionInfo.getCongestionInfos().size()) <= 0) {
            return 0;
        }
        for (int i2 = 0; i2 < size; i2++) {
            NaviCongestionDetailInfo naviCongestionDetailInfo = naviCongestionInfo.getCongestionInfos().get(i2);
