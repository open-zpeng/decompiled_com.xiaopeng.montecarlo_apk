...
public class NaviUtil {
    ...
    public static final int GUIDE_TRAFFIC_LIGHT_ENTER_GREEN_LIGHT = 4;
    public static final int GUIDE_TRAFFIC_LIGHT_GREEN_LIGHT = 5;
    public static final int GUIDE_TRAFFIC_LIGHT_LEFT = 1;
    public static final int GUIDE_TRAFFIC_LIGHT_RED_LIGHT = 2;
    public static final int GUIDE_TRAFFIC_LIGHT_RIGHT = 2;
    public static final int GUIDE_TRAFFIC_LIGHT_STRAIGHT = 8;
    public static final int GUIDE_TRAFFIC_LIGHT_SUSPEND = 7;
    public static final int GUIDE_TRAFFIC_LIGHT_TURN_AROUND = 7;
    public static final int GUIDE_TRAFFIC_LIGHT_WAIT_ROUND_COUNT = 1;
    public static final int GUIDE_TRAFFIC_LIGHT_WILL_GREEN_LIGHT = 3;
    public static final int GUIDE_TRAFFIC_LIGHT_WILL_RED_LIGHT = 6;
    public static final int GUIDE_TRAFFIC_LIGHT_YELLOW = 8;
    ...
    public static final String LANE_GUIDE_TRAFFIC_LIGHT_LEFT = "left";
    public static final String LANE_GUIDE_TRAFFIC_LIGHT_RIGHT = "right";
    public static final String LANE_GUIDE_TRAFFIC_LIGHT_STRAIGHT = "straight";
    public static final String LANE_GUIDE_TRAFFIC_LIGHT_TURN_AROUND = "turn_around";
