...
public class DebugConfiguration {
    ...
    public static final class DebugActionExtra {
        ...
        public static final String EHP_VERSION = "ehp_version";
        public static final String HAPPY_ENDING_AI = "ai";
        public static final String HAPPY_ENDING_DETOUR_OBSTACLE = "detour_obstacle";
        public static final String HAPPY_ENDING_LANE_CHANGE = "lane_change";
        public static final String HAPPY_ENDING_ROUNDABOUT = "roundabout";
        public static final String HAPPY_ENDING_TOTAL_MILEAGE = "total_mileage";
        public static final String HAPPY_ENDING_TRAFFIC_LIGHTS = "traffic_lights";
        ...
        public static final String TEST_XPU_SIG_RD = "rd_module_com";
        public static final String TEST_XPU_SIG_SM = "bp_to_sm";
        public static final String TEST_XPU_SIG_START = "start";
        public static final String TEST_XPU_SIG_TYPE = "sig_type";
        public static final String TEST_XPU_SIG_VALUE = "value";
    }
    ...
    /* loaded from: classes3.dex */
    public static final class DebugXpuSigType {
        public static final String SIG_TYPE_DISPLAY_ST = "display_st";
    }
    ...
    public static final class RegisterAction {
        ...
        public static final String EHP_VERSION = "com.xiaopeng.montecarlo.EHP_VERSION";
        ...
        public static final String SEND_XPU_SIG = "com.xiaopeng.montecarlo.SEND_SIG";
        public static final String SEND_XPU_SIG_RD = "com.xiaopeng.montecarlo.SEND_RD_MODULE";
        public static final String SEND_XPU_SIG_SM = "com.xiaopeng.montecarlo.SEND_SM";
        public static final String SHOW_HAPPY_ENDING = "com.xiaopeng.montecarlog.SHOW_HAPPY_ENDING";
        public static final String SPEECH_TEST_ACTION = "com.xiaopeng.montecarlo.TEST_SPEECH";
        public static final String START_SEND_XPU_SIG = "com.xiaopeng.montecarlo.START_RD_MODULE";
