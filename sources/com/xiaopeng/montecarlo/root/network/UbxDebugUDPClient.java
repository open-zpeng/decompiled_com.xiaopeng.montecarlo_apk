                                    ...
                                    if (UbxDebugUDPClient.this.mIsStarted) {
                                        ...
                                        if (2 == datagramPacket2.getLength() && UbxDebugUDPClient.PING_COMMAND[i] == data[i] && UbxDebugUDPClient.PING_COMMAND[1] == data[1]) {
                                            ...
                                            if (UbxDebugUDPClient.UBX_MON_HW_AGC[3] == data[3]) {
                                                String hexString = Integer.toHexString(data[25] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
                                                String hexString2 = Integer.toHexString(data[24] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
                                                int i6 = ((data[24] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) | ((data[25] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8)) & 65535;
