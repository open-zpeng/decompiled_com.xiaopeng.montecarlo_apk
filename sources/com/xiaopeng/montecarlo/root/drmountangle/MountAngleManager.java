    ...
    public static final HashMap<Integer, MountAngle> XP_CAR_MOUNT_ANGLE_MAP = new HashMap<Integer, MountAngle>() { // from class: com.xiaopeng.montecarlo.root.drmountangle.MountAngleManager.1
        {
            ...
            put(11, new MountAngle(new IMUAngle(-6.456f, 1.489f, 0.0f), new IMUAngleConvertType(0, 1, 2), new IMUAngle(-1.0f, -1.0f, 1.0f), true, new IMUAngle(0.0f, 0.0f, 0.0f), new IMUAngleConvertType(1, 0, 2), new IMUAngle(-1.0f, 1.0f, 1.0f), true));
        }
    };
