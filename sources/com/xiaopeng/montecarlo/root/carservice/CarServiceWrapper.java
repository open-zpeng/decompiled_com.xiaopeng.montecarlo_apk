...
public class CarServiceWrapper {
    ...
    public void mockScuCarSpeed(Float[] fArr, long j) {
        this.mCarService.mockScuCarSpeed(fArr, j);
    }
    ...
    public int getLeftTurnLampActiveStatus() {
        return this.mCarService.getLeftTurnLampActiveStatus();
    }

    public int getRightTurnLampActiveStatus() {
        return this.mCarService.getRightTurnLampActiveStatus();
    }

    public int getBrakeLightState() {
        return this.mCarService.getBrakeLightState();
    }

    public int isBcmBonnetOpened() {
        return this.mCarService.isBcmBonnetOpened();
    }

    public int getTrunk() {
        return this.mCarService.getTrunk();
    }

    public int[] getDoorsState() {
        return this.mCarService.getDoorsState();
    }
    ...
    public boolean isD55a() {
        return this.mCarService.isD55a();
    }
    ...
    public int getIcmSrMapWidth() {
        return this.mCarService.getIcmSrMapWidth();
    }

    public int getIcmSrMapHeight() {
        return this.mCarService.getIcmSrMapHeight();
    }

    public int getIcmSrMapFps() {
        return this.mCarService.getIcmSrMapFps();
    }
    ...
    public int getNgpSwitchStatus() {
        return this.mCarService.getNgpSwitchStatus();
    }
