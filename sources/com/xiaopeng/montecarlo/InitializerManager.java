...
public class InitializerManager {
    ...
    private IThemeSwitchListener mThemeSwitchListener = new IThemeSwitchListener() { // from class: com.xiaopeng.montecarlo.InitializerManager.2
        ...
        public void onSwitchTheme(String str, boolean z) {
            if (L.ENABLE) {
                ...
                L.d(tag, "onSwitchTheme themeName:" + str + ",isDay:" + z);
            }
            Utils.setAppTheme();
            ...
            TBTManager.getInstance().onSwitchTheme(z);
            SRNaviManager.getInstance().onSwitchTheme(z);
        }
    };
    ...
    public final void lambda$handleAppOnCreate$2$InitializerManager() {
        ...
        if (this.mBLInitialized || this.mBLIsDoingInit) {
            ...
            WorkThreadUtil.getInstance().executeCachedTask(new Runnable() { // from class: com.xiaopeng.montecarlo.-$$Lambda$InitializerManager$QUvkEivpGOcXfRNxZTV-5xjzpXc
                @Override // java.lang.Runnable
                public final void run() {
                    InitializerManager.this.lambda$initBLTasks$5$InitializerManager();
                }
            });
        }
    }

    public /* synthetic */ void lambda$initBLTasks$5$InitializerManager() {
        L.i(sTAG, "initBLTasks in work thread start, thread : " + Thread.currentThread().getName());
        ...
        LocationServiceManager.getInstance().init(this.mApplication, RootUtil.SD_CARD_NAVI_PATH + "/debug/");
        ...
        L.i(sTAG, "Application_onCreate_BL_thread_initBL end : " + initBL);
        TraceUtils.alwaysTraceEnd();
        ...
        L.i(sTAG, "Application_onCreate_BL_thread_initTBT end : " + initTBT);
        TraceUtils.alwaysTraceEnd();
        ...
        SRNaviManager.getInstance().onSwitchTheme(ThemeWatcherUtil.isDayMode());
        ...
        L.i(sTAG, "Application_onCreate_BL_thread_set mBLIsDoingInit: " + initTBT + " in thread : " + Thread.currentThread().getName());
        ...
        if (!ActivateManager.getInstance().isActivateSuccess()) {
            ...
            if (TBTManager.getInstance().isNeedRestoreRoute() && !isInRouteRestore()) {
                ...
                L.i(sTAG, "isNeedRestoreRoute params = " + restoreRouteParams);
                if (restoreRouteParams != null) {
                    restoreRouteParams.mStartInfo = TBTManager.getInstance().getStartPOIFromCurrent();
                    TBTManager.getInstance().requestRoute(restoreRouteParams, new AnonymousClass4());
                } else {
                    notifyBLInitFinished();
                }
                z = false;
    ...
    public class AnonymousClass4 implements RouteManager.IRouteResultListener {
        ...
        public /* synthetic */ void lambda$onNewRouteSuccess$0$InitializerManager$4(long j) {
            ...
            TBTManager.getInstance().startNavi(j, 0, ThemeWatcherUtil.getMapModeByCurrentTheme(), NavRestoreManager.isRestoreExplore(true) ? 2 : 1);
    ...
    public void lambda$handleAppOnCreate$3$InitializerManager() {
        ...
        WorkThreadUtil.getInstance().executeCachedTask(new Runnable() { // from class: com.xiaopeng.montecarlo.-$$Lambda$InitializerManager$A5i-Qtn3_OVOKYxL7D3w8s6_qPU
            @Override // java.lang.Runnable
            public final void run() {
                InitializerManager.this.lambda$initXp$6$InitializerManager();
            }
        });
    }

    public /* synthetic */ void lambda$initXp$6$InitializerManager() {
        L.Tag tag = sTAG;
    ...
    public void waitExternalStorage(final IWaitExternalStorageCallback iWaitExternalStorageCallback) {
        ...
        WorkThreadUtil.getInstance().executeIOTask(new Runnable() { // from class: com.xiaopeng.montecarlo.-$$Lambda$InitializerManager$soc72Lm4zEY96V3h8YZ4jiS-ZcI
            @Override // java.lang.Runnable
            public final void run() {
                InitializerManager.lambda$waitExternalStorage$7(IWaitExternalStorageCallback.this);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void lambda$waitExternalStorage$7(IWaitExternalStorageCallback iWaitExternalStorageCallback) {
        L.i(sTAG, "waitExternalStorage in work thread, add task to IO thread ");
        if (RootUtil.extsd_status == 0 || RootUtil.isTfExtSdExist()) {
            L.i(sTAG, "ExternalStorage is ready!");
