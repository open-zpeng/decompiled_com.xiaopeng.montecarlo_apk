...
public abstract class AbstractApplicationInitializer {
    ...
    public final boolean initBL() {
        ...
        baseInitParam.assetPath = RootUtil.SD_CARD_NAVI_PATH;
        baseInitParam.cachePath = RootUtil.SD_CARD_NAVI_PATH;
        baseInitParam.userDataPath = RootUtil.SD_CARD_NAVI_PATH + "/files/";
        ...
        int initBaseLibs = ServiceMgr.getServiceMgrInstance().initBaseLibs(baseInitParam, this.mContext);
        L.i(sTAG, "initBaseLibs = " + initBaseLibs);
        if (16777217 == initBaseLibs || 16777216 == initBaseLibs || -1 == initBaseLibs) {
