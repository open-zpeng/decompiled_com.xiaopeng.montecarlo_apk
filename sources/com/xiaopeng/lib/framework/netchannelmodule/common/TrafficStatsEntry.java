...
public class TrafficStatsEntry {
    ...
    static {
        ...
        sEntry.put("com.xiaopeng.xuiservice", new Entry(EGAOSREQUESTTYPE.AOS_REQTYPE_PASSPORT_CARLTDCHECKTOKEN, TAG_APP_XUI_SERVICE));
        ...
        sEntry.put(VuiConstants.SETTINS, new Entry(100016, TAG_APP_CAR_SETTINGS));
