...
public class TrafficStatsEntry {
    ...
    static {
        ...
        sEntry.put(IpcConfig.App.CAR_DEVTOOLS, new Entry(100004, TAG_APP_DEV_TOOLS));
        sEntry.put(IpcConfig.App.APP_XUI_SERVICE, new Entry(EGAOSREQUESTTYPE.AOS_REQTYPE_PASSPORT_CARLTDCHECKTOKEN, TAG_APP_XUI_SERVICE));
        sEntry.put(IpcConfig.App.DATA_COLLECTOR, new Entry(EGAOSREQUESTTYPE.AOS_REQTYPE_PASSPORT_CARLTDQUICKLOGIN, TAG_APP_DATA_COLLECTOR));
        sEntry.put("com.xiaopeng.data.uploader", new Entry(EGAOSREQUESTTYPE.AOS_REQTYPE_PASSPORT_CARLTDQUICKREGISTER, TAG_APP_DATA_UPLOADER));
        sEntry.put(IpcConfig.App.CAR_BT_PHONE, new Entry(EGAOSREQUESTTYPE.AOS_REQTYPE_PASSPORT_CARLTDUNBIND, TAG_APP_BLUETOOTH_PHONE));
        sEntry.put("com.xiaopeng.aiavatarservice", new Entry(EGAOSREQUESTTYPE.AOS_REQTYPE_PASSPORT_WSPPAUTOWEIXINQRCODE, TAG_APP_AVATAR_SERVICE));
        sEntry.put(IpcConfig.App.DEVICE_COMMUNICATION, new Entry(EGAOSREQUESTTYPE.AOS_REQTYPE_PASSPORT_WSPPAUTOWEIXINUNBIND, TAG_APP_DEVICE_COMMUNICATION));
        sEntry.put(IpcConfig.App.CAR_CAMERA, new Entry(100011, TAG_APP_CAR_CAMERA));
        sEntry.put(IpcConfig.App.CAR_GALLERY, new Entry(EGAOSREQUESTTYPE.AOS_REQTYPE_PASSPORT_WSPPQRCODEURLTRANSLATE, TAG_APP_CAR_GALLERY));
        sEntry.put("com.android.car", new Entry(EGAOSREQUESTTYPE.AOS_REQTYPE_PASSPORT_WSPPCARLTDCHECKBIND, TAG_APP_CAR_SERVICE));
        sEntry.put("com.xiaopeng.caraccount", new Entry(EGAOSREQUESTTYPE.AOS_REQTYPE_PASSPORT_CARLTDBIND_AUTHINFO, TAG_APP_CAR_ACCOUNT));
