...
public class BizRequestBuilder {
    ...
    private static final List<String> sBasicBizHeaders = Arrays.asList("XP-Appid", "XP-Client", "XP-Client-Encoding", "XP-Client-Type", "XP-Encryption-Type", "XP-Nonce", "XP-Uid", BizConstants.HEADER_AUTHORIZATION);
    ...
    private String bizHeaderValue(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case -576067417:
                ...
                break;
            case 366551663:
                if (str.equals("XP-Encryption-Type")) {
                    c = 5;
                    break;
                }
                c = 65535;
            ...
            case 852785248:
                ...
                break;
            case 1042155584:
                if (str.equals("XP-Client-Encoding")) {
                    c = 3;
                    break;
                }
                c = 65535;
    ...
    private String generateXpClient() {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("di=" + getHardwareId() + LocationUtils.DR_RECORD_DATA_SPLIT_CHAR);
        sb.append("pn=" + GlobalConfig.getApplicationName() + LocationUtils.DR_RECORD_DATA_SPLIT_CHAR);
        sb.append("ve=" + BuildInfoUtils.getSystemVersion() + LocationUtils.DR_RECORD_DATA_SPLIT_CHAR);
        sb.append("br=Xiaopeng;");
        sb.append("mo=" + replaceAll + LocationUtils.DR_RECORD_DATA_SPLIT_CHAR);
        sb.append("st=1;");
        sb.append("sv=" + BuildInfoUtils.getSystemVersion() + LocationUtils.DR_RECORD_DATA_SPLIT_CHAR);
        sb.append("nt=" + getNetworkType() + LocationUtils.DR_RECORD_DATA_SPLIT_CHAR);
        sb.append("t=" + System.currentTimeMillis() + LocationUtils.DR_RECORD_DATA_SPLIT_CHAR);
    ...
    private String getNetworkType() {
        ...
        return networkType != 1 ? networkType != 2 ? networkType != 3 ? networkType != 10 ? "UNKNOWN" : NETWORK_TYPE_WIFI : NETWORK_TYPE_4G : NETWORK_TYPE_3G : NETWORK_TYPE_2G;
    }
