...
public abstract class BaseOssTask implements Runnable {
    ...
    private static final byte[] KEY = {123, TarConstants.LF_FIFO, 90, 56, 23, 74, 89, 71, TarConstants.LF_CONTIG, 78, GnssLocation.LOC_VALID, 40, 100};
                ...
                try {
                    try {
                        try {
                            ...
                            LogUtils.e(TAG, "createOssClient failed, NoSuchAlgorithmException:" + e.getMessage());
                        }
