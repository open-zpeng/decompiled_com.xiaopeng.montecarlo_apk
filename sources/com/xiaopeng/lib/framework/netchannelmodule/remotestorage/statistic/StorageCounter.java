    ...
    private String getErrorCodesInString() {
        ...
        synchronized (this) {
            for (String str : this.mErrorCodes.keySet()) {
                sb.append(str + LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR + this.mErrorCodes.get(str) + LocationUtils.DR_RECORD_DATA_SPLIT_CHAR);
            }
        }
        return sb.toString();
    }
