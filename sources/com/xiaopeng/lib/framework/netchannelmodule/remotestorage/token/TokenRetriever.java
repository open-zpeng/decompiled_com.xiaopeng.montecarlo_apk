...
public final class TokenRetriever {
    ...
    public void getTokenWithCallback(IRetrievingCallback iRetrievingCallback) {
        if (this.mBlockingTime > 0 && System.currentTimeMillis() < this.mBlockingTime) {
            iRetrievingCallback.onFailure(new StorageExceptionImpl(769, String.valueOf((long) RESPONSE_NO_CERTIFICATE)));
    ...
    public class GetTokenCallback implements Callback {
        ...
        public void onFailure(IResponse iResponse) {
            ...
            TokenRetriever.this.callFailureCallbacks(new StorageExceptionImpl(769, message));
        }
        ...
        public void onSuccess(IResponse iResponse) {
            ...
            if (TextUtils.isEmpty(iResponse.body())) {
                TokenRetriever.this.callFailureCallbacks(new StorageExceptionImpl(769, "Empty response!"));
                return;
            }
            ...
            TokenRetriever.this.callFailureCallbacks(new StorageExceptionImpl(769, body));
        }
    }
