...
public class AgentService extends Service {
    ...
    private void startNotification() {
        ...
        startForeground(100, new NotificationCompat.Builder(this, notificationChannel.getId()).setSmallIcon(R.mipmap.icon_notification).setContentTitle(TITLE).setContentText(CONTENT).setPriority(3).setCategory("service").build());
    }
}
