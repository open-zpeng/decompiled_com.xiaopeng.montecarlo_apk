...
public class BuildInfoUtils {
    ...
    public static String getSystemVersion() {
        ...
        return (!"unknown".equals(string) || (indexOf = (fullSystemVersion = getFullSystemVersion()).indexOf(DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT)) <= 1 || (indexOf2 = fullSystemVersion.indexOf(DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT, (i = indexOf + 1))) <= indexOf) ? string : fullSystemVersion.substring(i, indexOf2);
    }
    ...
    public static String getBid() {
        ...
        return (!TextUtils.isEmpty(fullSystemVersion) && (indexOf = fullSystemVersion.indexOf(DebugConfiguration.DebugIntentActionExtra.POINT_SPLIT)) > 1) ? fullSystemVersion.substring(indexOf - 1, indexOf) : "4";
    }

    public static boolean isLanVersion() {
        return "4".equals(getBid());
    }

    public static boolean isPTSpecialVersion() {
        return "5".equals(getBid()) || BID_PT_SPECIAL_2.equals(getBid());
    }
