...
public class BitmapUtils {
    ...
    private static void decodeYUV420SP(int[] iArr, byte[] bArr, int i, int i2) {
        ...
        while (i4 < i2) {
            ...
            int i10 = 0;
            while (i10 < i) {
                int i11 = (bArr[i9] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) - 16;
                if (i11 < 0) {
                    i11 = 0;
                }
                if ((i10 & 1) == 0) {
                    int i12 = i8 + 1;
                    int i13 = i12 + 1;
                    i6 = (bArr[i12] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) - 128;
                    i7 = (bArr[i8] & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) - 128;
                    i8 = i13;
                }
                int i14 = i11 * 1192;
                int i15 = (i7 * 1634) + i14;
