...
public class DateUtils {
    ...
    private static SimpleDateFormat sSimpleFormat3 = new SimpleDateFormat(TimeFormatUtil.DATE_PATTERN_FORMAT_CN);
    private static SimpleDateFormat sSimpleFormat4 = new SimpleDateFormat("yyyy.MM.dd");
    private static SimpleDateFormat sSimpleFormat5 = new SimpleDateFormat(TimeFormatUtil.TIME_PATTERN_FORMAT);
    private static SimpleDateFormat sTimeSimpleFormat = new SimpleDateFormat(TimeFormatUtil.SHORT_TIME_PATTERN_FORMAT);
    private static SimpleDateFormat sBirthdaySimpleFormat = new SimpleDateFormat(TimeFormatUtil.DATE_PATTERN_FORMAT);
