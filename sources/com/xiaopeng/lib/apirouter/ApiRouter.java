...
public class ApiRouter {
    ...
    private static RemoteOperator wakeRemoteService(@NonNull UriStruct uriStruct) throws RemoteException {
        ...
        if (TextUtils.isEmpty(uriStruct.processTag)) {
            ...
            scheme.authority(uriStruct.targetUid + "@" + uriStruct.applicationId + ClientConstants.BINDER.API_SUFFIX);
        } else {
            Uri.Builder scheme2 = builder.scheme("content");
            scheme2.authority(uriStruct.targetUid + "@" + uriStruct.applicationId + "." + uriStruct.processTag + ClientConstants.BINDER.API_SUFFIX);
        }
    ...
    public static <T> T route(@NonNull Builder builder) throws RemoteException {
    ...
    public static <T> T route(@NonNull Uri uri, boolean z) throws RemoteException {
    ...
    public static <T> T route(@NonNull Uri uri, byte[] bArr, boolean z) throws RemoteException {
        return (T) route(uri, true, bArr, z, 0);
    }

    private static <T> T route(@NonNull Uri uri, boolean z, byte[] bArr, boolean z2, int i) throws RemoteException {
