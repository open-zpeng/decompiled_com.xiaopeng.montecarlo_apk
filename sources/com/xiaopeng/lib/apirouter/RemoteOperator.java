...
class RemoteOperator {
    ...
    public Object call(@NonNull Uri uri, boolean z, byte[] bArr) throws RemoteException {
        return call(uri, z, bArr, false);
    }

    public Object call(@NonNull Uri uri, boolean z, byte[] bArr, boolean z2) throws RemoteException {
        ...
        Object obj = null;
        Parcel obtain2 = z2 ? null : Parcel.obtain();
        try {
            ...
            this.mIBinder.transact(remoteMethod.getId(), obtain, obtain2, z2 ? 1 : 0);
            if (obtain2 != null) {
                try {
                    obtain2.readException();
                    obj = readResult(obtain2);
    ...
    public synchronized void linkToDeath() {
        if (this.mDeathRecipient == null) {
            ...
            try {
                ...
                String str = TAG;
                Log.e(str, "linkToDeath:" + this.mAuthority + "'s process has already died");
            }
        }
    }
    ...
    public synchronized void unLinkToDeath(String str) {
        ...
        if (this.mDeathRecipient != null) {
            if (!this.mIBinder.unlinkToDeath(this.mDeathRecipient, 0)) {
                String str2 = TAG;
                Log.e(str2, "unLinkToDeath(" + str + "):" + this.mAuthority + "'s process has already died");
            }
