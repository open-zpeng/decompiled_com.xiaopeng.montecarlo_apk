...
import com.xiaopeng.montecarlo.appengine.SpeechOverallObserver;
/* loaded from: classes2.dex */
public class SpeechOverallObserver_Stub extends Binder implements IInterface {
    public SpeechOverallObserver provider = new SpeechOverallObserver();
    public SpeechOverallObserver_Manifest manifest = new SpeechOverallObserver_Manifest();
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        if (i == 0) {
            parcel.enforceInterface(SpeechOverallObserver_Manifest.DESCRIPTOR);
            ...
            if (i == 1598968902) {
                parcel2.writeString(SpeechOverallObserver_Manifest.DESCRIPTOR);
                return true;
            }
