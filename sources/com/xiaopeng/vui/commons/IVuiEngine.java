...
public interface IVuiEngine {
    ...
    void buildScene(String str, List<View> list, List<String> list2, boolean z);
    ...
    void initScene(Lifecycle lifecycle, String str, View view, IVuiSceneListener iVuiSceneListener);

    void initScene(Lifecycle lifecycle, String str, View view, IVuiSceneListener iVuiSceneListener, IVuiElementChangedListener iVuiElementChangedListener);
    ...
    void vuiFeedback(View view, String str);
}
