...
public class VuiElement implements Cloneable {
    ...
    public static JsonObject getElementAction(String str) {
        ...
        for (int i = 0; i < split.length; i++) {
            if (split[i].contains(LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR)) {
                int indexOf = split[i].indexOf(LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR);
