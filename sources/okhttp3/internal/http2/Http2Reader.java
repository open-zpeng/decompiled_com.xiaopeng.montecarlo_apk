...
public final class Http2Reader implements Closeable {
    ...
    public boolean nextFrame(boolean z, Handler handler) throws IOException {
        try {
            ...
            byte readByte = (byte) (this.source.readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
            if (!z || readByte == 4) {
                byte readByte2 = (byte) (this.source.readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
    ...
    private void readHeaders(Handler handler, int i, byte b, int i2) throws IOException {
        ...
        boolean z = (b & 1) != 0;
        short readByte = (b & 8) != 0 ? (short) (this.source.readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) : (short) 0;
        if ((b & 32) != 0) {
    ...
    private void readPriority(Handler handler, int i) throws IOException {
        ...
        handler.priority(i, readInt & Integer.MAX_VALUE, (this.source.readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) + 1, (Integer.MIN_VALUE & readInt) != 0);
    }
    ...
    public static final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() throws IOException {
            ...
            byte readByte = (byte) (this.source.readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
            this.flags = (byte) (this.source.readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR);
    ...
    static int readMedium(BufferedSource bufferedSource) throws IOException {
        return (bufferedSource.readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) | ((bufferedSource.readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 16) | ((bufferedSource.readByte() & AIMGroupService.AIM_MAX_GROUP_MEMBER_CURSOR) << 8);
    }
