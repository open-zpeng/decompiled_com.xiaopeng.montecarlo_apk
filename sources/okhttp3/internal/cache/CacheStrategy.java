            ...
            if (!cacheControl2.noCache()) {
                ...
                if (j2 < j + computeFreshnessLifetime) {
                    ...
                    if (j2 >= computeFreshnessLifetime) {
                        newBuilder.addHeader(LaneModelDtoConstants.PARTS_WARNING, "110 HttpURLConnection \"Response is stale\"");
                    }
                    if (cacheResponseAge > XpCacheConsts.ONE_DAY && isFreshnessLifetimeHeuristic()) {
                        newBuilder.addHeader(LaneModelDtoConstants.PARTS_WARNING, "113 HttpURLConnection \"Heuristic expiration\"");
                    }
