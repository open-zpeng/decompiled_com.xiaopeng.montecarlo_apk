...
public final class Headers {
    ...
    public static final class Builder {
        ...
        public Builder addLenient(String str) {
            int indexOf = str.indexOf(LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR, 1);
            if (indexOf != -1) {
                return addLenient(str.substring(0, indexOf), str.substring(indexOf + 1));
            }
            if (str.startsWith(LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR)) {
        ...
        public Builder add(String str) {
            int indexOf = str.indexOf(LocationUtils.DR_RECORD_VALUE_SPLIT_CHAR);
            if (indexOf == -1) {
