...
public final class DynamicEnvironmentOuterClass {
    ...
    public interface BPoutputOrBuilder extends MessageOrBuilder {
        ...
        boolean getIsEgoInIntersection();
    ...
    public static final class BPoutput extends GeneratedMessageV3 implements BPoutputOrBuilder {
        ...
        public static final int IS_EGO_IN_INTERSECTION_FIELD_NUMBER = 38;
        ...
        private boolean isEgoInIntersection_;
        ...
        private BPoutput() {
            ...
            this.bpStatus_ = 0;
            this.isEgoInIntersection_ = false;
                    ...
                    try {
                        ...
                        switch (readTag) {
                            ...
                            case MarkUtils.MARKER_ID_TIE_1 /* 296 */:
                                ...
                                continue;
                            case 304:
                                this.isEgoInIntersection_ = codedInputStream.readBool();
                                continue;
                            case 317:
        ...
        @Override // xpilot.sr.proto.DynamicEnvironmentOuterClass.BPoutputOrBuilder
        public boolean getIsEgoInIntersection() {
            return this.isEgoInIntersection_;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            boolean z = this.isEgoInIntersection_;
            if (z) {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements BPoutputOrBuilder {
            ...
            public BPoutput buildPartial() {
                ...
                bPoutput.isEgoInIntersection_ = this.isEgoInIntersection_;
            ...
            public Builder mergeFrom(BPoutput bPoutput) {
                ...
                if (bPoutput.getIsEgoInIntersection()) {
                    setIsEgoInIntersection(bPoutput.getIsEgoInIntersection());
                }
            ...
            */
            ...
            public Builder setIsEgoInIntersection(boolean z) {
                this.isEgoInIntersection_ = z;
                onChanged();
                return this;
            }

            public Builder clearIsEgoInIntersection() {
                this.isEgoInIntersection_ = false;
                onChanged();
                return this;
            }
