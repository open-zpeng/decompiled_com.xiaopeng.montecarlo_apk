...
public class SimpleSlider extends View {
    ...
    /* JADX WARN: Type inference failed for: r3v1, types: [java.lang.Object, android.content.res.TypedArray] */
    /* JADX WARN: Type inference failed for: r3v2, types: [java.lang.Object, android.content.res.TypedArray] */
    /* JADX WARN: Type inference failed for: r4v3, types: [int, android.graphics.drawable.Drawable] */
    /* JADX WARN: Type inference failed for: r4v6, types: [int, android.graphics.drawable.Drawable] */
    private void init(Context context, AttributeSet attributeSet, int i, int i2) {
        int[] iArr = R.styleable.SimpleSlider;
        this.mProgressDrawableRes = attributeSet.getResourceId(R.styleable.SimpleSlider_android_progressDrawable, this.mProgressDrawableRes);
        ?? r4 = R.styleable.SimpleSlider_android_progressDrawable;
        ?? obj = new Object();
        setProgressDrawable(r4);
        this.mTickMarkRes = obj.getResourceId(R.styleable.SimpleSlider_android_tickMark, this.mTickMarkRes);
        ?? r42 = R.styleable.SimpleSlider_android_tickMark;
        ?? obj2 = new Object();
        setTickMark(r42);
        this.mTickMarkAll = obj2.getBoolean(R.styleable.SimpleSlider_ss_tickMarkAll, this.mTickMarkAll);
        this.mTickMarkPadding = obj2.getDimension(R.styleable.SimpleSlider_ss_tickMark_padding, this.mTickMarkPadding);
        this.mTickMarkProgressEnd = obj2.getBoolean(R.styleable.SimpleSlider_ss_tickMark_ProgressEnd, this.mTickMarkProgressEnd);
        this.mSlideScale = obj2.getFloat(R.styleable.SimpleSlider_ss_slideScale, this.mSlideScale);
        this.mEnabled = obj2.getBoolean(R.styleable.SimpleSlider_android_enabled, this.mEnabled);
        this.mDisabledAlpha = obj2.getFloat(R.styleable.SimpleSlider_android_disabledAlpha, 0.36f);
        setMin(obj2.getInt(R.styleable.SimpleSlider_android_min, this.mMin));
        setMax(obj2.getInt(R.styleable.SimpleSlider_android_max, this.mMax));
        setProgress(obj2.getInt(R.styleable.SimpleSlider_android_progress, this.mProgress));
        this.mTouchMode = obj2.getInt(R.styleable.SimpleSlider_ss_touchMode, this.mTouchMode);
