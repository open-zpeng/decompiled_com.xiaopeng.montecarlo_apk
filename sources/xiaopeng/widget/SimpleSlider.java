...
public class SimpleSlider extends View {
    ...
    /* JADX WARN: Type inference failed for: r3v1, types: [lombok.launch.PatchFixesHider$Util, android.content.res.TypedArray] */
    /* JADX WARN: Type inference failed for: r4v3, types: [int, java.lang.Class] */
    /* JADX WARN: Type inference failed for: r4v4, types: [java.lang.reflect.Method, android.graphics.drawable.Drawable] */
    /* JADX WARN: Type inference failed for: r4v7, types: [int, java.lang.Class] */
    /* JADX WARN: Type inference failed for: r4v8, types: [java.lang.reflect.Method, android.graphics.drawable.Drawable] */
    private void init(Context context, AttributeSet attributeSet, int i, int i2) {
        ?? r0 = R.styleable.SimpleSlider;
        ?? obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, r0, i, i2);
        ...
        setProgressDrawable(obtainStyledAttributes.findMethod(R.styleable.SimpleSlider_android_progressDrawable, r0, r0));
        this.mTickMarkRes = obtainStyledAttributes.getResourceId(R.styleable.SimpleSlider_android_tickMark, this.mTickMarkRes);
        setTickMark(obtainStyledAttributes.findMethod(R.styleable.SimpleSlider_android_tickMark, r0, r0));
