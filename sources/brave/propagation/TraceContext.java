...
public final class TraceContext extends SamplingFlags {
    ...
    public int hashCode() {
        ...
        if (i == 0) {
            long j = this.traceIdHigh;
            int i2 = (((int) (j ^ (j >>> 32))) ^ LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
            long j2 = this.traceId;
            int i3 = (i2 ^ ((int) (j2 ^ (j2 >>> 32)))) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS;
            long j3 = this.spanId;
            int i4 = ((i3 ^ ((int) ((j3 >>> 32) ^ j3))) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ (this.flags & 16);
            this.hashCode = i4;
            return i4;
        }
        return i;
