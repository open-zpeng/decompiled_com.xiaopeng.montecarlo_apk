...
public final class TraceContextOrSamplingFlags {
    ...
    public int hashCode() {
        return ((((this.type ^ LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ this.value.hashCode()) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ this.extra.hashCode();
    }
