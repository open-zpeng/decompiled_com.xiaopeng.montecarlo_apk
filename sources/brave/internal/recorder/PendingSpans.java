...
public final class PendingSpans extends ReferenceQueue<TraceContext> {
    ...
    static final class LookupKey {
        ...
        static int generateHashCode(long j, long j2, long j3, boolean z) {
            return ((((((((int) (j ^ (j >>> 32))) ^ LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ ((int) (j2 ^ (j2 >>> 32)))) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ ((int) ((j3 >>> 32) ^ j3))) * LogModuleType.LOG_SENCE_LAYER_RASTER_CROSS) ^ (z ? 16 : 0);
        }
