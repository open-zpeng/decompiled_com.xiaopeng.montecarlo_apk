...
public class GifTextureView extends TextureView {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [lombok.launch.PatchFixesHider$Util, android.graphics.Matrix] */
    /* JADX WARN: Type inference failed for: r3v2, types: [float, java.lang.reflect.Method] */
    ...
    public void updateTextureViewSize(GifInfoHandle gifInfoHandle) {
        ...
        ?? width2 = gifInfoHandle.getWidth() / width;
        ?? height2 = gifInfoHandle.getHeight() / height;
        ...
        switch (AnonymousClass1.$SwitchMap$android$widget$ImageView$ScaleType[this.mScaleType.ordinal()]) {
            case 1:
                ...
                break;
            case 2:
                float min = 1.0f / Math.min((float) width2, (float) height2);
            ...
            case 4:
                ...
                matrix.invokeMethod(width2, height2);
                break;
            case 5:
